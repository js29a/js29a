...
const mt = {}, ua = [], Fn = () => {
}, wg = () => false, Do = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && (e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Ku = (e) => e.startsWith("onUpdate:"), It = Object.assign, Wu = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, Sg = Object.prototype.hasOwnProperty, st = (e, t) => Sg.call(e, t), je = Array.isArray, Ga = (e) => kr(e) === "[object Map]", xg = (e) => kr(e) === "[object Set]", Cg = (e) => kr(e) === "[object RegExp]", Qe = (e) => typeof e == "function", Rt = (e) => typeof e == "string", ka = (e) => typeof e == "symbol", Et = (e) => e !== null && typeof e == "object", Cf = (e) => (Et(e) || Qe(e)) && Qe(e.then) && Qe(e.catch), kg = Object.prototype.toString, kr = (e) => kg.call(e), qg = (e) => kr(e).slice(8, -1), Tg = (e) => kr(e) === "[object Object]", Yu = (e) => Rt(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Xa = /* @__PURE__ */ Qu(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"), No = (e) => {
  const t = /* @__PURE__ */ Object.create(null);
...
const Fg = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Og = /* @__PURE__ */ Qu(Fg);
function qf(e) {
  return !!e || e === "";
}
/**
...
function $f(e) {
  ...
  for (; l; ) {
    const a = l.prevDep;
    l.version === -1 ? (l === n && (n = a), es(l), zg(l)) : t = l, l.dep.activeLink = l.prevActiveLink, l.prevActiveLink = void 0, l = a;
  }
...
const su = /* @__PURE__ */ new WeakMap(), Fl = Symbol(""), cu = Symbol(""), fr = Symbol("");
function Kt(e, t, n) {
  if (qn && bt) {
    let l = su.get(e);
...
function Kn(e, t, n, l, a, r) {
  ...
  if (Zu(), t === "clear") o.forEach(i);
    ...
    if (u && n === "length") {
      ...
      case "add":
        u ? c && i(o.get("length")) : (i(o.get(Fl)), Ga(e) && i(o.get(cu)));
        break;
      case "delete":
        u || (i(o.get(Fl)), Ga(e) && i(o.get(cu)));
        break;
      case "set":
        Ga(e) && i(o.get(Fl));
        break;
...
function Gg(e, t, n) {
  return function(...l) {
    ...
    return !t && Kt(r, "iterate", u ? cu : Fl), { next() {
...
function as(e) {
  return rs(e, false, Yg, Jg, If);
}
function Df(e) {
  return rs(e, true, Wg, e0, zf);
}
...
function c0(e, t, n = mt) {
  ...
  if (pt(e) ? (v = () => e.value, g = Tn(e)) : tr(e) ? (v = () => c(e), g = true) : je(e) ? (w = true, g = e.some((b) => tr(b) || Tn(b)), v = () => e.map((b) => {
  ...
  const S = Ig(), q = () => {
    s.stop(), S && S.active && Wu(S.effects, s);
  };
  if (r && t) {
    const b = t;
    t = (..._) => {
  ...
  const y = (b) => {
    if (!(!(s.flags & 1) || !s.dirty && !b)) if (t) {
      const _ = s.run();
      if (a || g || (w ? _.some((E, $) => ml(E, p[$])) : ml(_, p))) {
        h && h();
        const E = Al;
        Al = s;
        try {
          const $ = [_, p === Fr ? void 0 : w && p[0] === Fr ? [] : p, m];
          u ? u(t, 3, $) : t(...$), p = _;
        } finally {
          Al = E;
        }
...
const Yf = Symbol("_vte"), Gf = (e) => e.__isTeleport, nr = (e) => e && (e.disabled || e.disabled === ""), tc = (e) => e && (e.defer || e.defer === ""), nc = (e) => typeof SVGElement < "u" && e instanceof SVGElement, lc = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, vu = (e, t) => {
  ...
  if (e == null) {
    ...
    const $ = (L, P) => {
      ...
      const L = t.target = vu(t.props, g), P = Zf(L, t, w, m);
      L && (o !== "svg" && nc(L) ? o = "svg" : o !== "mathml" && lc(L) && (o = "mathml"), q || ($(L, P), to(t, false)));
    };
    q && ($(n, E), to(t, true)), tc(t.props) ? Bt(() => {
    ...
    const _ = t.anchor = e.anchor, E = t.target = e.target, $ = t.targetAnchor = e.targetAnchor, V = nr(e.props), L = V ? n : E, P = V ? _ : $;
    if (o === "svg" || nc(E) ? o = "svg" : (o === "mathml" || lc(E)) && (o = "mathml"), b ? (h(e.dynamicChildren, b, L, a, r, o, i), ds(e, t, true)) : u || v(e, t, L, P, a, r, o, i, false), q) V ? t.props && e.props && t.props.to !== e.props.to && (t.props.to = e.props.to) : Or(t, n, _, c, 1);
    else if ((t.props && t.props.to) !== (e.props && e.props.to)) {
      const F = t.target = vu(t.props, g);
      F && Or(t, F, null, c, 0);
    } else V && Or(t, E, $, c, 1);
    to(t, q);
  }
...
function mr(e, t, n, l, a) {
  const { appear: r, mode: o, persisted: i = false, onBeforeEnter: u, onEnter: c, onAfterEnter: s, onEnterCancelled: v, onBeforeLeave: h, onLeave: m, onAfterLeave: g, onLeaveCancelled: w, onBeforeAppear: S, onAppear: q, onAfterAppear: p, onAppearCancelled: y } = t, b = String(e.key), _ = lv(n, e), E = (L, P) => {
    L && En(L, l, 9, P);
  }, $ = (L, P) => {
    const F = P[1];
    E(L, P), je(L) ? L.every((T) => T.length <= 1) && F() : L.length <= 1 && F();
...
function go(e, t, n, l, a = false) {
  if (je(e)) {
    e.forEach((g, w) => go(g, t && (je(t) ? t[w] : t), n, l, a));
    return;
  }
  if (ca(l) && !a) {
    ...
    if (g || w) {
      const S = () => {
        if (e.f) {
          ...
          a ? je(q) && Wu(q, r) : je(q) ? q.includes(r) || q.push(r) : g ? (s[u] = [r], m(u) && (v[u] = s[u])) : (u.value = [r], e.k && (s[e.k] = u.value));
...
const ca = (e) => !!e.type.__asyncLoader, Qo = (e) => e.type.__isKeepAlive, y0 = { name: "KeepAlive", __isKeepAlive: true, props: { include: [String, RegExp, Array], exclude: [String, RegExp, Array], max: [String, Number] }, setup(e, { slots: t }) {
  ...
  l.activate = (p, y, b, _, E) => {
    const $ = p.component;
    c(p, y, b, 0, i), u($.vnode, p, y, b, $, i, _, p.slotScopeIds, E), Bt(() => {
      $.isDeactivated = false, $.a && Za($.a);
  ...
  return ft(q), Yo(q), Ke(() => {
    ...
    const _ = b.type, E = pu(ca(b) ? b.type.__asyncResolved || {} : _), { include: $, exclude: V, max: L } = e;
    if ($ && (!E || !ja($, E)) || V && E && ja(V, E)) return b.shapeFlag &= -257, o = b, y;
    const P = b.key == null ? _ : b.key, F = a.get(P);
    return b.el && (b = Gn(b), y.shapeFlag & 128 && (y.ssContent = b)), S = P, F ? (b.el = F.el, b.component = F.component, b.transition && bl(b, b.transition), b.shapeFlag |= 512, r.delete(P), r.add(P)) : (r.add(P), L && r.size > parseInt(L, 10) && w(r.values().next().value)), b.shapeFlag |= 256, o = b, po(y.type) ? y : b;
  };
} }, rv = y0;
function ja(e, t) {
...
const mu = (e) => e ? Mv(e) ? Jo(e) : mu(e.parent) : null, lr = It(/* @__PURE__ */ Object.create(null), { $: (e) => e, $el: (e) => e.vnode.el, $data: (e) => e.data, $props: (e) => e.props, $attrs: (e) => e.attrs, $slots: (e) => e.slots, $refs: (e) => e.refs, $parent: (e) => mu(e.parent), $root: (e) => mu(e.root), $host: (e) => e.ce, $emit: (e) => e.emit, $options: (e) => cv(e), $forceUpdate: (e) => e.f || (e.f = () => {
  is(e.update);
...
function M0(e) {
  ...
  s && ic(s, e, "c");
  function H(j, W) {
    je(W) ? W.forEach((te) => j(te.bind(n))) : W && j(W.bind(n));
  }
  if (H(Wo, v), H(ft, h), H(Ta, m), H(Yo, g), H(_l, w), H(On, S), H(x0, V), H(S0, E), H(w0, $), H(Ke, p), H(Go, b), H(_0, L), je(P)) if (P.length) {
    const j = e.exposed || (e.exposed = {});
    P.forEach((W) => {
      Object.defineProperty(j, W, { get: () => n[W], set: (te) => n[W] = te });
    });
  } else e.exposed || (e.exposed = {});
  _ && e.render === Fn && (e.render = _), F != null && (e.inheritAttrs = F), T && (e.components = T), x && (e.directives = x), L && av(e);
}
...
const A0 = { data: uc, props: sc, emits: sc, methods: Ua, computed: Ua, beforeCreate: Yt, created: Yt, beforeMount: Yt, mounted: Yt, beforeUpdate: Yt, updated: Yt, beforeDestroy: Yt, beforeUnmount: Yt, destroyed: Yt, unmounted: Yt, activated: Yt, deactivated: Yt, errorCaptured: Yt, serverPrefetch: Yt, components: Ua, directives: Ua, watch: R0, provide: uc, inject: $0 };
function uc(e, t) {
  return t ? e ? function() {
...
function sc(e, t) {
  return e ? je(e) && je(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : It(/* @__PURE__ */ Object.create(null), oc(e), oc(t ?? {})) : t;
}
function R0(e, t) {
  if (!e) return t;
  if (!t) return e;
...
function F0(e, t, n, l) {
  ...
  if ((l || o > 0) && !(o & 16)) {
    ...
    hv(e, t, a, r) && (c = true);
    let s;
    for (const v in i) (!t || !st(t, v) && ((s = Ul(v)) === v || !st(t, s))) && (u ? n && (n[v] !== void 0 || n[s] !== void 0) && (a[v] = bu(u, i, v, void 0, e, true)) : delete a[v]);
...
function H0(e, t) {
  ...
  const n = qr();
  n.__VUE__ = true;
  const { insert: l, remove: a, patchProp: r, createElement: o, createText: i, createComment: u, setText: c, setElementText: s, parentNode: v, nextSibling: h, setScopeId: m = Fn, insertStaticContent: g } = e, w = (k, A, z, Z = null, ne = null, K = null, de = void 0, me = null, fe = !!A.dynamicChildren) => {
    if (k === A) return;
    k && !fl(k, A) && (Z = R(k), M(k, ne, K, true), k = null), A.patchFlag === -2 && (fe = false, A.dynamicChildren = null);
    const { type: ce, ref: le, shapeFlag: N } = A;
    switch (ce) {
      case Zo:
        S(k, A, z, Z);
        break;
      ...
      case ki:
        ...
        break;
      case rn:
        T(k, A, z, Z, ne, K, de, me, fe);
        break;
      default:
        N & 1 ? _(k, A, z, Z, ne, K, de, me, fe) : N & 6 ? x(k, A, z, Z, ne, K, de, me, fe) : (N & 64 || N & 128) && ce.process(k, A, z, Z, ne, K, de, me, fe, re);
    }
    le != null && ne && go(le, k && k.ref, K, A || k, !A);
  }, S = (k, A, z, Z) => {
    if (k == null) l(A.el = i(A.children), z, Z);
    else {
      const ne = A.el = k.el;
      A.children !== k.children && c(ne, A.children);
    }
  }, q = (k, A, z, Z) => {
    k == null ? l(A.el = u(A.children || ""), z, Z) : A.el = k.el;
  }, p = (k, A, z, Z) => {
    [k.el, k.anchor] = g(k.children, A, z, Z, k.el, k.anchor);
  }, y = ({ el: k, anchor: A }, z, Z) => {
    let ne;
    for (; k && k !== A; ) ne = h(k), l(k, z, Z), k = ne;
    l(A, z, Z);
  }, b = ({ el: k, anchor: A }) => {
    let z;
    for (; k && k !== A; ) z = h(k), a(k), k = z;
    a(A);
  }, _ = (k, A, z, Z, ne, K, de, me, fe) => {
    A.type === "svg" ? de = "svg" : A.type === "math" && (de = "mathml"), k == null ? E(A, z, Z, ne, K, de, me, fe) : L(k, A, ne, K, de, me, fe);
  }, E = (k, A, z, Z, ne, K, de, me) => {
    let fe, ce;
    const { props: le, shapeFlag: N, transition: oe, dirs: _e } = k;
    if (fe = k.el = o(k.type, K, le && le.is, le), N & 8 ? s(fe, k.children) : N & 16 && V(k.children, fe, null, Z, ne, Ci(k, K), de, me), _e && xl(k, null, Z, "created"), $(fe, k, k.scopeId, de, Z), le) {
    ...
    _e && xl(k, null, Z, "beforeMount");
    const ke = j0(ne, oe);
    ke && oe.beforeEnter(fe), l(fe, A, z), ((ce = le && le.onVnodeMounted) || ke || _e) && Bt(() => {
      ce && vn(ce, Z, k), ke && oe.enter(fe), _e && xl(k, null, Z, "mounted");
    }, ne);
  }, $ = (k, A, z, Z, ne) => {
    if (z && m(k, z), Z) for (let K = 0; K < Z.length; K++) m(k, Z[K]);
    if (ne) {
      let K = ne.subTree;
      if (A === K || po(K.type) && (K.ssContent === A || K.ssFallback === A)) {
        const de = ne.vnode;
        $(k, de, de.scopeId, de.slotScopeIds, ne.parent);
      }
    }
  }, V = (k, A, z, Z, ne, K, de, me, fe = 0) => {
    for (let ce = fe; ce < k.length; ce++) {
      const le = k[ce] = me ? cl(k[ce]) : Ln(k[ce]);
      w(null, le, A, z, Z, ne, K, de, me);
    }
  }, L = (k, A, z, Z, ne, K, de) => {
    const me = A.el = k.el;
    let { patchFlag: fe, dynamicChildren: ce, dirs: le } = A;
    fe |= k.patchFlag & 16;
    const N = k.props || mt, oe = A.props || mt;
    let _e;
    if (z && Cl(z, false), (_e = oe.onVnodeBeforeUpdate) && vn(_e, z, A, k), le && xl(A, k, z, "beforeUpdate"), z && Cl(z, true), (N.innerHTML && oe.innerHTML == null || N.textContent && oe.textContent == null) && s(me, ""), ce ? P(k.dynamicChildren, ce, me, z, Z, Ci(A, ne), K) : de || W(k, A, me, null, z, Z, Ci(A, ne), K, false), fe > 0) {
      if (fe & 16) F(me, N, oe, z, ne);
        ...
        for (let qe = 0; qe < ke.length; qe++) {
          const Me = ke[qe], Ne = N[Me], Ve = oe[Me];
          (Ve !== Ne || Me === "value") && r(me, Me, Ne, Ve, ne, z);
        }
      }
      fe & 1 && k.children !== A.children && s(me, A.children);
    } else !de && ce == null && F(me, N, oe, z, ne);
    ((_e = oe.onVnodeUpdated) || le) && Bt(() => {
      _e && vn(_e, z, A, k), le && xl(A, k, z, "updated");
    }, Z);
  }, P = (k, A, z, Z, ne, K, de) => {
    for (let me = 0; me < A.length; me++) {
      const fe = k[me], ce = A[me], le = fe.el && (fe.type === rn || !fl(fe, ce) || fe.shapeFlag & 70) ? v(fe.el) : z;
      w(fe, ce, le, null, Z, ne, K, de, true);
    }
  }, F = (k, A, z, Z, ne) => {
    if (A !== z) {
      if (A !== mt) for (const K in A) !Xa(K) && !(K in z) && r(k, K, A[K], null, ne, Z);
      for (const K in z) {
        if (Xa(K)) continue;
        const de = z[K], me = A[K];
        de !== me && K !== "value" && r(k, K, me, de, ne, Z);
      }
      "value" in z && r(k, "value", A.value, z.value, ne);
    }
  }, T = (k, A, z, Z, ne, K, de, me, fe) => {
    const ce = A.el = k ? k.el : i(""), le = A.anchor = k ? k.anchor : i("");
    let { patchFlag: N, dynamicChildren: oe, slotScopeIds: _e } = A;
    _e && (me = me ? me.concat(_e) : _e), k == null ? (l(ce, z, Z), l(le, z, Z), V(A.children || [], z, le, ne, K, de, me, fe)) : N > 0 && N & 64 && oe && k.dynamicChildren ? (P(k.dynamicChildren, oe, z, ne, K, de, me), (A.key != null || ne && A === ne.subTree) && ds(k, A, true)) : W(k, A, z, le, ne, K, de, me, fe);
  }, x = (k, A, z, Z, ne, K, de, me, fe) => {
    A.slotScopeIds = me, k == null ? A.shapeFlag & 512 ? ne.ctx.activate(A, z, Z, de, fe) : C(A, z, Z, ne, K, de, fe) : D(k, A, fe);
  }, C = (k, A, z, Z, ne, K, de) => {
    const me = k.component = ub(k, Z, ne);
    if (Qo(k) && (me.ctx.renderer = re), sb(me, false, de), me.asyncDep) {
      if (ne && ne.registerDep(me, H, de), !k.el) {
        const fe = me.subTree = Je(Zt);
        q(null, fe, A, z);
      }
    } else H(me, k, A, z, ne, K, de);
  }, D = (k, A, z) => {
    const Z = A.component = k.component;
    if (J0(k, A, z)) if (Z.asyncDep && !Z.asyncResolved) {
      j(Z, A, z);
      return;
    } else Z.next = A, Z.update();
    else A.el = k.el, Z.vnode = A;
  }, H = (k, A, z, Z, ne, K, de) => {
    const me = () => {
      if (k.isMounted) {
        ...
        let Me = N, Ne;
        Cl(k, false), N ? (N.el = qe.el, j(k, N, de)) : N = qe, oe && Za(oe), (Ne = N.props && N.props.onVnodeBeforeUpdate) && vn(Ne, ke, N, qe), Cl(k, true);
        const Ve = dc(k), ie = k.subTree;
        k.subTree = Ve, w(ie, Ve, v(ie.el), R(ie), k, ne, K), N.el = Ve.el, Me === null && eb(k, Ve.el), _e && Bt(_e, ne), (Ne = N.props && N.props.onVnodeUpdated) && Bt(() => vn(Ne, ke, N, qe), ne);
      } else {
        let N;
        const { el: oe, props: _e } = A, { bm: ke, m: qe, parent: Me, root: Ne, type: Ve } = k, ie = ca(A);
        Cl(k, false), ke && Za(ke), !ie && (N = _e && _e.onVnodeBeforeMount) && vn(N, Me, A), Cl(k, true);
        {
          Ne.ce && Ne.ce._injectChildStyle(Ve);
          const ge = k.subTree = dc(k);
          w(null, ge, z, Z, k, ne, K), A.el = ge.el;
        }
        if (qe && Bt(qe, ne), !ie && (N = _e && _e.onVnodeMounted)) {
          const ge = A;
          Bt(() => vn(N, Me, ge), ne);
        }
        (A.shapeFlag & 256 || Me && ca(Me.vnode) && Me.vnode.shapeFlag & 256) && k.a && Bt(k.a, ne), k.isMounted = true, A = z = Z = null;
      }
    };
    k.scope.on();
    const fe = k.effect = new Tf(me);
    k.scope.off();
    const ce = k.update = fe.run.bind(fe), le = k.job = fe.runIfDirty.bind(fe);
    le.i = k, le.id = k.uid, fe.scheduler = () => is(le), Cl(k, true), ce();
  }, j = (k, A, z) => {
    A.component = k;
    const Z = k.vnode.props;
    k.vnode = A, k.next = null, F0(k, A.props, Z, z), z0(k, A.children, z), yl(), ec(k), pl();
  }, W = (k, A, z, Z, ne, K, de, me, fe = false) => {
    const ce = k && k.children, le = k ? k.shapeFlag : 0, N = A.children, { patchFlag: oe, shapeFlag: _e } = A;
    if (oe > 0) {
      if (oe & 128) {
  ...
  }, te = (k, A, z, Z, ne, K, de, me, fe) => {
    k = k || ua, A = A || ua;
    const ce = k.length, le = A.length, N = Math.min(ce, le);
    let oe;
    for (oe = 0; oe < N; oe++) {
      const _e = A[oe] = fe ? cl(A[oe]) : Ln(A[oe]);
      w(k[oe], _e, z, null, ne, K, de, me, fe);
    }
    ce > le ? B(k, ne, K, true, false, N) : V(A, z, Z, ne, K, de, me, fe, N);
  }, pe = (k, A, z, Z, ne, K, de, me, fe) => {
    let ce = 0;
    const le = A.length;
    let N = k.length - 1, oe = le - 1;
    for (; ce <= N && ce <= oe; ) {
      const _e = k[ce], ke = A[ce] = fe ? cl(A[ce]) : Ln(A[ce]);
      if (fl(_e, ke)) w(_e, ke, z, null, ne, K, de, me, fe);
      else break;
      ce++;
    }
    for (; ce <= N && ce <= oe; ) {
      const _e = k[N], ke = A[oe] = fe ? cl(A[oe]) : Ln(A[oe]);
      if (fl(_e, ke)) w(_e, ke, z, null, ne, K, de, me, fe);
      else break;
      N--, oe--;
    }
    if (ce > N) {
      if (ce <= oe) {
        const _e = oe + 1, ke = _e < le ? A[_e].el : Z;
        for (; ce <= oe; ) w(null, A[ce] = fe ? cl(A[ce]) : Ln(A[ce]), z, ke, ne, K, de, me, fe), ce++;
      }
    } else if (ce > oe) for (; ce <= N; ) M(k[ce], ne, K, true), ce++;
    else {
      const _e = ce, ke = ce, qe = /* @__PURE__ */ new Map();
      for (ce = ke; ce <= oe; ce++) {
        const Ce = A[ce] = fe ? cl(A[ce]) : Ln(A[ce]);
      ...
      for (ce = _e; ce <= N; ce++) {
        ...
        else for (Me = ke; Me <= oe; Me++) if (ae[Me - ke] === 0 && fl(Ce, A[Me])) {
          Oe = Me;
          break;
        }
        Oe === void 0 ? M(Ce, ne, K, true) : (ae[Oe - ke] = ce + 1, Oe >= ge ? ge = Oe : ie = true, w(Ce, A[Oe], z, null, ne, K, de, me, fe), Ne++);
      }
      const ye = ie ? U0(ae) : ua;
      for (Me = ye.length - 1, ce = Ve - 1; ce >= 0; ce--) {
        const Ce = ke + ce, Oe = A[Ce], Ae = Ce + 1 < le ? A[Ce + 1].el : Z;
        ae[ce] === 0 ? w(null, Oe, z, Ae, ne, K, de, me, fe) : ie && (Me < 0 || ce !== ye[Me] ? Q(Oe, z, Ae, 2) : Me--);
      }
    }
  }, Q = (k, A, z, Z, ne = null) => {
    const { el: K, type: de, transition: me, children: fe, shapeFlag: ce } = k;
    if (ce & 6) {
      Q(k.component.subTree, A, z, Z);
      return;
    }
    if (ce & 128) {
      k.suspense.move(A, z, Z);
      return;
    }
    if (ce & 64) {
      de.move(k, A, z, re);
    ...
    if (de === rn) {
      l(K, A, z);
      for (let N = 0; N < fe.length; N++) Q(fe[N], A, z, Z);
      l(k.anchor, A, z);
      return;
    }
    if (de === ki) {
    ...
    if (Z !== 2 && ce & 1 && me) if (Z === 0) me.beforeEnter(K), l(K, A, z), Bt(() => me.enter(K), ne);
    else {
      const { leave: N, delayLeave: oe, afterLeave: _e } = me, ke = () => l(K, A, z), qe = () => {
        N(K, () => {
          ke(), _e && _e();
        });
      };
  ...
  }, M = (k, A, z, Z = false, ne = false) => {
    const { type: K, props: de, ref: me, children: fe, dynamicChildren: ce, shapeFlag: le, patchFlag: N, dirs: oe, cacheIndex: _e } = k;
    if (N === -2 && (ne = false), me != null && go(me, null, z, k, true), _e != null && (A.renderCache[_e] = void 0), le & 256) {
      A.ctx.deactivate(k);
      return;
    }
    const ke = le & 1 && oe, qe = !ca(k);
    let Me;
    if (qe && (Me = de && de.onVnodeBeforeUnmount) && vn(Me, A, k), le & 6) be(k.component, z, Z);
    else {
      if (le & 128) {
        k.suspense.unmount(z, Z);
        return;
      }
      ke && xl(k, null, A, "beforeUnmount"), le & 64 ? k.type.remove(k, A, z, re, Z) : ce && !ce.hasOnce && (K !== rn || N > 0 && N & 64) ? B(ce, A, z, false, true) : (K === rn && N & 384 || !ne && le & 16) && B(fe, A, z), Z && ee(k);
    }
    (qe && (Me = de && de.onVnodeUnmounted) || ke) && Bt(() => {
      Me && vn(Me, A, k), ke && xl(k, null, A, "unmounted");
    }, z);
  }, ee = (k) => {
    const { type: A, el: z, anchor: Z, transition: ne } = k;
    if (A === rn) {
      X(z, Z);
      return;
    }
    ...
    let z;
    for (; k !== A; ) z = h(k), a(k), k = z;
    a(A);
  }, be = (k, A, z) => {
    const { bum: Z, scope: ne, job: K, subTree: de, um: me, m: fe, a: ce } = k;
    yo(fe), yo(ce), Z && Za(Z), ne.stop(), K && (K.flags |= 8, M(de, k, A, z)), me && Bt(me, A), Bt(() => {
      k.isUnmounted = true;
    }, A), A && A.pendingBranch && !A.isUnmounted && k.asyncDep && !k.asyncResolved && k.suspenseId === A.pendingId && (A.deps--, A.deps === 0 && A.resolve());
  }, B = (k, A, z, Z = false, ne = false, K = 0) => {
    for (let de = K; de < k.length; de++) M(k[de], A, z, Z, ne);
  }, R = (k) => {
    if (k.shapeFlag & 6) return R(k.component.subTree);
    if (k.shapeFlag & 128) return k.suspense.next();
    const A = h(k.anchor || k.el), z = A && A[Yf];
    return z ? h(z) : A;
  };
  let J = false;
  const O = (k, A, z) => {
    k == null ? A._vnode && M(A._vnode, null, null, true) : w(A._vnode || null, k, A, null, null, null, z), A._vnode = k, J || (J = true, ec(), Qf(), J = false);
...
function dc(e) {
  const { type: t, vnode: n, proxy: l, withProxy: a, propsOptions: [r], slots: o, attrs: i, emit: u, render: c, renderCache: s, props: v, data: h, setupState: m, ctx: g, inheritAttrs: w } = e, S = ho(e);
  let q, p;
  try {
    if (n.shapeFlag & 4) {
      const b = a || l, _ = b;
  ...
  if (p && w !== false) {
    ...
    b.length && _ & 7 && (r && b.some(Ku) && (p = Z0(p, r)), y = Gn(y, p, false, true));
  }
...
function lb(e, t = null, n = null, l = 0, a = null, r = false) {
  ...
  if (mb(e) && (e = e.__vccOpts), t) {
    ...
    i && !Rt(i) && (t.class = Xu(i)), Et(u) && (os(u) && !je(u) && (u = It({}, u)), t.style = Gu(u));
  }
  const o = Rt(e) ? 1 : po(e) ? 128 : Gf(e) ? 64 : Et(e) ? 4 : Qe(e) ? 2 : 0;
  return fa(e, t, n, l, a, o, r, true);
}
function ab(e) {
  return e ? os(e) || mv(e) ? It({}, e) : e : null;
}
...
let _o, yu;
{
  ...
  _o = t("__VUE_INSTANCE_SETTERS__", (n) => Ht = n), yu = t("__VUE_SSR_SETTERS__", (n) => br = n);
}
const Mr = (e) => {
  const t = Ht;
...
const Av = _u ? (e) => _u.createHTML(e) : (e) => e, gb = "http://www.w3.org/2000/svg", bb = "http://www.w3.org/1998/Math/MathML", Qn = typeof document < "u" ? document : null, yc = Qn && Qn.createElement("template"), yb = { insert: (e, t, n) => {
  ...
  if (a && (a === r || a.nextSibling)) for (; t.insertBefore(a.cloneNode(true), n), !(a === r || !(a = a.nextSibling)); ) ;
    ...
    yc.innerHTML = Av(l === "svg" ? `<svg>${e}</svg>` : l === "mathml" ? `<math>${e}</math>` : e);
    const i = yc.content;
    if (l === "svg" || l === "mathml") {
...
function Pv(e) {
  ...
  const { name: n = "v", type: l, duration: a, enterFromClass: r = `${n}-enter-from`, enterActiveClass: o = `${n}-enter-active`, enterToClass: i = `${n}-enter-to`, appearFromClass: u = r, appearActiveClass: c = o, appearToClass: s = i, leaveFromClass: v = `${n}-leave-from`, leaveActiveClass: h = `${n}-leave-active`, leaveToClass: m = `${n}-leave-to` } = e, g = _b(a), w = g && g[0], S = g && g[1], { onBeforeEnter: q, onEnter: p, onEnterCancelled: y, onLeave: b, onLeaveCancelled: _, onBeforeAppear: E = q, onAppear: $ = p, onAppearCancelled: V = y } = t, L = (T, x, C, D) => {
    T._enterCancelled = D, ol(T, x ? s : i), ol(T, x ? c : o), C && C();
  }, P = (T, x) => {
    T._isLeaving = false, ol(T, v), ol(T, m), ol(T, h), x && x();
  }, F = (T) => (x, C) => {
    const D = T ? $ : p, H = () => L(x, T, C);
    kl(D, [x, H]), _c(() => {
      ol(x, T ? u : r), Rn(x, T ? s : i), pc(D) || wc(x, l, w, H);
    });
  };
  return It(t, { onBeforeEnter(T) {
    kl(q, [T]), Rn(T, r), Rn(T, o);
  }, onBeforeAppear(T) {
    kl(E, [T]), Rn(T, u), Rn(T, c);
  }, onEnter: F(false), onAppear: F(true), onLeave(T, x) {
    T._isLeaving = true;
    const C = () => P(T, x);
    Rn(T, v), T._enterCancelled ? (Rn(T, h), wu()) : (wu(), Rn(T, h)), _c(() => {
      T._isLeaving && (ol(T, v), Rn(T, m), pc(b) || wc(T, l, S, C));
    }), kl(b, [T, C]);
  }, onEnterCancelled(T) {
    L(T, false, void 0, true), kl(y, [T]);
  }, onAppearCancelled(T) {
    L(T, true, void 0, true), kl(V, [T]);
  }, onLeaveCancelled(T) {
    P(T), kl(_, [T]);
  } });
}
...
const $c = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Bb = (e, t, n, l, a, r) => {
  const o = a === "svg";
  t === "class" ? Sb(e, l, o) : t === "style" ? kb(e, n, l) : Do(t) ? Ku(t) || Eb(e, t, n, l, r) : (t[0] === "." ? (t = t.slice(1), true) : t[0] === "^" ? (t = t.slice(1), false) : Fb(e, t, l, o)) ? (Mc(e, t, l), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Tc(e, t, l, o, r, t !== "value")) : e._isVueCE && (/[A-Z]/.test(t) || !Rt(l)) ? Mc(e, bn(t), l, r, t) : (t === "true-value" ? e._trueValue = l : t === "false-value" && (e._falseValue = l), Tc(e, t, l, o));
};
function Fb(e, t, n, l) {
  ...
  return $c(t) && Rt(n) ? false : t in e;
}
const Ov = /* @__PURE__ */ new WeakMap(), Vv = /* @__PURE__ */ new WeakMap(), So = Symbol("_moveCb"), Rc = Symbol("_enterCb"), Ob = (e) => (delete e.props.mode, e), Vb = Ob({ name: "TransitionGroup", props: It({}, Rv, { tag: String, moveClass: String }), setup(e, { slots: t }) {
  const n = Se(), l = Jf();
  let a, r;
  return Yo(() => {
    if (!a.length) return;
...
var Ai = ["sm", "md", "lg", "xl"], { passive: Bc } = dt, Jb = wl({ width: 0, height: 0, name: "xs", sizes: { sm: 600, md: 1024, lg: 1440, xl: 1920 }, lt: { sm: true, md: true, lg: true, xl: true }, gt: { xs: false, sm: false, md: false, lg: false }, xs: true, sm: false, md: false, lg: false, xl: false }, { setSizes: St, setDebounce: St, install({ $q: e, onSSRHydrated: t }) {
  var _a2;
...
var $l = wl({ __qLang: {} }, { getLocale: Fc, set(e = Cu, t) {
  const n = { ...e, rtl: e.rtl === true, getLocale: Fc };
  {
...
function fy(e, t, n) {
  e.config.globalProperties.$q = n.$q, e.provide(Wv, n.$q), Vc(n, Oc), t.components !== void 0 && Object.values(t.components).forEach((l) => {
  ...
  }), t.plugins !== void 0 && Vc(n, Object.values(t.plugins).filter((l) => typeof l.install == "function" && Oc.includes(l) === false)), nn.value === true && (n.$q.onSSRHydrated = () => {
...
var zc = "0 0 24 24", $i = (e) => e, Ri = (e) => `ionicons ${e}`, am = { "mdi-": (e) => `mdi ${e}`, "icon-": $i, "bt-": (e) => `bt ${e}`, "eva-": (e) => `eva ${e}`, "ion-md": Ri, "ion-ios": Ri, "ion-logo": Ri, "iconfont ": $i, "ti-": (e) => `themify-icon ${e}`, "bi-": (e) => `bootstrap-icons ${e}`, "i-": $i }, rm = { o_: "-outlined", r_: "-round", s_: "-sharp" }, om = { sym_o_: "-outlined", sym_r_: "-rounded", sym_s_: "-sharp" }, _y = new RegExp("^(" + Object.keys(am).join("|") + ")"), wy = new RegExp("^(" + Object.keys(rm).join("|") + ")"), Dc = new RegExp("^(" + Object.keys(om).join("|") + ")"), Sy = /^[Mm]\s?[-+]?\.?\d/, xy = /^img:/, Cy = /^svguse:/, ky = /^ion-/, qy = /^(fa-(classic|sharp|solid|regular|light|brands|duotone|thin)|[lf]a[srlbdk]?) /, et = ve({ name: "QIcon", props: { ...Jn, tag: { type: String, default: "i" }, name: String, color: String, left: Boolean, right: Boolean }, setup(e, { slots: t }) {
...
function li({ fallbackTag: e, useDisableForRouterLinkProps: t = true } = {}) {
  const n = Se(), { props: l, proxy: a, emit: r } = n, o = ps(n), i = f(() => l.disable !== true && l.href !== void 0), u = f(t === true ? () => o === true && l.disable !== true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== "" : () => o === true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== ""), c = f(() => u.value === true ? p(l.to) : null), s = f(() => c.value !== null), v = f(() => i.value === true || s.value === true), h = f(() => l.type === "a" || v.value === true ? "a" : l.tag || e || "div"), m = f(() => i.value === true ? { href: l.href, target: l.target } : s.value === true ? { href: c.value.href, target: l.target } : {}), g = f(() => {
    ...
    const { matched: _ } = c.value, { length: E } = _, $ = _[E - 1];
    if ($ === void 0) return -1;
    const V = a.$route.matched;
    if (V.length === 0) return -1;
    const L = V.findIndex(Hc.bind(null, $));
    if (L !== -1) return L;
    const P = Nc(_[E - 2]);
    return E > 1 && Nc($) === P && V[V.length - 1].path !== P ? V.findIndex(Hc.bind(null, _[E - 2])) : L;
  }), w = f(() => s.value === true && g.value !== -1 && Ay(a.$route.params, c.value.params)), S = f(() => w.value === true && g.value === a.$route.matched.length - 1 && Ry(a.$route.params, c.value.params)), q = f(() => s.value === true ? S.value === true ? ` ${l.exactActiveClass} ${l.activeClass}` : l.exact === true ? "" : w.value === true ? ` ${l.activeClass}` : "" : "");
  function p(_) {
    try {
  ...
  function y(_, { returnRouterError: E, to: $ = l.to, replace: V = l.replace } = {}) {
    ...
    _.preventDefault();
    const L = a.$router[V === true ? "replace" : "push"]($);
...
function Mt(e) {
  return { cSize: f(() => e.size in Mu ? `${Mu[e.size]}px` : e.size), classes: f(() => "q-spinner" + (e.color ? ` text-${e.color}` : "")) };
}
...
function Uc(e, t, n, l) {
  ...
  i.className = "q-ripple__inner", Eu(i, { height: `${m}px`, width: `${m}px`, transform: `translate3d(${S},${p},0) scale3d(.2,.2,1)`, opacity: 0 }), o.className = `q-ripple${a ? " text-" + a : ""}`, o.setAttribute("dir", "ltr"), o.appendChild(i), t.appendChild(o);
  const y = () => {
...
var ws = { ...Jn, ...cm, type: { type: String, default: "button" }, label: [Number, String], icon: String, iconRight: String, ...vm.reduce((e, t) => (e[t] = Boolean) && e, {}), square: Boolean, rounded: Boolean, glossy: Boolean, size: String, fab: Boolean, fabMini: Boolean, padding: String, color: String, textColor: String, noCaps: Boolean, noWrap: Boolean, dense: Boolean, tabindex: [Number, String], ripple: { type: [Boolean, Object], default: true }, align: { ...gs.align, default: "center" }, stack: Boolean, stretch: Boolean, loading: { type: Boolean, default: null }, disable: Boolean }, Oy = { ...ws, round: Boolean };
function Vy(e) {
  const t = el(e, Ly), n = bs(e), { hasRouterLink: l, hasLink: a, linkTag: r, linkAttrs: o, navigateOnClick: i } = li({ fallbackTag: "button" }), u = f(() => {
...
var { passiveCapture: fn } = dt, Gl = null, Xl = null, Zl = null, Ze = ve({ name: "QBtn", props: { ...Oy, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: n }) {
  const { proxy: l } = Se(), { classes: a, style: r, innerClasses: o, attributes: i, hasLink: u, linkTag: c, navigateOnClick: s, isActionable: v } = Vy(e), h = U(null), m = U(null);
  let g = null, w, S = null;
  const q = f(() => e.label !== void 0 && e.label !== null && e.label !== ""), p = f(() => e.disable === true || e.ripple === false ? false : { keyCodes: u.value === true ? [13, 32] : [13], ...e.ripple === true ? {} : e.ripple }), y = f(() => ({ center: e.round })), b = f(() => {
    ...
    if (v.value === true) {
      const C = { onClick: $, onKeydown: V, onMousedown: P };
  ...
  function V(C) {
    h.value !== null && (n("keydown", C), yn(C, [13, 32]) === true && Xl !== h.value && (Xl !== null && T(), C.defaultPrevented !== true && (C.qAvoidFocus !== true && h.value.focus(), Xl = h.value, h.value.classList.add("q-btn--active"), document.addEventListener("keyup", F, true), h.value.addEventListener("blur", F, fn)), He(C)));
  }
  function L(C) {
    h.value !== null && (n("touchstart", C), C.defaultPrevented !== true && (Gl !== h.value && (Gl !== null && T(), Gl = h.value, g = C.target, g.addEventListener("touchcancel", F, fn), g.addEventListener("touchend", F, fn)), w = true, S !== null && clearTimeout(S), S = setTimeout(() => {
      S = null, w = false;
    }, 200)));
  }
  function P(C) {
    h.value !== null && (C.qSkipRipple = w === true, n("mousedown", C), C.defaultPrevented !== true && Zl !== h.value && (Zl !== null && T(), Zl = h.value, h.value.classList.add("q-btn--active"), document.addEventListener("mouseup", F, fn)));
  }
  function F(C) {
  ...
  function T(C) {
    var _a2, _b2;
    const D = m.value;
    C !== true && (Gl === h.value || Zl === h.value) && D !== null && D !== document.activeElement && (D.setAttribute("tabindex", -1), D.focus()), Gl === h.value && (g !== null && (g.removeEventListener("touchcancel", F, fn), g.removeEventListener("touchend", F, fn)), Gl = g = null), Zl === h.value && (document.removeEventListener("mouseup", F, fn), Zl = null), Xl === h.value && (document.removeEventListener("keyup", F, true), (_a2 = h.value) == null ? void 0 : _a2.removeEventListener("blur", F, fn), Xl = null), (_b2 = h.value) == null ? void 0 : _b2.classList.remove("q-btn--active");
  }
  function x(C) {
  ...
  return Ke(() => {
    ...
    let C = [];
    e.icon !== void 0 && C.push(d(et, { name: e.icon, left: e.stack !== true && q.value === true, role: "img" })), q.value === true && C.push(d("span", { class: "block" }, [e.label])), C = kt(t.default, C), e.iconRight !== void 0 && e.round === false && C.push(d(et, { name: e.iconRight, right: e.stack !== true && q.value === true, role: "img" }));
    const D = [d("span", { class: "q-focus-helper", ref: m })];
    return e.loading === true && e.percentage !== void 0 && D.push(d("span", { class: "q-btn__progress absolute-full overflow-hidden" + (e.darkPercentage === true ? " q-btn__progress--dark" : "") }, [d("span", { class: "q-btn__progress-indicator fit block", style: b.value })])), D.push(d("span", { class: "q-btn__content text-center col items-center q-anchor--skip " + o.value }, C)), e.loading !== null && D.push(d(Ft, { name: "q-transition--fade" }, () => e.loading === true ? [d("span", { key: "loading", class: "absolute-full flex flex-center" }, t.loading !== void 0 ? t.loading() : [d(_n)])] : null)), sn(d(c.value, E.value, D), [[ai, p.value, void 0, y.value]]);
  };
...
function $a({ showing: e, canShow: t, hideOnRouteChange: n, handleShow: l, handleHide: a, processOnMount: r }) {
  ...
  he(() => i.modelValue, S), n !== void 0 && ps(o) === true && he(() => c.$route.fullPath, () => {
...
function ks(e, t = 0) {
  ...
  if (ze.is.ios === true && window.visualViewport !== void 0) {
    const E = document.body.style, { offsetLeft: $, offsetTop: V } = window.visualViewport;
    $ !== Wc && (E.setProperty("--q-pe-left", $ + "px"), Wc = $), V !== Yc && (E.setProperty("--q-pe-top", V + "px"), Yc = V);
  }
  ...
  const b = ep(q, p);
  let _ = Gc(g, b, r, o);
  if (i === void 0 || l === void 0) Li(_, g, b, r, o);
  else {
    const { top: E, left: $ } = _;
    Li(_, g, b, r, o);
    let V = false;
    ...
    V === true && (_ = Gc(g, b, r, o), Li(_, g, b, r, o));
  }
...
var ii = ve({ name: "QMenu", inheritAttrs: false, props: { ...bm, ...Ea, ...nt, ...Ol, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noEscDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: Ro }, self: { type: String, validator: Ro }, offset: { type: Array, validator: Mm }, scrollTarget: Wl, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...Aa, "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  let a = null, r, o, i;
  const u = Se(), { proxy: c } = u, { $q: s } = c, v = U(null), h = U(false), m = f(() => e.persistent !== true && e.noRouteDismiss !== true), g = lt(e, s), { registerTick: w, removeTick: S } = ga(), { registerTimeout: q } = Xn(), { transitionProps: p, transitionStyle: y } = ri(e), { localScrollTarget: b, changeScrollEvent: _, unconfigureScrollTarget: E } = ym(e, ee), { anchorEl: $, canShow: V } = Ss({ showing: h }), { hide: L } = $a({ showing: h, canShow: V, handleShow: pe, handleHide: Q, hideOnRouteChange: m, processOnMount: true }), { showPortal: P, hidePortal: F, renderPortal: T } = Cs(u, v, J, "menu"), x = { anchorEl: $, innerRef: v, onClickOutside(O) {
    if (e.persistent !== true && h.value === true) return L(O), (O.type === "touchstart" || O.target.classList.contains("q-dialog__backdrop")) && He(O), true;
  } }, C = f(() => Po(e.anchor || (e.cover === true ? "center middle" : "bottom start"), s.lang.rtl)), D = f(() => e.cover === true ? C.value : Po(e.self || "top start", s.lang.rtl)), H = f(() => (e.square === true ? " q-menu--square" : "") + (g.value === true ? " q-menu--dark q-dark" : "")), j = f(() => e.autoClose === true ? { onClick: X } : {}), W = f(() => h.value === true && e.persistent !== true);
  he(W, (O) => {
    O === true ? (Cm(B), Tm(x)) : (Mo(B), $o(x));
  });
  function te() {
    Ra(() => {
      let O = v.value;
  ...
  function pe(O) {
    if (a = e.noRefocus === false ? document.activeElement : null, qm(be), P(), ee(), r = void 0, O !== void 0 && (e.touchPosition || e.contextMenu)) {
      const re = en(O);
      if (re.left !== void 0) {
        const { top: we, left: k } = $.value.getBoundingClientRect();
  ...
  function M(O) {
    r = void 0, o !== void 0 && (o(), o = void 0), (O === true || h.value === true) && (Ru(be), E(), $o(x), Mo(B)), O !== true && (a = null);
  }
  function ee() {
    ($.value !== null || e.scrollTarget !== void 0) && (b.value = Vn($.value, e.scrollTarget), _(b.value, R));
  }
  function X(O) {
    i !== true ? (_m(c, O), n("click", O)) : i = false;
  }
  function be(O) {
    W.value === true && e.noFocus !== true && dm(v.value, O.target) !== true && te();
  }
  function B(O) {
    e.noEscDismiss !== true && (n("escapeKey"), L(O));
  }
  function R() {
    ks({ targetEl: v.value, offset: e.offset, anchorEl: $.value, anchorOrigin: C.value, selfOrigin: D.value, absoluteOffset: r, fit: e.fit, cover: e.cover, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function J() {
...
function wr() {
  (Bi === void 0 || Nr + 16 > Xc) && (Nr = 0, Bi = tp(Xc));
...
function ui({ getValue: e, required: t = true } = {}) {
  ...
  return e !== void 0 ? f(() => Zc(e(), t)) : U(`f_${wr()}`);
}
...
} }, Es = { modelValue: { required: true }, animated: Boolean, infinite: Boolean, swipeable: Boolean, vertical: Boolean, transitionPrev: String, transitionNext: String, transitionDuration: { type: [String, Number], default: 300 }, keepAlive: Boolean, keepAliveInclude: [String, Array, RegExp], keepAliveExclude: [String, Array, RegExp], keepAliveMax: Number }, As = ["update:modelValue", "beforeTransition", "transition"];
function $s() {
  ...
  const s = f(() => [[cp, c, void 0, { horizontal: e.vertical !== true, vertical: e.vertical, mouse: true }]]), v = f(() => e.transitionPrev || `slide-${e.vertical === true ? "down" : "right"}`), h = f(() => e.transitionNext || `slide-${e.vertical === true ? "up" : "left"}`), m = f(() => `--q-transition-duration: ${e.transitionDuration}ms`), g = f(() => typeof e.modelValue == "string" || typeof e.modelValue == "number" ? e.modelValue : String(e.modelValue)), w = f(() => ({ include: e.keepAliveInclude, exclude: e.keepAliveExclude, max: e.keepAliveMax })), S = f(() => e.keepAliveInclude !== void 0 || e.keepAliveExclude !== void 0);
  he(() => e.modelValue, (C, D) => {
    const H = b(C) === true ? _(C) : -1;
    o !== true && $(H === -1 ? 0 : H < _(D) ? -1 : 1), u.value !== H && (u.value = H, t("beforeTransition", C, D), a(() => {
      t("transition", C, D);
    }, e.transitionDuration));
  });
  function q() {
  ...
  function V(C, D = u.value) {
    ...
    for (; H !== -1 && H < r.length; ) {
      ...
      if (j !== void 0 && j.props.disable !== "" && j.props.disable !== true) {
        $(C), o = true, t("update:modelValue", j.props.name), setTimeout(() => {
          o = false;
        });
        return;
      }
  ...
  function P() {
    ...
    return e.keepAlive === true ? [d(rv, w.value, [d(S.value === true ? l(g.value, () => ({ ...Jc, name: g.value })) : Jc, { key: g.value, style: m.value }, () => C)])] : [d("div", { class: "q-panel scroll", style: m.value, key: g.value, role: "tabpanel" }, [C])];
  }
  function F() {
    if (r.length !== 0) return e.animated === true ? [d(Ft, { name: i.value }, P)] : P();
  }
  function T(C) {
    return r = ys(Pe(C.default, [])).filter((D) => D.props !== null && D.props.slot === void 0 && b(D.props.name) === true), r.length;
  }
  function x() {
    return r;
  }
...
var Fa = 0, Rs = { fullscreen: Boolean, noRouteFullscreenExit: Boolean }, Ps = ["update:fullscreen", "fullscreen"];
function Ls() {
...
ve({ name: "QCarousel", props: { ...nt, ...Es, ...Rs, transitionPrev: { type: String, default: "fade" }, transitionNext: { type: String, default: "fade" }, height: String, padding: Boolean, controlColor: String, controlTextColor: String, controlType: { type: String, validator: (e) => fp.includes(e), default: "flat" }, autoplay: [Number, Boolean], arrows: Boolean, prevIcon: String, nextIcon: String, navigation: Boolean, navigationPosition: { type: String, validator: (e) => dp.includes(e) }, navigationIcon: String, navigationActiveIcon: String, thumbnails: Boolean }, emits: [...Ps, ...As], setup(e, { slots: t }) {
  ...
  he(() => e.modelValue, () => {
    ...
    P ? $() : a !== null && (clearTimeout(a), a = null);
  });
  function $() {
...
function Lm(e, t) {
  const { props: n, slots: l, emit: a, proxy: r } = Se(), { $q: o } = r, i = lt(n, o), u = U(null), { refocusTargetEl: c, refocusTarget: s } = Am(n, u), v = el(n, $m), h = f(() => n.val !== void 0 && Array.isArray(n.modelValue)), m = f(() => {
    const T = Ye(n.val);
  ...
  function $(T) {
    T !== void 0 && (He(T), s(T)), n.disable !== true && a("update:modelValue", V(), T);
  }
  function V() {
    if (h.value === true) {
      if (g.value === true) {
  ...
  function P(T) {
    (T.keyCode === 13 || T.keyCode === 32) && $(T);
  }
  const F = t(g, S);
  return Object.assign(r, { toggle: $ }), () => {
    const T = F();
    ...
    return C !== void 0 && x.push(d("div", { class: `q-${e}__label q-anchor--skip` }, C)), d("div", { ref: u, class: p.value, ...E.value, onClick: $, onKeydown: L, onKeyup: P }, x);
  };
}
var vp = () => d("div", { key: "svg", class: "q-checkbox__bg absolute" }, [d("svg", { class: "q-checkbox__svg fit absolute-full", viewBox: "0 0 24 24" }, [d("path", { class: "q-checkbox__truthy", fill: "none", d: "M1.73,12.91 8.1,19.28 22.79,4.59" }), d("path", { class: "q-checkbox__indet", d: "M4,14H20V10H4" })])]), ir = ve({ name: "QCheckbox", props: Rm, emits: Pm, setup(e) {
  ...
  return () => {
    ...
    return c.value === true && Object.assign(S, v.value.chip, { onClick: m, onKeyup: h }), pn("div", S, w(), "ripple", e.ripple !== false && e.disable !== true, () => [[ai, e.ripple]]);
  };
} }), Bs = { ...Jn, min: { type: Number, default: 0 }, max: { type: Number, default: 100 }, color: String, centerColor: String, trackColor: String, fontSize: String, rounded: Boolean, thickness: { type: Number, default: 0.2, validator: (e) => e >= 0 && e <= 1 }, angle: { type: Number, default: 0 }, showValue: Boolean, reverse: Boolean, instantFeedback: Boolean }, Lu = 50, Fm = 2 * Lu, Om = Fm * Math.PI, hp = Math.round(Om * 1e3) / 1e3, Vm = ve({ name: "QCircularProgress", props: { ...Bs, value: { type: Number, default: 0 }, animationSpeed: { type: [String, Number], default: 600 }, indeterminate: Boolean }, setup(e, { slots: t }) {
  ...
  function h({ thickness: m, offset: g, color: w, cls: S, rounded: q }) {
    return d("circle", { class: "q-circular-progress__" + S + (w !== void 0 ? ` text-${w}` : ""), style: r.value, fill: "transparent", stroke: "currentColor", "stroke-width": m, "stroke-dasharray": hp, "stroke-dashoffset": g, "stroke-linecap": q, cx: o.value, cy: o.value, r: Lu });
  }
  return () => {
    const m = [];
...
} }), ed = "q-slider__marker-labels", bp = (e) => ({ value: e }), yp = ({ marker: e }) => d("div", { key: e.value, style: e.style, class: e.classes }, e.label), Fs = [34, 37, 40, 33, 39, 38], Im = { ...nt, ...wn, min: { type: Number, default: 0 }, max: { type: Number, default: 100 }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, snap: Boolean, vertical: Boolean, reverse: Boolean, color: String, markerLabelsClass: String, label: Boolean, labelColor: String, labelTextColor: String, labelAlways: Boolean, switchLabelSide: Boolean, markers: [Boolean, Number], markerLabels: [Boolean, Array, Object, Function], switchMarkerLabelsSide: Boolean, trackImg: String, trackColor: String, innerTrackImg: String, innerTrackColor: String, selectionColor: String, selectionImg: String, thumbSize: { type: String, default: "20px" }, trackSize: { type: String, default: "4px" }, disable: Boolean, readonly: Boolean, dense: Boolean, tabindex: [String, Number], thumbColor: String, thumbPath: { type: String, default: "M 4, 10 a 6,6 0 1,0 12,0 a 6,6 0 1,0 -12,0" } }, zm = ["pan", "update:modelValue", "change"];
function Dm({ updateValue: e, updatePosition: t, getDragging: n, formAttrs: l }) {
  const { props: a, emit: r, slots: o, proxy: { $q: i } } = Se(), u = lt(a, i), c = Sl(l), s = U(false), v = U(false), h = U(false), m = U(false), g = f(() => a.vertical === true ? "--v" : "--h"), w = f(() => "-" + (a.switchLabelSide === true ? "switched" : "standard")), S = f(() => a.vertical === true ? a.reverse === true : a.reverse !== (i.lang.rtl === true)), q = f(() => isNaN(a.innerMin) === true || a.innerMin < a.min ? a.min : a.innerMin), p = f(() => isNaN(a.innerMax) === true || a.innerMax > a.max ? a.max : a.innerMax), y = f(() => a.disable !== true && a.readonly !== true && q.value < p.value), b = f(() => {
    if (a.step === 0) return (ye) => ye;
    const ae = (String(a.step).trim().split(".")[1] || "").length;
    return (ye) => parseFloat(ye.toFixed(ae));
  }), _ = f(() => a.step === 0 ? 1 : a.step), E = f(() => y.value === true ? a.tabindex || 0 : -1), $ = f(() => a.max - a.min), V = f(() => p.value - q.value), L = f(() => we(q.value)), P = f(() => we(p.value)), F = f(() => a.vertical === true ? S.value === true ? "bottom" : "top" : S.value === true ? "right" : "left"), T = f(() => a.vertical === true ? "height" : "width"), x = f(() => a.vertical === true ? "width" : "height"), C = f(() => a.vertical === true ? "vertical" : "horizontal"), D = f(() => {
  ...
  function we(ae) {
    return $.value === 0 ? 0 : (ae - a.min) / $.value;
  }
  function k(ae, ye) {
  ...
  const A = f(() => pr(a.markers) === true ? a.markers : _.value), z = f(() => {
    const ae = [], ye = A.value, Ce = a.max;
    let Oe = a.min;
    do
      ae.push(Oe), Oe += ye;
    while (Oe < Ce);
    ...
    const ae = ` ${ed}${g.value}-`;
    return ed + `${ae}${a.switchMarkerLabelsSide === true ? "switched" : "standard"}${ae}${S.value === true ? "rtl" : "ltr"}`;
    ...
    const ae = V.value === 0 ? "2px" : 100 * A.value / V.value;
  ...
  function me(ae) {
    ...
    return Array.isArray(ae) === true ? ae.map((Ce) => $t(Ce) === true ? Ce : { value: Ce }).filter(ye) : Object.keys(ae).map((Ce) => {
      const Oe = ae[Ce], Ae = Number(Ce);
      return $t(Oe) === true ? { ...Oe, value: Ae } : { value: Ae, label: Oe };
    }).filter(ye);
  }
  function fe(ae) {
    return { [F.value]: `${100 * (ae - a.min) / $.value}%` };
  }
  const ce = f(() => {
  ...
  function ie(ae) {
    const ye = f(() => v.value === false && (h.value === ae.focusValue || h.value === "both") ? " q-slider--focus" : ""), Ce = f(() => `q-slider__thumb q-slider__thumb${g.value} q-slider__thumb${g.value}-${S.value === true ? "rtl" : "ltr"} absolute non-selectable` + ye.value + (ae.thumbColor.value !== void 0 ? ` text-${ae.thumbColor.value}` : "")), Oe = f(() => ({ width: a.thumbSize, height: a.thumbSize, [F.value]: `${100 * ae.ratio.value}%`, zIndex: h.value === ae.focusValue ? 2 : void 0 })), Ae = f(() => ae.labelColor.value !== void 0 ? ` text-${ae.labelColor.value}` : ""), We = f(() => Ve(ae.ratio.value)), it = f(() => "q-slider__text" + (ae.labelTextColor.value !== void 0 ? ` text-${ae.labelTextColor.value}` : ""));
    return () => {
      ...
      return (a.label === true || a.labelAlways === true) && (xt.push(d("div", { class: M.value + " absolute fit no-pointer-events" + Ae.value }, [d("div", { class: ee.value, style: { minWidth: a.thumbSize } }, [d("div", { class: X.value, style: We.value }, [d("span", { class: it.value }, ae.label.value)])])])), a.name !== void 0 && a.disable !== true && c(xt, "push")), d("div", { class: Ce.value, style: Oe.value, ...ae.getNodeData() }, xt);
    };
  }
  function ge(ae, ye, Ce, Oe) {
    const Ae = [];
    a.innerTrackColor !== "transparent" && Ae.push(d("div", { key: "inner", class: J.value, style: O.value })), a.selectionColor !== "transparent" && Ae.push(d("div", { key: "selection", class: te.value, style: ae.value })), a.markers !== false && Ae.push(d("div", { key: "marker", class: pe.value, style: de.value })), Oe(Ae);
    const We = [pn("div", { key: "trackC", class: Q.value, tabindex: ye.value, ...Ce.value }, [d("div", { class: B.value, style: R.value }, Ae)], "slide", y.value, () => N.value)];
  ...
  }), { state: { active: s, focus: h, preventFocus: v, dragging: m, editable: y, classes: H, tabindex: E, attributes: D, roundValueFn: b, keyStep: _, trackLen: $, innerMin: q, innerMinRatio: L, innerMax: p, innerMaxRatio: P, positionProp: F, sizeProp: T, isReversed: S }, methods: { onActivate: ke, onMobileClick: Me, onBlur: _e, onKeyup: Ne, getContent: ge, getThumbRenderFn: ie, convertRatioToModel: re, convertModelToRatio: we, getDraggingRatio: k } };
}
var pp = () => ({}), Jl = ve({ name: "QSlider", props: { ...Im, modelValue: { required: true, default: null, validator: (e) => typeof e == "number" || e === null }, labelValue: [String, Number] }, emits: zm, setup(e, { emit: t }) {
  const { proxy: { $q: n } } = Se(), { state: l, methods: a } = Dm({ updateValue: g, updatePosition: S, getDragging: w, formAttrs: Rr(e) }), r = U(null), o = U(0), i = U(0);
  function u() {
  ...
  function p(y) {
    if (Fs.includes(y.keyCode) === false) return;
    He(y);
...
var Hm = typeof ResizeObserver < "u", td = Hm === true ? {} : { style: "display:block;position:absolute;top:0;left:0;right:0;bottom:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;", url: "about:blank" }, Nl = ve({ name: "QResizeObserver", props: { debounce: { type: [String, Number], default: 100 } }, emits: ["resize"], setup(e, { emit: t }) {
...
var wp = ["left", "center", "right", "justify"], Bu = ve({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => wp.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: n }) {
  const { proxy: l } = Se(), { $q: a } = l, { registerTick: r } = ga(), { registerTick: o } = ga(), { registerTick: i } = ga(), { registerTimeout: u, removeTimeout: c } = Xn(), { registerTimeout: s, removeTimeout: v } = Xn(), h = U(null), m = U(null), g = U(e.modelValue), w = U(false), S = U(true), q = U(false), p = U(false), y = [], b = U(0), _ = U(false);
  let E = null, $ = null, V;
  ...
  function R(le, N) {
    const oe = Array.prototype.filter.call(m.value.children, (Ne) => Ne === N || Ne.matches && Ne.matches(".q-tab.q-focusable") === true), _e = oe.length;
    if (_e === 0) return;
    ...
    if (Me !== void 0) {
      const Ne = D.value === true ? -1 : 1, Ve = oe.indexOf(N) + Me * Ne;
...
function Qm(e, t, n, l) {
    ...
    if (l.hasRouterLink.value === true) {
      const _ = (E = {}) => {
        ...
        return l.navigateToRouterLink(y, { ...E, returnRouterError: true }).catch((L) => {
          ...
          var _a3;
          if (V === a.avoidRouteWatcher && (a.avoidRouteWatcher = false, $ === void 0 && (L === void 0 || ((_a3 = L.message) == null ? void 0 : _a3.startsWith("Avoided redundant navigation")) === true) && a.updateModel({ name: e.name })), E.returnRouterError === true) return $ !== void 0 ? Promise.reject($) : L;
        });
      };
  ...
  function S() {
    ...
    const E = [d("div", { class: "q-focus-helper", tabindex: -1, ref: o }), d("div", { class: h.value }, kt(t.default, b))];
...
var Oa = ve({ name: "QTab", props: Um, emits: jm, setup(e, { slots: t, emit: n }) {
  ...
  return () => l("div");
} }), xp = ve({ name: "QTabPanels", props: { ...Es, ...nt }, emits: As, setup(e, { slots: t }) {
...
} }), nd = /^#[0-9a-fA-F]{3}([0-9a-fA-F]{3})?$/, ld = /^#[0-9a-fA-F]{4}([0-9a-fA-F]{4})?$/, ad = /^#([0-9a-fA-F]{3}|[0-9a-fA-F]{4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/, Hr = /^rgb\(((0|[1-9][\d]?|1[\d]{0,2}|2[\d]?|2[0-4][\d]|25[0-5]),){2}(0|[1-9][\d]?|1[\d]{0,2}|2[\d]?|2[0-4][\d]|25[0-5])\)$/, jr = /^rgba\(((0|[1-9][\d]?|1[\d]{0,2}|2[\d]?|2[0-4][\d]|25[0-5]),){2}(0|[1-9][\d]?|1[\d]{0,2}|2[\d]?|2[0-4][\d]|25[0-5]),(0|0\.[0-9]+[1-9]|0\.[1-9]+|1)\)$/, oo = { date: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e), time: (e) => /^([0-1]?\d|2[0-3]):[0-5]\d$/.test(e), fulltime: (e) => /^([0-1]?\d|2[0-3]):[0-5]\d:[0-5]\d$/.test(e), timeOrFulltime: (e) => /^([0-1]?\d|2[0-3]):[0-5]\d(:[0-5]\d)?$/.test(e), email: (e) => /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(e), hexColor: (e) => nd.test(e), hexaColor: (e) => ld.test(e), hexOrHexaColor: (e) => ad.test(e), rgbColor: (e) => Hr.test(e), rgbaColor: (e) => jr.test(e), rgbOrRgbaColor: (e) => Hr.test(e) || jr.test(e), hexOrRgbColor: (e) => nd.test(e) || Hr.test(e), hexaOrRgbaColor: (e) => ld.test(e) || jr.test(e), anyColor: (e) => ad.test(e) || Hr.test(e) || jr.test(e) }, Cp = /^rgb(a)?\((\d{1,3}),(\d{1,3}),(\d{1,3}),?([01]?\.?\d*?)?\)$/;
...
ve({ name: "QColor", props: { ...nt, ...wn, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  const { proxy: n } = Se(), { $q: l } = n, a = lt(e, l), { getCache: r } = Pr(), o = U(null), i = U(null), u = f(() => e.formatModel === "auto" ? null : e.formatModel.indexOf("hex") !== -1), c = f(() => e.formatModel === "auto" ? null : e.formatModel.indexOf("a") !== -1), s = U(e.formatModel === "auto" ? e.modelValue === void 0 || e.modelValue === null || e.modelValue === "" || e.modelValue.startsWith("#") ? "hex" : "rgb" : e.formatModel.startsWith("hex") ? "hex" : "rgb"), v = U(e.defaultView), h = U(T(e.modelValue || e.defaultValue)), m = f(() => e.disable !== true && e.readonly !== true), g = f(() => e.modelValue === void 0 || e.modelValue === null || e.modelValue === "" || e.modelValue.startsWith("#")), w = f(() => u.value !== null ? u.value : g.value), S = f(() => ({ type: "hidden", name: e.name, value: h.value[w.value === true ? "hex" : "rgb"] })), q = Sl(S), p = f(() => c.value !== null ? c.value : h.value.a !== void 0), y = f(() => ({ backgroundColor: h.value.rgb || "#000" })), b = f(() => `q-color-picker__header-content q-color-picker__header-content--${(h.value.a !== void 0 && h.value.a < 65 ? true : kp(h.value) > 0.4) ? "light" : "dark"}`), _ = f(() => ({ background: `hsl(${h.value.h},100%,50%)` })), E = f(() => ({ top: `${100 - h.value.v}%`, [l.lang.rtl === true ? "right" : "left"]: `${h.value.s}%` })), $ = f(() => e.palette !== void 0 && e.palette.length !== 0 ? e.palette : qp), V = f(() => "q-color-picker" + (e.bordered === true ? " q-color-picker--bordered" : "") + (e.square === true ? " q-color-picker--square no-border-radius" : "") + (e.flat === true ? " q-color-picker--flat no-shadow" : "") + (e.disable === true ? " disabled" : "") + (a.value === true ? " q-color-picker--dark q-dark" : "")), L = f(() => e.disable === true ? { "aria-disabled": "true" } : {}), P = f(() => [[gn, te, void 0, { prevent: true, stop: true, mouse: true }]]);
  he(() => e.modelValue, (k) => {
    const A = T(k || e.defaultValue);
    A.hex !== h.value.hex && (h.value = A);
  }), he(() => e.defaultValue, (k) => {
    if (!e.modelValue && k) {
      const A = T(k);
      A.hex !== h.value.hex && (h.value = A);
  ...
  function F(k, A) {
    h.value.hex = rd(k), h.value.rgb = od(k), h.value.r = k.r, h.value.g = k.g, h.value.b = k.b, h.value.a = k.a;
    const z = h.value[w.value === true ? "hex" : "rgb"];
    t("update:modelValue", z), A === true && t("change", z);
  }
  function T(k) {
    const A = c.value !== void 0 ? c.value : e.formatModel === "auto" ? null : e.formatModel.indexOf("a") !== -1;
    if (typeof k != "string" || k.length === 0 || oo.anyColor(k.replace(/ /g, "")) !== true) return { h: 0, s: 0, v: 0, r: 0, g: 0, b: 0, a: A === true ? 100 : void 0, hex: void 0, rgb: void 0 };
    const z = Wm(k);
    return A === true && z.a === void 0 && (z.a = 100), z.hex = rd(z), z.rgb = od(z), Object.assign(z, Vi(z));
  }
  function x(k, A, z) {
    const Z = o.value;
    if (Z === null) return;
    ...
    const fe = Math.min(K, Math.max(0, A - de.top)), ce = Math.round(100 * me / ne), le = Math.round(100 * Math.max(0, Math.min(1, -(fe / K) + 1))), N = id({ h: h.value.h, s: ce, v: le, a: p.value === true ? h.value.a : void 0 });
    h.value.s = ce, h.value.v = le, F(N, z);
  }
  function C(k, A) {
    const z = Math.round(k), Z = id({ h: z, s: h.value.s, v: h.value.v, a: p.value === true ? h.value.a : void 0 });
    h.value.h = z, F(Z, A);
  }
  function D(k) {
    C(k, true);
  }
  function H(k, A, z, Z, ne) {
    ...
    const de = { r: A === "r" ? K : h.value.r, g: A === "g" ? K : h.value.g, b: A === "b" ? K : h.value.b, a: p.value === true ? A === "a" ? K : h.value.a : void 0 };
    if (A !== "a") {
      const me = Vi(de);
  ...
  function j(k, A) {
    ...
    const ne = Vi(z);
    if (h.value.h = ne.h, h.value.s = ne.s, h.value.v = ne.v, F(z, A), A !== true) {
  ...
  function W(k) {
    const A = T(k), z = { r: A.r, g: A.g, b: A.b, a: A.a };
    z.a === void 0 && (z.a = h.value.a), h.value.h = A.h, h.value.s = A.s, h.value.v = A.v, F(z, true);
  }
  function te(k) {
  ...
  function be() {
    const k = [];
    return e.noHeaderTabs !== true && k.push(d(Bu, { class: "q-color-picker__header-tabs", modelValue: s.value, dense: true, align: "justify", "onUpdate:modelValue": X }, () => [d(Oa, { label: "HEX" + (p.value === true ? "A" : ""), name: "hex", ripple: false }), d(Oa, { label: "RGB" + (p.value === true ? "A" : ""), name: "rgb", ripple: false })])), k.push(d("div", { class: "q-color-picker__header-banner row flex-center no-wrap" }, [d("input", { class: "fit", value: h.value[s.value], ...m.value !== true ? { readonly: true } : {}, ...r("topIn", { onInput: (A) => {
      ee(j(A) === true);
    }, onChange: wt, onBlur: (A) => {
      j(A, true) === true && n.$forceUpdate(), ee(false);
  ...
  function J() {
    return d("div", { class: "q-color-picker__footer relative-position overflow-hidden" }, [d(Bu, { class: "absolute-full", modelValue: v.value, dense: true, align: "justify", "onUpdate:modelValue": R }, () => [d(Oa, { icon: l.iconSet.colorPicker.spectrum, name: "spectrum", ripple: false }), d(Oa, { icon: l.iconSet.colorPicker.tune, name: "tune", ripple: false }), d(Oa, { icon: l.iconSet.colorPicker.palette, name: "palette", ripple: false })])]);
  }
  function O() {
    const k = { ref: o, class: "q-color-picker__spectrum non-selectable relative-position cursor-pointer" + (m.value !== true ? " readonly" : ""), style: _.value, ...m.value === true ? { onClick: Q, onMousedown: M } : {} }, A = [d("div", { style: { paddingBottom: "100%" } }), d("div", { class: "q-color-picker__spectrum-white absolute-full" }), d("div", { class: "q-color-picker__spectrum-black absolute-full" }), d("div", { class: "absolute", style: E.value }, [h.value.hex !== void 0 ? d("div", { class: "q-color-picker__spectrum-circle" }) : null])], z = [d(Jl, { class: "q-color-picker__hue non-selectable", modelValue: h.value.h, min: 0, max: 360, trackSize: "8px", innerTrackColor: "transparent", selectionColor: "transparent", readonly: m.value !== true, thumbPath: ud, "onUpdate:modelValue": C, onChange: D })];
    return p.value === true && z.push(d(Jl, { class: "q-color-picker__alpha non-selectable", modelValue: h.value.a, min: 0, max: 100, trackSize: "8px", trackColor: "white", innerTrackColor: "transparent", selectionColor: "transparent", trackImg: Tp, readonly: m.value !== true, hideSelection: true, thumbPath: ud, ...r("alphaSlide", { "onUpdate:modelValue": (Z) => H(Z, "a", 100), onChange: (Z) => H(Z, "a", 100, void 0, true) }) })), [pn("div", k, A, "spec", m.value, () => P.value), d("div", { class: "q-color-picker__sliders" }, z)];
  }
  function re() {
  ...
  function we() {
    const k = (A) => d("div", { class: "q-color-picker__cube col-auto", style: { backgroundColor: A }, ...m.value === true ? r("palette#" + A, { onClick: () => {
      W(A);
    } }) : {} });
    return [d("div", { class: "row items-center q-color-picker__palette-rows" + (m.value === true ? " q-color-picker__palette-rows--editable" : "") }, $.value.map(k))];
  }
  return () => {
    const k = [B()];
...
function Mp(e, t, n) {
  return Object.prototype.toString.call(e) === "[object Date]" && (n = e.getDate(), t = e.getMonth() + 1, e = e.getFullYear()), Rp(Os(e, t, n));
}
function sd(e, t, n) {
  return Gm($p(e, t, n));
}
...
function $p(e, t, n) {
  const l = Ym(e, true);
  return Os(l.gy, 3, l.march) + (t - 1) * 31 - _t(t, 7) * (t - 7) + n - 1;
}
function Rp(e) {
  const t = Gm(e).gy;
  let n = t - 621, l, a, r;
  const o = Ym(n, false), i = Os(t, 3, o.march);
  if (r = e - i, r >= 0) {
...
var Jm = 864e5, Lp = 36e5, Fu = 6e4, eh = "YYYY-MM-DDTHH:mm:ss.SSSZ", Bp = /\[((?:[^\]\\]|\\]|\\)*)\]|do|d{1,4}|Mo|M{1,4}|m{1,2}|wo|w{1,2}|Qo|Do|DDDo|D{1,4}|YY(?:YY)?|H{1,2}|h{1,2}|s{1,2}|S{1,3}|Z{1,2}|a{1,2}|[AQExX]/g, Fp = /(\[[^\]]*\])|do|d{1,4}|Mo|M{1,4}|m{1,2}|wo|w{1,2}|Qo|Do|DDDo|D{1,4}|YY(?:YY)?|H{1,2}|h{1,2}|s{1,2}|S{1,3}|Z{1,2}|a{1,2}|[AQExX]|([.*+:?^,\s${}()|\\]+)/g, Ii = {};
function Op(e, t) {
...
function Ur(e, t, n) {
  return (e.getTime() - e.getTimezoneOffset() * Fu - (t.getTime() - t.getTimezoneOffset() * Fu)) / n;
}
function nh(e, t, n = "days") {
  ...
  switch (n) {
    ...
    case "minutes":
    case "minute":
      return Ur(Un(l, "minute"), Un(a, "minute"), Fu);
    case "seconds":
    case "second":
...
var Dn = 20, Vp = ["Calendar", "Years", "Months"], fd = (e) => Vp.includes(e), Ni = (e) => /^-?[\d]+\/[0-1]\d$/.test(e), ta = " \u2014 ";
function ll(e) {
...
ve({ name: "QDate", props: { ...Fo, ...wn, ...nt, modelValue: { required: true, validator: (e) => typeof e == "string" || Array.isArray(e) === true || Object(e) === e || e === null }, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { ...Fo.mask, default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: Ni }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: Ni }, navigationMaxYearMonth: { type: String, validator: Ni }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: fd } }, emits: [...Xm, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: n }) {
  ...
  let v;
  const h = Rr(e), m = Sl(h), g = U(null), w = U(Ne()), S = U(c()), q = f(() => Ne()), p = f(() => c()), y = f(() => s()), b = U(ie(w.value, S.value)), _ = U(e.defaultView), E = f(() => a.lang.rtl === true ? "right" : "left"), $ = U(E.value), V = U(E.value), L = b.value.year, P = U(L - L % Dn - (L < 0 ? Dn : 0)), F = U(null), T = f(() => {
    ...
    return H.value.filter((Y) => $t(Y) === true && Y.from !== void 0 && Y.to !== void 0).map((Y) => ({ from: I(Y.from), to: I(Y.to) })).filter((Y) => Y.from.dateHash !== null && Y.to.dateHash !== null && Y.from.dateHash < Y.to.dateHash);
  }), te = f(() => e.calendar !== "persian" ? (I) => new Date(I.year, I.month - 1, I.day) : (I) => {
    const Y = sd(I.year, I.month, I.day);
    return new Date(Y.gy, Y.gm - 1, Y.gd);
  }), pe = f(() => e.calendar === "persian" ? jn : (I, Y, se) => lh(new Date(I.year, I.month - 1, I.day, I.hour, I.minute, I.second, I.millisecond), Y === void 0 ? w.value : Y, se === void 0 ? S.value : se, I.year, I.timezoneOffset)), Q = f(() => j.value.length + W.value.reduce((I, Y) => I + 1 + nh(te.value(Y.to), te.value(Y.from)), 0)), M = f(() => {
    ...
    if (Q.value === 0) return ta;
    if (Q.value > 1) return `${Q.value} ${S.value.pluralDay}`;
    const I = j.value[0], Y = te.value(I);
    return isNaN(Y.valueOf()) === true ? ta : S.value.headerTitle !== void 0 ? S.value.headerTitle(Y, I) : S.value.daysShort[Y.getDay()] + ", " + S.value.monthsShort[I.month - 1] + " " + I.day;
  ...
  function it(I, Y, se) {
    ...
    const Te = I + "/" + rt(Y) + "/01";
    Te !== b.value.dateHash && ($.value = b.value.dateHash < Te == (a.lang.rtl !== true) ? "left" : "right", I !== b.value.year && (V.value = $.value), Ge(() => {
  ...
  const Ue = { Calendar: () => [d("div", { key: "calendar-view", class: "q-date__view q-date__calendar" }, [d("div", { class: "q-date__navigation row items-center no-wrap" }, Be({ label: S.value.months[b.value.month - 1], type: "Months", key: b.value.month, dir: $.value, goTo: ae, boundaries: A.value.month, cls: " col" }).concat(Be({ label: b.value.year, type: "Years", key: b.value.year, dir: V.value, goTo: ye, boundaries: A.value.year, cls: "" }))), d("div", { class: "q-date__calendar-weekdays row items-center no-wrap" }, J.value.map((I) => d("div", { class: "q-date__calendar-item" }, [d("div", I)]))), d("div", { class: "q-date__calendar-days-container relative-position overflow-hidden" }, [d(Ft, { name: "q-transition--slide-" + $.value }, () => d("div", { key: K.value, class: "q-date__calendar-days fit" }, ce.value.map((I) => d("div", { class: I.classes }, [I.in === true ? d(Ze, { class: I.today === true ? "q-date__today" : "", dense: true, flat: I.flat, unelevated: I.unelevated, color: I.color, textColor: I.textColor, label: I.i, tabindex: i.value, ...o("day#" + I.i, { onClick: () => {
    yt(I.i);
  }, onMouseover: () => {
    ht(I.i);
    ...
    return e.yearsInMonthView === true && se.unshift(d("div", { class: "row no-wrap full-width" }, [Be({ label: b.value.year, type: "Years", key: b.value.year, dir: V.value, goTo: ye, boundaries: A.value.year, cls: " col" })])), d("div", { key: "months-view", class: "q-date__view q-date__months flex flex-center" }, se);
  }, Years() {
...
var Va = 0, Hi, ji, Ka, Ui = false, vd, md, hd, ql = null;
function Ip(e) {
  zp(e) && He(e);
}
function zp(e) {
...
function bd(e) {
  ...
  if (e === "add") {
    ...
    Hi = oi(window), ji = gl(window), vd = t.style.left, md = t.style.top, hd = window.location.href, t.style.left = `-${Hi}px`, t.style.top = `-${ji}px`, a !== "hidden" && (a === "scroll" || t.scrollWidth > window.innerWidth) && t.classList.add("q-body--force-scrollbar-x"), l !== "hidden" && (l === "scroll" || t.scrollHeight > window.innerHeight) && t.classList.add("q-body--force-scrollbar-y"), t.classList.add("q-body--prevent-scroll"), document.qScrollPrevented = true, ze.is.ios === true && (n === true ? (window.scrollTo(0, 0), window.visualViewport.addEventListener("resize", Qr, dt.passiveCapture), window.visualViewport.addEventListener("scroll", Qr, dt.passiveCapture), window.scrollTo(0, 0)) : window.addEventListener("scroll", gd, dt.passiveCapture));
  }
  ze.is.desktop === true && ze.is.mac === true && window[`${e}EventListener`]("wheel", Ip, dt.notPassive), e === "remove" && (ze.is.ios === true && (n === true ? (window.visualViewport.removeEventListener("resize", Qr, dt.passiveCapture), window.visualViewport.removeEventListener("scroll", Qr, dt.passiveCapture)) : window.removeEventListener("scroll", gd, dt.passiveCapture)), t.classList.remove("q-body--prevent-scroll"), t.classList.remove("q-body--force-scrollbar-x"), t.classList.remove("q-body--force-scrollbar-y"), document.qScrollPrevented = false, t.style.left = vd, t.style.top = md, window.location.href === hd && window.scrollTo(Hi, ji), Ka = void 0);
}
function Ou(e) {
  let t = "add";
  if (e === true) {
...
var Kr = 0, Dp = { standard: "fixed-full flex-center", top: "fixed-top justify-center", bottom: "fixed-bottom justify-center", right: "fixed-right items-center", left: "fixed-left items-center" }, yd = { standard: ["scale", "scale"], top: ["slide-down", "slide-up"], bottom: ["slide-up", "slide-down"], right: ["slide-left", "slide-right"], left: ["slide-right", "slide-left"] }, si = ve({ name: "QDialog", inheritAttrs: false, props: { ...Ea, ...Ol, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, backdropFilter: String, position: { type: String, default: "standard", validator: (e) => ["standard", "top", "bottom", "left", "right"].includes(e) } }, emits: [...Aa, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  const h = f(() => e.persistent !== true && e.noRouteDismiss !== true && e.seamless !== true), { preventBodyScroll: m } = rh(), { registerTimeout: g } = Xn(), { registerTick: w, removeTick: S } = ga(), { transitionProps: q, transitionStyle: p } = ri(e, () => yd[e.position][0], () => yd[e.position][1]), y = f(() => p.value + (e.backdropFilter !== void 0 ? `;backdrop-filter:${e.backdropFilter};-webkit-backdrop-filter:${e.backdropFilter}` : "")), { showPortal: b, hidePortal: _, portalIsAccessible: E, renderPortal: $ } = Cs(a, r, be, "dialog"), { hide: V } = $a({ showing: o, hideOnRouteChange: h, handleShow: D, handleHide: H, processOnMount: true }), { addToHistory: L, removeFromHistory: P } = ah(o, V, h), F = f(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${e.maximized === true ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${Dp[e.position]}` + (i.value === true ? " q-dialog__inner--animating" : "") + (e.fullWidth === true ? " q-dialog__inner--fullwidth" : "") + (e.fullHeight === true ? " q-dialog__inner--fullheight" : "") + (e.square === true ? " q-dialog__inner--square" : "")), T = f(() => o.value === true && e.seamless !== true), x = f(() => e.autoClose === true ? { onClick: M } : {}), C = f(() => [`q-dialog fullscreen no-pointer-events q-dialog--${T.value === true ? "modal" : "seamless"}`, l.class]);
  he(() => e.maximized, (B) => {
    o.value === true && Q(B);
  }), he(T, (B) => {
    m(B), B === true ? (qm(X), Cm(te)) : (Ru(X), Mo(te));
  });
  function D(B) {
    var _a2;
  ...
  function pe(B) {
    u !== null && (clearTimeout(u), u = null), (B === true || o.value === true) && (Q(false), e.seamless !== true && (m(false), Ru(X), Mo(te))), B !== true && (c = null);
  }
  function Q(B) {
  ...
  function X(B) {
    e.allowFocusOutside !== true && E.value === true && dm(r.value, B.target) !== true && j('[tabindex]:not([tabindex="-1"])');
  }
  ...
  function y(N, oe) {
    if ($(), N !== false && s.animate(), A(0), g.value === true) {
  ...
  he(g, (N) => {
    N === true ? (v = q.value, q.value === true && E(false)) : e.overlay === false && e.behavior !== "mobile" && v !== false && (q.value === true ? (A(0), z(0), me()) : _(false));
  }), he(() => e.side, (N, oe) => {
  ...
  function A(N) {
    N === void 0 ? Ge(() => {
      N = q.value === true ? 0 : S.value, A(F.value * N);
  ...
  function K(N) {
    ...
    if (N.isFinal === true) {
      _e >= Math.min(75, oe) === true ? _() : (s.animate(), z(0), A(F.value * oe)), x.value = false;
      return;
    }
    A((r.lang.rtl === true ? P.value !== true : P.value) ? Math.max(oe - _e, 0) : Math.min(0, _e - oe)), z(ct(_e / oe, 0, 1)), N.isFirst === true && (x.value = true);
  }
  function de(N) {
    if (q.value !== true) return;
    const oe = S.value, _e = N.direction === e.side, ke = (r.lang.rtl === true ? _e !== true : _e) ? ct(N.distance.x, 0, oe) : 0;
    if (N.isFinal === true) {
      Math.abs(ke) < Math.min(75, oe) === true ? (s.animate(), z(1), A(0)) : E(), x.value = false;
      return;
    }
    A(F.value * ke), z(ct(1 - ke / oe, 0, 1)), N.isFirst === true && (x.value = true);
  }
  function me() {
    i(false), Z(true);
  }
...
var Np = /^https?:\/\//, Hp = class {
  ...
  let a, r;
  const o = Se(), { proxy: { $q: i } } = o, u = U(null), c = U(false), s = f(() => Po(e.anchor, i.lang.rtl)), v = f(() => Po(e.self, i.lang.rtl)), h = f(() => e.persistent !== true), { registerTick: m, removeTick: g } = ga(), { registerTimeout: w } = Xn(), { transitionProps: S, transitionStyle: q } = ri(e), { localScrollTarget: p, changeScrollEvent: y, unconfigureScrollTarget: b } = ym(e, pe), { anchorEl: _, canShow: E, anchorEvents: $ } = Ss({ showing: c, configureAnchorEl: te }), { show: V, hide: L } = $a({ showing: c, canShow: E, handleShow: x, handleHide: C, hideOnRouteChange: h, processOnMount: true });
  Object.assign($, { delayShow: j, delayHide: W });
  const { showPortal: P, hidePortal: F, renderPortal: T } = Cs(o, u, M, "tooltip");
  ...
  function D() {
    r !== void 0 && (r.disconnect(), r = void 0), a !== void 0 && (a(), a = void 0), b(), Wt($, "tooltipTemp");
  }
  function H() {
    ks({ targetEl: u.value, offset: e.offset, anchorEl: _.value, anchorOrigin: s.value, selfOrigin: v.value, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function j(ee) {
    if (i.platform.is.mobile === true) {
  ...
  function W(ee) {
    i.platform.is.mobile === true && (Wt($, "tooltipTemp"), Mn(), setTimeout(() => {
...
function Up(e, t) {
  ...
  if (n) o = t.options.map((s) => {
    ...
    o = t.options.map((m) => {
      ...
      const S = m.htmlTip;
      return d(Sa, { active: w, activeClass: s, clickable: true, disable: g, dense: true, onClick(q) {
        var _a2;
...
ve({ name: "QEditor", props: { ...nt, ...Rs, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => e.length === 0 || e.every((t) => t.length), default: () => [["left", "center", "right", "justify"], ["bold", "italic", "underline", "strike"], ["undo", "redo"]] }, toolbarColor: String, toolbarBg: String, toolbarTextColor: String, toolbarToggleColor: { type: String, default: "primary" }, toolbarOutline: Boolean, toolbarPush: Boolean, toolbarRounded: Boolean, paragraphTag: { type: String, validator: (e) => ["div", "p"].includes(e), default: "div" }, contentStyle: Object, contentClass: [Object, Array, String], square: Boolean, flat: Boolean, dense: Boolean }, emits: [...Ps, "update:modelValue", "keydown", "click", "focus", "blur", "dropdownShow", "dropdownHide", "dropdownBeforeShow", "dropdownBeforeHide", "linkShow", "linkHide"], setup(e, { slots: t, emit: n }) {
  const { proxy: l } = Se(), { $q: a } = l, r = lt(e, a), { inFullscreen: o, toggleFullscreen: i } = Ls(), u = ch(), c = U(null), s = U(null), v = U(null), h = U(false), m = f(() => !e.readonly && !e.disable);
  ...
  const E = f(() => e.toolbar && e.toolbar.length !== 0), $ = f(() => {
    const B = {}, R = (J) => {
  ...
  return ft(() => {
    _.caret = l.caret = new Hp(s.value, _), Q(e.modelValue), ee(), document.addEventListener("selectionchange", pe);
  }), Ke(() => {
    document.removeEventListener("selectionchange", pe);
  }), Object.assign(l, { runCmd: M, refreshToolbar: ee, focus: X, getContentEl: be }), () => {
    let B;
    if (E.value) {
      const R = [d("div", { key: "qedt_top", class: "q-editor__toolbar row no-wrap scroll-x" + q.value }, Qp(_))];
      v.value !== null && R.push(d("div", { key: "qedt_btm", class: "q-editor__toolbar row no-wrap items-center scroll-x" + q.value }, Wp(_))), B = d("div", { key: "toolbar_ctainer", class: "q-editor__toolbars-container" }, R);
    }
...
} }), Is = ve({ name: "QSlideTransition", props: { appear: Boolean, duration: { type: Number, default: 300 } }, emits: ["show", "hide"], setup(e, { slots: t, emit: n }) {
...
ve({ name: "QExpansionItem", props: { ...Ar, ...Ea, ...nt, icon: String, label: String, labelLines: [Number, String], caption: String, captionLines: [Number, String], dense: Boolean, toggleAriaLabel: String, expandIcon: String, expandedIcon: String, expandIconClass: [Array, String, Object], duration: {}, headerInsetLevel: Number, contentInsetLevel: Number, expandSeparator: Boolean, defaultOpened: Boolean, hideExpandIcon: Boolean, expandIconToggle: Boolean, switchToggleSide: Boolean, denseToggle: Boolean, group: String, popup: Boolean, headerStyle: [Array, String, Object], headerClass: [Array, String, Object] }, emits: [...Aa, "click", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  function V(j, W) {
    var _a2;
    W !== true && j.qAvoidFocus !== true && ((_a2 = o.value) == null ? void 0 : _a2.focus()), s(j), He(j);
  }
  function L() {
    n("afterShow");
  }
  ...
  function F() {
    ...
    }), W = he(() => Tl[e.group], (te, pe) => {
      pe === v && te !== void 0 && te !== v && c();
    });
    h = () => {
      j(), W(), Tl[e.group] === v && delete Tl[e.group], h = void 0;
    };
  }
  function T() {
    ...
    return y.value === true && (Object.assign(j, { tabindex: 0, ..._.value, onClick: V, onKeyup: $ }), W.unshift(d("div", { ref: o, class: "q-expansion-item__toggle-focus q-icon q-focus-helper q-focus-helper--rounded", tabindex: -1 }))), d(mn, j, () => W);
  }
  function x() {
    let j;
  ...
  function C() {
    ...
    return q.value === true && (j.clickable = true, j.onClick = E, Object.assign(j, w.value === true ? S.value : _.value)), d(Sa, j, x);
  }
  function D() {
  ...
  function H() {
    const j = [C(), d(Is, { duration: e.duration, onShow: L, onHide: P }, D)];
...
ve({ name: "QFab", props: { ...Iu, ...Ea, icon: String, activeIcon: String, hideIcon: Boolean, hideLabel: { ...Iu.hideLabel, default: null }, direction: { type: String, default: "right", validator: (e) => e1.includes(e) }, persistent: Boolean, verticalActionsAlign: { type: String, default: "center", validator: (e) => t1.includes(e) } }, emits: Aa, setup(e, { slots: t }) {
  ...
  function q() {
    const p = [];
    return e.hideIcon !== true && p.push(d("div", { class: w.value }, [S("icon", "icon"), S("active-icon", "activeIcon")])), (e.label !== "" || t.label !== void 0) && p[i.value.action](d("div", i.value.data, t.label !== void 0 ? t.label(v.value) : [e.label])), kt(t.tooltip, p);
  }
...
ve({ name: "QFabAction", props: { ...Iu, icon: { type: String, default: "" }, anchor: { type: String, validator: (e) => n1.includes(e) }, to: [String, Object], replace: Boolean }, emits: ["click"], setup(e, { slots: t, emit: n }) {
...
function o1(e, t) {
  ...
  l1({ validate: w, resetValidation: g });
  let i = 0, u;
  ...
  function w(q = n.modelValue) {
    ...
    const p = ++i, y = t.value !== true ? () => {
      ...
      E === true && y(), a.value = E, r.value = $ || null, t.value = false;
    }, _ = [];
    for (let E = 0; E < n.rules.length; E++) {
      const $ = n.rules[E];
      let V;
      if (typeof $ == "function" ? V = $(q, oo) : typeof $ == "string" && oo[$] !== void 0 && (V = oo[$](q)), V === false || typeof V == "string") return b(true, V), false;
    ...
    return _.length === 0 ? (b(false), true) : (t.value = true, Promise.all(_).then((E) => {
      ...
      const $ = E.find((V) => V === false || typeof V == "string");
      return p === i && b($ !== void 0, $), $ === void 0;
...
function fi({ requiredForAttr: e = true, tagProp: t, changeEvent: n = false } = {}) {
  ...
  return { requiredForAttr: e, changeEvent: n, tag: t === true ? f(() => l.tag) : { value: "label" }, isDark: r, editable: f(() => l.disable !== true && l.readonly !== true), innerLoading: U(false), focused: U(false), hasPopupOpen: false, splitAttrs: ch(), targetUid: o, rootRef: U(null), targetRef: U(null), controlRef: U(null) };
}
function vi(e) {
  const { props: t, emit: n, slots: l, attrs: a, proxy: r } = Se(), { $q: o } = r;
  let i = null;
  e.hasValue === void 0 && (e.hasValue = f(() => jl(t.modelValue))), e.emitValue === void 0 && (e.emitValue = (W) => {
    n("update:modelValue", W);
  }), e.controlEvents === void 0 && (e.controlEvents = { onFocusin: L, onFocusout: P }), Object.assign(e, { clearValue: F, onControlFocusin: L, onControlFocusout: P, focus: $ }), e.computedCounter === void 0 && (e.computedCounter = f(() => {
    if (t.counter !== false) {
  ...
  function F(W) {
    var _a2;
    He(W), o.platform.is.mobile !== true ? (((_a2 = e.targetRef) == null ? void 0 : _a2.value) || e.rootRef.value).focus() : e.rootRef.value.contains(document.activeElement) === true && document.activeElement.blur(), t.type === "file" && (e.inputRef.value.value = null), n("update:modelValue", null), e.changeEvent === true && n("change", null), n("clear", t.modelValue), Ge(() => {
      const te = u.value;
      h(), u.value = te;
    });
  }
  ...
  }), Object.assign(r, { focus: $, blur: V }), function() {
...
function bh({ editable: e, dnd: t, getFileInput: n, addFilesToQueue: l }) {
  ...
  function m(p, y, b, _) {
    ...
    if (a.accept !== void 0 && u.value.indexOf("*/") === -1 && (E = na(E, $, "accept", (L) => u.value.some((P) => L.type.toUpperCase().startsWith(P) || L.name.toUpperCase().endsWith(P))), E.length === 0)) return V();
    if (a.maxFileSize !== void 0) {
      const L = parseInt(a.maxFileSize, 10);
      if (E = na(E, $, "max-file-size", (P) => P.size <= L), E.length === 0) return V();
    }
    if (a.multiple !== true && E.length !== 0 && (E = [E[0]]), E.forEach((L) => {
      ...
      E = na(E, $, "duplicate", (P) => L.includes(P.__key) === false);
    }
    if (E.length === 0) return V();
    if (a.maxTotalSize !== void 0) {
      let L = _ === true ? b.reduce((P, F) => P + F.size, 0) : 0;
      if (E = na(E, $, "max-total-size", (P) => (L += P.size, L <= s.value)), E.length === 0) return V();
    }
    if (typeof a.filter == "function") {
      const L = a.filter(E);
      E = na(E, $, "filter", (P) => L.includes(P));
    }
    if (a.maxFiles !== void 0) {
      let L = _ === true ? b.length : 0;
      if (E = na(E, $, "max-files", () => (L++, L <= c.value)), E.length === 0) return V();
    }
...
ve({ name: "QFile", inheritAttrs: false, props: { ...mh, ...wn, ...hh, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, ...gh], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  function D() {
    ...
    if (e.useChips === true) return w.value.length === 0 ? C() : w.value.map((W, te) => d(Bm, { key: "file-" + te, removable: r.editable.value, dense: true, textColor: e.color, tabindex: e.tabindex, onRemove: () => {
      $(te);
  ...
  return Object.assign(r, { fieldClass: _, emitValue: L, hasValue: S, inputRef: o, innerValue: w, floatingLabel: f(() => S.value === true || jl(e.displayValue)), computedCounter: f(() => {
  ...
  } }), Object.assign(a, { removeAtIndex: $, removeFile: V, getNativeElement: () => o.value }), Ot(a, "nativeEl", () => o.value), vi(r);
} });
ve({ name: "QFooter", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: n }) {
  ...
  function p() {
    ...
    const { direction: _, position: E, inflectionPoint: $ } = a.scroll.value;
    S(o, _ === "up" || E - $ < 100 || a.height.value - c.value - E - r.value < 300);
  }
  function y(_) {
  ...
  return a.instances.footer = b, e.modelValue === true && w("size", r.value), w("space", e.modelValue), w("offset", s.value), Ke(() => {
    ...
    const _ = kt(t.default, [d(Nl, { debounce: 0, onResize: q })]);
    ...
    return (e.greedy === true ? Promise.all(o.map(q)).then((y) => y.filter((b) => b.valid !== true)) : o.reduce((y, b) => y.then(() => q(b).then((_) => {
      ...
      if (w === r) {
        ...
        if (_ !== void 0 && console.error(_), S(false, b), g === true) {
          const E = y.find(({ comp: $ }) => typeof $.focus == "function" && hl($.$) === false);
...
var u1 = ve({ name: "QHeader", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, revealOffset: { type: Number, default: 250 }, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: n }) {
  ...
  return a.instances.header = q, e.modelValue === true && m("size", r.value), m("space", e.modelValue), m("offset", u.value), Ke(() => {
    ...
    return e.elevated === true && p.push(d("div", { class: "q-layout__shadow absolute-full overflow-hidden no-pointer-events" })), p.push(d(Nl, { debounce: 0, onResize: w })), d("header", { class: v.value, style: h.value, onFocusin: S }, p);
  };
} }), zs = { ratio: [String, Number] };
function Ds(e, t) {
  return f(() => {
...
ve({ name: "QImg", props: { ...zs, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, loadingShowDelay: { type: [Number, String], default: 0 }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: s1 }, placeholderSrc: String, errorSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: n }) {
  ...
  function E({ target: T }) {
    hl(r) === false && (i(), l.value = T.naturalHeight === 0 ? 0.5 : T.naturalWidth / T.naturalHeight, $(T, 1));
  }
  function $(T, x) {
...
ve({ name: "QInfiniteScroll", props: { offset: { type: Number, default: 500 }, debounce: { type: [String, Number], default: 100 }, scrollTarget: Wl, initialIndex: { type: Number, default: 0 }, disable: Boolean, reverse: Boolean }, emits: ["load"], setup(e, { slots: t, emit: n }) {
  ...
  function v() {
    ...
    const $ = zr(u), V = gl(u), L = _a(u);
    e.reverse === false ? Math.round(V + L + e.offset) >= Math.round($) && h() : Math.round(V) <= e.offset && h();
  }
  function h() {
    if (e.disable === true || l.value === true || a.value === false) return;
    i++, l.value = true;
  ...
  function p($) {
    $ = parseInt($, 10);
    const V = c;
    c = $ <= 0 ? v : Ma(v, isNaN($) === true ? 100 : $), u && a.value === true && (V !== void 0 && u.removeEventListener("scroll", V, Ml), u.addEventListener("scroll", c, Ml));
  }
  function y($) {
    if (b.value === true) {
      if (o.value === null) {
  ...
  return Object.assign(E.proxy, { poll: () => {
    ...
    const $ = Er(t.default, []);
    return b.value === true && $[e.reverse === false ? "push" : "unshift"](d("div", { ref: o, class: s.value }, Pe(t.loading))), d("div", { class: "q-infinite-scroll", ref: r }, $);
  };
} });
...
function f1(e, t, n, l) {
  ...
  function w() {
    ...
    const L = xd[e.mask] === void 0 ? e.mask : xd[e.mask], P = typeof e.fillMask == "string" && e.fillMask.length !== 0 ? e.fillMask.slice(0, 1) : "_", F = P.replace(Cd, "\\$&"), T = [], x = [], C = [];
    let D = e.reverseFillMask === true, H = "", j = "";
    L.replace(c1, (Q, M, ee, X, be) => {
      if (X !== void 0) {
        const B = Oo[X];
        ...
        H = B === "\\" ? "\\\\\\\\" : B.replace(Cd, "\\\\$&"), C.push(B), T.push("([^" + H + "]+)?" + H + "?");
      }
    });
  ...
  function S(L, P, F) {
    const T = l.value, x = T.selectionEnd, C = T.value.length - x, D = $(L);
    P === true && w();
    ...
    const te = e.unmaskedValue === true ? $(j) : j;
...
var wh = ve({ name: "QInput", inheritAttrs: false, props: { ...ci, ...d1, ...wn, modelValue: [String, Number, FileList], shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: n }) {
  ...
  const v = U(null), h = qs(e), { innerValue: m, hasMask: g, moveCursorForPaste: w, updateMaskValue: S, onMaskedKeydown: q, onMaskedClick: p } = f1(e, t, H, v), y = yh(e, true), b = f(() => jl(m.value)), _ = _h(C), E = fi({ changeEvent: true }), $ = f(() => e.type === "textarea" || e.autogrow === true), V = f(() => $.value === true || ["text", "search", "url", "tel", "password"].includes(e.type)), L = f(() => {
    ...
    return $.value === false && (M.type = e.type), e.autogrow === true && (M.rows = 1), M;
  });
  he(() => e.type, () => {
  ...
  Ke(() => {
    ...
    e.autogrow === true && j();
  }), Object.assign(E, { innerValue: m, fieldClass: f(() => `q-${$.value === true ? "textarea" : "input"}` + (e.autogrow === true ? " q-textarea--autogrow" : "")), hasShadow: f(() => e.type !== "file" && typeof e.shadowText == "string" && e.shadowText.length !== 0), inputRef: v, emitValue: H, hasValue: b, floatingLabel: f(() => b.value === true && (e.type !== "number" || isNaN(m.value) === false) || jl(e.displayValue)), getControl: () => d($.value === true ? "textarea" : "input", { ref: v, class: ["q-field__native q-placeholder", e.inputClass], style: e.inputStyle, ...P.value, ...L.value, ...e.type !== "file" ? { value: pe() } : y.value }), getShadowControl: () => d("div", { class: "q-field__native q-field__shadow absolute-bottom no-pointer-events" + ($.value === true ? "" : " text-no-wrap") }, [d("span", { class: "invisible" }, pe()), d("span", e.shadowText)]) });
  const Q = vi(E);
...
ve({ name: "QIntersection", props: { tag: { type: String, default: "div" }, once: Boolean, transition: String, transitionDuration: { type: [String, Number], default: 300 }, ssrPrerender: Boolean, margin: String, threshold: [Number, Array], root: { default: null }, disable: Boolean, onVisibility: Function }, setup(e, { slots: t, emit: n }) {
  const l = U(nn.value === true ? e.ssrPrerender : false), a = f(() => e.root !== void 0 || e.margin !== void 0 || e.threshold !== void 0 ? { handler: u, cfg: { root: e.root, rootMargin: e.margin, threshold: e.threshold } } : u), r = f(() => e.disable !== true && (nn.value !== true || e.once !== true || e.ssrPrerender !== true)), o = f(() => [[b1, a.value, void 0, { once: e.once }]]), i = f(() => `--q-transition-duration: ${e.transitionDuration}ms`);
  function u(s) {
...
ve({ name: "QKnob", props: { ...wn, ...Bs, modelValue: { type: Number, required: true }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, tabindex: { type: [Number, String], default: 0 }, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change", "dragValue"], setup(e, { slots: t, emit: n }) {
  ...
  const v = f(() => e.disable === false && e.readonly === false), h = f(() => "q-knob non-selectable" + (v.value === true ? " q-knob--editable" : e.disable === true ? " disabled" : "")), m = f(() => (String(e.step).trim().split(".")[1] || "").length), g = f(() => e.step === 0 ? 1 : e.step), w = f(() => e.instantFeedback === true || o.value === true), S = a.platform.is.mobile === true ? f(() => v.value === true ? { onClick: $ } : {}) : f(() => v.value === true ? { onMousedown: E, onClick: $, onKeydown: V, onKeyup: P } : {}), q = f(() => v.value === true ? { tabindex: e.tabindex } : { [`aria-${e.disable === true ? "disabled" : "readonly"}`]: "true" }), p = f(() => {
    const C = {};
    return p1.forEach((D) => {
      C[D] = e[D];
    }), C;
  ...
  function V(C) {
    if (Td.includes(C.keyCode) === false) return;
    He(C);
  ...
  return () => {
    ...
    return v.value === true && e.name !== void 0 && (D.internal = x), pn(Vm, C, D, "knob", v.value, () => b.value);
  };
} });
var { passive: Md } = dt, _1 = ["both", "horizontal", "vertical"], Ch = ve({ name: "QScrollObserver", props: { axis: { type: String, validator: (e) => _1.includes(e), default: "vertical" }, debounce: [String, Number], scrollTarget: Wl }, emits: ["scroll"], setup(e, { emit: t }) {
  ...
  function w(b) {
    ...
    let $ = false;
    r.value !== _ && ($ = true, r.value = _, e.onScrollHeight !== void 0 && n("scrollHeight", _), q()), o.value !== E && ($ = true, o.value = E), $ === true && e.onResize !== void 0 && n("resize", b);
  }
  function S({ height: b }) {
  ...
  if (hn(Kl, y), ro() > 0) {
    let b = function() {
      $ = null, V.classList.remove("hide-scrollbar");
    }, _ = function() {
      if ($ === null) {
      ...
      $ !== null && L === "remove" && (clearTimeout($), b()), window[`${L}EventListener`]("resize", _);
    }, $ = null;
    const V = document.body;
    he(() => e.container !== true ? "add" : "remove", E), e.container !== true && E("add"), Go(() => {
      E("remove");
    });
  }
  return () => {
    const b = kt(t.default, [d(Ch, { onScroll: g }), d(Nl, { onResize: w })]), _ = d("div", { class: s.value, style: v.value, ref: e.container === true ? void 0 : a, tabindex: -1 }, b);
    return e.container === true ? d("div", { class: "q-layout-container overflow-hidden", ref: a }, [d(Nl, { onResize: S }), d("div", { class: "absolute-full", style: h.value }, [d("div", { class: "scroll", style: m.value }, [_])])]) : _;
  };
...
var C1 = () => d("svg", { key: "svg", class: "q-radio__bg absolute non-selectable", viewBox: "0 0 24 24" }, [d("path", { d: "M12,22a10,10 0 0 1 -10,-10a10,10 0 0 1 10,-10a10,10 0 0 1 10,10a10,10 0 0 1 -10,10m0,-22a12,12 0 0 0 -12,12a12,12 0 0 0 12,12a12,12 0 0 0 12,-12a12,12 0 0 0 -12,-12" }), d("path", { class: "q-radio__check", d: "M12,6a6,6 0 0 0 -6,6a6,6 0 0 0 6,6a6,6 0 0 0 6,-6a6,6 0 0 0 -6,-6" })]), k1 = ve({ name: "QRadio", props: { ...nt, ...Jn, ...wn, modelValue: { required: true }, val: { required: true }, label: String, leftLabel: Boolean, checkedIcon: String, uncheckedIcon: String, color: String, keepColor: Boolean, dense: Boolean, disable: Boolean, tabindex: [String, Number] }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  const { proxy: l } = Se(), a = lt(e, l.$q), r = el(e, $m), o = U(null), { refocusTargetEl: i, refocusTarget: u } = Am(e, o), c = f(() => Ye(e.modelValue) === Ye(e.val)), s = f(() => "q-radio cursor-pointer no-outline row inline no-wrap items-center" + (e.disable === true ? " disabled" : "") + (a.value === true ? " q-radio--dark" : "") + (e.dense === true ? " q-radio--dense" : "") + (e.leftLabel === true ? " reverse" : "")), v = f(() => {
  ...
  return () => {
    ...
    const E = e.label !== void 0 ? kt(t.default, [e.label]) : Pe(t.default);
...
ve({ name: "QPagination", props: { ...nt, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => (typeof e == "string" ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => e === "" || vm.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  const w = f(() => "q-pagination row no-wrap items-center" + (e.disable === true ? " disabled" : "")), S = f(() => e.gutter in To ? `${To[e.gutter]}px` : e.gutter || null), q = f(() => S.value !== null ? `--q-pagination-gutter-parent:-${S.value};--q-pagination-gutter-child:${S.value}` : null), p = f(() => {
  ...
  }), y = f(() => ({ "aria-disabled": e.disable === true ? "true" : "false", role: "navigation" })), b = f(() => _s(e, "flat")), _ = f(() => ({ [b.value]: true, round: e.round, rounded: e.rounded, padding: e.padding, color: e.color, textColor: e.textColor, size: e.size, ripple: e.ripple !== null ? e.ripple : true })), E = f(() => {
    const x = { [b.value]: false };
    return e.activeDesign !== "" && (x[e.activeDesign] = true), x;
  }), $ = f(() => ({ ...E.value, color: e.activeColor || e.color, textColor: e.activeTextColor || e.textColor })), V = f(() => {
  ...
  function T(x, C, D) {
    ...
    return D === true && Object.assign(H, { "aria-current": "true", ...$.value }), C !== void 0 && (e.toFn !== void 0 ? H.to = e.toFn(C) : H.onClick = () => {
      L(C);
    }), d(Ze, H);
  }
...
ve({ name: "QParallax", props: { src: String, height: { type: Number, default: 500 }, speed: { type: Number, default: 1, validator: (e) => e >= 0 && e <= 1 }, scrollTarget: Wl, onScroll: Function }, setup(e, { slots: t, emit: n }) {
  ...
  function g() {
    let y, b, _;
    h === window ? (y = 0, _ = b = window.innerHeight) : (y = qo(h).top, b = _a(h), _ = y + b);
    const E = qo(a.value).top, $ = E + e.height;
    if (v !== void 0 || $ > y && E < _) {
  ...
  return ft(() => {
    w = Gi(w), m = Gi(m), s = Gi(S), u = t.media !== void 0 ? r.value.children[0] : o.value, u.onload = u.onloadstart = u.loadedmetadata = S, S(), u.style.display = "initial", window.IntersectionObserver !== void 0 ? (v = new IntersectionObserver((y) => {
...
ve({ name: "QPopupEdit", props: { modelValue: { required: true }, title: String, buttons: Boolean, labelSet: String, labelCancel: String, color: { type: String, default: "primary" }, validate: { type: Function, default: () => true }, autoSave: Boolean, cover: { type: Boolean, default: true }, disable: Boolean }, emits: ["update:modelValue", "save", "cancel", "beforeShow", "show", "beforeHide", "hide"], setup(e, { slots: t, emit: n }) {
  ...
  return Object.assign(l, { set: s, cancel: v, show(b) {
    ...
    if (e.disable !== true) return d(ii, { ref: r, class: "q-popup-edit", cover: e.cover, onBeforeShow: w, onShow: S, onBeforeHide: q, onHide: p, onEscapeKey: v }, y);
  };
} });
ve({ name: "QPopupProxy", props: { ...bm, breakpoint: { type: [String, Number], default: 450 } }, emits: ["show", "hide"], setup(e, { slots: t, emit: n, attrs: l }) {
  const { proxy: a } = Se(), { $q: r } = a, o = U(false), i = U(null), u = f(() => parseInt(e.breakpoint, 10)), { canShow: c } = Ss({ showing: o });
  function s() {
  ...
  return Object.assign(a, { show(w) {
    ...
    let S;
    return v.value === "dialog" ? S = si : (S = ii, Object.assign(w, { target: e.target, contextMenu: e.contextMenu, noParentEvent: true, separateClosePopup: true })), d(S, w, t.default);
  };
} });
...
var $1 = ve({ name: "QLinearProgress", props: { ...nt, ...Jn, value: { type: Number, default: 0 }, buffer: Number, color: String, trackColor: String, reverse: Boolean, stripe: Boolean, indeterminate: Boolean, query: Boolean, rounded: Boolean, animationSpeed: { type: [String, Number], default: 2100 }, instantFeedback: Boolean }, setup(e, { slots: t }) {
  const { proxy: n } = Se(), l = lt(e, n.$q), a = el(e, A1), r = f(() => e.indeterminate === true || e.query === true), o = f(() => e.reverse !== e.query), i = f(() => ({ ...a.value !== null ? a.value : {}, "--q-linear-progress-speed": `${e.animationSpeed}ms` })), u = f(() => "q-linear-progress" + (e.color !== void 0 ? ` text-${e.color}` : "") + (e.reverse === true || e.query === true ? " q-linear-progress--reverse" : "") + (e.rounded === true ? " rounded-borders" : "")), c = f(() => Ed(e.buffer !== void 0 ? e.buffer : 1, o.value, n.$q)), s = f(() => `with${e.instantFeedback === true ? "out" : ""}-transition`), v = f(() => `q-linear-progress__track absolute-full q-linear-progress__track--${s.value} q-linear-progress__track--${l.value === true ? "dark" : "light"}` + (e.trackColor !== void 0 ? ` bg-${e.trackColor}` : "")), h = f(() => Ed(r.value === true ? 1 : e.value, o.value, n.$q)), m = f(() => `q-linear-progress__model absolute-full q-linear-progress__model--${s.value} q-linear-progress__model--${r.value === true ? "in" : ""}determinate`), g = f(() => ({ width: `${e.value * 100}%` })), w = f(() => `q-linear-progress__stripe absolute-${e.reverse === true ? "right" : "left"} q-linear-progress__stripe--${s.value}`);
  return () => {
    const S = [d("div", { class: v.value, style: c.value }), d("div", { class: m.value, style: h.value })];
    return e.stripe === true && r.value === false && S.push(d("div", { class: w.value, style: g.value })), d("div", { class: u.value, style: i.value, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 1, "aria-valuenow": e.indeterminate === true ? void 0 : e.value }, kt(t.default, S));
  };
} }), Ad = 40, Xi = 20;
ve({ name: "QPullToRefresh", props: { color: String, bgColor: String, icon: String, noMouse: Boolean, disable: Boolean, scrollTarget: Wl }, emits: ["refresh"], setup(e, { slots: t, emit: n }) {
  ...
  function m(_) {
    ...
    u.value = E - Ad, o.value = ct(E / (Xi + Ad), 0, 1);
    const $ = u.value > Xi ? "pulled" : "pull";
    r.value !== $ && (r.value = $);
  }
  const g = f(() => {
    const _ = { down: true };
...
ve({ name: "QRange", props: { ...Im, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: zm, setup(e, { emit: t }) {
  const { proxy: { $q: n } } = Se(), { state: l, methods: a } = Dm({ updateValue: V, updatePosition: P, getDragging: L, formAttrs: f(() => ({ type: "hidden", name: e.name, value: `${e.modelValue.min}|${e.modelValue.max}` })) }), r = U(null), o = U(0), i = U(0), u = U({ min: 0, max: 0 });
  function c() {
  ...
  const q = f(() => e.dragOnlyRange !== true ? l.tabindex.value : null), p = f(() => n.platform.is.mobile !== true && (e.dragRange || e.dragOnlyRange === true) ? l.tabindex.value : null), y = U(null), b = f(() => S("min")), _ = a.getThumbRenderFn({ focusValue: "min", getNodeData: () => ({ ref: y, key: "tmin", ...b.value, tabindex: q.value }), ratio: h, label: f(() => e.leftLabelValue !== void 0 ? e.leftLabelValue : u.value.min), thumbColor: f(() => e.leftThumbColor || e.thumbColor || e.color), labelColor: f(() => e.leftLabelColor || e.labelColor), labelTextColor: f(() => e.leftLabelTextColor || e.labelTextColor) }), E = f(() => S("max")), $ = a.getThumbRenderFn({ focusValue: "max", getNodeData: () => ({ ...E.value, key: "tmax", tabindex: q.value }), ratio: m, label: f(() => e.rightLabelValue !== void 0 ? e.rightLabelValue : u.value.max), thumbColor: f(() => e.rightThumbColor || e.thumbColor || e.color), labelColor: f(() => e.rightLabelColor || e.labelColor), labelTextColor: f(() => e.rightLabelTextColor || e.labelTextColor) });
  function V(T) {
  ...
  function F(T) {
    if (Fs.includes(T.keyCode) === false) return;
    He(T);
...
ve({ name: "QRating", props: { ...Jn, ...wn, modelValue: { type: Number, required: true }, max: { type: [String, Number], default: 5 }, icon: [String, Array], iconHalf: [String, Array], iconSelected: [String, Array], iconAriaLabel: [String, Array], color: [String, Array], colorHalf: [String, Array], colorSelected: [String, Array], noReset: Boolean, noDimming: Boolean, readonly: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  const c = f(() => e.readonly !== true && e.disable !== true), s = f(() => `q-rating row inline items-center q-rating--${c.value === true ? "" : "non-"}editable` + (e.noDimming === true ? " q-rating--no-dimming" : "") + (e.disable === true ? " disabled" : "") + (e.color !== void 0 && Array.isArray(e.color) === false ? ` text-${e.color}` : "")), v = f(() => {
    const y = Array.isArray(e.icon) === true ? e.icon.length : 0, b = Array.isArray(e.iconSelected) === true ? e.iconSelected.length : 0, _ = Array.isArray(e.iconHalf) === true ? e.iconHalf.length : 0, E = Array.isArray(e.color) === true ? e.color.length : 0, $ = Array.isArray(e.colorSelected) === true ? e.colorSelected.length : 0, V = Array.isArray(e.colorHalf) === true ? e.colorHalf.length : 0;
    return { iconLen: y, icon: y > 0 ? e.icon[y - 1] : e.icon, selIconLen: b, selIcon: b > 0 ? e.iconSelected[b - 1] : e.iconSelected, halfIconLen: _, halfIcon: _ > 0 ? e.iconHalf[b - 1] : e.iconHalf, colorLen: E, color: E > 0 ? e.color[E - 1] : e.color, selColorLen: $, selColor: $ > 0 ? e.colorSelected[$ - 1] : e.colorSelected, halfColorLen: V, halfColor: V > 0 ? e.colorHalf[V - 1] : e.colorHalf };
  }), h = f(() => {
    ...
    const y = [], b = v.value, _ = Math.ceil(e.modelValue), E = c.value === true ? 0 : null, $ = e.iconHalf === void 0 || _ === e.modelValue ? -1 : _;
    for (let V = 1; V <= e.max; V++) {
      const L = i.value === 0 && e.modelValue >= V || i.value > 0 && i.value >= V, P = $ === V && i.value < V, F = i.value > 0 && (P === true ? _ : e.modelValue) >= V && i.value < V, T = P === true ? V <= b.halfColorLen ? e.colorHalf[V - 1] : b.halfColor : b.selColor !== void 0 && L === true ? V <= b.selColorLen ? e.colorSelected[V - 1] : b.selColor : V <= b.colorLen ? e.color[V - 1] : b.color, x = (P === true ? V <= b.halfIconLen ? e.iconHalf[V - 1] : b.halfIcon : b.selIcon !== void 0 && (L === true || F === true) ? V <= b.selIconLen ? e.iconSelected[V - 1] : b.selIcon : V <= b.iconLen ? e.icon[V - 1] : b.icon) || l.iconSet.rating.icon;
  ...
  return Ta(() => {
    ...
    const y = [];
    return m.value.forEach(({ iconClass: b, name: _, attrs: E }, $) => {
      const V = $ + 1;
...
var R1 = ve({ props: ["store", "barStyle", "verticalBarStyle", "horizontalBarStyle"], setup(e) {
  ...
  }), i.vertical.thumbHidden = f(() => (e.visible === null ? r.value : e.visible) !== true && l.value === false && a.value === false || i.vertical.size.value <= o.vertical.value + 1), i.vertical.thumbStart = f(() => e.verticalOffset[0] + i.vertical.percentage.value * (o.verticalInner.value - i.vertical.thumbSize.value)), i.vertical.thumbSize = f(() => Math.round(ct(o.verticalInner.value * o.verticalInner.value / i.vertical.size.value, Pd(o.verticalInner.value), o.verticalInner.value))), i.vertical.style = f(() => ({ ...e.thumbStyle, ...e.verticalThumbStyle, top: `${i.vertical.thumbStart.value}px`, height: `${i.vertical.thumbSize.value}px`, right: `${e.horizontalOffset[1]}px` })), i.vertical.thumbClass = f(() => "q-scrollarea__thumb q-scrollarea__thumb--v absolute-right" + (i.vertical.thumbHidden.value === true ? " q-scrollarea__thumb--invisible" : "")), i.vertical.barClass = f(() => "q-scrollarea__bar q-scrollarea__bar--v absolute-right" + (i.vertical.thumbHidden.value === true ? " q-scrollarea__bar--invisible" : "")), i.horizontal.percentage = f(() => {
    const C = i.horizontal.size.value - o.horizontal.value;
    if (C <= 0) return 0;
    const D = ct(Math.abs(i.horizontal.position.value) / C, 0, 1);
    return Math.round(D * 1e4) / 1e4;
  }), i.horizontal.thumbHidden = f(() => (e.visible === null ? r.value : e.visible) !== true && l.value === false && a.value === false || i.horizontal.size.value <= o.horizontal.value + 1), i.horizontal.thumbStart = f(() => e.horizontalOffset[0] + i.horizontal.percentage.value * (o.horizontalInner.value - i.horizontal.thumbSize.value)), i.horizontal.thumbSize = f(() => Math.round(ct(o.horizontalInner.value * o.horizontalInner.value / i.horizontal.size.value, Pd(o.horizontalInner.value), o.horizontalInner.value))), i.horizontal.style = f(() => ({ ...e.thumbStyle, ...e.horizontalThumbStyle, [u.$q.lang.rtl === true ? "right" : "left"]: `${i.horizontal.thumbStart.value}px`, width: `${i.horizontal.thumbSize.value}px`, bottom: `${e.verticalOffset[1]}px` })), i.horizontal.thumbClass = f(() => "q-scrollarea__thumb q-scrollarea__thumb--h absolute-bottom" + (i.horizontal.thumbHidden.value === true ? " q-scrollarea__thumb--invisible" : "")), i.horizontal.barClass = f(() => "q-scrollarea__bar q-scrollarea__bar--h absolute-bottom" + (i.horizontal.thumbHidden.value === true ? " q-scrollarea__bar--invisible" : ""));
  ...
  function p({ height: C, width: D }) {
    let H = false;
    o.vertical.value !== C && (o.vertical.value = C, H = true), o.horizontal.value !== D && (o.horizontal.value = D, H = true), H === true && $();
  }
  function y({ position: C }) {
    let D = false;
    i.vertical.position.value !== C.top && (i.vertical.position.value = C.top, D = true), i.horizontal.position.value !== C.left && (i.horizontal.position.value = C.left, D = true), D === true && $();
  }
  function b({ height: C, width: D }) {
    i.horizontal.size.value !== D && (i.horizontal.size.value = D, $()), i.vertical.size.value !== C && (i.vertical.size.value = C, $());
  }
  function _(C, D) {
    const H = i[D];
    if (C.isFirst === true) {
    ...
    const j = Zi[D], W = (H.size.value - o[D].value) / (o[D + "Inner"].value - H.thumbSize.value), te = C.distance[j.dist], pe = v + (C.direction === j.dir ? 1 : -1) * te * W;
    V(pe, D);
  }
  function E(C, D) {
    const H = i[D];
    if (H.thumbHidden.value !== true) {
      const j = D === "vertical" ? e.verticalOffset[0] : e.horizontalOffset[0], W = C[Zi[D].offset] - j, te = H.thumbStart.value - j;
  ...
  const x = { scroll: i, thumbVertDir: [[gn, (C) => {
    _(C, "vertical");
  }, void 0, { vertical: true, ...Rd }]], thumbHorizDir: [[gn, (C) => {
    _(C, "horizontal");
  }, void 0, { horizontal: true, ...Rd }]], onVerticalMousedown(C) {
    E(C, "vertical");
  }, onHorizontalMousedown(C) {
    E(C, "horizontal");
  } };
  return () => d("div", { class: m.value, onMouseenter: P, onMouseleave: F }, [d("div", { ref: h, class: "q-scrollarea__container scroll relative-position fit hide-scrollbar", tabindex: e.tabindex !== void 0 ? e.tabindex : void 0 }, [d("div", { class: "q-scrollarea__content absolute", style: g.value }, kt(t.default, [d(Nl, { debounce: 0, onResize: b })])), d(Ch, { axis: "both", onScroll: y })]), d(Nl, { debounce: 0, onResize: p }), d(R1, { store: x, barStyle: e.barStyle, verticalBarStyle: e.verticalBarStyle, horizontalBarStyle: e.horizontalBarStyle })]);
...
function Ah({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: n, virtualScrollItemSizeComputed: l }) {
  ...
  const E = f(() => l.value + ";" + r.virtualScrollHorizontal), $ = f(() => E.value + ";" + r.virtualScrollSliceRatioBefore + ";" + r.virtualScrollSliceRatioAfter);
  he($, () => {
    H();
  }), he(E, V);
  function V() {
  ...
  function P(Q, M) {
    ...
    const X = Ji(ee, n(), q.value, p.value, r.virtualScrollHorizontal, u.lang.rtl, r.virtualScrollStickySizeStart, r.virtualScrollStickySizeEnd);
    v !== X.scrollViewSize && H(X.scrollViewSize), T(ee, X, Math.min(e.value - 1, Math.max(0, parseInt(Q, 10) || 0)), 0, L1.indexOf(M) !== -1 ? M : s !== -1 && Q > s ? "end" : "start");
  }
  function F() {
    const Q = t();
    if (Q == null || Q.nodeType === 8) return;
    const M = Ji(Q, n(), q.value, p.value, r.virtualScrollHorizontal, u.lang.rtl, r.virtualScrollStickySizeStart, r.virtualScrollStickySizeEnd), ee = e.value - 1, X = M.scrollMaxSize - M.offsetStart - M.offsetEnd - w.value;
    ...
    if (be > 0 && Math.ceil(M.scrollStart) >= be) {
      T(Q, M, ee, M.scrollMaxSize - M.offsetEnd - h.reduce(ya, 0));
      return;
    }
  ...
  function T(Q, M, ee, X, be) {
    ...
    const { activeElement: k } = document, A = y.value;
    we === true && A !== null && A !== k && A.contains(k) === true && (A.addEventListener("focusout", C), setTimeout(() => {
      A == null ? void 0 : A.removeEventListener("focusout", C);
    })), B1(A, ee - O);
    const z = R !== void 0 ? m.slice(O, ee).reduce(ya, 0) : 0;
    if (we === true) {
      const Z = re >= b.value.from && O <= b.value.to ? b.value.to : re;
      b.value = { from: O, to: Z }, g.value = Ia(h, m, 0, O), w.value = Ia(h, m, re, e.value), requestAnimationFrame(() => {
        b.value.to !== re && c === M.scrollStart && (b.value = { from: b.value.from, to: re }, w.value = Ia(h, m, re, e.value));
      });
    }
    requestAnimationFrame(() => {
      if (c !== M.scrollStart) return;
      we === true && x(O);
      const Z = m.slice(O, ee).reduce(ya, 0), ne = Z + M.offsetStart + g.value, K = ne + m[ee];
      let de = ne + X;
      if (R !== void 0) {
      ...
      c = de, Ld(Q, de, r.virtualScrollHorizontal, u.lang.rtl), W(ee);
    });
  }
  function x(Q) {
    const M = y.value;
    if (M) {
      const ee = Th.call(M.children, (O) => O.classList && O.classList.contains("q-virtual-scroll--skip") === false), X = ee.length, be = r.virtualScrollHorizontal === true ? (O) => O.getBoundingClientRect().width : (O) => O.offsetHeight;
      let B = Q, R, J;
      for (let O = 0; O < X; ) {
  ...
  function D(Q, M) {
    ...
    s = -1, c = void 0, g.value = Ia(h, m, 0, b.value.from), w.value = Ia(h, m, b.value.to, e.value), Q >= 0 ? (x(b.value.from), Ge(() => {
      P(Q);
    })) : te();
  }
  function H(Q) {
    if (Q === void 0 && typeof window < "u") {
      const R = t();
      R != null && R.nodeType !== 8 && (Q = Ji(R, n(), q.value, p.value, r.virtualScrollHorizontal, u.lang.rtl, r.virtualScrollStickySizeStart, r.virtualScrollStickySizeEnd).scrollViewSize);
    }
    v = Q;
  ...
  H();
  const te = Ma(F, u.platform.is.ios === true ? 120 : 35);
  Wo(() => {
    H();
  });
  let pe = false;
  return On(() => {
    ...
    if (pe !== true) return;
    const Q = t();
    c !== void 0 && Q !== void 0 && Q !== null && Q.nodeType !== 8 ? Ld(Q, c, r.virtualScrollHorizontal, u.lang.rtl) : P(s);
  }), __QUASAR_SSR__ || Ke(() => {
    te.cancel();
...
var Bd = (e) => ["add", "add-unique", "toggle"].includes(e), F1 = ".*+?^${}()|[]\\", O1 = Object.keys(ci);
function eu(e, t) {
  if (typeof e == "function") return e;
  const n = e !== void 0 ? e : t;
...
var V1 = ve({ name: "QSelect", inheritAttrs: false, props: { ...Du, ...wn, ...ci, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], popupNoRouteDismiss: Boolean, useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: Bd }, mapOptions: Boolean, emitValue: Boolean, disableTabSelection: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: {}, transitionHide: {}, transitionDuration: {}, behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: Du.virtualScrollItemSize.type, onNewValue: Function, onFilter: Function }, emits: [...di, "add", "remove", "inputValue", "keyup", "keypress", "keydown", "popupShow", "popupHide", "filterAbort"], setup(e, { slots: t, emit: n }) {
  ...
  const _ = U(null), E = U(null), $ = U(null), V = U(null), L = U(null), P = qs(e), F = _h(ue), T = f(() => Array.isArray(e.options) ? e.options.length : 0), x = f(() => e.virtualScrollItemSize === void 0 ? e.optionsDense === true ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: C, virtualScrollSliceSizeComputed: D, localResetVirtualScroll: H, padVirtualScroll: j, onVirtualScrollEvt: W, scrollTo: te, setVirtualScrollSize: pe } = Ah({ virtualScrollLength: T, getVirtualScrollTarget: jt, getVirtualScrollEl: xt, virtualScrollItemSizeComputed: x }), Q = fi(), M = f(() => {
    const G = e.mapOptions === true && e.multiple !== true, $e = e.modelValue !== void 0 && (e.modelValue !== null || G === true) ? e.multiple === true && Array.isArray(e.modelValue) ? e.modelValue : [e.modelValue] : [];
  ...
  }), X = f(() => e.optionsDark === null ? Q.isDark.value : e.optionsDark), be = f(() => jl(M.value)), B = f(() => {
  ...
  }), Z = f(() => ({ id: `${Q.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": e.multiple === true ? "true" : "false" })), ne = f(() => M.value.map((G, $e) => ({ index: $e, opt: G, html: we.value(G), selected: true, removeAtIndex: Me, toggleOption: Ve, tabindex: A.value }))), K = f(() => {
    if (T.value === 0) return [];
    const { from: G, to: $e } = C.value;
    return e.options.slice(G, $e).map((Re, tt) => {
  ...
  function qe(G) {
    if (G !== -1 && G < M.value.length) if (e.multiple === true) {
      ...
      n("remove", { index: G, value: $e.splice(G, 1)[0] }), n("update:modelValue", $e);
  ...
  function Ne(G, $e) {
    ...
    if ($e === true && ye(G) === true || e.maxValues !== void 0 && e.modelValue.length >= e.maxValues) return;
  ...
  function Ve(G, $e) {
    ...
    const Re = ce.value(G);
    if (e.multiple !== true) {
      $e !== true && (Fe(e.fillInput === true ? le.value(G) : "", true, true), at()), (_a2 = E.value) == null ? void 0 : _a2.focus(), (M.value.length === 0 || kn(ce.value(M.value[0]), Re) !== true) && n("update:modelValue", e.emitValue === true ? Re : G);
      return;
    }
  ...
  function ae(G, $e) {
    ...
    return e.options.find(Re) || $e.find(Re) || G;
  }
  function ye(G) {
    const $e = ce.value(G);
  ...
  function Ae(G) {
    ...
    if (G.target.value = "", v !== null && (clearTimeout(v), v = null), h !== null && (clearTimeout(h), h = null), cn(), typeof $e == "string" && $e.length !== 0) {
  ...
  function it(G) {
    ...
    const $e = u.value.length !== 0 && (e.newValueMode !== void 0 || e.onNewValue !== void 0), Re = G.shiftKey !== true && e.disableTabSelection !== true && e.multiple !== true && (i.value !== -1 || $e === true);
    if (G.keyCode === 27) {
      Vt(G);
      return;
    }
    ...
    (G.keyCode === 35 || G.keyCode === 36) && (typeof u.value != "string" || u.value.length === 0) && (He(G), i.value = -1, ge(G.keyCode === 36 ? 1 : -1, e.multiple)), (G.keyCode === 33 || G.keyCode === 34) && D.value !== void 0 && (He(G), i.value = Math.max(-1, Math.min(T.value, i.value + (G.keyCode === 33 ? -1 : 1) * D.value.view)), ge(G.keyCode === 33 ? 1 : -1, e.multiple)), (G.keyCode === 38 || G.keyCode === 40) && (He(G), ge(G.keyCode === 38 ? -1 : 1, e.multiple));
    const tt = T.value;
    ...
    if (!(G.keyCode !== 13 && (G.keyCode !== 32 || e.useInput === true || y !== "") && (G.keyCode !== 9 || Re === false))) {
      ...
      if ($e === true) {
        const gt = (vt, Dt) => {
          ...
          (Dt === "toggle" ? Ve : Ne)(vt, Dt === "add-unique"), e.multiple !== true && ((_a2 = E.value) == null ? void 0 : _a2.focus(), at());
        };
  ...
  function xt() {
    return g === true ? L.value : $.value !== null && $.value.contentEl !== null ? $.value.contentEl : void 0;
  }
  function jt() {
    return xt();
  }
  function tl() {
    return e.hideSelected === true ? [] : t["selected-item"] !== void 0 ? ne.value.map((G) => t["selected-item"](G)).slice() : t.selected !== void 0 ? [].concat(t.selected()) : e.useChips === true ? ne.value.map((G, $e) => d(Bm, { key: "option-" + $e, removable: Q.editable.value === true && N.value(G.opt) !== true, dense: true, textColor: e.color, tabindex: A.value, onRemove() {
      G.removeAtIndex($e);
  ...
  function ln() {
    ...
    let $e = j("div", K.value.map(G));
    return t["before-options"] !== void 0 && ($e = t["before-options"]().concat($e)), kt(t["after-options"], $e);
  }
  function In(G, $e) {
    const Re = $e === true ? { ...z.value, ...Q.splitAttrs.attributes.value } : void 0, tt = { ref: $e === true ? E : void 0, key: "i_t", class: B.value, style: e.inputStyle, value: u.value !== void 0 ? u.value : "", type: "search", ...Re, id: $e === true ? Q.targetUid.value : void 0, maxlength: e.maxlength, autocomplete: e.autocomplete, "data-autofocus": G === true || e.autofocus === true || void 0, disabled: e.disable === true, readonly: e.readonly === true, ..._e.value };
  ...
  function xe(G, $e) {
    u.value !== G && (u.value = G, $e === true || e.inputDebounce === 0 || e.inputDebounce === "0" ? n("inputValue", G) : h = setTimeout(() => {
      h = null, n("inputValue", G);
    }, e.inputDebounce));
  }
  function Fe(G, $e, Re) {
    w = Re !== true, e.useInput === true && (xe(G, true), ($e === true || Re !== true) && (q = G), $e !== true && Be(G));
  }
  function Be(G, $e, Re) {
    if (e.onFilter === void 0 || $e !== true && Q.focused.value !== true) return;
    ...
    S !== null && clearTimeout(S), S = tt, n("filter", G, (gt, vt) => {
      ($e === true || Q.focused.value === true) && S === tt && (clearTimeout(S), typeof gt == "function" && gt(), s.value = false, Ge(() => {
        Q.innerLoading.value = false, Q.editable.value === true && ($e === true ? r.value === true && at() : r.value === true ? hi(true) : r.value = true), typeof vt == "function" && Ge(() => {
          vt(l);
  ...
  function Ue() {
    return d(ii, { ref: $, class: R.value, style: e.popupContentStyle, modelValue: r.value, fit: e.menuShrink !== true, cover: e.optionsCover === true && J.value !== true && e.useInput !== true, anchor: e.menuAnchor, self: e.menuSelf, offset: e.menuOffset, dark: X.value, noParentEvent: true, noRefocus: true, noFocus: true, noRouteDismiss: e.popupNoRouteDismiss, square: me.value, transitionShow: e.transitionShow, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, separateClosePopup: true, ...Z.value, onScrollPassive: W, onBeforeShow: Ws, onBeforeHide: yt, onShow: ht }, ln);
  }
  function yt(G) {
    Ys(G), Le();
  }
  ...
  function se() {
    const G = [d(i1, { class: `col-auto ${Q.fieldClass.value}`, ...ee.value, for: Q.targetUid.value, dark: X.value, square: true, loading: s.value, itemAligned: false, filled: true, stackLabel: u.value.length !== 0, ...Q.splitAttrs.listeners.value, onFocus: I, onBlur: Y }, { ...t, rawControl: () => Q.getControl(true), before: void 0, after: void 0 })];
    return r.value === true && G.push(d("div", { ref: L, class: R.value + " scroll", style: e.popupContentStyle, ...Z.value, onClick: Vt, onScrollPassive: W }, ln())), d(si, { ref: V, modelValue: o.value, position: e.useInput === true ? "top" : void 0, transitionShow: p, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, noRouteDismiss: e.popupNoRouteDismiss, onBeforeShow: Ws, onBeforeHide: Te, onHide: Ee, onShow: Xe }, () => d("div", { class: "q-select__dialog" + (X.value === true ? " q-select__dialog--dark q-dark" : "") + (c.value === true ? " q-select__dialog--focused" : "") }, G));
  }
  function Te(G) {
    Ys(G), V.value !== null && V.value.__updateRefocusTarget(Q.rootRef.value.querySelector(".q-field__native > [tabindex]:last-child")), Q.focused.value = false;
  }
  function Ee(G) {
  ...
  function _g(G, $e) {
    r.value === true && Q.innerLoading.value === false && (H(-1, true), Ge(() => {
      r.value === true && Q.innerLoading.value === false && (G > $e ? H() : hi(true));
    }));
  }
  function Ks() {
    o.value === false && $.value !== null && $.value.updatePosition();
  }
  function Ws(G) {
  ...
  return Ta(Gs), Yo(Ks), Gs(), Ke(() => {
    ...
    return d("div", { class: "q-field__native row items-center", ...tt, ...Q.splitAttrs.listeners.value }, $e);
  }, getInnerAppend: () => e.loading !== true && s.value !== true && e.hideDropdownIcon !== true ? [d(et, { class: "q-select__dropdown-icon" + (r.value === true ? " rotate-180" : ""), name: de.value })] : null }), vi(Q);
...
var Fd = [["left", "center", "start", "width"], ["right", "center", "end", "width"], ["top", "start", "center", "height"], ["bottom", "end", "center", "height"]];
ve({ name: "QSlideItem", props: { ...nt, leftColor: String, rightColor: String, topColor: String, bottomColor: String, onSlide: Function }, emits: ["action", "top", "right", "bottom", "left"], setup(e, { slots: t, emit: n }) {
  ...
  function S(q) {
    const p = i.value;
    if (q.isFirst) c = { dir: null, size: { left: 0, right: 0, top: 0, bottom: 0 }, scale: 0 }, p.classList.add("no-transition"), Fd.forEach((E) => {
      if (t[E[0]] !== void 0) {
        const $ = v[E[0]];
        $.style.transform = "scale(1)", c.size[E[0]] = $.getBoundingClientRect()[E[3]];
      }
  ...
  return Ta(() => {
    ...
    Fd.forEach((_) => {
      const E = _[0];
      t[E] !== void 0 && q.push(d("div", { key: E, ref: ($) => {
        s[E] = $;
      }, class: `q-slide-item__${E} absolute-full row no-wrap items-${_[1]} justify-${_[2]}` + (e[E + "Color"] !== void 0 ? ` bg-${e[E + "Color"]}` : "") }, [d("div", { ref: ($) => {
        v[E] = $;
      } }, t[E]())]));
    });
...
ve({ name: "QSplitter", props: { ...nt, modelValue: { type: Number, required: true }, reverse: Boolean, unit: { type: String, default: "%", validator: (e) => ["%", "px"].includes(e) }, limits: { type: Array, validator: (e) => e.length !== 2 || typeof e[0] != "number" || typeof e[1] != "number" ? false : e[0] >= 0 && e[0] <= e[1] }, emitImmediately: Boolean, horizontal: Boolean, disable: Boolean, beforeClass: [Array, String, Object], afterClass: [Array, String, Object], separatorClass: [Array, String, Object], separatorStyle: [Array, String, Object] }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  function p(_) {
    if (_.isFirst === true) {
      const $ = r.value.getBoundingClientRect()[u.value];
      m = e.horizontal === true ? "up" : "left", g = e.unit === "%" ? 100 : $, w = Math.min(g, s.value[1], Math.max(s.value[0], e.modelValue)), S = (e.reverse !== true ? 1 : -1) * (e.horizontal === true ? 1 : l.lang.rtl === true ? -1 : 1) * (e.unit === "%" ? $ === 0 ? 0 : 100 / $ : 1), r.value.classList.add("q-splitter--active");
      return;
    }
    if (_.isFinal === true) {
  ...
  return he(() => e.modelValue, (_) => {
    ...
    return d("div", { class: i.value, ref: r }, kt(t.default, _));
  };
} });
...
ve({ name: "QStep", props: { ...Ms, icon: String, color: String, title: { type: String, required: true }, caption: String, prefix: [String, Number], doneIcon: String, doneColor: String, activeIcon: String, activeColor: String, errorIcon: String, errorColor: String, headerNav: { type: Boolean, default: true }, done: Boolean, error: Boolean, onScroll: [Function, Array] }, setup(e, { slots: t, emit: n }) {
  ...
  function s() {
    ...
    return v === true && a.value.keepAlive === true ? d(rv, a.value.keepAliveProps.value, i.value === true ? [d(a.value.needsUniqueKeepAliveWrapper.value === true ? r(c.value, () => ({ ...Od, name: c.value })) : Od, { key: c.value }, t.default)] : void 0) : v !== true || i.value === true ? Rh(t) : void 0;
  }
  return () => d("div", { ref: o, class: "q-stepper__step", role: "tabpanel", ...u.value }, a.value.vertical === true ? [d($h, { stepper: a.value, step: e, goToPanel: a.value.goToPanel }), a.value.animated === true ? d(Is, s) : s()] : [s()]);
} });
var s_ = /(-\w)/g;
function c_(e) {
  const t = {};
...
ve({ name: "QStepper", props: { ...nt, ...Es, flat: Boolean, bordered: Boolean, alternativeLabels: Boolean, headerNav: Boolean, contracted: Boolean, headerClass: String, inactiveColor: String, inactiveIcon: String, doneIcon: String, doneColor: String, activeIcon: String, activeColor: String, errorIcon: String, errorColor: String }, emits: As, setup(e, { slots: t }) {
  ...
  return () => (a(t), d("div", { class: m.value }, kt(t.navigation, w())));
} });
...
var f_ = { list: xh, table: x1 }, v_ = ["list", "table", "__qtable"], m_ = ve({ name: "QVirtualScroll", props: { ...Du, type: { type: String, default: "list", validator: (e) => v_.includes(e) }, items: { type: Array, default: () => [] }, itemsFn: Function, itemsSize: Number, scrollTarget: Wl }, setup(e, { slots: t, attrs: n }) {
  let l;
  const a = U(null), r = f(() => e.itemsSize >= 0 && e.itemsFn !== void 0 ? parseInt(e.itemsSize, 10) : Array.isArray(e.items) ? e.items.length : 0), { virtualScrollSliceRange: o, localResetVirtualScroll: i, padVirtualScroll: u, onVirtualScrollEvt: c } = Ah({ virtualScrollLength: r, getVirtualScrollTarget: g, getVirtualScrollEl: m }), s = f(() => {
    if (r.value === 0) return [];
...
function b_(e, t, n, l) {
  const a = f(() => {
    ...
    return i.sort((m, g) => {
      let w = h(m), S = h(g);
      return s.rawSort !== void 0 ? s.rawSort(w, S, m, g) * v : w == null ? -1 * v : S == null ? 1 * v : s.sort !== void 0 ? s.sort(w, S, m, g) * v : pr(w) === true && pr(S) === true ? (w - S) * v : qu(w) === true && qu(S) === true ? h_(w, S) * v : typeof w == "boolean" && typeof S == "boolean" ? (w - S) * v : ([w, S] = [w, S].map((q) => (q + "").toLocaleString().toLowerCase()), w < S ? -1 * v : w === S ? 0 : v);
    });
  });
  function o(i) {
...
ve({ name: "QTable", props: { rows: { type: Array, required: true }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: {}, ...Lh, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], tableRowStyleFn: Function, tableRowClassFn: Function, cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], cardStyleFn: Function, cardClassFn: Function, hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...nt, ...Rs, ...A_, ...y_, ...w_, ...T_, ...C_, ...g_ }, emits: ["request", "virtualScroll", ...Ps, ...M_, ...k_], setup(e, { slots: t, emit: n }) {
  ...
  }), { hasSelectionMode: F, singleSelection: T, multipleSelection: x, allRowsSelected: C, someRowsSelected: D, rowsSelectedNumber: H, isRowSelected: j, clearSelection: W, updateSelection: te } = q_(e, n, P, u), { colList: pe, computedCols: Q, computedColsMap: M, computedColspan: ee } = $_(e, S, F), { columnToSort: X, computedSortMethod: be, sort: B } = b_(e, S, pe, y), { firstRowIndex: R, lastRowIndex: J, isFirstPage: O, isLastPage: re, pagesNumber: we, computedRowsPerPageOptions: k, computedRowsNumber: A, firstPage: z, prevPage: Z, nextPage: ne, lastPage: K } = x_(l, w, S, q, y, L), de = f(() => P.value.length === 0), me = f(() => {
    const ue = {};
  ...
  function ce() {
    ...
    if (v.value === true) {
      ...
      return Be !== void 0 && (Ue.after = () => d("tbody", Be({ cols: Q.value }))), d(m_, { ref: s, class: e.tableClass, style: e.tableStyle, ...me.value, scrollTarget: e.virtualScrollTarget, items: P.value, type: "__qtable", tableColspan: ee.value, onVirtualScroll: N }, Ue);
    }
    const xe = [ke()];
  ...
  function Oe() {
    ...
    if (T.value === true && e.grid !== true) Fe.unshift(d("th", { class: "q-table--col-auto-width" }, " "));
      ...
      const Be = t["header-selection"], Ue = Be !== void 0 ? Be(Ae({})) : [d(ir, { color: e.color, modelValue: ye.value, dark: r.value, dense: e.dense, "onUpdate:modelValue": We })];
  ...
  function tl(ue) {
    ...
    if (ue.push(d("div", { class: "q-table__separator col" })), yt === true && ue.push(d("div", { class: "q-table__control" }, [d("span", { class: "q-table__bottom-item" }, [e.rowsPerPageLabel || a.lang.table.recordsPerPage]), d(V1, { class: "q-table__select inline q-table__bottom-item", color: e.color, modelValue: Fe, options: k.value, displayValue: Fe === 0 ? a.lang.table.allRows : Fe, dark: r.value, borderless: true, dense: true, optionsDense: true, optionsCover: true, "onUpdate:modelValue": jt })])), Ue !== void 0) xe = Ue(ge.value);
    else if (xe = [d("span", Fe !== 0 ? { class: "q-table__bottom-item" } : {}, [Fe ? Be(R.value + 1, Math.min(J.value, A.value), A.value) : Be(1, L.value, A.value)])], Fe !== 0 && we.value > 1) {
...
ve({ name: "QTime", props: { ...nt, ...wn, ...Fo, modelValue: { required: true, validator: (e) => typeof e == "string" || e === null }, mask: { ...Fo.mask, default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: Xm, setup(e, { slots: t, emit: n }) {
  ...
  let h, m;
  const g = U(null), w = f(() => be()), S = f(() => u()), q = f(() => B()), p = Qa(e.modelValue, w.value, S.value, e.calendar, q.value), y = U(R_(p)), b = U(p), _ = U(p.hour === null || p.hour < 12), E = f(() => `q-time q-time--${e.landscape === true ? "landscape" : "portrait"}` + (r.value === true ? " q-time--dark q-dark" : "") + (e.disable === true ? " disabled" : e.readonly === true ? " q-time--readonly" : "") + (e.bordered === true ? " q-time--bordered" : "") + (e.square === true ? " q-time--square no-border-radius" : "") + (e.flat === true ? " q-time--flat no-shadow" : "")), $ = f(() => {
    const ie = b.value;
    ...
    const Oe = [];
    for (let Ae = ie, We = ie; Ae <= ge; Ae += ye, We++) {
      const it = Ae + ae, xt = (Ce == null ? void 0 : Ce.includes(it)) === false, jt = y.value === "hour" && Ae === 0 ? V.value === true ? "00" : "12" : Ae;
      Oe.push({ val: it, index: We, disable: xt, label: jt });
    }
    return Oe;
  }), pe = f(() => [[gn, O, void 0, { stop: true, prevent: true, mouse: true }]]);
  he(() => e.modelValue, (ie) => {
    const ge = Qa(ie, w.value, S.value, e.calendar, q.value);
  ...
  function X(ie, { min: ge, max: ae, values: ye, threshold: Ce }) {
    ...
    const Oe = ye.findIndex((it) => ie <= it), Ae = ye[Oe - 1], We = ye[Oe];
  ...
  function we(ie, ge, ae) {
    ...
    if (ye.top < ge.top ? We = ge.left < ye.left ? 90 - We : 270 + We : We = ge.left < ye.left ? We + 90 : 270 - We, y.value === "hour") {
      ...
      } else Ae = Math.round(Ae), V.value === true ? Oe < ge.dist ? Ae < 12 && (Ae += 12) : Ae === 12 && (Ae = 0) : _.value === true && Ae === 12 ? Ae = 0 : _.value === false && Ae !== 12 && (Ae += 12);
      V.value === true && (_.value = Ae < 12);
    } else Ae = Math.round(We / 6) % 60, y.value === "minute" && H.value !== null ? Ae = X(Ae, H.value) : y.value === "second" && j.value !== null && (Ae = X(Ae, j.value));
    return ae !== Ae && N[y.value](Ae), Ae;
  }
  const k = { hour() {
    y.value = "hour";
  }, minute() {
  ...
  function Me(ie) {
    const ge = Object.assign({ ...b.value }, ie), ae = e.calendar === "persian" ? rt(ge.hour) + ":" + rt(ge.minute) + (e.withSeconds === true ? ":" + rt(ge.second) : "") : lh(new Date(ge.year, ge.month === null ? null : ge.month - 1, ge.day, ge.hour, ge.minute, ge.second, ge.millisecond), w.value, S.value, ge.year, ge.timezoneOffset);
    ge.changed = ae !== e.modelValue, n("update:modelValue", ae, ge);
  }
  function Ne() {
    const ie = [d("div", { class: "q-time__link " + (y.value === "hour" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onClick: k.hour, onKeyup: K }, $.value.hour), d("div", ":"), d("div", P.value === true ? { class: "q-time__link " + (y.value === "minute" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: de, onClick: k.minute } : { class: "q-time__link" }, $.value.minute)];
    e.withSeconds === true && ie.push(d("div", ":"), d("div", F.value === true ? { class: "q-time__link " + (y.value === "second" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: me, onClick: k.second } : { class: "q-time__link" }, $.value.second));
    const ge = [d("div", { class: "q-time__header-label row items-center no-wrap", dir: "ltr" }, ie)];
    return V.value === false && ge.push(d("div", { class: "q-time__header-ampm column items-between no-wrap" }, [d("div", { class: "q-time__link " + (_.value === true ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onClick: oe, onKeyup: A }, "AM"), d("div", { class: "q-time__link " + (_.value !== true ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onClick: _e, onKeyup: z }, "PM")])), d("div", { class: "q-time__header flex flex-center no-wrap " + i.value }, ge);
  }
  function Ve() {
  ...
  return l.proxy.setNow = Q, () => {
    ...
    return ge !== void 0 && ie.push(d("div", { class: "q-time__actions" }, ge)), e.name !== void 0 && e.disable !== true && v(ie, "push"), d("div", { class: E.value, tabindex: -1 }, [Ne(), d("div", { class: "q-time__main col overflow-auto" }, ie)]);
  };
} });
...
ve({ name: "QTree", props: { ...nt, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => F_.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: {}, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  const s = f(() => `q-tree q-tree--${e.dense === true ? "dense" : "standard"}` + (e.noConnectors === true ? " q-tree--no-connectors" : "") + (r.value === true ? " q-tree--dark" : "") + (e.color !== void 0 ? ` text-${e.color}` : "")), v = f(() => e.selected !== void 0), h = f(() => e.icon || a.iconSet.tree.icon), m = f(() => e.controlColor || e.color), g = f(() => e.textColor !== void 0 ? ` text-${e.textColor}` : ""), w = f(() => {
    ...
    const M = {}, ee = (X, be) => {
      const B = X.tickStrategy || (be ? be.tickStrategy : e.tickStrategy), R = X[e.nodeKey], J = X[e.childrenKey] && Array.isArray(X[e.childrenKey]) && X[e.childrenKey].length !== 0, O = X.disabled !== true && v.value === true && X.selectable !== false, re = X.disabled !== true && X.expandable !== false, we = B !== "none", k = B === "strict", A = B === "leaf-filtered", z = B === "leaf" || B === "leaf-filtered";
      ...
      const K = { key: R, parent: be, isParent: J, lazy: ne, disabled: X.disabled, link: X.disabled !== true && (O === true || re === true && (J === true || ne === true)), children: [], matchesFilter: e.filter ? S.value(X, e.filter) : true, selected: R === e.selected && O === true, selectable: O, expanded: J === true ? u.value.includes(R) : false, expandable: re, noTick: X.noTick === true || k !== true && ne && ne !== "loaded", tickable: Z, tickStrategy: B, hasTicking: we, strictTicking: k, leafFilteredTicking: A, leafTicking: z, ticked: k === true ? i.value.includes(R) : J === true ? false : i.value.includes(R) };
      if (M[R] = K, J === true && (K.children = X[e.childrenKey].map((de) => ee(de, K)), e.filter && (K.matchesFilter !== true ? K.matchesFilter = K.children.some((de) => de.matchesFilter) : K.noTick !== true && K.disabled !== true && K.tickable === true && A === true && K.children.every((de) => de.matchesFilter !== true || de.noTick === true || de.tickable !== true) === true && (K.tickable = false)), K.matchesFilter === true && (K.noTick !== true && k !== true && K.children.every((de) => de.noTick) === true && (K.noTick = true), z))) {
  ...
  function j(M) {
    ...
    return J !== void 0 && (J = d("div", { class: "q-tree__node-body relative-position" }, [d("div", { class: g.value }, [J(O)])])), d("div", { key: ee, class: `q-tree__node relative-position q-tree__node--${R === true ? "parent" : "child"}` }, [d("div", { class: "q-tree__node-header relative-position row no-wrap items-center" + (X.link === true ? " q-tree__node--link q-hoverable q-focusable" : "") + (X.selected === true ? " q-tree__node--selected" : "") + (X.disabled === true ? " q-tree__node--disabled" : ""), tabindex: X.link === true ? 0 : -1, ariaExpanded: B.length > 0 ? X.expanded : null, role: "treeitem", onClick: (re) => {
      ...
      Ql(re) !== true && (re.keyCode === 13 ? te(M, X, re, true) : re.keyCode === 32 && pe(M, X, re, true));
      ...
      Q(X, re);
    } }) : null, d("div", { class: "q-tree__node-header-content col row no-wrap items-center" + (X.selected === true ? w.value : g.value) }, [be ? be(O) : [C(M), d("div", M[e.labelKey])]])]), R === true ? e.noTransition === true ? X.expanded === true ? d("div", { class: "q-tree__node-collapsible" + g.value, key: `${ee}__q` }, [J, d("div", { class: "q-tree__children" + (X.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, B)]) : null : d(Is, { duration: e.duration, onShow: D, onHide: H }, () => sn(d("div", { class: "q-tree__node-collapsible" + g.value, key: `${ee}__q` }, [J, d("div", { class: "q-tree__children" + (X.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, B)]), [[Fv, X.expanded]])) : J]);
  }
  function W(M) {
    var _a2;
  ...
  function pe(M, ee, X, be) {
    X !== void 0 && He(X), be !== true && ee.selectable !== false && W(ee.key), V(ee.key, !ee.expanded, M, ee);
  }
  function Q(M, ee) {
  ...
  return e.defaultExpandAll === true && $(), Object.assign(l, { getNodeByKey: p, getTickedNodes: y, getExpandedNodes: b, isExpanded: _, collapseAll: E, expandAll: $, setExpanded: V, isTicked: P, setTicked: F }), () => {
    const M = x(e.nodes);
...
function V_(e, t) {
  ...
  function c(O, re, we) {
    ...
    O.__uploaded = re === "uploaded" ? O.size : we, O.__progress = re === "uploaded" ? 1 : Math.min(0.9999, O.__uploaded / O.size), O.__progressLabel = zd(O.__progress), o.$forceUpdate();
  }
  const s = f(() => l.disable !== true && l.readonly !== true), v = U(false), h = U(null), m = U(null), g = { files: U([]), queuedFiles: U([]), uploadedFiles: U([]), uploadedSize: U(0), updateFileStatus: c, isAlive: () => hl(n) === false }, { pickFiles: w, addFiles: S, onDragover: q, onDragleave: p, processFiles: y, getDndNode: b, maxFilesNumber: _, maxTotalSizeNumber: E } = bh({ editable: s, dnd: v, getFileInput: Q, addFilesToQueue: M });
  Object.assign(g, e({ props: l, slots: a, emit: r, helpers: g, exposeApi: (O) => {
    Object.assign(g, O);
  } })), g.isBusy === void 0 && (g.isBusy = U(false));
  const $ = U(0), V = f(() => $.value === 0 ? 0 : g.uploadedSize.value / $.value), L = f(() => zd(V.value)), P = f(() => Tu($.value)), F = f(() => s.value === true && g.isUploading.value !== true && (l.multiple === true || g.queuedFiles.value.length === 0) && (l.maxFiles === void 0 || g.files.value.length < _.value) && (l.maxTotalSize === void 0 || $.value < E.value)), T = f(() => s.value === true && g.isBusy.value !== true && g.isUploading.value !== true && g.queuedFiles.value.length !== 0);
  hn(tm, be);
  ...
  function D() {
    l.disable === false && (g.abort(), g.uploadedSize.value = 0, $.value = 0, pe(), g.files.value = [], g.queuedFiles.value = [], g.uploadedFiles.value = []);
  }
  function H() {
  ...
  function M(O, re) {
    ...
    k != null && (k.value = ""), we !== void 0 && (we.forEach((A) => {
      if (g.updateFileStatus(A, "idle"), $.value += A.size, l.noThumbnails !== true && A.type.toUpperCase().startsWith("IMAGE")) {
        const z = new Image();
        z.src = window.URL.createObjectURL(A), A.__img = z;
      }
  ...
  function X(O, re, we) {
    if (O === true) {
      ...
      let A;
      return re === "add" ? (k.onClick = w, A = be) : k.onClick = we, d(Ze, k, A);
    }
  }
  function be() {
  ...
  return Object.assign(J, { upload: ee, reset: D, removeUploadedFiles: H, removeQueuedFiles: j, removeFile: te, pickFiles: w, addFiles: S }), zv(J, { canAddFiles: () => F.value, canUpload: () => T.value, uploadSizeLabel: () => P.value, uploadProgressLabel: () => L.value }), t({ ...g, upload: ee, reset: D, removeUploadedFiles: H, removeQueuedFiles: j, removeFile: te, pickFiles: w, addFiles: S, canAddFiles: F, canUpload: T, uploadSizeLabel: P, uploadProgressLabel: L }), () => {
...
function U_({ props: e, emit: t, helpers: n }) {
  ...
  function m(g, w) {
    ...
    q.upload.addEventListener("progress", (T) => {
      ...
      }), t("uploaded", { files: g, xhr: q })) : (L = true, n.uploadedSize.value -= $, n.queuedFiles.value = n.queuedFiles.value.concat(g), g.forEach((T) => {
...
ve({ name: "QVideo", props: { ...zs, src: { type: String, required: true }, title: String, fetchpriority: { type: String, default: "auto" }, loading: { type: String, default: "eager" }, referrerpolicy: { type: String, default: "strict-origin-when-cross-origin" } }, setup(e) {
...
var Hd = ["Top", "Right", "Bottom", "Left"], jd = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], W_ = /-block|-inline|block-|inline-/, Y_ = /(-block|-inline|block-|inline-).*:/;
function Ud(e, t) {
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    if (n[r] === "") if (r === "cssText") {
      ...
      let i = "";
      for (let u = 0; u < Hd.length; u++) {
        const c = "border" + Hd[u] + o;
        i += n[c] + " ";
      }
      l[r] = i;
...
function J_(e) {
  ...
  let i, u, c, s;
  const v = o.parentNode, h = o.nextElementSibling, m = Nd(o, r.resize), { width: g, height: w } = Zr(v), { borderWidth: S, borderStyle: q, borderColor: p, borderRadius: y, backgroundColor: b, transform: _, position: E, cssText: $ } = Ud(o, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), V = o.classList.toString(), L = o.style.cssText, P = o.cloneNode(true), F = r.tween === true ? o.cloneNode(true) : void 0;
  ...
  const T = () => {
    ...
    const W = () => {
      ...
      const { borderWidth: X, borderStyle: be, borderColor: B, borderRadius: R, backgroundColor: J, transform: O, position: re, cssText: we } = Ud(x, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), k = x.classList.toString(), A = x.style.cssText;
      ...
      else if ($t(r.style) === true) for (const ye in r.style) x.style[ye] = r.style[ye];
      const Ve = Qd(P), ie = Qd(x), ge = Me === true ? document.documentElement : { scrollLeft: 0, scrollTop: 0 };
      x.style.position = Me === true ? "fixed" : "absolute", x.style.left = `${z.left - ge.scrollLeft}px`, x.style.right = "unset", x.style.top = `${z.top - ge.scrollTop}px`, x.style.margin = 0, r.resize === true && (x.style.minWidth = "unset", x.style.maxWidth = "unset", x.style.minHeight = "unset", x.style.maxHeight = "unset", x.style.overflow = "hidden", x.style.overflowX = "hidden", x.style.overflowY = "hidden"), document.body.appendChild(x), F !== void 0 && (F.style.cssText = $, F.style.transform = "none", F.style.animation = "none", F.style.transition = "none", F.style.position = x.style.position, F.style.left = `${m.left - ge.scrollLeft}px`, F.style.right = "unset", F.style.top = `${m.top - ge.scrollTop}px`, F.style.margin = 0, F.style.pointerEvents = "none", r.resize === true && (F.style.minWidth = "unset", F.style.maxWidth = "unset", F.style.minHeight = "unset", F.style.maxHeight = "unset", F.style.overflow = "hidden", F.style.overflowX = "hidden", F.style.overflowY = "hidden"), document.body.appendChild(F));
      const ae = (ye) => {
        o === x && l !== true ? (x.style.cssText = L, x.className = V) : (x.style.cssText = A, x.className = k), M.parentNode === te && te.insertBefore(x, M), P.remove(), M.remove(), F == null ? void 0 : F.remove(), t = () => false, o.qMorphCancel = void 0, x.qMorphCancel = void 0, typeof r.onEnd == "function" && r.onEnd(l === true ? "to" : "from", ye === true);
      };
      if (r.useCSS !== true && typeof x.animate == "function") {
        ...
        o.qMorphCancel = () => {
          ...
          x.qMorphCancel = void 0, n = true, xt();
        ...
        const ye = `q-morph-anim-${++K_}`, Ce = document.createElement("style"), Oe = r.resize === true ? `
            transform: translate(${Z}px, ${ne}px);
            width: ${N}px;
            height: ${oe}px;
          ` : `transform: translate(${Z}px, ${ne}px) scale(${K}, ${de});`, Ae = r.resize === true ? `
            width: ${_e}px;
            height: ${ke}px;
          ` : "", We = r.resize === true ? `
            width: ${N}px;
          ...
          ` : "", it = r.resize === true ? `
            ...
            width: ${_e}px;
            height: ${ke}px;
          ` : `transform: translate(${-1 * Z}px, ${-1 * ne}px) scale(${1 / K}, ${1 / de});`, xt = F !== void 0 ? `opacity: ${r.tweenToOpacity};` : `background-color: ${b};`, jt = F !== void 0 ? "opacity: 1;" : `background-color: ${J};`, tl = F === void 0 ? "" : `
...
function hw(e, t, n) {
  return (l) => {
    ...
    let i, u = false;
    const c = U(null), s = $r(false, "dialog"), v = (p) => {
      var _a2;
      ...
      if (i !== null) {
        if (o === true) Object.assign(r, p);
          ...
          y !== void 0 && (_.cardClass = y), b !== void 0 && (_.cardStyle = b), Hh(r, _);
        }
        i.$forceUpdate();
      }
      return g;
      ...
      q.unmount(s), xs(s), q = null, i = null, u !== true && m.forEach((p) => {
        p();
      });
    };
    let q = ni({ name: "QGlobalDialog", setup: () => () => d(a, { ...r, ref: c, onOk: w, onHide: S, onVnodeMounted(...p) {
...
var Ns = { install({ $q: e, ssrContext: t }) {
  e.cookies = this;
} };
__QUASAR_SSR__ && (Ns.parseSSR = (e) => {
  if (e !== void 0) return Wh(e);
});
Object.assign(Ns, Wh());
var ww = Ns, Sw = ve({ name: "DialogPluginComponent", props: { ...nt, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  const { proxy: n } = Se(), { $q: l } = n, a = lt(e, l), r = U(null), o = U(e.prompt !== void 0 ? e.prompt.model : e.options !== void 0 ? e.options.model : void 0), i = f(() => "q-dialog-plugin" + (a.value === true ? " q-dialog-plugin--dark q-dark" : "") + (e.progress !== false ? " q-dialog-plugin--progress" : "")), u = f(() => e.color || (a.value === true ? "amber" : "primary")), c = f(() => e.progress === false ? null : $t(e.progress) === true ? { component: e.progress.spinner || _n, props: { color: e.progress.color || u.value } } : { component: _n, props: { color: u.value } }), s = f(() => e.prompt !== void 0 || e.options !== void 0), v = f(() => {
    if (s.value !== true) return {};
    const { model: C, isValid: D, items: H, ...j } = e.prompt !== void 0 ? e.prompt : e.options;
    return j;
  }), h = f(() => $t(e.ok) === true || e.ok === true ? l.lang.label.ok : e.ok), m = f(() => $t(e.cancel) === true || e.cancel === true ? l.lang.label.cancel : e.cancel), g = f(() => e.prompt !== void 0 ? e.prompt.isValid !== void 0 && e.prompt.isValid(o.value) !== true : e.options !== void 0 ? e.options.isValid !== void 0 && e.options.isValid(o.value) !== true : false), w = f(() => ({ color: u.value, label: h.value, ripple: false, disable: g.value, ...$t(e.ok) === true ? e.ok : { flat: true }, "data-autofocus": e.focus === "ok" && s.value !== true || void 0, onClick: y })), S = f(() => ({ color: u.value, label: m.value, ripple: false, ...$t(e.cancel) === true ? e.cancel : { flat: true }, "data-autofocus": e.focus === "cancel" && s.value !== true || void 0, onClick: b }));
  ...
  function L() {
    return [d(wh, { color: u.value, dense: true, autofocus: true, dark: a.value, ...v.value, modelValue: o.value, "onUpdate:modelValue": E, onKeyup: $ })];
  }
  function P() {
    return [d(M1, { color: u.value, options: e.options.items, dark: a.value, ...v.value, modelValue: o.value, "onUpdate:modelValue": E })];
  }
  function F() {
    const C = [];
    return e.cancel && C.push(d(Ze, S.value)), e.ok && C.push(d(Ze, w.value)), d(op, { class: e.stackButtons === true ? "items-end" : "", vertical: e.stackButtons, align: "right" }, () => C);
  }
  function T() {
    const C = [];
    return e.title && C.push(V("q-dialog__title", e.title)), e.progress !== false && C.push(d(Pl, { class: "q-dialog__progress" }, () => d(c.value.component, c.value.props))), e.message && C.push(V("q-dialog__message", e.message)), e.prompt !== void 0 ? C.push(d(Pl, { class: "scroll q-dialog-plugin__form" }, L)) : e.options !== void 0 && C.push(d(Hl, { dark: a.value }), d(Pl, { class: "scroll q-dialog-plugin__form" }, P), d(Hl, { dark: a.value })), (e.ok || e.cancel) && C.push(F()), C;
  }
  function x() {
    return [d(Em, { class: [i.value, e.cardClass], style: e.cardStyle, dark: a.value }, T)];
  }
  return Object.assign(n, { show: q, hide: p }), () => d(si, { ref: r, onHide: _ }, x);
} }), xw = { install({ $q: e, parentApp: t }) {
  e.dialog = this.create = hw(Sw, true, t);
} }, la, nu, ef = 0, El = null, zt = {}, Bl = {}, Yh = { group: "__default_quasar_group__", delay: 0, message: false, html: false, spinnerSize: 80, spinnerColor: "", messageColor: "", backgroundColor: "", boxClass: "", spinner: _n, customClass: "" }, Gh = { ...Yh };
function Cw(e) {
...
var Sn = wl({ isActive: false }, { show(e) {
  zt = Cw(e);
  const { group: t } = zt;
  return Sn.isActive = true, la !== void 0 ? (zt.uid = ef, nu.$forceUpdate()) : (zt.uid = ++ef, El !== null && clearTimeout(El), El = setTimeout(() => {
    El = null;
    const n = $r("q-loading");
    la = ni({ name: "QLoading", setup() {
      ...
      function l() {
        Sn.isActive !== true && la !== void 0 && (Ou(false), la.unmount(n), xs(n), la = void 0, nu = void 0);
      }
      function a() {
...
} }), qw = 0, uo = {}, so = {}, xn = {}, Xh = {}, Tw = /^\s*$/, Zh = [], Mw = [void 0, null, true, false, ""], Hs = ["top-left", "top-right", "bottom-left", "bottom-right", "top", "bottom", "left", "right", "center"], Ew = ["top-left", "top-right", "bottom-left", "bottom-right"], Wa = { positive: { icon: (e) => e.iconSet.type.positive, color: "positive" }, negative: { icon: (e) => e.iconSet.type.negative, color: "negative" }, warning: { icon: (e) => e.iconSet.type.warning, color: "warning", textColor: "dark" }, info: { icon: (e) => e.iconSet.type.info, color: "info" }, ongoing: { group: false, timeout: 0, spinner: true, color: "grey-8" } };
function Jh(e, t, n) {
  var _a2;
  ...
  if (e.ignoreDefaults !== true && Object.assign(a, uo), $t(e) === false && (a.type && Object.assign(a, Wa[a.type]), e = { message: e }), Object.assign(a, Wa[e.type || a.type], e), typeof a.icon == "function" && (a.icon = a.icon(t)), a.spinner ? (a.spinner === true && (a.spinner = _n), a.spinner = jo(a.spinner)) : a.spinner = false, a.meta = { hasMedia: !!(a.spinner !== false || a.icon || a.avatar), hasText: nf(a.message) || nf(a.caption) }, a.position) {
    if (Hs.includes(a.position) === false) return Na("wrong position", e);
...
function $w() {
  return ve({ name: "QNotifications", devtools: { hide: true }, setup() {
    return () => d("div", { class: "q-notifications" }, Hs.map((e) => d(Ib, { key: e, class: Xh[e], tag: "div", name: `q-notification--${e}` }, () => xn[e].value.map((t) => {
      const n = t.meta, l = [];
...
const ag = (e, t) => {
  ...
  return (r, o) => {
    ...
    return Yn(), Rl(Ie(w1), { view: "hHh LpR fFf" }, { default: Lt(() => [Je(Ie(u1), { class: "bg-primary text-white", elevated: "" }, { default: Lt(() => [Je(Ie(L_), null, { default: Lt(() => [Je(Ie(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: o[0] || (o[0] = (c) => pt(n) ? n.value = !Ie(n) : n = !Ie(n)) }), Je(Ie(B_), null, { default: Lt(() => [Je(Ie(im), null, { default: Lt(() => o[10] || (o[10] = [fa("img", { src: "https://cdn.quasar.dev/logo-v2/svg/logo-mono-white.svg" }, null, -1)])), _: 1 }), o[11] || (o[11] = oa("\xA0Title"))]), _: 1 }), Ie(t).dark.isActive ? (Yn(), Rl(Ie(Ze), { key: 0, dense: "", flat: "", round: "", icon: Ie(jw), onClick: o[1] || (o[1] = (c) => Ie(t).dark.set(false)) }, null, 8, ["icon"])) : mc("", true), Ie(t).dark.isActive ? mc("", true) : (Yn(), Rl(Ie(Ze), { key: 1, dense: "", flat: "", round: "", icon: Ie(Hw), onClick: o[2] || (o[2] = (c) => Ie(t).dark.set(true)) }, null, 8, ["icon"])), Je(Ie(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: o[3] || (o[3] = (c) => pt(l) ? l.value = !Ie(l) : l = !Ie(l)) })]), _: 1 }), Je(Ie(Bu), { align: "left" }, { default: Lt(() => [Je(Ie(tu), { to: "/page1", label: "Page One" }), Je(Ie(tu), { to: "/page2", label: "Page Two" }), Je(Ie(tu), { to: "/page3", label: "Page Three" })]), _: 1 })]), _: 1 }), Je(Ie(_d), { modelValue: Ie(n), "onUpdate:modelValue": o[8] || (o[8] = (c) => pt(n) ? n.value = c : n = c), side: "left", bordered: "", mini: Ie(a), overlay: "" }, { default: Lt(() => [Je(Ie(P1), { class: "fit" }, { default: Lt(() => [Je(Ie(xh), { class: "menu-list padding" }, { default: Lt(() => [sn((Yn(), Rl(Ie(Sa), { clickable: "", onMouseover: o[4] || (o[4] = (c) => pt(a) ? a.value = false : a = false), onMouseout: o[5] || (o[5] = (c) => pt(a) ? a.value = true : a = true) }, { default: Lt(() => [Je(Ie(mn), { avatar: "" }, { default: Lt(() => [Je(Ie(et), { name: "inbox" })]), _: 1 }), Je(Ie(mn), null, { default: Lt(() => o[12] || (o[12] = [oa("inbox")])), _: 1 })]), _: 1 })), [[u]]), sn((Yn(), Rl(Ie(Sa), { clickable: "", onMouseover: o[6] || (o[6] = (c) => pt(a) ? a.value = false : a = false), onMouseout: o[7] || (o[7] = (c) => pt(a) ? a.value = true : a = true) }, { default: Lt(() => [Je(Ie(mn), { avatar: "" }, { default: Lt(() => [Je(Ie(et), { name: "login" })]), _: 1 }), Je(Ie(mn), null, { default: Lt(() => o[13] || (o[13] = [oa("login")])), _: 1 })]), _: 1 })), [[u]])]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["modelValue", "mini"]), Je(Ie(_d), { modelValue: Ie(l), "onUpdate:modelValue": o[9] || (o[9] = (c) => pt(l) ? l.value = c : l = c), side: "right", bordered: "", overlay: "" }, { default: Lt(() => o[14] || (o[14] = [oa("right")])), _: 1 }, 8, ["modelValue"]), Je(Ie(E1), { class: "fit" }, { default: Lt(() => [Je(i)]), _: 1 })]), _: 1 });
  };
} });
/*!
* vue-router v4.5.0
...
function cS(e, t) {
  return An(e) ? af(e, t) : An(t) ? af(t, e) : e === t;
}
function af(e, t) {
...
function _S(e, t, n, l) {
  let a = [], r = [], o = null;
  const i = ({ state: h }) => {
    const m = fg(e, location), g = n.value, w = t.value;
    let S = 0;
    if (h) {
  ...
  function u(c) {
    ...
    for (const h of e) {
      ...
      for (const m of h) if (m.type === 0) s += m.value;
        ...
        if (An(q) && !w) throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);
...
function PS(e, t) {
  ...
  function r(v, h, m) {
    ...
    if ("alias" in v) {
      ...
      for (const _ of b) q.push(ff(ut({}, w, { components: m ? m.record.components : w.components, path: _, aliasOf: m ? m.record : w })));
    }
    let p, y;
    for (const b of q) {
      const { path: _ } = b;
      if (h && _[0] !== "/") {
        const E = h.record.path, $ = E[E.length - 1] === "/" ? "" : "/";
        b.path = h.record.path + (_ && $ + _);
      }
      if (p = RS(b, h, S), m ? m.alias.push(p) : (y = y || p, y !== p && y.alias.push(p), g && v.name && !vf(p) && o(v.name)), gg(p) && u(p), w.children) {
        const E = w.children;
        for (let $ = 0; $ < E.length; $++) r(E[$], p, m && m.children[$]);
      }
      m = m || p;
    }
    return y ? () => {
  ...
  function c(v, h) {
    ...
    if ("name" in v && v.name) {
      ...
      S = m.record.name, g = ut(df(h.params, m.keys.filter((y) => !y.optional).concat(m.parent ? m.parent.keys.filter((y) => y.optional) : []).map((y) => y.name)), v.params && df(v.params, m.keys.map((y) => y.name))), w = m.stringify(g);
    ...
    return { name: S, path: w, params: g, matched: q, meta: BS(q) };
  }
  e.forEach((v) => r(v));
  function s() {
    n.length = 0, l.clear();
...
function hf(e) {
  ...
  for (let n in e) {
    ...
    (An(l) ? l.map((r) => r && Nu(r)) : [l && Nu(l)]).forEach((r) => {
...
const zS = Symbol(""), gf = Symbol(""), Us = Symbol(""), bg = Symbol(""), ju = Symbol("");
function Ha() {
  let e = [];
  function t(l) {
    return e.push(l), () => {
...
function bf(e) {
  const t = qt(Us), n = qt(bg), l = f(() => {
    ...
    if (h > -1) return h;
    const m = yf(u[c - 2]);
    return c > 1 && yf(s) === m && v[v.length - 1].path !== m ? v.findIndex(xa.bind(null, u[c - 2])) : h;
...
const NS = /* @__PURE__ */ qa({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" } }, useLink: bf, setup(e, { slots: t }) {
  const n = Bn(bf(e)), { options: l } = qt(Us), a = f(() => ({ [pf(e.activeClass, l.linkActiveClass, "router-link-active")]: n.isActive, [pf(e.exactActiveClass, l.linkExactActiveClass, "router-link-exact-active")]: n.isExactActive }));
  return () => {
...
const pf = (e, t, n) => e ?? t ?? n, QS = /* @__PURE__ */ qa({ name: "RouterView", inheritAttrs: false, props: { name: { type: String, default: "default" }, route: Object }, compatConfig: { MODE: 3 }, setup(e, { attrs: t, slots: n }) {
  const l = qt(ju), a = f(() => e.route || l.value), r = qt(gf, 0), o = f(() => {
    let c = Ie(r);
  ...
  hn(gf, f(() => o.value + 1)), hn(zS, i), hn(ju, a);
  const u = U();
  return he(() => [u.value, i.value, e.name], ([c, s, v], [h, m, g]) => {
    s && (s.instances[v] = c, m && m !== s && c && c === h && (s.leaveGuards.size || (s.leaveGuards = m.leaveGuards), s.updateGuards.size || (s.updateGuards = m.updateGuards))), c && s && (!m || !xa(s, m) || !h) && (s.enterCallbacks[v] || []).forEach((w) => w(c));
  }, { flush: "post" }), () => {
    ...
    return _f(n.default, { Component: S, route: c }) || S;
  };
} });
function _f(e, t) {
  if (!e) return null;
...
function WS(e) {
  ...
  const s = lu.bind(null, (R) => "" + R), v = lu.bind(null, rS), h = lu.bind(null, xr);
  function m(R, J) {
    let O, re;
    return vg(R) ? (O = t.getRecordMatcher(R), re = J) : re = R, t.addRoute(re, O);
  }
  function g(R) {
  ...
  function q(R, J) {
    if (J = ut({}, J || u.value), typeof R == "string") {
      const z = au(n, R, J.path), Z = t.resolve({ path: z.path }, J), ne = a.createHref(z.fullPath);
      return ut(z, Z, { params: h(Z.params), hash: xr(z.hash), redirectedFrom: void 0, href: ne });
    }
    let O;
    if (R.path != null) O = ut({}, R, { path: au(n, R.path, J.path).path });
    else {
      const z = ut({}, R.params);
    ...
    const k = uS(l, ut({}, R, { hash: nS(we), path: re.path })), A = a.createHref(k);
    return ut({ fullPath: k, hash: we, query: l === hf ? IS(R.query) : R.query || {} }, re, { redirectedFrom: void 0, href: A });
  }
  function p(R) {
  ...
  function $(R, J) {
    const O = c = q(R), re = u.value, we = R.state, k = R.force, A = R.replace === true, z = E(O);
    if (z) return $(ut(p(z), { state: typeof z == "object" ? ut({}, we, z.state) : we, force: k, replace: A }), J || O);
    const Z = O;
    Z.redirectedFrom = J;
    let ne;
    return !k && sS(l, re, O) && (ne = Ca(16, { to: Z, from: re }), Q(re, re, true, false)), (ne ? Promise.resolve(ne) : P(Z, re)).catch((K) => Hn(K) ? Hn(K, 2) ? K : pe(K) : W(K, Z, re)).then((K) => {
      if (K) {
        if (Hn(K, 2)) return $(ut({ replace: A }, p(K.to), { state: typeof K.to == "object" ? ut({}, we, K.to.state) : we, force: k }), J || Z);
      } else K = T(Z, re, true, A, we);
      return F(Z, re, K), K;
    });
  }
  function V(R, J) {
  ...
  function P(R, J) {
    let O;
    const [re, we, k] = YS(R, J);
    O = ru(re.reverse(), "beforeRouteLeave", R, J);
    for (const z of re) z.leaveGuards.forEach((Z) => {
      O.push(dl(Z, R, J));
    });
    const A = V.bind(null, R, J);
    return O.push(A), B(O).then(() => {
      O = [];
      for (const z of r.list()) O.push(dl(z, R, J));
      return O.push(A), B(O);
    }).then(() => {
      O = ru(we, "beforeRouteUpdate", R, J);
      ...
      O = [];
      for (const z of k) if (z.beforeEnter) if (An(z.beforeEnter)) for (const Z of z.beforeEnter) O.push(dl(Z, R, J));
      else O.push(dl(z.beforeEnter, R, J));
      return O.push(A), B(O);
    }).then(() => (R.matched.forEach((z) => z.enterCallbacks = {}), O = ru(k, "beforeRouteEnter", R, J, L), O.push(A), B(O))).then(() => {
      O = [];
  ...
  function T(R, J, O, re, we) {
    const k = y(R, J);
    if (k) return k;
    const A = J === rl, z = ra ? history.state : {};
    O && (re || A ? a.replace(R.fullPath, ut({ scroll: A && z && z.scroll }, we)) : a.push(R.fullPath, we)), u.value = R, Q(R, J, O, A), pe();
  }
  let x;
  function C() {
    x || (x = a.listen((R, J, O) => {
      ...
      if (we) {
        $(ut(we, { replace: true, force: true }), re).catch(sr);
        return;
      }
      c = re;
      const k = u.value;
      ra && bS(rf(k.fullPath, O.delta), mi()), P(re, k).catch((A) => Hn(A, 12) ? A : Hn(A, 2) ? ($(ut(p(A.to), { force: true }), re).then((z) => {
        Hn(z, 20) && !O.delta && O.type === Cr.pop && a.go(-1, false);
      }).catch(sr), Promise.reject()) : (O.delta && a.go(-O.delta, false), W(A, re, k))).then((A) => {
        A = A || T(re, k, false), A && (O.delta && !Hn(A, 8) ? a.go(-O.delta, false) : O.type === Cr.pop && Hn(A, 20) && a.go(-1, false)), F(re, k, A);
      }).catch(sr);
    }));
  }
  let D = Ha(), H = Ha(), j;
  ...
  function Q(R, J, O, re) {
    ...
    const k = !O && yS(rf(R.fullPath, 0)) || (re || !O) && history.state && history.state.scroll || null;
    return Ge().then(() => we(R, J, k)).then((A) => A && gS(A)).catch((A) => W(A, R, J));
  }
  const M = (R) => a.go(R);
  let ee;
  const X = /* @__PURE__ */ new Set(), be = { currentRoute: u, listening: true, addRoute: m, removeRoute: g, clearRoutes: t.clearRoutes, hasRoute: S, getRoutes: w, resolve: q, options: e, push: b, replace: _, go: M, back: () => M(-1), forward: () => M(1), beforeEach: r.add, beforeResolve: o.add, afterEach: i.add, onError: H.add, isReady: te, install(R) {
    const J = this;
    R.component("RouterLink", HS), R.component("RouterView", KS), R.config.globalProperties.$router = J, Object.defineProperty(R.config.globalProperties, "$route", { enumerable: true, get: () => Ie(u) }), ra && !ee && u.value === rl && (ee = true, b(a.location).catch((we) => {
    }));
    const O = {};
    for (const we in rl) Object.defineProperty(O, we, { get: () => u.value[we], enumerable: true });
    R.provide(Us, J), R.provide(bg, as(O)), R.provide(ju, u);
    const re = R.unmount;
...
function iu(e, t, n, l) {
  var a = l[0], r = l[1], o = l[2], i = Math.hypot(a, r, o), u, c, s, v, h, m, g, w, S, q, p, y, b, _, E, $, V, L, P, F, T, x, C, D;
  return i < ux ? null : (i = 1 / i, a *= i, r *= i, o *= i, u = Math.sin(n), c = Math.cos(n), s = 1 - c, v = t[0], h = t[1], m = t[2], g = t[3], w = t[4], S = t[5], q = t[6], p = t[7], y = t[8], b = t[9], _ = t[10], E = t[11], $ = a * a * s + c, V = r * a * s + o * u, L = o * a * s - r * u, P = a * r * s - o * u, F = r * r * s + c, T = o * r * s + a * u, x = a * o * s + r * u, C = r * o * s - a * u, D = o * o * s + c, e[0] = v * $ + w * V + y * L, e[1] = h * $ + S * V + b * L, e[2] = m * $ + q * V + _ * L, e[3] = g * $ + p * V + E * L, e[4] = v * P + w * F + y * T, e[5] = h * P + S * F + b * T, e[6] = m * P + q * F + _ * T, e[7] = g * P + p * F + E * T, e[8] = v * x + w * C + y * D, e[9] = h * x + S * C + b * D, e[10] = m * x + q * C + _ * D, e[11] = g * x + p * C + E * D, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e);
}
...
const dx = ["width", "height"], fx = /* @__PURE__ */ qa({ __name: "WebGL", setup(e) {
  ...
  const u = () => {
    ...
    for (let x = 0; x < 6; ++x) {
      const C = 3.141 * x * 60 / 180;
      E = E.concat([1 * Math.cos(C), 1 * Math.sin(C), 0.2]);
    }
    for (let x = 0; x < 6; ++x) {
      const C = 3.141 * x * 60 / 180;
      E = E.concat([1.2 * Math.cos(C), 1.2 * Math.sin(C), 0.2]);
    }
    for (let x = 0; x < 6; ++x) {
      const C = 3.141 * x * 60 / 180;
    ...
    let $ = [1, 1, 0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 0, 1, 1];
    for (let x = 0; x < 6; ++x) $ = $.concat([1, 1, 1, 1]);
    for (let x = 0; x < 6; ++x) $ = $.concat([1, 1, 1, 1]);
    for (let x = 0; x < 6; ++x) $ = $.concat([0.75, 0.75, 0.75, 1]);
    for (let x = 0; x < 6; ++x) $ = $.concat([0.5, 0.5, 0.5, 1]);
    const V = n.createBuffer();
    n.bindBuffer(n.ARRAY_BUFFER, V), n.bufferData(n.ARRAY_BUFFER, new Float32Array($), n.STATIC_DRAW);
    ...
    `, P = u(), F = n.getUniformLocation($, "uProjectionMatrix"), T = n.getUniformLocation($, "uModelViewMatrix"), x = n.getUniformLocation($, "uSampler"), C = n.getUniformLocation($, "fTime"), D = n.getUniformLocation($, "fMode");
    ...
    const pe = { prog_draw: $, prog_pick: H, attr: { vertex: n.getAttribLocation($, "aVertexPosition"), vertex_pick: n.getAttribLocation(H, "aVertexPosition"), color: n.getAttribLocation($, "aVertexColor"), texture: n.getAttribLocation($, "aTextureCoord") }, locs: { proj: F, view: T, sampler: x, time: C, mode: D, proj_pick: j, view_pick: W, id_pick: te }, bufs: { pos: P[0], color: P[1], tex: P[2], index: P[3] }, pick: { fb: n.createFramebuffer(), rb: n.createRenderbuffer(), tex: n.createTexture() } };
    ...
    const $ = w(n.VERTEX_SHADER, _), V = w(n.FRAGMENT_SHADER, E), L = n.createProgram();
    return n.attachShader(L, $), n.attachShader(L, V), n.linkProgram(L), L;
  }, w = (_, E) => {
    if (n === null) throw new Error("no webgl");
    const $ = n.createShader(_);
    if ($ === null) throw new Error("bad shader");
    return n.shaderSource($, E), n.compileShader($), $;
  };
  let S = null, q = null;
  const p = () => {
    ...
    const $ = E.target;
    _ === "base" && n.bindTexture(n.TEXTURE_2D, S), _ === "body" && n.bindTexture(n.TEXTURE_2D, q), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, $), n.generateMipmap(n.TEXTURE_2D);
  }, b = (_) => {
    if (n === null || t.value === void 0) return;
    const E = _, $ = E.offsetX, V = E.offsetY;
    $ - t.value.clientWidth / 2, V - t.value.clientHeight / 2, ($ - n.canvas.width / 2) / 2, (V - n.canvas.height / 2) / 2, l.value = [$, V];
  };
  return ft(() => {
    o.value = document.body.getBoundingClientRect().width, i.value = document.body.getBoundingClientRect().height - 100, Ge(m);
  }), (_, E) => (Yn(), qv(rn, null, [fa("canvas", { id: "canvas", ref_key: "canvas", ref: t, onMousemove: E[0] || (E[0] = ($) => b($)), width: Ie(o), height: Ie(i) }, null, 40, dx), fa("img", { src: "img/tex.jpg", onLoad: E[1] || (E[1] = ($) => y("base", $)), style: { display: "none" } }, null, 32), fa("img", { src: "img/wood.jpg", onLoad: E[2] || (E[2] = ($) => y("body", $)), style: { display: "none" } }, null, 32)], 64));
} }), vx = { BASE_URL: "./", DEV: false, MODE: "production", PROD: true, SSR: false, VITE_APP_NAME: "vite mtg", VITE_client_id: "quasar-2fa", VITE_client_secret: "spoon" }, Qs = Iv(Nw);
console.log(vx);
...
Qs.use(hx);
Qs.use(Iw, { plugins: { Dialog: xw, Dark: Hv, Loading: kw, Cookies: ww, Notify: Rw }, config: { dark: "auto" } });
window.cb = (e) => {
  alert(e);
};
window.log = (e) => {
