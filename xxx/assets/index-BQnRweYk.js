...
class Uf {
  ...
  get(t, n, l) {
    ...
    return (pl(n) ? jf.has(n) : Yg(n)) || (a || Kt(t, "get", n), r) ? i : pt(i) ? o && Zu(n) ? i : i.value : xt(i) ? a ? Gf(i) : Bn(i) : i;
  }
}
class Qf extends Uf {
  constructor(t = false) {
  ...
  set(t, n, l, a) {
    ...
    return t === Ge(a) && (o ? hl(l, r) && Kn(t, "set", n, l) : Kn(t, "add", n, l)), i;
  }
  deleteProperty(t, n) {
    const l = st(t, n);
    t[n];
...
function n0(e, t) {
  ...
  return zt(n, e ? { add: Br("add"), set: Br("set"), delete: Br("delete"), clear: Br("clear") } : { add(a) {
    ...
    const s = u.call(o, a);
    return o.set(a, r), c ? hl(r, s) && Kn(o, "set", a, r) : Kn(o, "add", a, r), this;
  }, delete(a) {
...
const Gt = (e) => xt(e) ? Bn(e) : e, hu = (e) => xt(e) ? Gf(e) : e;
function pt(e) {
...
function h0(e, t, n = mt) {
  ...
  const y = (b) => {
    if (!(!(s.flags & 1) || !s.dirty && !b)) if (t) {
      const x = s.run();
      if (a || g || (_ ? x.some((R, B) => hl(R, p[B])) : hl(x, p))) {
        m && m();
        const R = $l;
        $l = s;
        try {
          const B = [x, p === Fr ? void 0 : _ && p[0] === Fr ? [] : p, h];
          u ? u(t, 3, B) : t(...B), p = x;
        } finally {
          $l = R;
        }
...
const av = Symbol("_vte"), rv = (e) => e.__isTeleport, nr = (e) => e && (e.disabled || e.disabled === ""), lc = (e) => e && (e.defer || e.defer === ""), ac = (e) => typeof SVGElement < "u" && e instanceof SVGElement, rc = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, gu = (e, t) => {
  ...
  const { mc: s, pc: f, pbc: m, o: { insert: h, querySelector: g, createText: _, createComment: S } } = c, k = nr(t.props);
  let { shapeFlag: p, children: y, dynamicChildren: b } = t;
  if (e == null) {
    const x = t.el = _(""), R = t.anchor = _("");
    h(x, n, l), h(R, n, l);
    const B = (L, $) => {
      p & 16 && (a && a.isCE && (a.ce._teleportTarget = L), s(y, L, $, a, r, o, i, u));
    }, I = () => {
      const L = t.target = gu(t.props, g), $ = iv(L, t, _, h);
...
function mr(e, t, n, l, a) {
  const { appear: r, mode: o, persisted: i = false, onBeforeEnter: u, onEnter: c, onAfterEnter: s, onEnterCancelled: f, onBeforeLeave: m, onLeave: h, onAfterLeave: g, onLeaveCancelled: _, onBeforeAppear: S, onAppear: k, onAfterAppear: p, onAppearCancelled: y } = t, b = String(e.key), x = fv(n, e), R = (L, $) => {
    L && En(L, l, 9, $);
  }, B = (L, $) => {
    const z = $[1];
    ...
    let A = false;
    const C = L[Vr] = (N) => {
      A || (A = true, N ? R(q, [L]) : R(z, [L]), I.delayedLeave && I.delayedLeave(), L[Vr] = void 0);
    };
    $ ? B($, [L, C]) : C();
  }, leave(L, $) {
    ...
    let q = false;
    const A = L[cl] = (C) => {
      q || (q = true, $(), C ? R(_, [L]) : R(g, [L]), L[cl] = void 0, x[z] === e && delete x[z]);
    };
    x[z] = e, h ? B(h, [L, A]) : A();
  }, clone(L) {
    const $ = mr(L, t, n, l, a);
...
const va = (e) => !!e.type.__asyncLoader, Ko = (e) => e.type.__isKeepAlive, x0 = { name: "KeepAlive", __isKeepAlive: true, props: { include: [String, RegExp, Array], exclude: [String, RegExp, Array], max: [String, Number] }, setup(e, { slots: t }) {
  ...
  return ft(k), Go(k), Ke(() => {
    ...
    return b.el && (b = Xn(b), y.shapeFlag & 128 && (y.ssContent = b)), S = $, z ? (b.el = z.el, b.component = z.component, b.transition && yl(b, b.transition), b.shapeFlag |= 512, r.delete($), r.add($)) : (r.add($), L && r.size > parseInt(L, 10) && _(r.values().next().value)), b.shapeFlag |= 256, o = b, po(y.type) ? y : b;
  };
} }, mv = x0;
function Ua(e, t) {
...
function P0(e) {
  ...
  if (yu = true, r) for (const W in r) {
    const F = r[W], H = Qe(F) ? F.bind(n, n) : Qe(F.get) ? F.get.bind(n, n) : Fn, le = !Qe(F) && Qe(F.set) ? F.set.bind(n) : Fn, Q = v({ get: H, set: le });
  ...
  s && sc(s, e, "c");
  function U(W, F) {
    Ne(F) ? F.forEach((H) => W(H.bind(n))) : F && W(F.bind(n));
  }
  if (U(Yo, f), U(ft, m), U(Ma, h), U(Go, g), U(Sl, _), U(On, S), U(M0, I), U(T0, R), U(q0, B), U(Ke, p), U(Xo, b), U(k0, L), Ne($)) if ($.length) {
    const W = e.exposed || (e.exposed = {});
    $.forEach((F) => {
      Object.defineProperty(W, F, { get: () => n[F], set: (H) => n[F] = H });
    });
  } else e.exposed || (e.exposed = {});
  x && e.render === Fn && (e.render = x), z != null && (e.inheritAttrs = z), q && (e.components = q), A && (e.directives = A), L && vv(e);
}
...
function kv(e, t, n = false) {
  ...
  if (Ne(r)) for (let s = 0; s < r.length; s++) {
    ...
    if (fc(f)) {
      ...
      h[0] = _, h[1] = S, (_ || st(h, "default")) && i.push(f);
    }
  }
  const c = [o, i];
...
const qv = (e) => e[0] === "_" || e === "$stable", fs = (e) => Ne(e) ? e.map(Ln) : [Ln(e)], H0 = (e, t, n) => {
  if (t._n) return t;
...
function W0(e, t) {
  ...
  const n = qr();
  n.__VUE__ = true;
  const { insert: l, remove: a, patchProp: r, createElement: o, createText: i, createComment: u, setText: c, setElementText: s, parentNode: f, nextSibling: m, setScopeId: h = Fn, insertStaticContent: g } = e, _ = (w, E, D, te = null, ae = null, Y = null, me = void 0, be = null, he = !!E.dynamicChildren) => {
    if (w === E) return;
    w && !vl(w, E) && (te = M(w), T(w, ae, Y, true), w = null), E.patchFlag === -2 && (he = false, E.dynamicChildren = null);
    ...
    switch (ve) {
      ...
      case Ti:
        ...
        break;
      case rn:
        q(w, E, D, te, ae, Y, me, be, he);
        break;
      default:
        j & 1 ? x(w, E, D, te, ae, Y, me, be, he) : j & 6 ? A(w, E, D, te, ae, Y, me, be, he) : (j & 64 || j & 128) && ve.process(w, E, D, te, ae, Y, me, be, he, oe);
    }
    re != null && ae && go(re, w && w.ref, Y, E || w, !E);
  }, S = (w, E, D, te) => {
    if (w == null) l(E.el = i(E.children), D, te);
    else {
      const ae = E.el = w.el;
      E.children !== w.children && c(ae, E.children);
    }
  }, k = (w, E, D, te) => {
    w == null ? l(E.el = u(E.children || ""), D, te) : E.el = w.el;
  }, p = (w, E, D, te) => {
    [w.el, w.anchor] = g(w.children, E, D, te, w.el, w.anchor);
  }, y = ({ el: w, anchor: E }, D, te) => {
    let ae;
    for (; w && w !== E; ) ae = m(w), l(w, D, te), w = ae;
    l(E, D, te);
  }, b = ({ el: w, anchor: E }) => {
    let D;
    for (; w && w !== E; ) D = m(w), a(w), w = D;
    a(E);
  }, x = (w, E, D, te, ae, Y, me, be, he) => {
    E.type === "svg" ? me = "svg" : E.type === "math" && (me = "mathml"), w == null ? R(E, D, te, ae, Y, me, be, he) : L(w, E, ae, Y, me, be, he);
  }, R = (w, E, D, te, ae, Y, me, be) => {
    let he, ve;
    const { props: re, shapeFlag: j, transition: ue, dirs: we } = w;
    if (he = w.el = o(w.type, Y, re && re.is, re), j & 8 ? s(he, w.children) : j & 16 && I(w.children, he, null, te, ae, qi(w, Y), me, be), we && kl(w, null, te, "created"), B(he, w, w.scopeId, me, te), re) {
      for (const qe in re) qe !== "value" && !Xa(qe) && r(he, qe, null, re[qe], Y, te);
      "value" in re && r(he, "value", null, re.value, Y), (ve = re.onVnodeBeforeMount) && vn(ve, te, w);
    }
    we && kl(w, null, te, "beforeMount");
    const ke = Y0(ae, ue);
    ke && ue.beforeEnter(he), l(he, E, D), ((ve = re && re.onVnodeMounted) || ke || we) && Bt(() => {
      ve && vn(ve, te, w), ke && ue.enter(he), we && kl(w, null, te, "mounted");
    }, ae);
  }, B = (w, E, D, te, ae) => {
    if (D && h(w, D), te) for (let Y = 0; Y < te.length; Y++) h(w, te[Y]);
    if (ae) {
      let Y = ae.subTree;
      if (E === Y || po(Y.type) && (Y.ssContent === E || Y.ssFallback === E)) {
        const me = ae.vnode;
        B(w, me, me.scopeId, me.slotScopeIds, ae.parent);
      }
    }
  }, I = (w, E, D, te, ae, Y, me, be, he = 0) => {
    for (let ve = he; ve < w.length; ve++) {
      const re = w[ve] = be ? dl(w[ve]) : Ln(w[ve]);
      _(null, re, E, D, te, ae, Y, me, be);
    }
  }, L = (w, E, D, te, ae, Y, me) => {
    const be = E.el = w.el;
    let { patchFlag: he, dynamicChildren: ve, dirs: re } = E;
    he |= w.patchFlag & 16;
    const j = w.props || mt, ue = E.props || mt;
    let we;
    if (D && ql(D, false), (we = ue.onVnodeBeforeUpdate) && vn(we, D, E, w), re && kl(E, w, D, "beforeUpdate"), D && ql(D, true), (j.innerHTML && ue.innerHTML == null || j.textContent && ue.textContent == null) && s(be, ""), ve ? $(w.dynamicChildren, ve, be, D, te, qi(E, ae), Y) : me || F(w, E, be, null, D, te, qi(E, ae), Y, false), he > 0) {
      ...
      he & 1 && w.children !== E.children && s(be, E.children);
    } else !me && ve == null && z(be, j, ue, D, ae);
    ((we = ue.onVnodeUpdated) || re) && Bt(() => {
      we && vn(we, D, E, w), re && kl(E, w, D, "updated");
    }, te);
  }, $ = (w, E, D, te, ae, Y, me) => {
    for (let be = 0; be < E.length; be++) {
      const he = w[be], ve = E[be], re = he.el && (he.type === rn || !vl(he, ve) || he.shapeFlag & 70) ? f(he.el) : D;
      _(he, ve, re, null, te, ae, Y, me, true);
    }
  }, z = (w, E, D, te, ae) => {
    if (E !== D) {
      if (E !== mt) for (const Y in E) !Xa(Y) && !(Y in D) && r(w, Y, E[Y], null, ae, te);
      for (const Y in D) {
        if (Xa(Y)) continue;
        const me = D[Y], be = E[Y];
        me !== be && Y !== "value" && r(w, Y, be, me, ae, te);
      }
      "value" in D && r(w, "value", E.value, D.value, ae);
    }
  }, q = (w, E, D, te, ae, Y, me, be, he) => {
    const ve = E.el = w ? w.el : i(""), re = E.anchor = w ? w.anchor : i("");
    let { patchFlag: j, dynamicChildren: ue, slotScopeIds: we } = E;
    we && (be = be ? be.concat(we) : we), w == null ? (l(ve, D, te), l(re, D, te), I(E.children || [], D, re, ae, Y, me, be, he)) : j > 0 && j & 64 && ue && w.dynamicChildren ? ($(w.dynamicChildren, ue, D, ae, Y, me, be), (E.key != null || ae && E === ae.subTree) && vs(w, E, true)) : F(w, E, D, re, ae, Y, me, be, he);
  }, A = (w, E, D, te, ae, Y, me, be, he) => {
    E.slotScopeIds = be, w == null ? E.shapeFlag & 512 ? ae.ctx.activate(E, D, te, me, he) : C(E, D, te, ae, Y, me, he) : N(w, E, he);
  }, C = (w, E, D, te, ae, Y, me) => {
    const be = w.component = mb(w, te, ae);
    if (Ko(w) && (be.ctx.renderer = oe), hb(be, false, me), be.asyncDep) {
      if (ae && ae.registerDep(be, U, me), !w.el) {
        const he = be.subTree = Je(Zt);
        k(null, he, E, D);
      }
    } else U(be, w, E, D, ae, Y, me);
  }, N = (w, E, D) => {
    const te = E.component = w.component;
    if (ab(w, E, D)) if (te.asyncDep && !te.asyncResolved) {
      W(te, E, D);
      return;
    } else te.next = E, te.update();
    else E.el = w.el, te.vnode = E;
  }, U = (w, E, D, te, ae, Y, me) => {
    const be = () => {
      if (w.isMounted) {
        let { next: j, bu: ue, u: we, parent: ke, vnode: qe } = w;
        {
          const pe = Av(w);
          if (pe) {
            j && (j.el = qe.el, W(w, j, me)), pe.asyncDep.then(() => {
              w.isUnmounted || be();
            });
            return;
          }
        ...
        let Me = j, He;
        ql(w, false), j ? (j.el = qe.el, W(w, j, me)) : j = qe, ue && Za(ue), (He = j.props && j.props.onVnodeBeforeUpdate) && vn(He, ke, j, qe), ql(w, true);
        const Ve = vc(w), se = w.subTree;
        w.subTree = Ve, _(se, Ve, f(se.el), M(se), w, ae, Y), j.el = Ve.el, Me === null && rb(w, Ve.el), we && Bt(we, ae), (He = j.props && j.props.onVnodeUpdated) && Bt(() => vn(He, ke, j, qe), ae);
      } else {
        let j;
        const { el: ue, props: we } = E, { bm: ke, m: qe, parent: Me, root: He, type: Ve } = w, se = va(E);
        ql(w, false), ke && Za(ke), !se && (j = we && we.onVnodeBeforeMount) && vn(j, Me, E), ql(w, true);
        {
          He.ce && He.ce._injectChildStyle(Ve);
          const pe = w.subTree = vc(w);
          _(null, pe, D, te, w, ae, Y), E.el = pe.el;
        }
        if (qe && Bt(qe, ae), !se && (j = we && we.onVnodeMounted)) {
          const pe = E;
          Bt(() => vn(j, Me, pe), ae);
        }
        (E.shapeFlag & 256 || Me && va(Me.vnode) && Me.vnode.shapeFlag & 256) && w.a && Bt(w.a, ae), w.isMounted = true, E = D = te = null;
      }
    };
    w.scope.on();
    const he = w.effect = new Ff(be);
    w.scope.off();
    const ve = w.update = he.run.bind(he), re = w.job = he.runIfDirty.bind(he);
    re.i = w, re.id = w.uid, he.scheduler = () => ss(re), ql(w, true), ve();
  }, W = (w, E, D) => {
    E.component = w;
    const te = w.vnode.props;
    w.vnode = E, w.next = null, D0(w, E.props, te, D), U0(w, E.children, D), _l(), nc(w), wl();
  }, F = (w, E, D, te, ae, Y, me, be, he = false) => {
    const ve = w && w.children, re = w ? w.shapeFlag : 0, j = E.children, { patchFlag: ue, shapeFlag: we } = E;
    if (ue > 0) {
      if (ue & 128) {
        le(ve, j, D, te, ae, Y, me, be, he);
        return;
      } else if (ue & 256) {
        H(ve, j, D, te, ae, Y, me, be, he);
        return;
      }
    }
    we & 8 ? (re & 16 && P(ve, ae, Y), j !== ve && s(D, j)) : re & 16 ? we & 16 ? le(ve, j, D, te, ae, Y, me, be, he) : P(ve, ae, Y, true) : (re & 8 && s(D, ""), we & 16 && I(j, D, te, ae, Y, me, be, he));
  }, H = (w, E, D, te, ae, Y, me, be, he) => {
    w = w || ca, E = E || ca;
    const ve = w.length, re = E.length, j = Math.min(ve, re);
    let ue;
    for (ue = 0; ue < j; ue++) {
      const we = E[ue] = he ? dl(E[ue]) : Ln(E[ue]);
      _(w[ue], we, D, null, ae, Y, me, be, he);
    }
    ve > re ? P(w, ae, Y, true, false, j) : I(E, D, te, ae, Y, me, be, he, j);
  }, le = (w, E, D, te, ae, Y, me, be, he) => {
    let ve = 0;
    const re = E.length;
    let j = w.length - 1, ue = re - 1;
    for (; ve <= j && ve <= ue; ) {
      const we = w[ve], ke = E[ve] = he ? dl(E[ve]) : Ln(E[ve]);
      if (vl(we, ke)) _(we, ke, D, null, ae, Y, me, be, he);
      else break;
      ve++;
    }
    for (; ve <= j && ve <= ue; ) {
      const we = w[j], ke = E[ue] = he ? dl(E[ue]) : Ln(E[ue]);
      if (vl(we, ke)) _(we, ke, D, null, ae, Y, me, be, he);
      else break;
      j--, ue--;
    }
    if (ve > j) {
      if (ve <= ue) {
        const we = ue + 1, ke = we < re ? E[we].el : te;
        for (; ve <= ue; ) _(null, E[ve] = he ? dl(E[ve]) : Ln(E[ve]), D, ke, ae, Y, me, be, he), ve++;
      }
    } else if (ve > ue) for (; ve <= j; ) T(w[ve], ae, Y, true), ve++;
    else {
      const we = ve, ke = ve, qe = /* @__PURE__ */ new Map();
      for (ve = ke; ve <= ue; ve++) {
        const Ce = E[ve] = he ? dl(E[ve]) : Ln(E[ve]);
      ...
      for (ve = we; ve <= j; ve++) {
        ...
        Oe === void 0 ? T(Ce, ae, Y, true) : (ie[Oe - ke] = ve + 1, Oe >= pe ? pe = Oe : se = true, _(Ce, E[Oe], D, null, ae, Y, me, be, he), He++);
      }
      const _e = se ? G0(ie) : ca;
      for (Me = _e.length - 1, ve = Ve - 1; ve >= 0; ve--) {
        const Ce = ke + ve, Oe = E[Ce], Ae = Ce + 1 < re ? E[Ce + 1].el : te;
        ie[ve] === 0 ? _(null, Oe, D, Ae, ae, Y, me, be, he) : se && (Me < 0 || ve !== _e[Me] ? Q(Oe, D, Ae, 2) : Me--);
      }
    }
  }, Q = (w, E, D, te, ae = null) => {
    const { el: Y, type: me, transition: be, children: he, shapeFlag: ve } = w;
    if (ve & 6) {
      Q(w.component.subTree, E, D, te);
      return;
    }
    if (ve & 128) {
      w.suspense.move(E, D, te);
      return;
    }
    if (ve & 64) {
      me.move(w, E, D, oe);
    ...
    if (me === rn) {
      l(Y, E, D);
      for (let j = 0; j < he.length; j++) Q(he[j], E, D, te);
      l(w.anchor, E, D);
      return;
    }
    if (me === Ti) {
    ...
    if (te !== 2 && ve & 1 && be) if (te === 0) be.beforeEnter(Y), l(Y, E, D), Bt(() => be.enter(Y), ae);
    else {
  ...
  }, T = (w, E, D, te = false, ae = false) => {
    const { type: Y, props: me, ref: be, children: he, dynamicChildren: ve, shapeFlag: re, patchFlag: j, dirs: ue, cacheIndex: we } = w;
    if (j === -2 && (ae = false), be != null && go(be, null, D, w, true), we != null && (E.renderCache[we] = void 0), re & 256) {
      E.ctx.deactivate(w);
      return;
    }
    const ke = re & 1 && ue, qe = !va(w);
    let Me;
    if (qe && (Me = me && me.onVnodeBeforeUnmount) && vn(Me, E, w), re & 6) ce(w.component, D, te);
    else {
      if (re & 128) {
        w.suspense.unmount(D, te);
        return;
      }
      ke && kl(w, null, E, "beforeUnmount"), re & 64 ? w.type.remove(w, E, D, oe, te) : ve && !ve.hasOnce && (Y !== rn || j > 0 && j & 64) ? P(ve, E, D, false, true) : (Y === rn && j & 384 || !ae && re & 16) && P(he, E, D), te && Z(w);
    }
    (qe && (Me = me && me.onVnodeUnmounted) || ke) && Bt(() => {
      Me && vn(Me, E, w), ke && kl(w, null, E, "unmounted");
    }, D);
  }, Z = (w) => {
    const { type: E, el: D, anchor: te, transition: ae } = w;
    if (E === rn) {
      G(D, te);
      return;
    }
    ...
    if (w.shapeFlag & 1 && ae && !ae.persisted) {
      const { leave: me, delayLeave: be } = ae, he = () => me(D, Y);
      be ? be(w.el, Y, he) : he();
    } else Y();
  }, G = (w, E) => {
    let D;
    for (; w !== E; ) D = m(w), a(w), w = D;
    a(E);
  }, ce = (w, E, D) => {
    const { bum: te, scope: ae, job: Y, subTree: me, um: be, m: he, a: ve } = w;
    yo(he), yo(ve), te && Za(te), ae.stop(), Y && (Y.flags |= 8, T(me, w, E, D)), be && Bt(be, E), Bt(() => {
      w.isUnmounted = true;
    }, E), E && E.pendingBranch && !E.isUnmounted && w.asyncDep && !w.asyncResolved && w.suspenseId === E.pendingId && (E.deps--, E.deps === 0 && E.resolve());
  }, P = (w, E, D, te = false, ae = false, Y = 0) => {
    for (let me = Y; me < w.length; me++) T(w[me], E, D, te, ae);
  }, M = (w) => {
    if (w.shapeFlag & 6) return M(w.component.subTree);
    if (w.shapeFlag & 128) return w.suspense.next();
    const E = m(w.anchor || w.el), D = E && E[av];
    return D ? m(D) : E;
  };
  let ee = false;
  const O = (w, E, D) => {
    w == null ? E._vnode && T(E._vnode, null, null, true) : _(E._vnode || null, w, E, null, null, null, D), E._vnode = w, ee || (ee = true, nc(), tv(), ee = false);
  }, oe = { p: _, um: T, m: Q, r: Z, mt: C, mc: I, pc: F, pbc: $, n: M, o: e };
...
function Rv(e, t, n = mt) {
  ...
  if (br) {
    if (r === "sync") {
      ...
      return h.stop = Fn, h.resume = Fn, h.pause = Fn, h;
    }
  }
  const s = Ht;
...
function vc(e) {
  const { type: t, vnode: n, proxy: l, withProxy: a, propsOptions: [r], slots: o, attrs: i, emit: u, render: c, renderCache: s, props: f, data: m, setupState: h, ctx: g, inheritAttrs: _ } = e, S = ho(e);
  let k, p;
  try {
    if (n.shapeFlag & 4) {
      const b = a || l, x = b;
      k = Ln(c.call(x, b, s, f, h, m, g)), p = i;
    } else {
      const b = t;
      k = Ln(b.length > 1 ? b(f, { attrs: i, slots: o, emit: u }) : b(f, null)), p = t.props ? i : nb(i);
    }
  } catch (b) {
...
function Gn(e, t = null, n = null, l = 0, a = null, r = e === rn ? 0 : 1, o = false, i = false) {
...
function gc(e = "", t = false) {
  return t ? (Yn(), Ll(Zt, null, e)) : Je(Zt, null, e);
}
function Ln(e) {
...
const zv = xu ? (e) => xu.createHTML(e) : (e) => e, wb = "http://www.w3.org/2000/svg", Sb = "http://www.w3.org/1998/Math/MathML", Qn = typeof document < "u" ? document : null, _c = Qn && Qn.createElement("template"), xb = { insert: (e, t, n) => {
...
function Nv(e) {
  ...
  const { name: n = "v", type: l, duration: a, enterFromClass: r = `${n}-enter-from`, enterActiveClass: o = `${n}-enter-active`, enterToClass: i = `${n}-enter-to`, appearFromClass: u = r, appearActiveClass: c = o, appearToClass: s = i, leaveFromClass: f = `${n}-leave-from`, leaveActiveClass: m = `${n}-leave-active`, leaveToClass: h = `${n}-leave-to` } = e, g = kb(a), _ = g && g[0], S = g && g[1], { onBeforeEnter: k, onEnter: p, onEnterCancelled: y, onLeave: b, onLeaveCancelled: x, onBeforeAppear: R = k, onAppear: B = p, onAppearCancelled: I = y } = t, L = (q, A, C, N) => {
    q._enterCancelled = N, il(q, A ? s : i), il(q, A ? c : o), C && C();
  }, $ = (q, A) => {
    q._isLeaving = false, il(q, f), il(q, h), il(q, m), A && A();
  }, z = (q) => (A, C) => {
    const N = q ? B : p, U = () => L(A, q, C);
    Tl(N, [A, U]), Sc(() => {
      il(A, q ? u : r), $n(A, q ? s : i), wc(N) || xc(A, l, _, U);
    });
  };
...
var Cy = ge({ name: "QAjaxBar", props: { position: { type: String, default: "top", validator: (e) => py.includes(e) }, size: { type: String, default: "2px" }, color: String, skipHijack: Boolean, reverse: Boolean, hijackFilter: Function }, emits: ["start", "stop"], setup(e, { emit: t }) {
  ...
  }), Object.assign(n, { start: g, stop: S, increment: _ }), () => d("div", { class: c.value, style: m.value, ...h.value });
...
function ai({ fallbackTag: e, useDisableForRouterLinkProps: t = true } = {}) {
  ...
  }), _ = v(() => s.value === true && g.value !== -1 && By(a.$route.params, c.value.params)), S = v(() => _.value === true && g.value === a.$route.matched.length - 1 && Oy(a.$route.params, c.value.params)), k = v(() => s.value === true ? S.value === true ? ` ${l.exactActiveClass} ${l.activeClass}` : l.exact === true ? "" : _.value === true ? ` ${l.activeClass}` : "" : "");
  function p(x) {
    try {
  ...
  return { hasRouterLink: s, hasHrefLink: i, hasLink: f, linkTag: m, resolvedLink: c, linkIsActive: _, linkIsExactActive: S, linkClass: k, linkAttrs: h, getLink: p, navigateToRouterLink: y, navigateOnClick: b };
}
...
function Kc(e, t, n, l) {
  ...
  r = r === true || l === true;
  const o = document.createElement("span"), i = document.createElement("span"), u = en(e), { left: c, top: s, width: f, height: m } = t.getBoundingClientRect(), h = Math.sqrt(f * f + m * m), g = h / 2, _ = `${(f - h) / 2}px`, S = r ? _ : `${u.left - c - g}px`, k = `${(m - h) / 2}px`, p = r ? k : `${u.top - s - g}px`;
...
var { passiveCapture: fn } = dt, Jl = null, ea = null, ta = null, Ze = ge({ name: "QBtn", props: { ...Ny, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: n }) {
  ...
  function L(C) {
    m.value !== null && (n("touchstart", C), C.defaultPrevented !== true && (Jl !== m.value && (Jl !== null && q(), Jl = m.value, g = C.target, g.addEventListener("touchcancel", z, fn), g.addEventListener("touchend", z, fn)), _ = true, S !== null && clearTimeout(S), S = setTimeout(() => {
      S = null, _ = false;
    }, 200)));
  }
  function $(C) {
    m.value !== null && (C.qSkipRipple = _ === true, n("mousedown", C), C.defaultPrevented !== true && ta !== m.value && (ta !== null && q(), ta = m.value, m.value.classList.add("q-btn--active"), document.addEventListener("mouseup", z, fn)));
  }
  function z(C) {
    if (m.value !== null && !((C == null ? void 0 : C.type) === "blur" && document.activeElement === m.value)) {
      if ((C == null ? void 0 : C.type) === "keyup") {
        if (ea === m.value && yn(C, [13, 32]) === true) {
          ...
          N.qKeyEvent = true, C.defaultPrevented === true && Vt(N), C.cancelBubble === true && wt(N), m.value.dispatchEvent(N), je(C), C.qKeyEvent = true;
        }
        n("keyup", C);
      }
      q();
...
function Ts(e, t = 0) {
  ...
  const { offsetWidth: _, offsetHeight: S } = n, { elWidth: k, elHeight: p } = u === true || c === true ? { elWidth: Math.max(g.width, _), elHeight: c === true ? Math.max(g.height, S) : S } : { elWidth: _, elHeight: S };
...
var ui = ge({ name: "QMenu", inheritAttrs: false, props: { ...km, ...Aa, ...nt, ...Il, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noEscDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: $o }, self: { type: String, validator: $o }, offset: { type: Array, validator: Fm }, scrollTarget: Xl, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...Ra, "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  let a = null, r, o, i;
  const u = Se(), { proxy: c } = u, { $q: s } = c, f = K(null), m = K(false), h = v(() => e.persistent !== true && e.noRouteDismiss !== true), g = lt(e, s), { registerTick: _, removeTick: S } = ya(), { registerTimeout: k } = Zn(), { transitionProps: p, transitionStyle: y } = oi(e), { localScrollTarget: b, changeScrollEvent: x, unconfigureScrollTarget: R } = qm(e, Z), { anchorEl: B, canShow: I } = Cs({ showing: m }), { hide: L } = $a({ showing: m, canShow: I, handleShow: le, handleHide: Q, hideOnRouteChange: h, processOnMount: true }), { showPortal: $, hidePortal: z, renderPortal: q } = qs(u, f, ee, "menu"), A = { anchorEl: B, innerRef: f, onClickOutside(O) {
    if (e.persistent !== true && m.value === true) return L(O), (O.type === "touchstart" || O.target.classList.contains("q-dialog__backdrop")) && je(O), true;
  } }, C = v(() => Po(e.anchor || (e.cover === true ? "center middle" : "bottom start"), s.lang.rtl)), N = v(() => e.cover === true ? C.value : Po(e.self || "top start", s.lang.rtl)), U = v(() => (e.square === true ? " q-menu--square" : "") + (g.value === true ? " q-menu--dark q-dark" : "")), W = v(() => e.autoClose === true ? { onClick: G } : {}), F = v(() => m.value === true && e.persistent !== true);
  ye(F, (O) => {
  ...
  function le(O) {
    if (a = e.noRefocus === false ? document.activeElement : null, Lm(ce), $(), Z(), r = void 0, O !== void 0 && (e.touchPosition || e.contextMenu)) {
      const oe = en(O);
      if (oe.left !== void 0) {
        const { top: ne, left: w } = B.value.getBoundingClientRect();
        r = { left: oe.left - w, top: oe.top - ne };
      }
    }
    o === void 0 && (o = ye(() => s.screen.width + "|" + s.screen.height + "|" + e.self + "|" + e.anchor + "|" + s.lang.rtl, M)), e.noFocus !== true && document.activeElement.blur(), _(() => {
      M(), e.noFocus !== true && H();
    }), k(() => {
  ...
  function Z() {
    (B.value !== null || e.scrollTarget !== void 0) && (b.value = Vn(B.value, e.scrollTarget), x(b.value, M));
  }
  function G(O) {
    i !== true ? (Mm(c, O), n("click", O)) : i = false;
  }
  function ce(O) {
    F.value === true && e.noFocus !== true && pm(f.value, O.target) !== true && H();
  }
  function P(O) {
    e.noEscDismiss !== true && (n("escapeKey"), L(O));
  }
  function M() {
    Ts({ targetEl: f.value, offset: e.offset, anchorEl: B.value, anchorOrigin: C.value, selfOrigin: N.value, absoluteOffset: r, fit: e.fit, cover: e.cover, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function ee() {
  ...
  return Ke(T), Object.assign(c, { focus: H, updatePosition: M }), q;
...
ge({ name: "QBtnToggle", props: { ...wn, modelValue: { required: true }, options: { type: Array, required: true, validator: (e) => e.every((t) => ("label" in t || "icon" in t || "slot" in t) && "value" in t) }, color: String, textColor: String, toggleColor: { type: String, default: "primary" }, toggleTextColor: String, outline: Boolean, flat: Boolean, unelevated: Boolean, rounded: Boolean, push: Boolean, glossy: Boolean, size: String, padding: String, noCaps: Boolean, noWrap: Boolean, dense: Boolean, readonly: Boolean, disable: Boolean, stack: Boolean, stretch: Boolean, spread: Boolean, clearable: Boolean, ripple: { type: [Boolean, Object], default: true } }, emits: ["update:modelValue", "clear", "click"], setup(e, { slots: t, emit: n }) {
  const l = v(() => e.options.find((m) => m.value === e.modelValue) !== void 0), a = v(() => ({ type: "hidden", name: e.name, value: e.modelValue })), r = Cl(a), o = v(() => Sm(e)), i = v(() => ({ rounded: e.rounded, dense: e.dense, ...o.value })), u = v(() => e.options.map((m, h) => {
    const { attrs: g, value: _, slot: S, ...k } = m;
    return { slot: S, props: { key: h, "aria-pressed": _ === e.modelValue ? "true" : "false", ...g, ...k, ...i.value, disable: e.disable === true || k.disable === true, color: _ === e.modelValue ? s(k, "toggleColor") : s(k, "color"), textColor: _ === e.modelValue ? s(k, "toggleTextColor") : s(k, "textColor"), noCaps: s(k, "noCaps") === true, noWrap: s(k, "noWrap") === true, size: s(k, "size"), padding: s(k, "padding"), ripple: s(k, "ripple"), stack: s(k, "stack") === true, stretch: s(k, "stretch") === true, onClick(p) {
      c(_, m, p);
    } } };
  }));
  function c(m, h, g) {
...
function Ps() {
  ...
  function c(C) {
    ...
    I((n.$q.lang.rtl === true ? -1 : 1) * (C.direction === N ? 1 : -1));
  }
  const s = v(() => [[hp, c, void 0, { horizontal: e.vertical !== true, vertical: e.vertical, mouse: true }]]), f = v(() => e.transitionPrev || `slide-${e.vertical === true ? "down" : "right"}`), m = v(() => e.transitionNext || `slide-${e.vertical === true ? "up" : "left"}`), h = v(() => `--q-transition-duration: ${e.transitionDuration}ms`), g = v(() => typeof e.modelValue == "string" || typeof e.modelValue == "number" ? e.modelValue : String(e.modelValue)), _ = v(() => ({ include: e.keepAliveInclude, exclude: e.keepAliveExclude, max: e.keepAliveMax })), S = v(() => e.keepAliveInclude !== void 0 || e.keepAliveExclude !== void 0);
  ye(() => e.modelValue, (C, N) => {
    const U = b(C) === true ? x(C) : -1;
    o !== true && B(U === -1 ? 0 : U < x(N) ? -1 : 1), u.value !== U && (u.value = U, t("beforeTransition", C, N), a(() => {
      t("transition", C, N);
    }, e.transitionDuration));
  });
  function k() {
  ...
  function x(C) {
    return r.findIndex((N) => N.props.name === C && N.props.disable !== "" && N.props.disable !== true);
  }
  function R() {
  ...
  function I(C, N = u.value) {
    ...
    e.infinite === true && r.length !== 0 && N !== -1 && N !== r.length && I(C, C === -1 ? r.length : -1);
  }
  function L() {
  ...
  function $() {
    ...
    return e.keepAlive === true ? [d(mv, _.value, [d(S.value === true ? l(g.value, () => ({ ...td, name: g.value })) : td, { key: g.value, style: h.value }, () => C)])] : [d("div", { class: "q-panel scroll", style: h.value, key: g.value, role: "tabpanel" }, [C])];
  }
  function z() {
    if (r.length !== 0) return e.animated === true ? [d(Ft, { name: i.value }, $)] : $();
  }
  function q(C) {
    return r = _s(Pe(C.default, [])).filter((N) => N.props !== null && N.props.slot === void 0 && b(N.props.name) === true), r.length;
  }
  function A() {
    return r;
  }
  return Object.assign(n, { next: k, previous: p, goTo: y }), { panelIndex: u, panelDirectives: s, updatePanelsList: q, updatePanelIndex: L, getPanelContent: z, getEnabledPanels: R, getPanels: A, isValidPanelName: b, keepAliveProps: _, needsUniqueKeepAliveWrapper: S, goToPanelByOffset: I, goToPanel: y, nextPanel: k, previousPanel: p };
}
...
ge({ name: "QCarousel", props: { ...nt, ...Rs, ...Ls, transitionPrev: { type: String, default: "fade" }, transitionNext: { type: String, default: "fade" }, height: String, padding: Boolean, controlColor: String, controlTextColor: String, controlType: { type: String, validator: (e) => bp.includes(e), default: "flat" }, autoplay: [Number, Boolean], arrows: Boolean, prevIcon: String, nextIcon: String, navigation: Boolean, navigationPosition: { type: String, validator: (e) => gp.includes(e) }, navigationIcon: String, navigationActiveIcon: String, thumbnails: Boolean }, emits: [...Bs, ...$s], setup(e, { slots: t }) {
  ...
  let a = null, r;
  const { updatePanelsList: o, getPanelContent: i, panelDirectives: u, goToPanel: c, previousPanel: s, nextPanel: f, getEnabledPanels: m, panelIndex: h } = Ps(), { inFullscreen: g } = Fs(), _ = v(() => g.value !== true && e.height !== void 0 ? { height: e.height } : {}), S = v(() => e.vertical === true ? "vertical" : "horizontal"), k = v(() => e.navigationPosition || (e.vertical === true ? "right" : "bottom")), p = v(() => `q-carousel q-panel-parent q-carousel--with${e.padding === true ? "" : "out"}-padding` + (g.value === true ? " fullscreen" : "") + (l.value === true ? " q-carousel--dark q-dark" : "") + (e.arrows === true ? ` q-carousel--arrows-${S.value}` : "") + (e.navigation === true ? ` q-carousel--navigation-${k.value}` : "")), y = v(() => {
  ...
  function L() {
    ...
    if (e.navigation === true) {
      ...
      $.push(I("buttons", (A, C) => {
        const N = A.props.name, U = h.value === C;
        return z({ index: C, maxIndex: q, name: N, active: U, btnProps: { icon: U === true ? x.value : b.value, size: "sm", ...R.value }, onClick: () => {
          c(N);
        } });
      }));
...
function Nm(e, t) {
  ...
  }), g = v(() => m.value === true ? h.value !== -1 : Ge(n.modelValue) === Ge(n.trueValue)), _ = v(() => m.value === true ? h.value === -1 : Ge(n.modelValue) === Ge(n.falseValue)), S = v(() => g.value === false && _.value === false), k = v(() => n.disable === true ? -1 : n.tabindex || 0), p = v(() => `q-${e} cursor-pointer no-outline row inline no-wrap items-center` + (n.disable === true ? " disabled" : "") + (i.value === true ? ` q-${e}--dark` : "") + (n.dense === true ? ` q-${e}--dense` : "") + (n.leftLabel === true ? " reverse" : "")), y = v(() => {
...
var yp = () => d("div", { key: "svg", class: "q-checkbox__bg absolute" }, [d("svg", { class: "q-checkbox__svg fit absolute-full", viewBox: "0 0 24 24" }, [d("path", { class: "q-checkbox__truthy", fill: "none", d: "M1.73,12.91 8.1,19.28 22.79,4.59" }), d("path", { class: "q-checkbox__indet", d: "M4,14H20V10H4" })])]), ir = ge({ name: "QCheckbox", props: Im, emits: Dm, setup(e) {
  ...
  return () => {
    ...
    return c.value === true && Object.assign(S, f.value.chip, { onClick: h, onKeyup: m }), pn("div", S, _(), "ripple", e.ripple !== false && e.disable !== true, () => [[ri, e.ripple]]);
  };
  ...
  function m({ thickness: h, offset: g, color: _, cls: S, rounded: k }) {
    return d("circle", { class: "q-circular-progress__" + S + (_ !== void 0 ? ` text-${_}` : ""), style: r.value, fill: "transparent", stroke: "currentColor", "stroke-width": h, "stroke-dasharray": _p, "stroke-dashoffset": g, "stroke-linecap": k, cx: o.value, cy: o.value, r: Vu });
  }
  return () => {
    const h = [];
...
function Ym({ updateValue: e, updatePosition: t, getDragging: n, formAttrs: l }) {
  const { props: a, emit: r, slots: o, proxy: { $q: i } } = Se(), u = lt(a, i), c = Cl(l), s = K(false), f = K(false), m = K(false), h = K(false), g = v(() => a.vertical === true ? "--v" : "--h"), _ = v(() => "-" + (a.switchLabelSide === true ? "switched" : "standard")), S = v(() => a.vertical === true ? a.reverse === true : a.reverse !== (i.lang.rtl === true)), k = v(() => isNaN(a.innerMin) === true || a.innerMin < a.min ? a.min : a.innerMin), p = v(() => isNaN(a.innerMax) === true || a.innerMax > a.max ? a.max : a.innerMax), y = v(() => a.disable !== true && a.readonly !== true && k.value < p.value), b = v(() => {
    if (a.step === 0) return (_e) => _e;
    const ie = (String(a.step).trim().split(".")[1] || "").length;
    return (_e) => parseFloat(_e.toFixed(ie));
  }), x = v(() => a.step === 0 ? 1 : a.step), R = v(() => y.value === true ? a.tabindex || 0 : -1), B = v(() => a.max - a.min), I = v(() => p.value - k.value), L = v(() => ne(k.value)), $ = v(() => ne(p.value)), z = v(() => a.vertical === true ? S.value === true ? "bottom" : "top" : S.value === true ? "right" : "left"), q = v(() => a.vertical === true ? "height" : "width"), A = v(() => a.vertical === true ? "width" : "height"), C = v(() => a.vertical === true ? "vertical" : "horizontal"), N = v(() => {
  ...
  }), le = v(() => F("markers") + " absolute overflow-hidden"), Q = v(() => F("track-container")), T = v(() => W("pin")), Z = v(() => W("label")), G = v(() => W("text-container")), ce = v(() => W("marker-labels-container") + (a.markerLabelsClass !== void 0 ? ` ${a.markerLabelsClass}` : "")), P = v(() => "q-slider__track relative-position no-outline" + (a.trackColor !== void 0 ? ` bg-${a.trackColor}` : "")), M = v(() => {
  ...
  }), ae = v(() => a.markerLabels === false ? null : be(a.markerLabels).map((ie, _e) => ({ index: _e, value: ie.value, label: ie.label || ie.value, classes: te.value + (ie.classes !== void 0 ? " " + ie.classes : ""), style: { ...he(ie.value), ...ie.style || {} } }))), Y = v(() => ({ markerList: ae.value, markerMap: ve.value, classes: te.value, getStyle: he })), me = v(() => {
  ...
  function pe(ie, _e, Ce, Oe) {
    const Ae = [];
    a.innerTrackColor !== "transparent" && Ae.push(d("div", { key: "inner", class: ee.value, style: O.value })), a.selectionColor !== "transparent" && Ae.push(d("div", { key: "selection", class: H.value, style: ie.value })), a.markers !== false && Ae.push(d("div", { key: "marker", class: le.value, style: me.value })), Oe(Ae);
...
var Cp = () => ({}), na = ge({ name: "QSlider", props: { ...Km, modelValue: { required: true, default: null, validator: (e) => typeof e == "number" || e === null }, labelValue: [String, Number] }, emits: Wm, setup(e, { emit: t }) {
  const { proxy: { $q: n } } = Se(), { state: l, methods: a } = Ym({ updateValue: g, updatePosition: S, getDragging: _, formAttrs: $r(e) }), r = K(null), o = K(0), i = K(0);
  function u() {
...
var qp = ["left", "center", "right", "justify"], ad = ge({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => qp.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: n }) {
  const { proxy: l } = Se(), { $q: a } = l, { registerTick: r } = ya(), { registerTick: o } = ya(), { registerTick: i } = ya(), { registerTimeout: u, removeTimeout: c } = Zn(), { registerTimeout: s, removeTimeout: f } = Zn(), m = K(null), h = K(null), g = K(e.modelValue), _ = K(false), S = K(true), k = K(false), p = K(false), y = [], b = K(0), x = K(false);
  let R = null, B = null, I;
  ...
  function H(re) {
    ...
    _.value = we, we === true && o(T), p.value = j < parseInt(e.breakpoint, 10);
  }
  function le(re, j) {
    ...
    we && _.value === true && Q(we.rootRef.value);
  }
  function Q(re) {
  ...
  function T() {
    ...
    N.value === true ? (S.value = Math.ceil(ue + j.width) < re.scrollWidth - 1, k.value = ue > 0) : (S.value = ue > 0, k.value = e.vertical === true ? Math.ceil(ue + j.height) < re.scrollHeight : Math.ceil(ue + j.width) < re.scrollWidth);
  }
  function Z(re) {
  ...
  function M(re, j) {
    ...
    if (Me !== void 0) {
      const He = N.value === true ? -1 : 1, Ve = ue.indexOf(j) + Me * He;
      return Ve >= 0 && Ve < we && (Q(ue[Ve]), ue[Ve].focus({ preventScroll: true })), true;
    }
  }
  const ee = v(() => U.value === true ? { get: (re) => Math.abs(re.scrollLeft), set: (re, j) => {
    re.scrollLeft = -j;
  ...
  function O(re) {
    const j = h.value, { get: ue, set: we } = ee.value;
  ...
  function w(re) {
    if (c(), x.value !== true && m.value !== null && re.target && typeof re.target.closest == "function") {
      ...
      j && m.value.contains(j) === true && (x.value = true, _.value === true && Q(j));
    }
  }
  function E() {
    u(() => {
  ...
  function D() {
    me.avoidRouteWatcher === false ? s(ne) : f();
  }
  function te() {
    if (I === void 0) {
  ...
  function ae(re) {
    ...
    }) : (te(), re.routeData.hasRouterLink.value === true && D());
  }
  function Y(re) {
...
ge({ name: "QColor", props: { ...nt, ...wn, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function z(w, E) {
    m.value.hex = ud(w), m.value.rgb = sd(w), m.value.r = w.r, m.value.g = w.g, m.value.b = w.b, m.value.a = w.a;
    const D = m.value[_.value === true ? "hex" : "rgb"];
    t("update:modelValue", D), E === true && t("change", D);
  }
  function q(w) {
    const E = c.value !== void 0 ? c.value : e.formatModel === "auto" ? null : e.formatModel.indexOf("a") !== -1;
    if (typeof w != "string" || w.length === 0 || oo.anyColor(w.replace(/ /g, "")) !== true) return { h: 0, s: 0, v: 0, r: 0, g: 0, b: 0, a: E === true ? 100 : void 0, hex: void 0, rgb: void 0 };
    const D = nh(w);
  ...
  function A(w, E, D) {
    const te = o.value;
    if (te === null) return;
    const ae = te.clientWidth, Y = te.clientHeight, me = te.getBoundingClientRect();
    let be = Math.min(ae, Math.max(0, w - me.left));
  ...
  function C(w, E) {
    const D = Math.round(w), te = cd({ h: D, s: m.value.s, v: m.value.v, a: p.value === true ? m.value.a : void 0 });
    m.value.h = D, z(te, E);
  }
  function N(w) {
    C(w, true);
  }
  function U(w, E, D, te, ae) {
    if (te !== void 0 && wt(te), !/^[0-9]+$/.test(w)) {
      ae === true && n.$forceUpdate();
      return;
    }
    const Y = Math.floor(Number(w));
    if (Y < 0 || Y > D) {
      ae === true && n.$forceUpdate();
      return;
    }
    ...
    if (z(me, ae), ae !== true && (te == null ? void 0 : te.target.selectionEnd) !== void 0) {
      const be = te.target.selectionEnd;
      We(() => {
        te.target.setSelectionRange(be, be);
      });
    }
  }
  function W(w, E) {
    ...
    if (wt(w), s.value === "hex") {
      if (te.length !== (p.value === true ? 9 : 7) || !/^#[0-9A-Fa-f]+$/.test(te)) return true;
      D = th(te);
    } else {
      let Y;
      if (te.endsWith(")")) if (p.value !== true && te.startsWith("rgb(")) {
        if (Y = te.substring(4, te.length - 1).split(",").map((me) => parseInt(me, 10)), Y.length !== 3 || !/^rgb\([0-9]{1,3},[0-9]{1,3},[0-9]{1,3}\)$/.test(te)) return true;
      } else if (p.value === true && te.startsWith("rgba(")) {
    ...
    if (m.value.h = ae.h, m.value.s = ae.s, m.value.v = ae.v, z(D, E), E !== true) {
      const Y = w.target.selectionEnd;
      We(() => {
        w.target.setSelectionRange(Y, Y);
      });
    }
  }
  function F(w) {
    const E = q(w), D = { r: E.r, g: E.g, b: E.b, a: E.a };
    D.a === void 0 && (D.a = m.value.a), m.value.h = E.h, m.value.s = E.s, m.value.v = E.v, z(D, true);
  }
  function H(w) {
    w.isFinal ? A(w.position.left, w.position.top, true) : le(w);
  }
  const le = _m((w) => {
    A(w.position.left, w.position.top);
  }, 20);
  function Q(w) {
    A(w.pageX - window.pageXOffset, w.pageY - window.pageYOffset, true);
  }
  function T(w) {
    A(w.pageX - window.pageXOffset, w.pageY - window.pageYOffset);
  }
  function Z(w) {
    i.value !== null && (i.value.$el.style.opacity = w ? 1 : 0);
  }
  function G(w) {
    s.value = w;
  }
  function ce() {
    const w = [];
    return e.noHeaderTabs !== true && w.push(d(ad, { class: "q-color-picker__header-tabs", modelValue: s.value, dense: true, align: "justify", "onUpdate:modelValue": G }, () => [d(Va, { label: "HEX" + (p.value === true ? "A" : ""), name: "hex", ripple: false }), d(Va, { label: "RGB" + (p.value === true ? "A" : ""), name: "rgb", ripple: false })])), w.push(d("div", { class: "q-color-picker__header-banner row flex-center no-wrap" }, [d("input", { class: "fit", value: m.value[s.value], ...h.value !== true ? { readonly: true } : {}, ...r("topIn", { onInput: (E) => {
      Z(W(E) === true);
    }, onChange: wt, onBlur: (E) => {
      W(E, true) === true && n.$forceUpdate(), Z(false);
    } }) }), d(et, { ref: i, class: "q-color-picker__error-icon absolute no-pointer-events", name: l.iconSet.type.negative })])), d("div", { class: "q-color-picker__header relative-position overflow-hidden" }, [d("div", { class: "q-color-picker__header-bg absolute-full" }), d("div", { class: b.value, style: y.value }, w)]);
  }
  function P() {
    return d(Mp, { modelValue: f.value, animated: true }, () => [d(zi, { class: "q-color-picker__spectrum-tab overflow-hidden", name: "spectrum" }, O), d(zi, { class: "q-pa-md q-color-picker__tune-tab", name: "tune" }, oe), d(zi, { class: "q-color-picker__palette-tab", name: "palette" }, ne)]);
  }
  function M(w) {
    f.value = w;
  }
  ...
  function O() {
    const w = { ref: o, class: "q-color-picker__spectrum non-selectable relative-position cursor-pointer" + (h.value !== true ? " readonly" : ""), style: x.value, ...h.value === true ? { onClick: Q, onMousedown: T } : {} }, E = [d("div", { style: { paddingBottom: "100%" } }), d("div", { class: "q-color-picker__spectrum-white absolute-full" }), d("div", { class: "q-color-picker__spectrum-black absolute-full" }), d("div", { class: "absolute", style: R.value }, [m.value.hex !== void 0 ? d("div", { class: "q-color-picker__spectrum-circle" }) : null])], D = [d(na, { class: "q-color-picker__hue non-selectable", modelValue: m.value.h, min: 0, max: 360, trackSize: "8px", innerTrackColor: "transparent", selectionColor: "transparent", readonly: h.value !== true, thumbPath: dd, "onUpdate:modelValue": C, onChange: N })];
    return p.value === true && D.push(d(na, { class: "q-color-picker__alpha non-selectable", modelValue: m.value.a, min: 0, max: 100, trackSize: "8px", trackColor: "white", innerTrackColor: "transparent", selectionColor: "transparent", trackImg: $p, readonly: h.value !== true, hideSelection: true, thumbPath: dd, ...r("alphaSlide", { "onUpdate:modelValue": (te) => U(te, "a", 100), onChange: (te) => U(te, "a", 100, void 0, true) }) })), [pn("div", w, E, "spec", h.value, () => $.value), d("div", { class: "q-color-picker__sliders" }, D)];
  }
  function oe() {
    return [d("div", { class: "row items-center no-wrap" }, [d("div", "R"), d(na, { modelValue: m.value.r, min: 0, max: 255, color: "red", dark: a.value, readonly: h.value !== true, ...r("rSlide", { "onUpdate:modelValue": (w) => U(w, "r", 255), onChange: (w) => U(w, "r", 255, void 0, true) }) }), d("input", { value: m.value.r, maxlength: 3, readonly: h.value !== true, onChange: wt, ...r("rIn", { onInput: (w) => U(w.target.value, "r", 255, w), onBlur: (w) => U(w.target.value, "r", 255, w, true) }) })]), d("div", { class: "row items-center no-wrap" }, [d("div", "G"), d(na, { modelValue: m.value.g, min: 0, max: 255, color: "green", dark: a.value, readonly: h.value !== true, ...r("gSlide", { "onUpdate:modelValue": (w) => U(w, "g", 255), onChange: (w) => U(w, "g", 255, void 0, true) }) }), d("input", { value: m.value.g, maxlength: 3, readonly: h.value !== true, onChange: wt, ...r("gIn", { onInput: (w) => U(w.target.value, "g", 255, w), onBlur: (w) => U(w.target.value, "g", 255, w, true) }) })]), d("div", { class: "row items-center no-wrap" }, [d("div", "B"), d(na, { modelValue: m.value.b, min: 0, max: 255, color: "blue", readonly: h.value !== true, dark: a.value, ...r("bSlide", { "onUpdate:modelValue": (w) => U(w, "b", 255), onChange: (w) => U(w, "b", 255, void 0, true) }) }), d("input", { value: m.value.b, maxlength: 3, readonly: h.value !== true, onChange: wt, ...r("bIn", { onInput: (w) => U(w.target.value, "b", 255, w), onBlur: (w) => U(w.target.value, "b", 255, w, true) }) })]), p.value === true ? d("div", { class: "row items-center no-wrap" }, [d("div", "A"), d(na, { modelValue: m.value.a, color: "grey", readonly: h.value !== true, dark: a.value, ...r("aSlide", { "onUpdate:modelValue": (w) => U(w, "a", 100), onChange: (w) => U(w, "a", 100, void 0, true) }) }), d("input", { value: m.value.a, maxlength: 3, readonly: h.value !== true, onChange: wt, ...r("aIn", { onInput: (w) => U(w.target.value, "a", 100, w), onBlur: (w) => U(w.target.value, "a", 100, w, true) }) })]) : null];
  }
  function ne() {
    const w = (E) => d("div", { class: "q-color-picker__cube col-auto", style: { backgroundColor: E }, ...h.value === true ? r("palette#" + E, { onClick: () => {
      F(E);
    } }) : {} });
    return [d("div", { class: "row items-center q-color-picker__palette-rows" + (h.value === true ? " q-color-picker__palette-rows--editable" : "") }, B.value.map(w))];
  }
  return () => {
    const w = [P()];
    return e.name !== void 0 && e.disable !== true && k(w, "push"), e.noHeader !== true && w.unshift(ce()), e.noFooter !== true && w.push(ee()), d("div", { class: I.value, ...L.value }, w);
  };
} });
...
function ch(e, t, n = "days") {
  ...
  switch (n) {
    ...
    case "hours":
    case "hour":
      return Ur(Un(l, "hour"), Un(a, "hour"), zp);
    case "minutes":
    case "minute":
      return Ur(Un(l, "minute"), Un(a, "minute"), zu);
    case "seconds":
    case "second":
...
var Dn = 20, Hp = ["Calendar", "Years", "Months"], hd = (e) => Hp.includes(e), ji = (e) => /^-?[\d]+\/[0-1]\d$/.test(e), aa = " \u2014 ";
function al(e) {
...
ge({ name: "QDate", props: { ...Fo, ...wn, ...nt, modelValue: { required: true, validator: (e) => typeof e == "string" || Array.isArray(e) === true || Object(e) === e || e === null }, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { ...Fo.mask, default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: ji }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: ji }, navigationMaxYearMonth: { type: String, validator: ji }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: hd } }, emits: [...rh, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: n }) {
  ...
  let f;
  const m = $r(e), h = Cl(m), g = K(null), _ = K(He()), S = K(c()), k = v(() => He()), p = v(() => c()), y = v(() => s()), b = K(se(_.value, S.value)), x = K(e.defaultView), R = v(() => a.lang.rtl === true ? "right" : "left"), B = K(R.value), I = K(R.value), L = b.value.year, $ = K(L - L % Dn - (L < 0 ? Dn : 0)), z = K(null), q = v(() => {
  ...
  }), A = v(() => e.color || "primary"), C = v(() => e.textColor || "white"), N = v(() => e.emitImmediately === true && e.multiple !== true && e.range !== true), U = v(() => Array.isArray(e.modelValue) === true ? e.modelValue : e.modelValue !== null && e.modelValue !== void 0 ? [e.modelValue] : []), W = v(() => U.value.filter((V) => typeof V == "string").map((V) => Ve(V, _.value, S.value)).filter((V) => V.dateHash !== null && V.day !== null && V.month !== null && V.year !== null)), F = v(() => {
    const V = (X) => Ve(X, _.value, S.value);
  ...
  }), H = v(() => e.calendar !== "persian" ? (V) => new Date(V.year, V.month - 1, V.day) : (V) => {
    const X = fd(V.year, V.month, V.day);
    return new Date(X.gy, X.gm - 1, X.gd);
  }), le = v(() => e.calendar === "persian" ? jn : (V, X, fe) => dh(new Date(V.year, V.month - 1, V.day, V.hour, V.minute, V.second, V.millisecond), X === void 0 ? _.value : X, fe === void 0 ? S.value : fe, V.year, V.timezoneOffset)), Q = v(() => W.value.length + F.value.reduce((V, X) => V + 1 + ch(H.value(X.to), H.value(X.from)), 0)), T = v(() => {
    if (e.title !== void 0 && e.title !== null && e.title.length !== 0) return e.title;
    if (z.value !== null) {
      const fe = z.value.init, Te = H.value(fe);
  ...
  }), oe = v(() => typeof e.eventColor == "function" ? e.eventColor : () => e.eventColor), ne = v(() => {
    ...
    return ne.value !== null && ne.value.year >= b.value.year && (V.year.prev = false, ne.value.year === b.value.year && ne.value.month >= b.value.month && (V.month.prev = false)), w.value !== null && w.value.year <= b.value.year && (V.year.next = false, w.value.year === b.value.year && w.value.month <= b.value.month && (V.month.next = false)), V;
  }), D = v(() => {
    const V = {};
  ...
  ye(() => e.modelValue, (V) => {
    ...
    xe(V, S.value, "mask"), _.value = V;
  }), ye(p, (V) => {
    xe(_.value, V, "locale"), S.value = V;
  });
  function j(V) {
    f = JSON.stringify(V);
  }
  ...
  function Me(V, X) {
    ...
    z.value = { init: fe, initHash: jn(fe), final: Te, finalHash: jn(Te) }, qe(fe.year, fe.month);
  }
  function He() {
  ...
  function ie(V) {
    ...
    fe === 13 ? (fe = 1, X++) : fe === 0 && (fe = 12, X--), it(X, fe), N.value === true && jt("month");
  }
  function _e(V) {
    const X = Number(b.value.year) + V;
    it(X, b.value.month), N.value === true && jt("year");
  }
  function Ce(V) {
    it(V, b.value.month), x.value = e.defaultView === "Years" ? "Months" : "Calendar", N.value === true && jt("year");
  }
  function Oe(V) {
    it(b.value.year, V), x.value = "Calendar", N.value === true && jt("month");
  }
  function Ae(V, X) {
    var _a2;
    (((_a2 = D.value[X]) == null ? void 0 : _a2.includes(V.day)) === true ? de : zn)(V);
  }
  function Ye(V) {
    return { year: V.year, month: V.month, day: V.day };
  }
  function it(V, X, fe) {
    if (ne.value !== null && V <= ne.value.year && ((X < ne.value.month || V < ne.value.year) && (X = ne.value.month), V = ne.value.year), w.value !== null && V >= w.value.year && ((X > w.value.month || V > w.value.year) && (X = w.value.month), V = w.value.year), fe !== void 0) {
    ...
    Te !== b.value.dateHash && (B.value = b.value.dateHash < Te == (a.lang.rtl !== true) ? "left" : "right", V !== b.value.year && (I.value = B.value), We(() => {
      $.value = V - V % Dn - (V < 0 ? Dn : 0), Object.assign(b.value, { year: V, month: X, day: 1, dateHash: Te });
    }));
  }
  function Ct(V, X, fe) {
  ...
  function ln(V, X, fe) {
    return V.from !== void 0 ? { from: le.value(V.from, X, fe), to: le.value(V.to, X, fe) } : le.value(V, X, fe);
  }
  function zn(V) {
    let X;
    if (e.multiple === true) if (V.from !== void 0) {
      const fe = jn(V.from), Te = jn(V.to), Ee = W.value.filter((Le) => Le.dateHash < fe || Le.dateHash > Te), Xe = F.value.filter(({ from: Le, to: De }) => De.dateHash < fe || Le.dateHash > Te);
  ...
  const Ue = { Calendar: () => [d("div", { key: "calendar-view", class: "q-date__view q-date__calendar" }, [d("div", { class: "q-date__navigation row items-center no-wrap" }, Be({ label: S.value.months[b.value.month - 1], type: "Months", key: b.value.month, dir: B.value, goTo: ie, boundaries: E.value.month, cls: " col" }).concat(Be({ label: b.value.year, type: "Years", key: b.value.year, dir: I.value, goTo: _e, boundaries: E.value.year, cls: "" }))), d("div", { class: "q-date__calendar-weekdays row items-center no-wrap" }, ee.value.map((V) => d("div", { class: "q-date__calendar-item" }, [d("div", V)]))), d("div", { class: "q-date__calendar-days-container relative-position overflow-hidden" }, [d(Ft, { name: "q-transition--slide-" + B.value }, () => d("div", { key: Y.value, class: "q-date__calendar-days fit" }, ve.value.map((V) => d("div", { class: V.classes }, [V.in === true ? d(Ze, { class: V.today === true ? "q-date__today" : "", dense: true, flat: V.flat, unelevated: V.unelevated, color: V.color, textColor: V.textColor, label: V.i, tabindex: i.value, ...o("day#" + V.i, { onClick: () => {
    ...
    const V = $.value, X = V + Dn, fe = [], Te = (Ee) => ne.value !== null && ne.value.year > Ee || w.value !== null && w.value.year < Ee;
    ...
    return d("div", { class: "q-date__view q-date__years flex flex-center" }, [d("div", { class: "col-auto" }, [d(Ze, { round: true, dense: true, flat: true, icon: P.value[0], ariaLabel: a.lang.date.prevRangeYears(Dn), tabindex: i.value, disable: Te(V), ...o("y-", { onClick: () => {
      $.value -= Dn;
    } }) })]), d("div", { class: "q-date__years-content col self-stretch row items-center" }, fe), d("div", { class: "col-auto" }, [d(Ze, { round: true, dense: true, flat: true, icon: P.value[1], ariaLabel: a.lang.date.nextRangeYears(Dn), tabindex: i.value, disable: Te(X), ...o("y+", { onClick: () => {
      $.value += Dn;
    } }) })])]);
  } };
  function yt(V) {
    ...
    if (z.value === null) {
      ...
      const fe = z.value.initHash, Te = jn(X), Ee = fe <= Te ? { from: z.value.init, to: X } : { from: X, to: z.value.init };
      z.value = null, zn(fe === Te ? X : { target: X, ...Ee }), n("rangeEnd", { from: Ye(Ee.from), to: Ye(Ee.to) });
    }
  }
  function ht(V) {
    if (z.value !== null) {
      const X = { ...b.value, day: V };
      Object.assign(z.value, { final: X, finalHash: jn(X) });
    }
  }
...
var Kr = 0, Qp = { standard: "fixed-full flex-center", top: "fixed-top justify-center", bottom: "fixed-bottom justify-center", right: "fixed-right items-center", left: "fixed-left items-center" }, wd = { standard: ["scale", "scale"], top: ["slide-down", "slide-up"], bottom: ["slide-up", "slide-down"], right: ["slide-left", "slide-right"], left: ["slide-right", "slide-left"] }, ci = ge({ name: "QDialog", inheritAttrs: false, props: { ...Aa, ...Il, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, backdropFilter: String, position: { type: String, default: "standard", validator: (e) => ["standard", "top", "bottom", "left", "right"].includes(e) } }, emits: [...Ra, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  const m = v(() => e.persistent !== true && e.noRouteDismiss !== true && e.seamless !== true), { preventBodyScroll: h } = vh(), { registerTimeout: g } = Zn(), { registerTick: _, removeTick: S } = ya(), { transitionProps: k, transitionStyle: p } = oi(e, () => wd[e.position][0], () => wd[e.position][1]), y = v(() => p.value + (e.backdropFilter !== void 0 ? `;backdrop-filter:${e.backdropFilter};-webkit-backdrop-filter:${e.backdropFilter}` : "")), { showPortal: b, hidePortal: x, portalIsAccessible: R, renderPortal: B } = qs(a, r, ce, "dialog"), { hide: I } = $a({ showing: o, hideOnRouteChange: m, handleShow: N, handleHide: U, processOnMount: true }), { addToHistory: L, removeFromHistory: $ } = fh(o, I, m), z = v(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${e.maximized === true ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${Qp[e.position]}` + (i.value === true ? " q-dialog__inner--animating" : "") + (e.fullWidth === true ? " q-dialog__inner--fullwidth" : "") + (e.fullHeight === true ? " q-dialog__inner--fullheight" : "") + (e.square === true ? " q-dialog__inner--square" : "")), q = v(() => o.value === true && e.seamless !== true), A = v(() => e.autoClose === true ? { onClick: T } : {}), C = v(() => [`q-dialog fullscreen no-pointer-events q-dialog--${q.value === true ? "modal" : "seamless"}`, l.class]);
  ye(() => e.maximized, (P) => {
    o.value === true && Q(P);
  }), ye(q, (P) => {
    h(P), P === true ? (Lm(G), $m(H)) : (Fu(G), Mo(H));
  });
  function N(P) {
    var _a2;
    L(), c = e.noRefocus === false && document.activeElement !== null ? document.activeElement : null, Q(e.maximized), b(), i.value = true, e.noFocus !== true ? ((_a2 = document.activeElement) == null ? void 0 : _a2.blur(), _(W)) : S(), g(() => {
      if (a.proxy.$q.platform.is.ios === true) {
        if (e.seamless !== true && document.activeElement) {
          const { top: M, bottom: ee } = document.activeElement.getBoundingClientRect(), { innerHeight: O } = window, oe = window.visualViewport !== void 0 ? window.visualViewport.height : O;
          M > 0 && ee > oe / 2 && (document.scrollingElement.scrollTop = Math.min(document.scrollingElement.scrollHeight - oe, ee >= O ? 1 / 0 : Math.ceil(document.scrollingElement.scrollTop + ee - oe / 2))), document.activeElement.scrollIntoView();
        }
  ...
  function U(P) {
    S(), $(), le(true), i.value = true, x(), c !== null && ((((P == null ? void 0 : P.type.indexOf("key")) === 0 ? c.closest('[tabindex]:not([tabindex^="-"])') : void 0) || c).focus(), c = null), g(() => {
  ...
  function le(P) {
    u !== null && (clearTimeout(u), u = null), (P === true || o.value === true) && (Q(false), e.seamless !== true && (h(false), Fu(G), Mo(H))), P !== true && (c = null);
  }
  function Q(P) {
  ...
  let f, m = null, h;
  const g = K(e.behavior === "mobile" || e.behavior !== "desktop" && s.totalWidth.value <= e.breakpoint), _ = v(() => e.mini === true && g.value !== true), S = v(() => _.value === true ? e.miniWidth : e.width), k = K(e.showIfAbove === true && g.value === false ? true : e.modelValue === true), p = v(() => e.persistent !== true && (g.value === true || le.value === true));
  function y(j, ue) {
    ...
    } else D(0), j !== false && te(false);
    u(() => {
      j !== false && te(true), ue !== true && n("show", j);
    }, Sd);
  }
  function b(j, ue) {
  ...
  const { show: x, hide: R } = $a({ showing: k, hideOnRouteChange: p, handleShow: y, handleHide: b }), { addToHistory: B, removeFromHistory: I } = fh(k, R, p), L = { belowBreakpoint: g, hide: R }, $ = v(() => e.side === "right"), z = v(() => (r.lang.rtl === true ? -1 : 1) * ($.value === true ? 1 : -1)), q = K(0), A = K(false), C = K(false), N = K(S.value * z.value), U = v(() => $.value === true ? "left" : "right"), W = v(() => k.value === true && g.value === false && e.overlay === false ? e.miniToOverlay === true ? e.miniWidth : S.value : 0), F = v(() => e.overlay === true || e.miniToOverlay === true || s.view.value.indexOf($.value ? "R" : "L") !== -1 || r.platform.is.ios === true && s.isContainer.value === true), H = v(() => e.overlay === false && k.value === true && g.value === false), le = v(() => e.overlay === true && k.value === true && g.value === false), Q = v(() => "fullscreen q-drawer__backdrop" + (k.value === false && A.value === false ? " hidden" : "")), T = v(() => ({ backgroundColor: `rgba(0,0,0,${q.value * 0.4})` })), Z = v(() => $.value === true ? s.rows.value.top[2] === "r" : s.rows.value.top[0] === "l"), G = v(() => $.value === true ? s.rows.value.bottom[2] === "r" : s.rows.value.bottom[0] === "l"), ce = v(() => {
    const j = {};
    ...
    const j = { width: `${S.value}px`, transform: `translateX(${N.value}px)` };
    return g.value === true ? j : Object.assign(j, ce.value);
  }), M = v(() => "q-drawer__content fit " + (s.isContainer.value !== true ? "scroll" : "overflow-auto")), ee = v(() => `q-drawer q-drawer--${e.side}` + (C.value === true ? " q-drawer--mini-animate" : "") + (e.bordered === true ? " q-drawer--bordered" : "") + (o.value === true ? " q-drawer--dark q-dark" : "") + (A.value === true ? " no-transition" : k.value === true ? "" : " q-layout--prevent-focus") + (g.value === true ? " fixed q-drawer--on-top q-drawer--mobile q-drawer--top-padding" : ` q-drawer--${_.value === true ? "mini" : "standard"}` + (F.value === true || H.value !== true ? " fixed" : "") + (e.overlay === true || e.miniToOverlay === true ? " q-drawer--on-top" : "") + (Z.value === true ? " q-drawer--top-padding" : ""))), O = v(() => {
  ...
  ye(g, (j) => {
    ...
    s.instances[ue] === L && (s.instances[ue] = void 0, s[ue].space = false, s[ue].offset = 0), s.instances[j] = L, s[j].size = S.value, s[j].space = H.value, s[j].offset = W.value;
  }), ye(s.totalWidth, () => {
    (s.isContainer.value === true || document.qScrollPrevented !== true) && w();
  }), ye(() => e.behavior + e.breakpoint, w), ye(s.isContainer, (j) => {
    k.value === true && i(j !== true), j === true && w();
  }), ye(s.scrollbarWidth, () => {
  ...
  function E(j) {
    ...
    }) : (s.isContainer.value === true && $.value === true && (g.value === true || Math.abs(j) === S.value) && (j += z.value * s.scrollbarWidth.value), N.value = j);
  }
  function D(j) {
    q.value = j;
  }
  ...
  return s.instances[e.side] = L, re(e.miniToOverlay, S.value), he("space", H.value), he("offset", W.value), e.showIfAbove === true && e.modelValue !== true && k.value === true && e["onUpdate:modelValue"] !== void 0 && n("update:modelValue", true), ft(() => {
    ...
    const j = [];
    g.value === true && (e.noSwipeOpen === false && j.push(sn(d("div", { key: "open", class: `q-drawer__opener fixed-${e.side}`, "aria-hidden": "true" }), O.value)), j.push(pn("div", { ref: "backdrop", class: Q.value, style: T.value, "aria-hidden": "true", onClick: R }, void 0, "backdrop", e.noSwipeBackdrop !== true && k.value === true, () => ne.value)));
    const ue = _.value === true && t.mini !== void 0, we = [d("div", { ...l, key: "" + ue, class: [M.value, l.class] }, ue === true ? t.mini() : Pe(t.default))];
    return e.elevated === true && k.value === true && we.push(d("div", { class: "q-layout__shadow absolute-full overflow-hidden no-pointer-events" })), j.push(pn("aside", { ref: "content", class: ee.value, style: P.value }, we, "contentclose", e.noSwipeClose !== true && g.value === true, () => oe.value)), d("div", { class: "q-drawer-container" }, j);
  };
} });
function mh(e, t) {
...
var Kp = /^https?:\/\//, Wp = class {
  ...
  let a, r;
  const o = Se(), { proxy: { $q: i } } = o, u = K(null), c = K(false), s = v(() => Po(e.anchor, i.lang.rtl)), f = v(() => Po(e.self, i.lang.rtl)), m = v(() => e.persistent !== true), { registerTick: h, removeTick: g } = ya(), { registerTimeout: _ } = Zn(), { transitionProps: S, transitionStyle: k } = oi(e), { localScrollTarget: p, changeScrollEvent: y, unconfigureScrollTarget: b } = qm(e, le), { anchorEl: x, canShow: R, anchorEvents: B } = Cs({ showing: c, configureAnchorEl: H }), { show: I, hide: L } = $a({ showing: c, canShow: R, handleShow: A, handleHide: C, hideOnRouteChange: m, processOnMount: true });
  ...
  function A(Z) {
    $(), h(() => {
      r = new MutationObserver(() => U()), r.observe(u.value, { attributes: false, childList: true, characterData: true, subtree: true }), U(), le();
    }), a === void 0 && (a = ye(() => i.screen.width + "|" + i.screen.height + "|" + e.self + "|" + e.anchor + "|" + i.lang.rtl, U)), _(() => {
      $(true), n("show", Z);
    }, e.transitionDuration);
  }
  function C(Z) {
  ...
  return Ke(N), Object.assign(o.proxy, { updatePosition: U }), q;
  ...
  return () => {
    const y = { ref: s, class: g.value, style: _.value, role: "listitem", onClick: S, onKeyup: k };
...
function Gp(e, t) {
  ...
  if (n) o = t.options.map((s) => {
    ...
    o = t.options.map((h) => {
      ...
      } }, () => [m === true ? null : d(mn, { class: _ ? s : f, side: true }, () => d(et, { name: h.icon !== null ? h.icon : void 0 })), d(mn, S ? () => d("div", { class: "text-no-wrap", innerHTML: h.htmlTip }) : h.tip ? () => d("div", { class: "text-no-wrap" }, h.tip) : void 0)]);
...
ge({ name: "QEditor", props: { ...nt, ...Ls, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => e.length === 0 || e.every((t) => t.length), default: () => [["left", "center", "right", "justify"], ["bold", "italic", "underline", "strike"], ["undo", "redo"]] }, toolbarColor: String, toolbarBg: String, toolbarTextColor: String, toolbarToggleColor: { type: String, default: "primary" }, toolbarOutline: Boolean, toolbarPush: Boolean, toolbarRounded: Boolean, paragraphTag: { type: String, validator: (e) => ["div", "p"].includes(e), default: "div" }, contentStyle: Object, contentClass: [Object, Array, String], square: Boolean, flat: Boolean, dense: Boolean }, emits: [...Bs, "update:modelValue", "keydown", "click", "focus", "blur", "dropdownShow", "dropdownHide", "dropdownBeforeShow", "dropdownBeforeHide", "linkShow", "linkHide"], setup(e, { slots: t, emit: n }) {
  ...
  const k = v(() => e.toolbarBg ? ` bg-${e.toolbarBg}` : ""), p = v(() => ({ type: "a", flat: e.toolbarOutline !== true && e.toolbarPush !== true, noWrap: true, outline: e.toolbarOutline, push: e.toolbarPush, rounded: e.toolbarRounded, dense: true, color: e.toolbarColor, disable: !h.value, size: "sm" })), y = v(() => {
    ...
    return e.toolbar.map((ee) => ee.map((O) => {
      if (O.options) return { type: "dropdown", icon: O.icon, label: O.label, size: "sm", dense: true, fixedLabel: O.fixedLabel, fixedIcon: O.fixedIcon, highlight: O.highlight, list: O.list, options: O.options.map((ne) => M[ne]) };
      const oe = M[O];
  ...
  function A(P) {
    ...
    const M = P.keyCode, ee = B.value[M];
    if (ee !== void 0) {
      const { cmd: O, param: oe } = ee;
      je(P), T(O, oe, false);
    }
  }
  function C(P) {
  ...
  function Q(P, M) {
    if (s.value !== null) {
      ...
      const ee = `inner${m.value === true ? "Text" : "HTML"}`;
      s.value[ee] = P, M === true && (x.caret.restorePosition(s.value[ee].length), Z());
    }
  }
  function T(P, M, ee = true) {
  ...
  return ft(() => {
    x.caret = l.caret = new Wp(s.value, x), Q(e.modelValue), Z(), document.addEventListener("selectionchange", le);
  }), Ke(() => {
    document.removeEventListener("selectionchange", le);
    ...
    return d("div", { ref: c, class: L.value, style: { height: o.value === true ? "100%" : null }, ...z.value, onFocusin: W, onFocusout: F }, [P, d("div", { ref: s, style: I.value, class: $.value, contenteditable: h.value, placeholder: e.placeholder, ...u.listeners.value, onInput: q, onKeydown: A, onClick: C, onBlur: N, onFocus: U, onMousedown: H, onTouchstartPassive: H })]);
  };
} });
var Du = ge({ name: "QItemLabel", props: { overline: Boolean, caption: Boolean, header: Boolean, lines: [Number, String] }, setup(e, { slots: t }) {
  ...
  function f(_, S, k) {
    S !== void 0 && (_.style.height = `${S}px`), _.style.transition = `height ${e.duration}ms cubic-bezier(.25, .8, .50, 1)`, l = true, a = k;
  }
  function m(_, S) {
  ...
  function h(_, S) {
    let k = 0;
    r = _, l === true ? (s(), k = _.offsetHeight === _.scrollHeight ? 0 : void 0) : (c = "hide", _.style.overflowY = "hidden"), f(_, k, S), o = setTimeout(() => {
  ...
  function g(_, S) {
    let k;
    r = _, l === true ? s() : (c = "show", _.style.overflowY = "hidden", k = _.scrollHeight), f(_, k, S), o = setTimeout(() => {
...
ge({ name: "QExpansionItem", props: { ...Ar, ...Aa, ...nt, icon: String, label: String, labelLines: [Number, String], caption: String, captionLines: [Number, String], dense: Boolean, toggleAriaLabel: String, expandIcon: String, expandedIcon: String, expandIconClass: [Array, String, Object], duration: {}, headerInsetLevel: Number, contentInsetLevel: Number, expandSeparator: Boolean, defaultOpened: Boolean, hideExpandIcon: Boolean, expandIconToggle: Boolean, switchToggleSide: Boolean, denseToggle: Boolean, group: String, popup: Boolean, headerStyle: [Array, String, Object], headerClass: [Array, String, Object] }, emits: [...Ra, "click", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  let f, m;
  const h = v(() => `q-expansion-item q-item-type q-expansion-item--${r.value === true ? "expanded" : "collapsed"} q-expansion-item--${e.popup === true ? "popup" : "standard"}`), g = v(() => e.contentInsetLevel === void 0 ? null : { ["padding" + (l.lang.rtl === true ? "Right" : "Left")]: e.contentInsetLevel * 56 + "px" }), _ = v(() => e.disable !== true && (e.href !== void 0 || e.to !== void 0 && e.to !== null && e.to !== "")), S = v(() => {
    const W = {};
    return l1.forEach((F) => {
      W[F] = e[F];
    }), W;
  ...
  function C() {
    ...
    return k.value === true && (W.clickable = true, W.onClick = R, Object.assign(W, _.value === true ? S.value : x.value)), d(Ca, W, A);
  }
  function N() {
  ...
  function U() {
    const W = [C(), d(Ds, { duration: e.duration, onShow: L, onHide: $ }, N)];
...
ge({ name: "QFab", props: { ...Nu, ...Aa, icon: String, activeIcon: String, hideIcon: Boolean, hideLabel: { ...Nu.hideLabel, default: null }, direction: { type: String, default: "right", validator: (e) => r1.includes(e) }, persistent: Boolean, verticalActionsAlign: { type: String, default: "center", validator: (e) => o1.includes(e) } }, emits: Ra, setup(e, { slots: t }) {
  ...
  function k() {
    const p = [];
    return e.hideIcon !== true && p.push(d("div", { class: _.value }, [S("icon", "icon"), S("active-icon", "activeIcon")])), (e.label !== "" || t.label !== void 0) && p[i.value.action](d("div", i.value.data, t.label !== void 0 ? t.label(f.value) : [e.label])), qt(t.tooltip, p);
  }
...
function mi(e) {
  ...
  e.hasValue === void 0 && (e.hasValue = v(() => Kl(t.modelValue))), e.emitValue === void 0 && (e.emitValue = (F) => {
    ...
    if (t.counter !== false) {
      const F = typeof t.modelValue == "string" || typeof t.modelValue == "number" ? ("" + t.modelValue).length : Array.isArray(t.modelValue) === true ? t.modelValue.length : 0, H = t.maxlength !== void 0 ? t.maxlength : t.maxValues;
      return F + (H !== void 0 ? " / " + H : "");
    }
  }));
  ...
  function R() {
    ...
    H && (F === null || F.id !== e.targetUid.value) && (H.hasAttribute("tabindex") === true || (H = H.querySelector("[tabindex]")), H !== F && (H == null ? void 0 : H.focus({ preventScroll: true })));
  }
  function B() {
    Pa(R);
  }
  ...
  function $(F, H) {
    i !== null && clearTimeout(i), i = setTimeout(() => {
      i = null, !(document.hasFocus() === true && (e.hasPopupOpen === true || e.controlRef === void 0 || e.controlRef.value === null || e.controlRef.value.contains(document.activeElement) !== false)) && (e.focused.value === true && (e.focused.value = false, n("blur", F)), H == null ? void 0 : H());
    });
  }
  function z(F) {
    var _a2;
  ...
  function N() {
    let F, H;
    s.value === true ? f.value !== null ? (F = [d("div", { role: "alert" }, f.value)], H = `q--slot-error-${f.value}`) : (F = Pe(l.error), H = "q--slot-error") : (t.hideHint !== true || e.focused.value === true) && (t.hint !== void 0 ? (F = [d("div", t.hint)], H = `q--slot-hint-${t.hint}`) : (F = Pe(l.hint), H = "q--slot-hint"));
    const le = t.counter === true || l.counter !== void 0;
    if (t.hideBottomSpace === true && le === false && F === void 0) return;
    const Q = d("div", { key: H, class: "q-field__messages col" }, F);
    return d("div", { class: "q-field__bottom row items-start q-field__bottom--" + (t.hideBottomSpace !== true ? "animated" : "stale"), onClick: Vt }, [t.hideBottomSpace === true ? Q : d(Ft, { name: "q-transition--field-message" }, () => Q), le === true ? d("div", { class: "q-field__counter" }, l.counter !== void 0 ? l.counter() : e.computedCounter.value) : null]);
  }
  function U(F, H) {
    return H === null ? null : d("div", { key: F, class: "q-field__append q-field__marginal row no-wrap items-center q-anchor--skip" }, H);
  }
  let W = false;
  return On(() => {
    W = true;
    ...
    const H = e.getControl === void 0 && l.control === void 0 ? { ...e.splitAttrs.attributes.value, "data-autofocus": t.autofocus === true || void 0, ...x.value } : x.value;
    return d(e.tag.value, { ref: e.rootRef, class: [S.value, a.class], style: a.style, ...H }, [l.before !== void 0 ? d("div", { class: "q-field__before q-field__marginal row no-wrap items-center", onClick: Vt }, l.before()) : null, d("div", { class: "q-field__inner relative-position col self-stretch" }, [d("div", { ref: e.controlRef, class: k.value, tabindex: -1, ...e.controlEvents }, A()), g.value === true ? N() : null]), l.after !== void 0 ? d("div", { class: "q-field__after q-field__marginal row no-wrap items-center", onClick: Vt }, l.after()) : null]);
  };
}
...
ge({ name: "QFile", inheritAttrs: false, props: { ...Sh, ...wn, ...xh, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...fi, ...Ch], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  function A(W, F) {
    const H = m(W, F, _.value, R.value), le = q();
    le != null && (le.value = ""), H !== void 0 && ((e.multiple === true ? e.modelValue && H.every((Q) => _.value.includes(Q)) : e.modelValue === H[0]) || L(R.value === true ? _.value.concat(H) : H));
  }
  function C() {
    return [d("input", { class: [e.inputClass, "q-file__filler"], style: e.inputStyle })];
  }
  function N() {
    if (t.file !== void 0) return _.value.length === 0 ? C() : _.value.map((F, H) => t.file({ index: H, file: F, ref: this }));
    if (t.selected !== void 0) return _.value.length === 0 ? C() : t.selected({ files: _.value, ref: this });
    if (e.useChips === true) return _.value.length === 0 ? C() : _.value.map((F, H) => d(Hm, { key: "file-" + H, removable: r.editable.value, dense: true, textColor: e.color, tabindex: e.tabindex, onRemove: () => {
      B(H);
  ...
  return Object.assign(r, { fieldClass: x, emitValue: L, hasValue: S, inputRef: o, innerValue: _, floatingLabel: v(() => S.value === true || Kl(e.displayValue)), computedCounter: v(() => {
    ...
    return r.editable.value === true && Object.assign(W, { onDragover: s, onDragleave: f, onKeydown: $, onKeyup: z }), d("div", W, [U()].concat(N()));
...
ge({ name: "QForm", props: { autofocus: Boolean, noErrorFocus: Boolean, noResetFocus: Boolean, greedy: Boolean, onSubmit: Function }, emits: ["reset", "validationSuccess", "validationError"], setup(e, { slots: t, emit: n }) {
  ...
  const o = [];
  function i(h) {
    const g = typeof h == "boolean" ? h : e.noErrorFocus !== true, _ = ++r, S = (y, b) => {
...
var m1 = ge({ name: "QHeader", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, revealOffset: { type: Number, default: 250 }, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: n }) {
  ...
  return a.instances.header = k, e.modelValue === true && h("size", r.value), h("space", e.modelValue), h("offset", u.value), Ke(() => {
    ...
    return e.elevated === true && p.push(d("div", { class: "q-layout__shadow absolute-full overflow-hidden no-pointer-events" })), p.push(d(Ul, { debounce: 0, onResize: _ })), d("header", { class: f.value, style: m.value, onFocusin: S }, p);
  };
...
ge({ name: "QImg", props: { ...Ns, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, loadingShowDelay: { type: [Number, String], default: 0 }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: h1 }, placeholderSrc: String, errorSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: n }) {
  const l = K(e.initialRatio), a = Hs(e, l), r = Se(), { registerTimeout: o, removeTimeout: i } = Zn(), { registerTimeout: u, removeTimeout: c } = Zn(), s = v(() => e.placeholderSrc !== void 0 ? { src: e.placeholderSrc } : null), f = v(() => e.errorSrc !== void 0 ? { src: e.errorSrc, __qerror: true } : null), m = [K(null), K(s.value)], h = K(0), g = K(false), _ = K(false), S = v(() => `q-img q-img--${e.noNativeMenu === true ? "no-" : ""}menu`), k = v(() => ({ width: e.width, height: e.height })), p = v(() => `q-img__image ${e.imgClass !== void 0 ? e.imgClass + " " : ""}q-img__image--with${e.noTransition === true ? "out" : ""}-transition q-img__image--`), y = v(() => ({ ...e.imgStyle, objectFit: e.fit, objectPosition: e.position }));
  function b() {
  ...
  }
  {
    let q = function() {
      ye(() => e.src || e.srcset || e.sizes ? { src: e.src, srcset: e.srcset, sizes: e.sizes } : null, (A) => {
        i(), _.value = false, A === null ? (x(), m[h.value ^ 1].value = s.value) : b(), m[h.value].value = A;
      }, { immediate: true });
    };
...
ge({ name: "QInfiniteScroll", props: { offset: { type: Number, default: 500 }, debounce: { type: [String, Number], default: 100 }, scrollTarget: Xl, initialIndex: { type: Number, default: 0 }, disable: Boolean, reverse: Boolean }, emits: ["load"], setup(e, { slots: t, emit: n }) {
  ...
  function S() {
    if (u && a.value === true && u.removeEventListener("scroll", c, Al), u = Vn(r.value, e.scrollTarget), a.value === true) {
  ...
  return Object.assign(R.proxy, { poll: () => {
    c == null ? void 0 : c();
  }, trigger: m, stop: _, reset: h, resume: g, setIndex: k, updateScrollTarget: S }), () => {
...
function y1(e, t, n, l) {
  ...
  ye(() => e.type + e.autogrow, _), ye(() => e.mask, (L) => {
    if (L !== void 0) S(f.value, true);
    else {
      const $ = B(f.value);
      _(), e.modelValue !== $ && t("update:modelValue", $);
    }
  ...
  function _() {
    ...
    let N = e.reverseFillMask === true, U = "", W = "";
    L.replace(g1, (Q, T, Z, G, ce) => {
      if (G !== void 0) {
        const P = Oo[G];
        C.push(P), W = P.negate, N === true && (A.push("(?:" + W + "+)?(" + P.pattern + "+)?(?:" + W + "+)?(" + P.pattern + "+)?"), N = false), A.push("(?:" + W + "+)?(" + P.pattern + ")?");
    ...
    const F = new RegExp("^" + q.join("") + "(" + (U === "" ? "." : "[^" + U + "]") + "+)?" + (U === "" ? "" : "[" + U + "]*") + "$"), H = A.length - 1, le = A.map((Q, T) => T === 0 && e.reverseFillMask === true ? new RegExp("^" + z + "*" + Q) : T === H ? new RegExp("^" + Q + "(" + (W === "" ? "." : W) + "+)?" + (e.reverseFillMask === true ? "$" : z + "*")) : new RegExp("^" + Q));
    o = C, i = (Q) => {
      const T = F.exec(e.reverseFillMask === true ? Q : Q.slice(0, C.length + 1));
      T !== null && (Q = T.slice(1).join(""));
      const Z = [], G = le.length;
      for (let ce = 0, P = Q; ce < G; ce++) {
        const M = le[ce].exec(P);
        if (M === null) break;
  ...
  function S(L, $, z) {
    const q = l.value, A = q.selectionEnd, C = q.value.length - A, N = B(L);
    $ === true && _();
    const U = x(N), W = e.fillMask !== false ? I(U) : U, F = f.value !== W;
    q.value !== W && (q.value = W), F === true && (f.value = W), document.activeElement === q && We(() => {
      if (W === r) {
        const le = e.reverseFillMask === true ? r.length : 0;
        q.setSelectionRange(le, le, "forward");
        return;
      }
      if (z === "insertFromPaste" && e.reverseFillMask !== true) {
        const le = q.selectionEnd;
        let Q = A - 1;
        for (let T = u; T <= Q && T < le; T++) a[T] !== Lt && Q++;
        p.right(q, Q);
        return;
      }
      if (["deleteContentBackward", "deleteContentForward"].indexOf(z) !== -1) {
        const le = e.reverseFillMask === true ? A === 0 ? W.length > U.length ? 1 : 0 : Math.max(0, W.length - (W === r ? 0 : Math.min(U.length, C) + 1)) + 1 : A;
        q.setSelectionRange(le, le, "forward");
        return;
      }
      if (e.reverseFillMask === true) if (F === true) {
        const le = Math.max(0, W.length - (W === r ? 0 : Math.min(U.length, C + 1)));
        le === 1 && A === 1 ? q.setSelectionRange(le, le, "forward") : p.rightReverse(q, le);
      } else {
        const le = W.length - C;
        q.setSelectionRange(le, le, "backward");
      }
      else if (F === true) {
        const le = Math.max(0, a.indexOf(Lt), Math.min(U.length, A) - 1);
        p.right(q, le);
      } else {
        const le = A - 1;
        p.right(q, le);
    ...
    const H = e.unmaskedValue === true ? B(W) : W;
  ...
  function x(L) {
    ...
    for (let A = 0; A < $.length; A++) {
      const C = L[z], N = $[A];
      if (typeof N == "string") q += N, C === N && z++;
      else if (C !== void 0 && N.regex.test(C)) q += N.transform !== void 0 ? N.transform(C) : C, z++;
      else return q;
    }
    return q;
  }
  function R(L) {
    ...
    for (let C = $.length - 1; C >= 0 && q !== -1; C--) {
      const N = $[C];
      let U = L[q];
      if (typeof N == "string") A = N + A, U === N && q--;
      else if (U !== void 0 && N.regex.test(U)) do
        A = (N.transform !== void 0 ? N.transform(U) : U) + A, q--, U = L[q];
      while (z === C && U !== void 0 && N.regex.test(U));
      else return A;
    }
    return A;
  }
...
var Eh = ge({ name: "QInput", inheritAttrs: false, props: { ...di, ...b1, ...wn, modelValue: [String, Number, FileList], shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...fi, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: n }) {
  ...
  const f = K(null), m = Ms(e), { innerValue: h, hasMask: g, moveCursorForPaste: _, updateMaskValue: S, onMaskedKeydown: k, onMaskedClick: p } = y1(e, t, U, f), y = qh(e, true), b = v(() => Kl(h.value)), x = Mh(C), R = vi({ changeEvent: true }), B = v(() => e.type === "textarea" || e.autogrow === true), I = v(() => B.value === true || ["text", "search", "url", "tel", "password"].includes(e.type)), L = v(() => {
    const T = { ...R.splitAttrs.listeners.value, onInput: C, onPaste: A, onChange: F, onBlur: H, onFocus: wt };
    return T.onCompositionstart = T.onCompositionupdate = T.onCompositionend = x, g.value === true && (T.onKeydown = k, T.onClick = p), e.autogrow === true && (T.onAnimationend = N), T;
  }), $ = v(() => {
  ...
  Ke(() => {
    ...
    e.autogrow === true && W();
  }), Object.assign(R, { innerValue: h, fieldClass: v(() => `q-${B.value === true ? "textarea" : "input"}` + (e.autogrow === true ? " q-textarea--autogrow" : "")), hasShadow: v(() => e.type !== "file" && typeof e.shadowText == "string" && e.shadowText.length !== 0), inputRef: f, emitValue: U, hasValue: b, floatingLabel: v(() => b.value === true && (e.type !== "number" || isNaN(h.value) === false) || Kl(e.displayValue)), getControl: () => d(B.value === true ? "textarea" : "input", { ref: f, class: ["q-field__native q-placeholder", e.inputClass], style: e.inputStyle, ...$.value, ...L.value, ...e.type !== "file" ? { value: le() } : y.value }), getShadowControl: () => d("div", { class: "q-field__native q-field__shadow absolute-bottom no-pointer-events" + (B.value === true ? "" : " text-no-wrap") }, [d("span", { class: "invisible" }, le()), d("span", e.shadowText)]) });
  const Q = mi(R);
...
ge({ name: "QKnob", props: { ...wn, ...Os, modelValue: { type: Number, required: true }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, tabindex: { type: [Number, String], default: 0 }, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change", "dragValue"], setup(e, { slots: t, emit: n }) {
  ...
  function x() {
    const { top: C, left: N, width: U, height: W } = l.$el.getBoundingClientRect();
    c = { top: C + W / 2, left: N + U / 2 };
  }
  function R(C) {
    x(), L(C);
  }
  ...
  function I(C) {
    ...
    je(C);
    const N = ([34, 33].includes(C.keyCode) ? 10 : 1) * g.value, U = [34, 37, 40].includes(C.keyCode) ? -N : N;
  ...
  function L(C, N) {
    ...
    let H = Math.asin(W / F) * (180 / Math.PI);
    U.top < c.top ? H = c.left < U.left ? 90 - H : 270 + H : H = c.left < U.left ? H + 90 : 270 - H, a.lang.rtl === true ? H = Co(-H - e.angle, 0, 360) : e.angle && (H = Co(H - e.angle, 0, 360)), e.reverse === true && (H = 360 - H);
    let le = e.min + H / 360 * (e.max - e.min);
    if (g.value !== 0) {
      const Q = le % g.value;
      le = le - Q + (Math.abs(Q) >= g.value / 2 ? (Q < 0 ? -1 : 1) * g.value : 0), le = parseFloat(le.toFixed(h.value));
    }
    le = ct(le, i.value, u.value), n("dragValue", le), r.value !== le && (r.value = le), z(N);
  }
  function $(C) {
  ...
  return () => {
    const C = { class: m.value, role: "slider", "aria-valuemin": i.value, "aria-valuemax": u.value, "aria-valuenow": e.modelValue, ...k.value, ...p.value, value: r.value, instantFeedback: _.value, ...S.value }, N = { default: t.default };
    return f.value === true && e.name !== void 0 && (N.internal = A), pn(Qm, C, N, "knob", f.value, () => b.value);
  };
} });
var { passive: Rd } = dt, q1 = ["both", "horizontal", "vertical"], $h = ge({ name: "QScrollObserver", props: { axis: { type: String, validator: (e) => q1.includes(e), default: "vertical" }, debounce: [String, Number], scrollTarget: Xl }, emits: ["scroll"], setup(e, { emit: t }) {
  ...
  function i() {
    a = Vn(r, e.scrollTarget), a.addEventListener("scroll", c, Rd), c(true);
  }
  function u() {
...
var L1 = ge({ name: "QOptionGroup", props: { ...nt, modelValue: { required: true }, options: { type: Array, validator: (e) => e.every(Pt), default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], name: String, type: { type: String, default: "radio", validator: (e) => P1.includes(e) }, color: String, keepColor: Boolean, dense: Boolean, size: String, leftLabel: Boolean, inline: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { emit: t, slots: n }) {
  ...
  return () => d("div", { class: f.value, ...m.value }, e.options.map((g, _) => {
    ...
    return d("div", [d(o.value, { label: S === void 0 ? u.value(g) : null, modelValue: e.modelValue, "onUpdate:modelValue": h, ...s.value[_] }, S)]);
  }));
} });
...
ge({ name: "QPagination", props: { ...nt, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => (typeof e == "string" ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => e === "" || wm.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  const _ = v(() => "q-pagination row no-wrap items-center" + (e.disable === true ? " disabled" : "")), S = v(() => e.gutter in To ? `${To[e.gutter]}px` : e.gutter || null), k = v(() => S.value !== null ? `--q-pagination-gutter-parent:-${S.value};--q-pagination-gutter-child:${S.value}` : null), p = v(() => {
  ...
  function q(A, C, N) {
    ...
    return N === true && Object.assign(U, { "aria-current": "true", ...B.value }), C !== void 0 && (e.toFn !== void 0 ? U.to = e.toFn(C) : U.onClick = () => {
      L(C);
    }), d(Ze, U);
  }
  return Object.assign(n, { set: L, setByOffset: $ }), () => {
    ...
    if (c.value === true && (A.push(q({ key: "bls", disable: e.disable || e.modelValue <= r.value, icon: p.value[0], "aria-label": l.lang.pagination.first }, r.value)), C.unshift(q({ key: "ble", disable: e.disable || e.modelValue >= o.value, icon: p.value[3], "aria-label": l.lang.pagination.last }, o.value))), f.value === true && (A.push(q({ key: "bdp", disable: e.disable || e.modelValue <= r.value, icon: p.value[1], "aria-label": l.lang.pagination.prev }, e.modelValue - 1)), C.unshift(q({ key: "bdn", disable: e.disable || e.modelValue >= o.value, icon: p.value[2], "aria-label": l.lang.pagination.next }, e.modelValue + 1))), e.input !== true) {
      ...
      if (I.value.boundaryStart === true) {
        ...
        A.push(q({ key: "bns", style: F, disable: e.disable, label: r.value }, r.value, H));
      }
      if (I.value.boundaryEnd === true) {
        const H = o.value === e.modelValue;
        C.unshift(q({ key: "bne", style: F, disable: e.disable, label: o.value }, o.value, H));
      }
...
ge({ name: "QParallax", props: { src: String, height: { type: Number, default: 500 }, speed: { type: Number, default: 1, validator: (e) => e >= 0 && e <= 1 }, scrollTarget: Xl, onScroll: Function }, setup(e, { slots: t, emit: n }) {
  ...
  function k() {
    i = true, m = Vn(a.value, e.scrollTarget), m.addEventListener("scroll", g, Gr), window.addEventListener("resize", s, Gr), g();
  }
  function p() {
  ...
  return ft(() => {
    _ = Zi(_), h = Zi(h), s = Zi(S), u = t.media !== void 0 ? r.value.children[0] : o.value, u.onload = u.onloadstart = u.loadedmetadata = S, S(), u.style.display = "initial", window.IntersectionObserver !== void 0 ? (f = new IntersectionObserver((y) => {
...
ge({ name: "QPopupEdit", props: { modelValue: { required: true }, title: String, buttons: Boolean, labelSet: String, labelCancel: String, color: { type: String, default: "primary" }, validate: { type: Function, default: () => true }, autoSave: Boolean, cover: { type: Boolean, default: true }, disable: Boolean }, emits: ["update:modelValue", "save", "cancel", "beforeShow", "show", "beforeHide", "hide"], setup(e, { slots: t, emit: n }) {
  ...
  return Object.assign(l, { set: s, cancel: f, show(b) {
    ...
    if (e.disable !== true) return d(ui, { ref: r, class: "q-popup-edit", cover: e.cover, onBeforeShow: _, onShow: S, onBeforeHide: k, onHide: p, onEscapeKey: f }, y);
  };
} });
ge({ name: "QPopupProxy", props: { ...km, breakpoint: { type: [String, Number], default: 450 } }, emits: ["show", "hide"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  return Object.assign(a, { show(_) {
    ...
    let S;
    return f.value === "dialog" ? S = ci : (S = ui, Object.assign(_, { target: e.target, contextMenu: e.contextMenu, noParentEvent: true, separateClosePopup: true })), d(S, _, t.default);
  };
} });
...
var O1 = ge({ name: "QLinearProgress", props: { ...nt, ...el, value: { type: Number, default: 0 }, buffer: Number, color: String, trackColor: String, reverse: Boolean, stripe: Boolean, indeterminate: Boolean, query: Boolean, rounded: Boolean, animationSpeed: { type: [String, Number], default: 2100 }, instantFeedback: Boolean }, setup(e, { slots: t }) {
  ...
  return () => {
    ...
    return e.stripe === true && r.value === false && S.push(d("div", { class: _.value, style: g.value })), d("div", { class: u.value, style: i.value, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 1, "aria-valuenow": e.indeterminate === true ? void 0 : e.value }, qt(t.default, S));
  };
} }), Pd = 40, Ji = 20;
...
ge({ name: "QRange", props: { ...Km, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: Wm, setup(e, { emit: t }) {
  ...
  function L(q) {
    const { left: A, top: C, width: N, height: U } = r.value.getBoundingClientRect(), W = e.dragOnlyRange === true ? 0 : e.vertical === true ? y.value.offsetHeight / (2 * U) : y.value.offsetWidth / (2 * N), F = { left: A, top: C, width: N, height: U, valueMin: u.value.min, valueMax: u.value.max, ratioMin: s.value, ratioMax: f.value }, H = a.getDraggingRatio(q, F);
    return e.dragOnlyRange !== true && H < F.ratioMin + W ? F.type = rl.MIN : e.dragOnlyRange === true || H < F.ratioMax - W ? e.dragRange === true || e.dragOnlyRange === true ? (F.type = rl.RANGE, Object.assign(F, { offsetRatio: H, offsetModel: a.convertRatioToModel(H), rangeValue: F.valueMax - F.valueMin, rangeRatio: F.ratioMax - F.ratioMin })) : F.type = F.ratioMax - H < H - F.ratioMin ? rl.MAX : rl.MIN : F.type = rl.MAX, F;
  }
  function $(q, A = l.dragging.value) {
    let C;
    const N = a.getDraggingRatio(q, A), U = a.convertRatioToModel(N);
    switch (A.type) {
      case rl.MIN:
        N <= A.ratioMax ? (C = { minR: N, maxR: A.ratioMax, min: U, max: A.valueMax }, l.focus.value = "min") : (C = { minR: A.ratioMax, maxR: N, min: A.valueMax, max: U }, l.focus.value = "max");
        break;
      case rl.MAX:
        N >= A.ratioMin ? (C = { minR: A.ratioMin, maxR: N, min: A.valueMin, max: U }, l.focus.value = "max") : (C = { minR: N, maxR: A.ratioMin, min: U, max: A.valueMin }, l.focus.value = "min");
        break;
      case rl.RANGE:
        const W = N - A.offsetRatio, F = ct(A.ratioMin + W, l.innerMinRatio.value, l.innerMaxRatio.value - A.rangeRatio), H = U - A.offsetModel, le = ct(A.valueMin + H, l.innerMin.value, l.innerMax.value - A.rangeValue);
        C = { minR: F, maxR: F + A.rangeRatio, min: l.roundValueFn.value(le), max: l.roundValueFn.value(le + A.rangeValue) }, l.focus.value = "both";
        break;
    }
  ...
  function z(q) {
    ...
    if (l.focus.value === "both") {
      const N = u.value.max - u.value.min, U = ct(l.roundValueFn.value(u.value.min + C), l.innerMin.value, l.innerMax.value - N);
      u.value = { min: U, max: l.roundValueFn.value(U + N) };
    } else {
...
var V1 = ge({ props: ["store", "barStyle", "verticalBarStyle", "horizontalBarStyle"], setup(e) {
  ...
  function _() {
    ...
    return Ld.forEach((N) => {
      const U = i[N];
      Object.assign(C, { [N + "Position"]: U.position.value, [N + "Percentage"]: U.percentage.value, [N + "Size"]: U.size.value, [N + "ContainerSize"]: o[N].value, [N + "ContainerInnerSize"]: o[N + "Inner"].value });
    }), C;
  }
  const S = Ea(() => {
    const C = _();
  ...
  function k(C, N, U) {
    ...
    (C === "vertical" ? pa : Bi)(m.value, N, U);
  }
  function p({ height: C, width: N }) {
    let U = false;
    o.vertical.value !== C && (o.vertical.value = C, U = true), o.horizontal.value !== N && (o.horizontal.value = N, U = true), U === true && B();
  }
  function y({ position: C }) {
    let N = false;
    i.vertical.position.value !== C.top && (i.vertical.position.value = C.top, N = true), i.horizontal.position.value !== C.left && (i.horizontal.position.value = C.left, N = true), N === true && B();
  }
  function b({ height: C, width: N }) {
    i.horizontal.size.value !== N && (i.horizontal.size.value = N, B()), i.vertical.size.value !== C && (i.vertical.size.value = C, B());
  }
  function x(C, N) {
    const U = i[N];
    if (C.isFirst === true) {
    ...
    const W = eu[N], F = (U.size.value - o[N].value) / (o[N + "Inner"].value - U.thumbSize.value), H = C.distance[W.dist], le = f + (C.direction === W.dir ? 1 : -1) * H * F;
    I(le, N);
  }
  function R(C, N) {
    const U = i[N];
    if (U.thumbHidden.value !== true) {
      const W = N === "vertical" ? e.verticalOffset[0] : e.horizontalOffset[0], F = C[eu[N].offset] - W, H = U.thumbStart.value - W;
      if (F < H || F > H + U.thumbSize.value) {
        const le = F - U.thumbSize.value / 2, Q = ct(le / (o[N + "Inner"].value - U.thumbSize.value), 0, 1);
        I(Q * Math.max(0, U.size.value - o[N].value), N);
      }
  ...
  }), Ke(S.cancel), Object.assign(u, { getScrollTarget: () => m.value, getScroll: _, getScrollPosition: () => ({ top: i.vertical.position.value, left: i.horizontal.position.value }), getScrollPercentage: () => ({ top: i.vertical.percentage.value, left: i.horizontal.percentage.value }), setScrollPosition: k, setScrollPercentage(C, N, U) {
    k(C, N * (i[C].size.value - o[C].value) * (C === "horizontal" && u.$q.lang.rtl === true ? -1 : 1), U);
  } });
...
function Vh({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: n, virtualScrollItemSizeComputed: l }) {
  ...
  let c, s, f, m = [], h;
  const g = K(0), _ = K(0), S = K({}), k = K(null), p = K(null), y = K(null), b = K({ from: 0, to: 0 }), x = v(() => r.tableColspan !== void 0 ? r.tableColspan : 100);
  ...
  function z() {
    ...
    const T = tu(Q, n(), k.value, p.value, r.virtualScrollHorizontal, u.lang.rtl, r.virtualScrollStickySizeStart, r.virtualScrollStickySizeEnd), Z = e.value - 1, G = T.scrollMaxSize - T.offsetStart - T.offsetEnd - _.value;
    ...
    let P = 0, M = T.scrollStart - T.offsetStart, ee = M;
    if (M <= G && M + T.scrollViewSize >= g.value) M -= g.value, P = b.value.from, ee = M;
    else for (let O = 0; M >= m[O] && P < Z; O++) M -= m[O], P += Cn;
    for (; M > 0 && P < Z; ) M -= h[P], M > -T.scrollViewSize ? (P++, ee = M) : ee = h[P] + M;
    q(Q, T, P, ee);
  }
  function q(Q, T, Z, G, ce) {
    const P = typeof ce == "string" && ce.indexOf("-force") !== -1, M = P === true ? ce.replace("-force", "") : ce, ee = M !== void 0 ? M : "start";
    let O = Math.max(0, Z - S.value[ee]), oe = O + S.value.total;
    oe > e.value && (oe = e.value, O = Math.max(0, oe - S.value.total)), c = T.scrollStart;
    const ne = O !== b.value.from || oe !== b.value.to;
    if (ne === false && M === void 0) {
      F(Z);
      return;
    }
    const { activeElement: w } = document, E = y.value;
    ne === true && E !== null && E !== w && E.contains(w) === true && (E.addEventListener("focusout", C), setTimeout(() => {
      E == null ? void 0 : E.removeEventListener("focusout", C);
    })), D1(E, Z - O);
    const D = M !== void 0 ? h.slice(O, Z).reduce(_a, 0) : 0;
    if (ne === true) {
      const te = oe >= b.value.from && O <= b.value.to ? b.value.to : oe;
      b.value = { from: O, to: te }, g.value = Ia(m, h, 0, O), _.value = Ia(m, h, oe, e.value), requestAnimationFrame(() => {
        b.value.to !== oe && c === T.scrollStart && (b.value = { from: b.value.from, to: oe }, _.value = Ia(m, h, oe, e.value));
      });
    }
    requestAnimationFrame(() => {
      if (c !== T.scrollStart) return;
      ne === true && A(O);
      const te = h.slice(O, Z).reduce(_a, 0), ae = te + T.offsetStart + g.value, Y = ae + h[Z];
      let me = ae + G;
      if (M !== void 0) {
        const be = te - D, he = T.scrollStart + be;
  ...
  function N(Q, T) {
    ...
    s = -1, c = void 0, g.value = Ia(m, h, 0, b.value.from), _.value = Ia(m, h, b.value.to, e.value), Q >= 0 ? (A(b.value.from), We(() => {
      $(Q);
    })) : H();
  }
  function U(Q) {
  ...
  function W(Q, T) {
    ...
    return [Q === "tbody" ? d(Q, { class: "q-virtual-scroll__padding", key: "before", ref: k }, [d("tr", [d("td", { style: { [Z]: `${g.value}px`, ...G }, colspan: x.value })])]) : d(Q, { class: "q-virtual-scroll__padding", key: "before", ref: k, style: { [Z]: `${g.value}px`, ...G } }), d(Q, { class: "q-virtual-scroll__content", key: "content", ref: y, tabindex: -1 }, T.flat()), Q === "tbody" ? d(Q, { class: "q-virtual-scroll__padding", key: "after", ref: p }, [d("tr", [d("td", { style: { [Z]: `${_.value}px`, ...G }, colspan: x.value })])]) : d(Q, { class: "q-virtual-scroll__padding", key: "after", ref: p, style: { [Z]: `${_.value}px`, ...G } })];
  }
  function F(Q) {
  ...
  U();
  const H = Ea(z, u.platform.is.ios === true ? 120 : 35);
  Yo(() => {
    U();
  });
  let le = false;
  return On(() => {
    ...
    H.cancel();
  }), Object.assign(i, { scrollTo: $, reset: I, refresh: L }), { virtualScrollSliceRange: b, virtualScrollSliceSizeComputed: S, setVirtualScrollSize: U, onVirtualScrollEvt: H, localResetVirtualScroll: N, padVirtualScroll: W, scrollTo: $, reset: I, refresh: L };
}
...
var j1 = ge({ name: "QSelect", inheritAttrs: false, props: { ...ju, ...wn, ...di, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], popupNoRouteDismiss: Boolean, useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: Vd }, mapOptions: Boolean, emitValue: Boolean, disableTabSelection: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: {}, transitionHide: {}, transitionDuration: {}, behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: ju.virtualScrollItemSize.type, onNewValue: Function, onFilter: Function }, emits: [...fi, "add", "remove", "inputValue", "keyup", "keypress", "keydown", "popupShow", "popupHide", "filterAbort"], setup(e, { slots: t, emit: n }) {
  ...
  let f = null, m = null, h, g, _, S = null, k, p, y, b;
  const x = K(null), R = K(null), B = K(null), I = K(null), L = K(null), $ = Ms(e), z = Mh(de), q = v(() => Array.isArray(e.options) ? e.options.length : 0), A = v(() => e.virtualScrollItemSize === void 0 ? e.optionsDense === true ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: C, virtualScrollSliceSizeComputed: N, localResetVirtualScroll: U, padVirtualScroll: W, onVirtualScrollEvt: F, scrollTo: H, setVirtualScrollSize: le } = Vh({ virtualScrollLength: q, getVirtualScrollTarget: jt, getVirtualScrollEl: Ct, virtualScrollItemSizeComputed: A }), Q = vi(), T = v(() => {
  ...
  }), M = v(() => (e.virtualScrollHorizontal === true ? "q-virtual-scroll--horizontal" : "") + (e.popupContentClass ? " " + e.popupContentClass : "")), ee = v(() => q.value === 0), O = v(() => T.value.map((J) => re.value(J)).join(", ")), oe = v(() => e.displayValue !== void 0 ? e.displayValue : O.value), ne = v(() => e.optionsHtml === true ? () => true : (J) => (J == null ? void 0 : J.html) === true), w = v(() => e.displayValueHtml === true || e.displayValue === void 0 && (e.optionsHtml === true || T.value.some(ne.value))), E = v(() => Q.focused.value === true ? e.tabindex : -1), D = v(() => {
  ...
  }), te = v(() => ({ id: `${Q.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": e.multiple === true ? "true" : "false" })), ae = v(() => T.value.map((J, Re) => ({ index: Re, opt: J, html: ne.value(J), selected: true, removeAtIndex: Me, toggleOption: Ve, tabindex: E.value }))), Y = v(() => {
    if (q.value === 0) return [];
    ...
    return e.options.slice(J, Re).map(($e, tt) => {
      ...
      return gt !== true && (i.value === Dt && ($t.focused = true), a.platform.is.desktop === true && ($t.onMousemove = () => {
        r.value === true && se(Dt);
      })), { index: Dt, opt: $e, html: ne.value($e), label: re.value($e), selected: $t.active, focused: $t.focused, toggleOption: Ve, setOptionIndex: se, itemProps: $t };
    });
  ...
  ye(T, (J) => {
    h = J, e.useInput === true && e.fillInput === true && e.multiple !== true && Q.innerLoading.value !== true && (o.value !== true && r.value !== true || ce.value !== true) && (_ !== true && cn(), (o.value === true || r.value === true) && Be(""));
  ...
  function pe(J = 1, Re) {
    if (r.value === true) {
      ...
      i.value !== $e && (se($e), H($e), Re !== true && e.useInput === true && e.fillInput === true && xe($e >= 0 ? re.value(e.options[$e]) : k, true));
    }
  }
  function ie(J, Re) {
  ...
  function it(J) {
    ...
    (J.keyCode === 35 || J.keyCode === 36) && (typeof u.value != "string" || u.value.length === 0) && (je(J), i.value = -1, pe(J.keyCode === 36 ? 1 : -1, e.multiple)), (J.keyCode === 33 || J.keyCode === 34) && N.value !== void 0 && (je(J), i.value = Math.max(-1, Math.min(q.value, i.value + (J.keyCode === 33 ? -1 : 1) * N.value.view)), pe(J.keyCode === 33 ? 1 : -1, e.multiple)), (J.keyCode === 38 || J.keyCode === 40) && (je(J), pe(J.keyCode === 38 ? -1 : 1, e.multiple));
    const tt = q.value;
    if ((y === void 0 || b < Date.now()) && (y = ""), tt > 0 && e.useInput !== true && J.key !== void 0 && J.key.length === 1 && J.altKey === false && J.ctrlKey === false && J.metaKey === false && (J.keyCode !== 32 || y.length !== 0)) {
      ...
      i.value !== $t && We(() => {
        se($t), H($t), $t >= 0 && e.useInput === true && e.fillInput === true && xe(re.value(e.options[$t]), true);
      });
      return;
    }
  ...
  function nl() {
    return e.hideSelected === true ? [] : t["selected-item"] !== void 0 ? ae.value.map((J) => t["selected-item"](J)).slice() : t.selected !== void 0 ? [].concat(t.selected()) : e.useChips === true ? ae.value.map((J, Re) => d(Hm, { key: "option-" + Re, removable: Q.editable.value === true && j.value(J.opt) !== true, dense: true, textColor: e.color, tabindex: E.value, onRemove() {
      J.removeAtIndex(Re);
    } }, () => d("span", { class: "ellipsis", [J.html === true ? "innerHTML" : "textContent"]: re.value(J.opt) }))) : [d("span", { class: "ellipsis", [w.value === true ? "innerHTML" : "textContent"]: oe.value })];
  }
  function ln() {
  ...
  function de(J) {
    f !== null && (clearTimeout(f), f = null), m !== null && (clearTimeout(m), m = null), !(J && J.target && J.target.qComposing === true) && (xe(J.target.value || ""), _ = true, k = u.value, Q.focused.value !== true && (g !== true || c.value === true) && Q.focus(), e.onFilter !== void 0 && (f = setTimeout(() => {
      f = null, Be(u.value);
    }, e.inputDebounce)));
  }
  function xe(J, Re) {
  ...
  function Be(J, Re, $e) {
    ...
    Q.innerLoading.value === true ? n("filterAbort") : (Q.innerLoading.value = true, s.value = true), J !== "" && e.multiple !== true && T.value.length !== 0 && _ !== true && J === re.value(T.value[0]) && (J = "");
    const tt = setTimeout(() => {
  ...
  function Ue() {
    return d(ui, { ref: B, class: M.value, style: e.popupContentStyle, modelValue: r.value, fit: e.menuShrink !== true, cover: e.optionsCover === true && ee.value !== true && e.useInput !== true, anchor: e.menuAnchor, self: e.menuSelf, offset: e.menuOffset, dark: G.value, noParentEvent: true, noRefocus: true, noFocus: true, noRouteDismiss: e.popupNoRouteDismiss, square: be.value, transitionShow: e.transitionShow, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, separateClosePopup: true, ...te.value, onScrollPassive: F, onBeforeShow: Gs, onBeforeHide: yt, onShow: ht }, ln);
  }
  function yt(J) {
    Xs(J), Le();
  }
  ...
  function Xe() {
    ...
    (J === null || J.id !== Q.targetUid.value) && R.value !== null && R.value !== J && R.value.focus(), le();
  }
  function Le() {
  ...
  function De(J) {
    Q.editable.value === true && (g === true ? (Q.onControlFocusin(J), o.value = true, We(() => {
      Q.focus();
    })) : Q.focus(), e.onFilter !== void 0 ? Be(u.value) : (ee.value !== true || t["no-option"] !== void 0) && (r.value = true));
  }
  function at() {
    o.value = false, Le();
  }
  ...
  return Ma(Zs), Go(Ys), Zs(), Ke(() => {
    ...
    if (Q.editable.value !== false && (o.value === true || ee.value !== true || t["no-option"] !== void 0)) return g === true ? fe() : Ue();
    ...
    if (e.useInput === true) Re.push(zn(J, $e));
...
ge({ name: "QSplitter", props: { ...nt, modelValue: { type: Number, required: true }, reverse: Boolean, unit: { type: String, default: "%", validator: (e) => ["%", "px"].includes(e) }, limits: { type: Array, validator: (e) => e.length !== 2 || typeof e[0] != "number" || typeof e[1] != "number" ? false : e[0] >= 0 && e[0] <= e[1] }, emitImmediately: Boolean, horizontal: Boolean, disable: Boolean, beforeClass: [Array, String, Object], afterClass: [Array, String, Object], separatorClass: [Array, String, Object], separatorStyle: [Array, String, Object] }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  function p(x) {
    if (x.isFirst === true) {
      ...
      h = e.horizontal === true ? "up" : "left", g = e.unit === "%" ? 100 : B, _ = Math.min(g, s.value[1], Math.max(s.value[0], e.modelValue)), S = (e.reverse !== true ? 1 : -1) * (e.horizontal === true ? 1 : l.lang.rtl === true ? -1 : 1) * (e.unit === "%" ? B === 0 ? 0 : 100 / B : 1), r.value.classList.add("q-splitter--active");
      return;
    }
    if (x.isFinal === true) {
    ...
    const R = _ + S * (x.direction === h ? -1 : 1) * x.distance[e.horizontal === true ? "y" : "x"];
...
var y_ = { list: Rh, table: E1 }, p_ = ["list", "table", "__qtable"], __ = ge({ name: "QVirtualScroll", props: { ...ju, type: { type: String, default: "list", validator: (e) => p_.includes(e) }, items: { type: Array, default: () => [] }, itemsFn: Function, itemsSize: Number, scrollTarget: Xl }, setup(e, { slots: t, attrs: n }) {
  ...
  function _() {
    l = Vn(h(), e.scrollTarget), l.addEventListener("scroll", c, dt.passive);
  }
  function S() {
...
function x_(e, t, n, l) {
  const a = v(() => {
    ...
    return i.sort((h, g) => {
      let _ = m(h), S = m(g);
      return s.rawSort !== void 0 ? s.rawSort(_, S, h, g) * f : _ == null ? -1 * f : S == null ? 1 * f : s.sort !== void 0 ? s.sort(_, S, h, g) * f : pr(_) === true && pr(S) === true ? (_ - S) * f : Eu(_) === true && Eu(S) === true ? w_(_, S) * f : typeof _ == "boolean" && typeof S == "boolean" ? (_ - S) * f : ([_, S] = [_, S].map((k) => (k + "").toLocaleString().toLowerCase()), _ < S ? -1 * f : _ === S ? 0 : f);
    });
  });
  function o(i) {
...
function E_(e, t, n, l, a, r) {
  ...
  return o["onUpdate:pagination"] !== void 0 && i("update:pagination", { ...n.value }), { firstRowIndex: s, lastRowIndex: f, isFirstPage: m, isLastPage: g, pagesNumber: h, computedRowsPerPageOptions: _, computedRowsNumber: c, firstPage: S, prevPage: k, nextPage: p, lastPage: y };
}
...
function $_(e, t, n, l) {
  ...
  function h(g, _, S, k) {
    t("selection", { rows: _, added: S, keys: g, evt: k });
...
ge({ name: "QTable", props: { rows: { type: Array, required: true }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: {}, ...Nh, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], tableRowStyleFn: Function, tableRowClassFn: Function, cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], cardStyleFn: Function, cardClassFn: Function, hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...nt, ...Ls, ...F_, ...C_, ...T_, ...P_, ...A_, ...S_ }, emits: ["request", "virtualScroll", ...Bs, ...L_, ...R_], setup(e, { slots: t, emit: n }) {
  ...
  const { innerPagination: _, computedPagination: S, isServerSide: k, requestServerInteraction: p, setPagination: y } = M_(l, se), { computedFilterMethod: b } = k_(e, y), { isRowExpanded: x, setExpanded: R, updateExpanded: B } = B_(e, n), I = v(() => {
    let de = e.rows;
    ...
    return xe !== 0 && (M.value === 0 && e.rows !== de ? de.length > ee.value && (de = de.slice(0, ee.value)) : de = de.slice(M.value, ee.value)), de;
  }), { hasSelectionMode: z, singleSelection: q, multipleSelection: A, allRowsSelected: C, someRowsSelected: N, rowsSelectedNumber: U, isRowSelected: W, clearSelection: F, updateSelection: H } = $_(e, n, $, u), { colList: le, computedCols: Q, computedColsMap: T, computedColspan: Z } = O_(e, S, z), { columnToSort: G, computedSortMethod: ce, sort: P } = x_(e, S, le, y), { firstRowIndex: M, lastRowIndex: ee, isFirstPage: O, isLastPage: oe, pagesNumber: ne, computedRowsPerPageOptions: w, computedRowsNumber: E, firstPage: D, prevPage: te, nextPage: ae, lastPage: Y } = E_(l, _, S, k, y, L), me = v(() => $.value.length === 0), be = v(() => {
    const de = {};
  ...
  function re(de, xe) {
    ...
    if (Fe !== null) {
      ...
      Be.scrollTop = Ue, n("virtualScroll", { index: de, from: 0, to: _.value.rowsPerPage - 1, direction: yt });
    }
  }
  function j(de) {
    n("virtualScroll", de);
  ...
  const pe = v(() => ({ pagination: S.value, pagesNumber: ne.value, isFirstPage: O.value, isLastPage: oe.value, firstPage: D, prevPage: te, nextPage: ae, lastPage: Y, inFullscreen: o.value, toggleFullscreen: i }));
  function ie() {
  ...
  const _e = v(() => N.value === true ? null : C.value);
  function Ce() {
    const de = Oe();
  ...
  function Ye(de) {
    N.value === true && (de = false), H($.value.map(u.value), $.value, de);
  }
  const it = v(() => {
  ...
  function nl(de) {
    ...
    if (de.push(d("div", { class: "q-table__separator col" })), yt === true && de.push(d("div", { class: "q-table__control" }, [d("span", { class: "q-table__bottom-item" }, [e.rowsPerPageLabel || a.lang.table.recordsPerPage]), d(j1, { class: "q-table__select inline q-table__bottom-item", color: e.color, modelValue: Fe, options: w.value, displayValue: Fe === 0 ? a.lang.table.allRows : Fe, dark: r.value, borderless: true, dense: true, optionsDense: true, optionsCover: true, "onUpdate:modelValue": jt })])), Ue !== void 0) xe = Ue(pe.value);
    else if (xe = [d("span", Fe !== 0 ? { class: "q-table__bottom-item" } : {}, [Fe ? Be(M.value + 1, Math.min(ee.value, E.value), E.value) : Be(1, L.value, E.value)])], Fe !== 0 && ne.value > 1) {
      const ht = { color: e.color, round: true, dense: true, flat: true };
      e.dense === true && (ht.size = "sm"), ne.value > 2 && xe.push(d(Ze, { key: "pgFirst", ...ht, icon: it.value[0], disable: O.value, ariaLabel: a.lang.pagination.first, onClick: D })), xe.push(d(Ze, { key: "pgPrev", ...ht, icon: it.value[1], disable: O.value, ariaLabel: a.lang.pagination.prev, onClick: te }), d(Ze, { key: "pgNext", ...ht, icon: it.value[2], disable: oe.value, ariaLabel: a.lang.pagination.next, onClick: ae })), ne.value > 2 && xe.push(d(Ze, { key: "pgLast", ...ht, icon: it.value[3], disable: oe.value, ariaLabel: a.lang.pagination.last, onClick: Y }));
    }
  ...
  return Object.assign(l.proxy, { requestServerInteraction: p, setPagination: y, firstPage: D, prevPage: te, nextPage: ae, lastPage: Y, isRowSelected: W, clearSelection: F, isRowExpanded: x, setExpanded: R, sort: P, resetVirtualScroll: he, scrollTo: re, getCellValue: se }), Yv(l.proxy, { filteredSortedRows: () => I.value, computedRows: () => $.value, computedRowsNumber: () => E.value }), () => {
...
ge({ name: "QTime", props: { ...nt, ...wn, ...Fo, modelValue: { required: true, validator: (e) => typeof e == "string" || e === null }, mask: { ...Fo.mask, default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: rh, setup(e, { slots: t, emit: n }) {
  ...
  const g = K(null), _ = v(() => ce()), S = v(() => u()), k = v(() => P()), p = Ka(e.modelValue, _.value, S.value, e.calendar, k.value), y = K(V_(p)), b = K(p), x = K(p.hour === null || p.hour < 12), R = v(() => `q-time q-time--${e.landscape === true ? "landscape" : "portrait"}` + (r.value === true ? " q-time--dark q-dark" : "") + (e.disable === true ? " disabled" : e.readonly === true ? " q-time--readonly" : "") + (e.bordered === true ? " q-time--bordered" : "") + (e.square === true ? " q-time--square no-border-radius" : "") + (e.flat === true ? " q-time--flat no-shadow" : "")), B = v(() => {
  ...
  }), $ = v(() => b.value.hour !== null), z = v(() => $.value === true && b.value.minute !== null), q = v(() => e.hourOptions !== void 0 ? (se) => e.hourOptions.includes(se) : e.options !== void 0 ? (se) => e.options(se, null, null) : null), A = v(() => e.minuteOptions !== void 0 ? (se) => e.minuteOptions.includes(se) : e.options !== void 0 ? (se) => e.options(b.value.hour, se, null) : null), C = v(() => e.secondOptions !== void 0 ? (se) => e.secondOptions.includes(se) : e.options !== void 0 ? (se) => e.options(b.value.hour, b.value.minute, se) : null), N = v(() => {
    ...
    return Oe;
  }), le = v(() => [[gn, O, void 0, { stop: true, prevent: true, mouse: true }]]);
  ye(() => e.modelValue, (se) => {
    const pe = Ka(se, _.value, S.value, e.calendar, k.value);
  ...
  function P() {
    if (typeof e.defaultDate != "string") {
      const se = c(true);
      return se.dateHash = jn(se), se;
    }
    return Ka(e.defaultDate, "YYYY/MM/DD", void 0, e.calendar);
  }
  function M() {
    return gl(l) === true || F.value !== null && (F.value.values.length === 0 || y.value === "hour" && I.value !== true && N.value[x.value === true ? "am" : "pm"].values.length === 0);
  }
  function ee() {
  ...
  function ne(se, pe, ie) {
    ...
    if (_e.top < pe.top ? Ye = pe.left < _e.left ? 90 - Ye : 270 + Ye : Ye = pe.left < _e.left ? Ye + 90 : 270 - Ye, y.value === "hour") {
      if (Ae = Ye / 30, N.value !== null) {
        const it = I.value !== true ? x.value === true : N.value.am.values.length !== 0 && N.value.pm.values.length !== 0 ? Oe >= pe.dist : N.value.am.values.length !== 0;
        Ae = G(Ae + (it === true ? 0 : 12), N.value[it === true ? "am" : "pm"]);
  ...
  function te(se) {
    M() !== true && (a.platform.is.desktop !== true && ne(se, ee()), oe());
  }
  function ae(se) {
    M() !== true && ne(se, ee());
  }
  function Y(se) {
    if (se.keyCode === 13) y.value = "hour";
      ...
      if (N.value !== null) {
        const ie = I.value === true ? N.value.values : N.value[x.value === true ? "am" : "pm"].values;
  ...
  function Me(se) {
    const pe = Object.assign({ ...b.value }, se), ie = e.calendar === "persian" ? rt(pe.hour) + ":" + rt(pe.minute) + (e.withSeconds === true ? ":" + rt(pe.second) : "") : dh(new Date(pe.year, pe.month === null ? null : pe.month - 1, pe.day, pe.hour, pe.minute, pe.second, pe.millisecond), _.value, S.value, pe.year, pe.timezoneOffset);
    pe.changed = ie !== e.modelValue, n("update:modelValue", ie, pe);
  }
  function He() {
    const se = [d("div", { class: "q-time__link " + (y.value === "hour" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onClick: w.hour, onKeyup: Y }, B.value.hour), d("div", ":"), d("div", $.value === true ? { class: "q-time__link " + (y.value === "minute" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: me, onClick: w.minute } : { class: "q-time__link" }, B.value.minute)];
    e.withSeconds === true && se.push(d("div", ":"), d("div", z.value === true ? { class: "q-time__link " + (y.value === "second" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: be, onClick: w.second } : { class: "q-time__link" }, B.value.second));
...
ge({ name: "QTree", props: { ...nt, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => I_.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: {}, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  const s = v(() => `q-tree q-tree--${e.dense === true ? "dense" : "standard"}` + (e.noConnectors === true ? " q-tree--no-connectors" : "") + (r.value === true ? " q-tree--dark" : "") + (e.color !== void 0 ? ` text-${e.color}` : "")), f = v(() => e.selected !== void 0), m = v(() => e.icon || a.iconSet.tree.icon), h = v(() => e.controlColor || e.color), g = v(() => e.textColor !== void 0 ? ` text-${e.textColor}` : ""), _ = v(() => {
    ...
    const T = {}, Z = (G, ce) => {
      const P = G.tickStrategy || (ce ? ce.tickStrategy : e.tickStrategy), M = G[e.nodeKey], ee = G[e.childrenKey] && Array.isArray(G[e.childrenKey]) && G[e.childrenKey].length !== 0, O = G.disabled !== true && f.value === true && G.selectable !== false, oe = G.disabled !== true && G.expandable !== false, ne = P !== "none", w = P === "strict", E = P === "leaf-filtered", D = P === "leaf" || P === "leaf-filtered";
      let te = G.disabled !== true && G.tickable !== false;
      D === true && te === true && ce && ce.tickable !== true && (te = false);
      let ae = G.lazy;
      ae === true && o.value[M] !== void 0 && Array.isArray(G[e.childrenKey]) === true && (ae = o.value[M]);
      const Y = { key: M, parent: ce, isParent: ee, lazy: ae, disabled: G.disabled, link: G.disabled !== true && (O === true || oe === true && (ee === true || ae === true)), children: [], matchesFilter: e.filter ? S.value(G, e.filter) : true, selected: M === e.selected && O === true, selectable: O, expanded: ee === true ? u.value.includes(M) : false, expandable: oe, noTick: G.noTick === true || w !== true && ae && ae !== "loaded", tickable: te, tickStrategy: P, hasTicking: ne, strictTicking: w, leafFilteredTicking: E, leafTicking: D, ticked: w === true ? i.value.includes(M) : ee === true ? false : i.value.includes(M) };
      if (T[M] = Y, ee === true && (Y.children = G[e.childrenKey].map((me) => Z(me, Y)), e.filter && (Y.matchesFilter !== true ? Y.matchesFilter = Y.children.some((me) => me.matchesFilter) : Y.noTick !== true && Y.disabled !== true && Y.tickable === true && E === true && Y.children.every((me) => me.matchesFilter !== true || me.noTick === true || me.tickable !== true) === true && (Y.tickable = false)), Y.matchesFilter === true && (Y.noTick !== true && w !== true && Y.children.every((me) => me.noTick) === true && (Y.noTick = true), D))) {
  ...
  function L(T, Z) {
    ...
    if (ce === true && (G = G.slice()), Z) {
      ...
      G = G.concat([T]).filter((P, M, ee) => ee.indexOf(P) === M);
  ...
  function z(T, Z) {
    ...
    ce === true && (G = G.slice()), Z ? G = G.concat(T).filter((P, M, ee) => ee.indexOf(P) === M) : G = G.filter((P) => T.includes(P) === false), ce === true && n("update:ticked", G);
  }
  function q(T, Z, G) {
  ...
  function W(T) {
    ...
    const O = ce !== void 0 || ee !== void 0 ? q(T, G, Z) : null;
    return ee !== void 0 && (ee = d("div", { class: "q-tree__node-body relative-position" }, [d("div", { class: g.value }, [ee(O)])])), d("div", { key: Z, class: `q-tree__node relative-position q-tree__node--${M === true ? "parent" : "child"}` }, [d("div", { class: "q-tree__node-header relative-position row no-wrap items-center" + (G.link === true ? " q-tree__node--link q-hoverable q-focusable" : "") + (G.selected === true ? " q-tree__node--selected" : "") + (G.disabled === true ? " q-tree__node--disabled" : ""), tabindex: G.link === true ? 0 : -1, ariaExpanded: P.length > 0 ? G.expanded : null, role: "treeitem", onClick: (oe) => {
      ...
      Yl(oe) !== true && (oe.keyCode === 13 ? H(T, G, oe, true) : oe.keyCode === 32 && le(T, G, oe, true));
      ...
      Q(G, oe);
    } }) : null, d("div", { class: "q-tree__node-header-content col row no-wrap items-center" + (G.selected === true ? _.value : g.value) }, [ce ? ce(O) : [C(T), d("div", T[e.labelKey])]])]), M === true ? e.noTransition === true ? G.expanded === true ? d("div", { class: "q-tree__node-collapsible" + g.value, key: `${Z}__q` }, [ee, d("div", { class: "q-tree__children" + (G.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, P)]) : null : d(Ds, { duration: e.duration, onShow: N, onHide: U }, () => sn(d("div", { class: "q-tree__node-collapsible" + g.value, key: `${Z}__q` }, [ee, d("div", { class: "q-tree__children" + (G.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, P)]), [[Uv, G.expanded]])) : ee]);
  }
  function F(T) {
    var _a2;
  ...
  function H(T, Z, G, ce) {
    ce !== true && Z.selectable !== false && F(Z.key), f.value && Z.selectable ? e.noSelectionUnset === false ? n("update:selected", Z.key !== e.selected ? Z.key : null) : Z.key !== e.selected && n("update:selected", Z.key === void 0 ? null : Z.key) : le(T, Z, G, ce), typeof T.handler == "function" && T.handler(T);
  }
  function le(T, Z, G, ce) {
...
function N_(e, t) {
  ...
  function N() {
    l.disable === false && (g.abort(), g.uploadedSize.value = 0, B.value = 0, le(), g.files.value = [], g.queuedFiles.value = [], g.uploadedFiles.value = []);
  }
  function U() {
  ...
  function F(O, oe) {
    ...
    const ne = { files: [], size: 0 }, w = g.files.value.filter((E) => O.indexOf(E.__status) === -1 ? true : (ne.size += E.size, ne.files.push(E), E.__img !== void 0 && window.URL.revokeObjectURL(E.__img.src), false));
    ne.files.length !== 0 && (g.files.value = w, oe(ne), r("removed", ne.files));
  }
  function H(O) {
  ...
  function T(O, oe) {
    const ne = y(O, oe, g.files.value, true), w = Q();
    w != null && (w.value = ""), ne !== void 0 && (ne.forEach((E) => {
    ...
    }), g.files.value = g.files.value.concat(ne), g.queuedFiles.value = g.queuedFiles.value.concat(ne), r("added", ne), l.autoUpload === true && g.upload());
  }
  function Z() {
  ...
  function G(O, oe, ne) {
    if (O === true) {
      const w = { type: "a", key: oe, icon: i.iconSet.uploader[oe], flat: true, dense: true };
      let E;
      return oe === "add" ? (w.onClick = _, E = ce) : w.onClick = ne, d(Ze, w, E);
    }
  }
  function ce() {
  ...
  Ke(() => {
    g.isUploading.value === true && g.abort(), g.files.value.length !== 0 && le();
  });
  const ee = {};
  for (const O in g) pt(g[O]) === true ? Ot(ee, O, () => g[O].value) : ee[O] = g[O];
  return Object.assign(ee, { upload: Z, reset: N, removeUploadedFiles: U, removeQueuedFiles: W, removeFile: H, pickFiles: _, addFiles: S }), Yv(ee, { canAddFiles: () => z.value, canUpload: () => q.value, uploadSizeLabel: () => $.value, uploadProgressLabel: () => L.value }), t({ ...g, upload: Z, reset: N, removeUploadedFiles: U, removeQueuedFiles: W, removeFile: H, pickFiles: _, addFiles: S, canAddFiles: z, canUpload: q, uploadSizeLabel: $, uploadProgressLabel: L }), () => {
...
function Y_({ props: e, emit: t, helpers: n }) {
  const l = K([]), a = K([]), r = K(0), o = v(() => ({ url: Nn(e.url), method: Nn(e.method), headers: Nn(e.headers), formFields: Nn(e.formFields), fieldName: Nn(e.fieldName), withCredentials: Nn(e.withCredentials), sendRaw: Nn(e.sendRaw), batch: Nn(e.batch) })), i = v(() => r.value > 0), u = v(() => a.value.length !== 0);
  let c;
  function s() {
    l.value.forEach((g) => {
      g.abort();
  ...
  function m(g) {
    ...
    if (!_) t("factoryFailed", new Error("QUploader: factory() does not return properly"), g), r.value--;
      ...
      _.then((k) => {
        c === true ? S(new Error("Aborted")) : n.isAlive() === true && (a.value = a.value.filter((p) => p !== _), h(g, k));
      }).catch(S);
    } else h(g, _ || {});
  }
  function h(g, _) {
    const S = new FormData(), k = new XMLHttpRequest(), p = (q, A) => _[q] !== void 0 ? Nn(_[q])(A) : o.value[q](A), y = p("url", g);
    if (!y) {
...
function lw(e) {
  ...
  const q = () => {
    ...
    const { width: C, height: N } = Zr(f), { width: U, height: W } = Zr(A.parentNode);
    ...
    const F = () => {
      ...
      const H = A.parentNode, { width: le, height: Q } = Zr(H), T = A.cloneNode(r.keepToClone);
      ...
      const Z = A === o && f === H ? $ : A.nextElementSibling;
      H.insertBefore(T, Z);
      const { borderWidth: G, borderStyle: ce, borderColor: P, borderRadius: M, backgroundColor: ee, transform: O, position: oe, cssText: ne } = Gd(A, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), w = A.classList.toString(), E = A.style.cssText;
      A.style.cssText = ne, A.style.transform = "none", A.style.animation = "none", A.style.transition = "none", A.className = w.split(" ").filter((_e) => /^bg-/.test(_e) === false).join(" ");
      const D = Kd(A, r.resize), te = h.left - D.left, ae = h.top - D.top, Y = h.width / (D.width > 0 ? D.width : 10), me = h.height / (D.height > 0 ? D.height : 100), be = g - C, he = _ - N, ve = le - U, re = Q - W, j = Math.max(h.widthM, be), ue = Math.max(h.heightM, he), we = Math.max(D.widthM, ve), ke = Math.max(D.heightM, re), qe = o === A && ["absolute", "fixed"].includes(oe) === false && ["absolute", "fixed"].includes(R) === false;
      let Me = oe === "fixed", He = H;
      ...
      const ie = (_e) => {
        o === A && l !== true ? (A.style.cssText = L, A.className = I) : (A.style.cssText = E, A.className = w), T.parentNode === H && H.insertBefore(A, T), $.remove(), T.remove(), z == null ? void 0 : z.remove(), t = () => false, o.qMorphCancel = void 0, A.qMorphCancel = void 0, typeof r.onEnd == "function" && r.onEnd(l === true ? "to" : "from", _e === true);
      };
      if (r.useCSS !== true && typeof A.animate == "function") {
        const _e = r.resize === true ? { transform: `translate(${te}px, ${ae}px)`, width: `${j}px`, height: `${ue}px` } : { transform: `translate(${te}px, ${ae}px) scale(${Y}, ${me})` }, Ce = r.resize === true ? { width: `${we}px`, height: `${ke}px` } : {}, Oe = r.resize === true ? { width: `${j}px`, height: `${ue}px` } : {}, Ae = r.resize === true ? { transform: `translate(${-1 * te}px, ${-1 * ae}px)`, width: `${we}px`, height: `${ke}px` } : { transform: `translate(${-1 * te}px, ${-1 * ae}px) scale(${1 / Y}, ${1 / me})` }, Ye = z !== void 0 ? { opacity: r.tweenToOpacity } : { backgroundColor: b }, it = z !== void 0 ? { opacity: 1 } : { backgroundColor: ee };
        ...
        const _e = `q-morph-anim-${++X_}`, Ce = document.createElement("style"), Oe = r.resize === true ? `
            ...
            width: ${j}px;
            height: ${ue}px;
          ` : `transform: translate(${te}px, ${ae}px) scale(${Y}, ${me});`, Ae = r.resize === true ? `
            width: ${we}px;
            height: ${ke}px;
          ` : "", Ye = r.resize === true ? `
            width: ${j}px;
          ...
          ` : "", it = r.resize === true ? `
            ...
            width: ${we}px;
            height: ${ke}px;
          ` : `transform: translate(${-1 * te}px, ${-1 * ae}px) scale(${1 / Y}, ${1 / me});`, Ct = z !== void 0 ? `opacity: ${r.tweenToOpacity};` : `background-color: ${b};`, jt = z !== void 0 ? "opacity: 1;" : `background-color: ${ee};`, nl = z === void 0 ? "" : `
    ...
    r.waitFor > 0 || r.waitFor === "transitionend" || r.waitFor === Object(r.waitFor) && typeof r.waitFor.then == "function" ? (r.waitFor > 0 ? new Promise((le) => setTimeout(le, r.waitFor)) : r.waitFor === "transitionend" ? new Promise((le) => {
      const Q = () => {
        T !== null && (clearTimeout(T), T = null), A && (A.removeEventListener("transitionend", Q), A.removeEventListener("transitioncancel", Q)), le();
      };
...
function pw(e, t, n) {
  return (l) => {
    ...
    let k = li({ name: "QGlobalDialog", setup: () => () => d(a, { ...r, ref: c, onOk: _, onHide: S, onVnodeMounted(...p) {
...
var kw = js, qw = ge({ name: "DialogPluginComponent", props: { ...nt, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  const { proxy: n } = Se(), { $q: l } = n, a = lt(e, l), r = K(null), o = K(e.prompt !== void 0 ? e.prompt.model : e.options !== void 0 ? e.options.model : void 0), i = v(() => "q-dialog-plugin" + (a.value === true ? " q-dialog-plugin--dark q-dark" : "") + (e.progress !== false ? " q-dialog-plugin--progress" : "")), u = v(() => e.color || (a.value === true ? "amber" : "primary")), c = v(() => e.progress === false ? null : Pt(e.progress) === true ? { component: e.progress.spinner || _n, props: { color: e.progress.color || u.value } } : { component: _n, props: { color: u.value } }), s = v(() => e.prompt !== void 0 || e.options !== void 0), f = v(() => {
    ...
    const { model: C, isValid: N, items: U, ...W } = e.prompt !== void 0 ? e.prompt : e.options;
    return W;
  ...
  function I(C, N) {
    return e.html === true ? d(Fl, { class: C, innerHTML: N }) : d(Fl, { class: C }, () => N);
  }
  function L() {
  ...
  function z() {
    const C = [];
    return e.cancel && C.push(d(Ze, S.value)), e.ok && C.push(d(Ze, _.value)), d(dp, { class: e.stackButtons === true ? "items-end" : "", vertical: e.stackButtons, align: "right" }, () => C);
  }
  function q() {
    const C = [];
...
const fg = (e, t) => {
  ...
  return (o, i) => {
    ...
    return Yn(), Ll(Ie(T1), { view: "hHh LpR fFf" }, { default: At(() => [Je(Ie(m1), { class: "bg-primary text-white", elevated: "", id: "header" }, { default: At(() => [Je(Ie(Hd), null, { default: At(() => [Je(Ie(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: i[0] || (i[0] = (s) => pt(n) ? n.value = !Ie(n) : n = !Ie(n)) }), Je(Ie(jd), null, { default: At(() => [Je(Ie($u), null, { default: At(() => i[10] || (i[10] = [Gn("img", { src: "https://cdn.quasar.dev/logo-v2/svg/logo-mono-white.svg" }, null, -1)])), _: 1 }), i[11] || (i[11] = Bl("\xA0WebGL mtg"))]), _: 1 }), Ie(t).dark.isActive ? (Yn(), Ll(Ie(Ze), { key: 0, dense: "", flat: "", round: "", icon: Ie(Ww), onClick: i[1] || (i[1] = (s) => Ie(t).dark.set(false)) }, null, 8, ["icon"])) : gc("", true), Ie(t).dark.isActive ? gc("", true) : (Yn(), Ll(Ie(Ze), { key: 1, dense: "", flat: "", round: "", icon: Ie(Kw), onClick: i[2] || (i[2] = (s) => Ie(t).dark.set(true)) }, null, 8, ["icon"])), Je(Ie(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: i[3] || (i[3] = (s) => pt(l) ? l.value = !Ie(l) : l = !Ie(l)) })]), _: 1 })]), _: 1 }), Je(Ie(xd), { modelValue: Ie(n), "onUpdate:modelValue": i[8] || (i[8] = (s) => pt(n) ? n.value = s : n = s), side: "left", bordered: "", mini: Ie(a), overlay: "" }, { default: At(() => [Je(Ie(z1), { class: "fit" }, { default: At(() => [Je(Ie(Rh), { class: "menu-list padding" }, { default: At(() => [sn((Yn(), Ll(Ie(Ca), { clickable: "", onMouseover: i[4] || (i[4] = (s) => pt(a) ? a.value = false : a = false), onMouseout: i[5] || (i[5] = (s) => pt(a) ? a.value = true : a = true) }, { default: At(() => [Je(Ie(mn), { avatar: "" }, { default: At(() => [Je(Ie(et), { name: "inbox" })]), _: 1 }), Je(Ie(mn), null, { default: At(() => i[12] || (i[12] = [Bl("inbox")])), _: 1 })]), _: 1 })), [[c]]), sn((Yn(), Ll(Ie(Ca), { clickable: "", onMouseover: i[6] || (i[6] = (s) => pt(a) ? a.value = false : a = false), onMouseout: i[7] || (i[7] = (s) => pt(a) ? a.value = true : a = true) }, { default: At(() => [Je(Ie(mn), { avatar: "" }, { default: At(() => [Je(Ie(et), { name: "login" })]), _: 1 }), Je(Ie(mn), null, { default: At(() => i[13] || (i[13] = [Bl("login")])), _: 1 })]), _: 1 })), [[c]])]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["modelValue", "mini"]), Je(Ie(xd), { modelValue: Ie(l), "onUpdate:modelValue": i[9] || (i[9] = (s) => pt(l) ? l.value = s : l = s), side: "right", bordered: "", overlay: "" }, { default: At(() => i[14] || (i[14] = [Bl("right")])), _: 1 }, 8, ["modelValue"]), Je(Ie(B1), null, { default: At(() => [Je(u)]), _: 1 }), Je(Ie(v1), { class: "bg-grey-8 text-orange", elevated: "", id: "footer" }, { default: At(() => [Je(Ie(Hd), null, { default: At(() => [Je(Ie(jd), { style: { "font-size": "1.0em" } }, { default: At(() => [Je(Ie($u), { class: "q-mr-sm", size: "sm" }, { default: At(() => i[15] || (i[15] = [Gn("img", { src: "https://cdn.quasar.dev/logo-v2/svg/logo-mono-white.svg" }, null, -1)])), _: 1 }), Bl("\xA0vite / vue / quasar / wasm / webgl mtg \xA0mode: " + Lf(Ie(r)), 1)]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 });
  };
} });
/*!
* vue-router v4.5.0
  ...
  for (const c of e) {
    ...
    for (let f = 0; f < c.length; f++) {
      ...
      if (m.type === 0) f || (a += "/"), a += m.value.replace(AS, "\\$&"), h += 40;
        ...
        const { value: g, repeatable: _, optional: S, regexp: k } = m;
        ...
        let y = _ ? `((?:${p})(?:/(?:${p}))*)` : `(${p})`;
        f || (y = S && c.length < 2 ? `(?:/${y})` : "/" + y), S && (y += "?"), a += y, h += 20, S && (h += -8), _ && (h += -20), p === ".*" && (h += -50);
      }
      s.push(h);
    }
    l.push(s);
  ...
  function u(c) {
    ...
    for (const m of e) {
      ...
      for (const h of m) if (h.type === 0) s += h.value;
        ...
        const { value: g, repeatable: _, optional: S } = h, k = g in c ? c[g] : "";
...
function OS(e, t) {
  ...
  function r(f, m, h) {
    ...
    for (const b of k) {
      ...
      if (p = FS(b, m, S), h ? h.alias.push(p) : (y = y || p, y !== p && y.alias.push(p), g && f.name && !yf(p) && o(f.name)), Cg(p) && u(p), _.children) {
        const R = _.children;
  ...
  function c(f, m) {
    ...
    if ("name" in f && f.name) {
      ...
      S = h.record.name, g = ut(gf(m.params, h.keys.filter((y) => !y.optional).concat(h.parent ? h.parent.keys.filter((y) => y.optional) : []).map((y) => y.name)), f.params && gf(f.params, h.keys.map((y) => y.name))), _ = h.stringify(g);
    } else if (f.path != null) _ = f.path, h = n.find((y) => y.re.test(_)), h && (g = h.parse(_), S = h.record.name);
    else {
      if (h = m.name ? l.get(m.name) : n.find((y) => y.re.test(m.path)), !h) throw qa(1, { location: f, currentLocation: m });
      S = h.record.name, g = ut({}, m.params, f.params), _ = h.stringify(g);
    }
    const k = [];
    let p = h;
    for (; p; ) k.unshift(p.record), p = p.parent;
    return { name: S, path: _, params: g, matched: k, meta: zS(k) };
  }
  e.forEach((f) => r(f));
  function s() {
    n.length = 0, l.clear();
...
const QS = /* @__PURE__ */ Ta({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" } }, useLink: Sf, setup(e, { slots: t }) {
  const n = Bn(Sf(e)), { options: l } = Tt(Ks), a = v(() => ({ [Cf(e.activeClass, l.linkActiveClass, "router-link-active")]: n.isActive, [Cf(e.exactActiveClass, l.linkExactActiveClass, "router-link-exact-active")]: n.isExactActive }));
  return () => {
...
function ZS(e) {
  ...
  function h(M, ee) {
    let O, oe;
    return wg(M) ? (O = t.getRecordMatcher(M), oe = ee) : oe = M, t.addRoute(oe, O);
  }
  function g(M) {
  ...
  function k(M, ee) {
    if (ee = ut({}, ee || u.value), typeof M == "string") {
      const D = ru(n, M, ee.path), te = t.resolve({ path: D.path }, ee), ae = a.createHref(D.fullPath);
      return ut(D, te, { params: m(te.params), hash: xr(D.hash), redirectedFrom: void 0, href: ae });
    }
    let O;
    if (M.path != null) O = ut({}, M, { path: ru(n, M.path, ee.path).path });
    else {
      const D = ut({}, M.params);
      for (const te in D) D[te] == null && delete D[te];
      O = ut({}, M, { params: f(D) }), ee.params = f(ee.params);
    }
    const oe = t.resolve(O, ee), ne = M.hash || "";
    oe.params = s(m(oe.params));
    const w = fS(l, ut({}, M, { hash: oS(ne), path: oe.path })), E = a.createHref(w);
    return ut({ fullPath: w, hash: ne, query: l === _f ? HS(M.query) : M.query || {} }, oe, { redirectedFrom: void 0, href: E });
  }
  function p(M) {
  ...
  function B(M, ee) {
    const O = c = k(M), oe = u.value, ne = M.state, w = M.force, E = M.replace === true, D = R(O);
    if (D) return B(ut(p(D), { state: typeof D == "object" ? ut({}, ne, D.state) : ne, force: w, replace: E }), ee || O);
    const te = O;
    te.redirectedFrom = ee;
    let ae;
    return !w && vS(l, oe, O) && (ae = qa(16, { to: te, from: oe }), Q(oe, oe, true, false)), (ae ? Promise.resolve(ae) : $(te, oe)).catch((Y) => Hn(Y) ? Hn(Y, 2) ? Y : le(Y) : F(Y, te, oe)).then((Y) => {
      if (Y) {
        if (Hn(Y, 2)) return B(ut({ replace: E }, p(Y.to), { state: typeof Y.to == "object" ? ut({}, ne, Y.to.state) : ne, force: w }), ee || te);
      } else Y = q(te, oe, true, E, ne);
      return z(te, oe, Y), Y;
    });
  }
  function I(M, ee) {
  ...
  function $(M, ee) {
    let O;
    const [oe, ne, w] = JS(M, ee);
    O = ou(oe.reverse(), "beforeRouteLeave", M, ee);
    for (const D of oe) D.leaveGuards.forEach((te) => {
      O.push(fl(te, M, ee));
    });
    const E = I.bind(null, M, ee);
    return O.push(E), P(O).then(() => {
      O = [];
      for (const D of r.list()) O.push(fl(D, M, ee));
      return O.push(E), P(O);
    }).then(() => {
      O = ou(ne, "beforeRouteUpdate", M, ee);
      for (const D of ne) D.updateGuards.forEach((te) => {
        O.push(fl(te, M, ee));
      });
      return O.push(E), P(O);
    }).then(() => {
      O = [];
      for (const D of w) if (D.beforeEnter) if (An(D.beforeEnter)) for (const te of D.beforeEnter) O.push(fl(te, M, ee));
      else O.push(fl(D.beforeEnter, M, ee));
      return O.push(E), P(O);
    }).then(() => (M.matched.forEach((D) => D.enterCallbacks = {}), O = ou(w, "beforeRouteEnter", M, ee, L), O.push(E), P(O))).then(() => {
      O = [];
      for (const D of o.list()) O.push(fl(D, M, ee));
      return O.push(E), P(O);
    }).catch((D) => Hn(D, 8) ? D : Promise.reject(D));
  }
  function z(M, ee, O) {
    i.list().forEach((oe) => L(() => oe(M, ee, O)));
  }
  function q(M, ee, O, oe, ne) {
    const w = y(M, ee);
    if (w) return w;
    const E = ee === ol, D = ua ? history.state : {};
    O && (oe || E ? a.replace(M.fullPath, ut({ scroll: E && D && D.scroll }, ne)) : a.push(M.fullPath, ne)), u.value = M, Q(M, ee, O, E), le();
  }
  let A;
  function C() {
    A || (A = a.listen((M, ee, O) => {
      if (!ce.listening) return;
      const oe = k(M), ne = R(oe);
      if (ne) {
        B(ut(ne, { replace: true, force: true }), oe).catch(sr);
        return;
      }
      c = oe;
      const w = u.value;
      ua && wS(df(w.fullPath, O.delta), hi()), $(oe, w).catch((E) => Hn(E, 12) ? E : Hn(E, 2) ? (B(ut(p(E.to), { force: true }), oe).then((D) => {
        Hn(D, 20) && !O.delta && O.type === Cr.pop && a.go(-1, false);
      }).catch(sr), Promise.reject()) : (O.delta && a.go(-O.delta, false), F(E, oe, w))).then((E) => {
        E = E || q(oe, w, false), E && (O.delta && !Hn(E, 8) ? a.go(-O.delta, false) : O.type === Cr.pop && Hn(E, 20) && a.go(-1, false)), z(oe, w, E);
      }).catch(sr);
    }));
  }
  let N = ja(), U = ja(), W;
  function F(M, ee, O) {
    le(M);
    const oe = U.list();
    return oe.length ? oe.forEach((ne) => ne(M, ee, O)) : console.error(M), Promise.reject(M);
  }
  function H() {
  ...
  function le(M) {
    return W || (W = !M, C(), N.list().forEach(([ee, O]) => M ? O(M) : ee()), N.reset()), M;
  }
  function Q(M, ee, O, oe) {
    const { scrollBehavior: ne } = e;
    if (!ua || !ne) return Promise.resolve();
    const w = !O && SS(df(M.fullPath, 0)) || (oe || !O) && history.state && history.state.scroll || null;
    return We().then(() => ne(M, ee, w)).then((E) => E && _S(E)).catch((E) => F(E, M, ee));
  }
  const T = (M) => a.go(M);
  let Z;
  const G = /* @__PURE__ */ new Set(), ce = { currentRoute: u, listening: true, addRoute: h, removeRoute: g, clearRoutes: t.clearRoutes, hasRoute: S, getRoutes: _, resolve: k, options: e, push: b, replace: x, go: T, back: () => T(-1), forward: () => T(1), beforeEach: r.add, beforeResolve: o.add, afterEach: i.add, onError: U.add, isReady: H, install(M) {
    const ee = this;
    M.component("RouterLink", KS), M.component("RouterView", XS), M.config.globalProperties.$router = ee, Object.defineProperty(M.config.globalProperties, "$route", { enumerable: true, get: () => Ie(u) }), ua && !Z && u.value === ol && (Z = true, b(a.location).catch((ne) => {
    }));
    const O = {};
    for (const ne in ol) Object.defineProperty(O, ne, { get: () => u.value[ne], enumerable: true });
  ...
  function P(M) {
    return M.reduce((ee, O) => ee.then(() => L(O)), Promise.resolve());
  }
  return ce;
}
function JS(e, t) {
...
const cx = /* @__PURE__ */ Ta({ __name: "HelloWorld", setup(e) {
  ...
  return (n, l) => {
    ...
    return Yn(), Bv(rn, null, [Je(Ie(Ze), { class: "q-ma-lg", color: "primary", onClick: t }, { default: At(() => l[0] || (l[0] = [Bl("test")])), _: 1 }), Je(a)], 64);
  };
...
function mx(e, t) {
  var n = t[0], l = t[1], a = t[2], r = t[3], o = t[4], i = t[5], u = t[6], c = t[7], s = t[8], f = t[9], m = t[10], h = t[11], g = t[12], _ = t[13], S = t[14], k = t[15], p = n * i - l * o, y = n * u - a * o, b = n * c - r * o, x = l * u - a * i, R = l * c - r * i, B = a * c - r * u, I = s * _ - f * g, L = s * S - m * g, $ = s * k - h * g, z = f * S - m * _, q = f * k - h * _, A = m * k - h * S, C = p * A - y * q + b * z + x * $ - R * L + B * I;
  return C ? (C = 1 / C, e[0] = (i * A - u * q + c * z) * C, e[1] = (a * q - l * A - r * z) * C, e[2] = (_ * B - S * R + k * x) * C, e[3] = (m * R - f * B - h * x) * C, e[4] = (u * $ - o * A - c * L) * C, e[5] = (n * A - a * $ + r * L) * C, e[6] = (S * b - g * B - k * y) * C, e[7] = (s * B - m * b + h * y) * C, e[8] = (o * q - i * $ + c * I) * C, e[9] = (l * $ - n * q - r * I) * C, e[10] = (g * R - _ * b + k * p) * C, e[11] = (f * b - s * R - h * p) * C, e[12] = (i * L - o * z - u * I) * C, e[13] = (n * z - l * L + a * I) * C, e[14] = (_ * y - g * x - S * p) * C, e[15] = (s * x - f * y + m * p) * C, e) : null;
}
function su(e, t, n) {
  var l = n[0], a = n[1], r = n[2], o, i, u, c, s, f, m, h, g, _, S, k;
  return t === e ? (e[12] = t[0] * l + t[4] * a + t[8] * r + t[12], e[13] = t[1] * l + t[5] * a + t[9] * r + t[13], e[14] = t[2] * l + t[6] * a + t[10] * r + t[14], e[15] = t[3] * l + t[7] * a + t[11] * r + t[15]) : (o = t[0], i = t[1], u = t[2], c = t[3], s = t[4], f = t[5], m = t[6], h = t[7], g = t[8], _ = t[9], S = t[10], k = t[11], e[0] = o, e[1] = i, e[2] = u, e[3] = c, e[4] = s, e[5] = f, e[6] = m, e[7] = h, e[8] = g, e[9] = _, e[10] = S, e[11] = k, e[12] = o * l + s * a + g * r + t[12], e[13] = i * l + f * a + _ * r + t[13], e[14] = u * l + m * a + S * r + t[14], e[15] = c * l + h * a + k * r + t[15]), e;
}
function cu(e, t, n, l) {
  var a = l[0], r = l[1], o = l[2], i = Math.hypot(a, r, o), u, c, s, f, m, h, g, _, S, k, p, y, b, x, R, B, I, L, $, z, q, A, C, N;
  return i < fx ? null : (i = 1 / i, a *= i, r *= i, o *= i, u = Math.sin(n), c = Math.cos(n), s = 1 - c, f = t[0], m = t[1], h = t[2], g = t[3], _ = t[4], S = t[5], k = t[6], p = t[7], y = t[8], b = t[9], x = t[10], R = t[11], B = a * a * s + c, I = r * a * s + o * u, L = o * a * s - r * u, $ = a * r * s - o * u, z = r * r * s + c, q = o * r * s + a * u, A = a * o * s + r * u, C = r * o * s - a * u, N = o * o * s + c, e[0] = f * B + _ * I + y * L, e[1] = m * B + S * I + b * L, e[2] = h * B + k * I + x * L, e[3] = g * B + p * I + R * L, e[4] = f * $ + _ * z + y * q, e[5] = m * $ + S * z + b * q, e[6] = h * $ + k * z + x * q, e[7] = g * $ + p * z + R * q, e[8] = f * A + _ * C + y * N, e[9] = m * A + S * C + b * N, e[10] = h * A + k * C + x * N, e[11] = g * A + p * C + R * N, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e);
}
...
const bx = ["width", "height"], yx = /* @__PURE__ */ Ta({ __name: "WebGL", setup(e) {
  const t = K();
  let n = null;
  const l = { front_0: null, front_1: null, front_2: null, body: null };
  let a = null;
  const r = K([0, 0]), o = K(""), i = K(-1), u = K([0, 0, 0, 0]), c = K(640), s = K(480), f = K(0), m = (F, H, le, Q, T, Z, G) => {
    const ce = [];
    for (let P = 0; P < 6; ++P) ce.push(F + (P + Q) % 6 + 1 + G), ce.push(H + (P + T) % 6 + 1 + G), ce.push(le + (P + Z) % 6 + 1 + G);
    return ce;
  }, h = () => {
    ...
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1 * Math.cos(w), 1 * Math.sin(w), 0]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1 * Math.cos(w), 1 * Math.sin(w), 0]);
    ...
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1 * Math.cos(w), 1 * Math.sin(w), 0.2]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1 * Math.cos(w), 1 * Math.sin(w), 0.2]);
    ...
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1.2 * Math.cos(w), 1.2 * Math.sin(w), 0.2]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1.2 * Math.cos(w), 1.2 * Math.sin(w), 0.2]);
    ...
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      H = H.concat([1.2 * Math.cos(w), 1.2 * Math.sin(w), -1]);
    }
    n.bufferData(n.ARRAY_BUFFER, new Float32Array(H), n.STATIC_DRAW);
    let le = [1, 1, 0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 0, 1, 1];
    for (let ne = 0; ne < 6; ++ne) le = le.concat([1, 1, 1, 1]);
    for (let ne = 0; ne < 6; ++ne) le = le.concat([1, 1, 1, 1]);
    for (let ne = 0; ne < 6; ++ne) le = le.concat([1, 1, 1, 1]);
    for (let ne = 0; ne < 6; ++ne) le = le.concat([1, 1, 1, 1]);
    for (let ne = 0; ne < 6; ++ne) le = le.concat([1, 1, 1, 1]);
    ...
    n.bindBuffer(n.ARRAY_BUFFER, Q), n.bufferData(n.ARRAY_BUFFER, new Float32Array(le), n.STATIC_DRAW);
    const T = n.createBuffer();
    let Z = [0.5, 0.5];
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      Z = Z.concat([0.5 + 0.5 * Math.cos(w), 0.5 + 0.5 * Math.sin(w)]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      Z = Z.concat([0.5 + 0.4 * Math.cos(w), 0.5 + 0.4 * Math.sin(w)]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      Z = Z.concat([0.7 + 0.4 * Math.cos(w), 0.7 + 0.4 * Math.sin(w)]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      Z = Z.concat([0.8 + 0.5 * Math.cos(w), 0.8 + 0.5 * Math.sin(w)]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * ne * 60 / 180;
      Z = Z.concat([0.9 + 0.5 * Math.cos(w), 0.9 + 0.5 * Math.sin(w)]);
    }
    for (let ne = 0; ne < 6; ++ne) {
      const w = 3.141 * (ne + 1) * 60 / 180;
      Z = Z.concat([0.3 + 0.5 * Math.cos(w + 0), 0.3 + 0.5 * Math.sin(w + 0)]);
    }
    n.bindBuffer(n.ARRAY_BUFFER, T), n.bufferData(n.ARRAY_BUFFER, new Float32Array(Z), n.STATIC_DRAW);
    const G = n.createBuffer();
    let ce = [];
    for (let ne = 1; ne < 7; ++ne) ce = ce.concat([0, ne, 1 + ne % 6]);
    ...
    let M = [0, 0, 1], ee = [], O = [], oe = [];
    for (let ne = 0; ne < 6; ++ne) {
      const w = ne * 3.414 / 180 * 60, E = 0 * (90 * 3.414 / 180);
      ee = ee.concat([0, 0, 1]), O = O.concat([-Math.cos(w - E), -Math.sin(w - E), 0]), oe = oe.concat([Math.cos(w - E), Math.sin(w - E), 0]);
    }
    return M = M.concat(ee), M = M.concat(O), M = M.concat(O), M = M.concat(ee), M = M.concat(ee), M = M.concat(oe), M = M.concat(oe), n.bindBuffer(n.ARRAY_BUFFER, P), n.bufferData(n.ARRAY_BUFFER, new Float32Array(M), n.STATIC_DRAW), [F, Q, T, G, P];
  }, g = (F, H) => {
    const le = uu();
    return su(le, le, [0, 0, -6]), cu(le, le, 1.3 * Math.sin(H) * 3.141 / 6 / 3, [0, 1, 0]), cu(le, le, 1.2 * Math.sin(H * 1.15 + 1) * 3.141 / 4 / 3, [1, 0, 0]), cu(le, le, 1.1 * Math.sin(H * 1.33 + 2) * 3.141 / 5 / 3, [0, 0, 1]), su(le, le, [F[0], F[1], F[2]]), le;
  }, _ = (F, H) => {
    n !== null && (n.uniform1i(H.unif.sampler, 0), n.uniform1f(H.unif.mode, 1), n.drawElements(n.TRIANGLES, 3 * 6, n.UNSIGNED_SHORT, 0), n.uniform1i(H.unif.sampler, 1), n.uniform1f(H.unif.mode, 0), n.drawElements(n.TRIANGLES, 3 * 6 * 6, n.UNSIGNED_SHORT, 2 * 3 * 6));
  }, S = [[0, 1], [0, -2.2 + 1], [-2, 0], [2, 0]], k = (F, H) => {
    ...
    for (let M = 0; M < 4; ++M) {
      ...
      const ee = g(S[M].concat([u.value[M] * 0.5]), H);
      n.uniformMatrix4fv(F.unif.model, false, ee), n.uniform1f(F.unif.fade, u.value[M]);
      const O = uu();
      mx(O, ee), vx(O, O), n.uniformMatrix4fv(F.unif.normal, false, O), _(M + 1, F);
    }
    ...
    for (let M = 0; M < 4; ++M) n.uniformMatrix4fv(F.unif.model_pick, false, g(S[M].concat([u.value[M]]), H)), n.uniform4f(F.unif.id_pick, (M + 1) / 255, 0, 0, 0), n.drawElements(n.TRIANGLES, 3 * 6, n.UNSIGNED_SHORT, 0);
    ...
    const le = 3, Q = n.FLOAT, T = false, Z = 0, G = 0;
    n.bindBuffer(n.ARRAY_BUFFER, F.bufs.pos), n.vertexAttribPointer(H ? F.attr.pos_pick : F.attr.pos, le, Q, T, Z, G), n.enableVertexAttribArray(H ? F.attr.pos_pick : F.attr.pos);
  }, y = (F) => {
  ...
  const B = () => {
    ...
    `, Z = h(), G = $(Q, T), ce = { prog_draw: le, prog_pick: G, attr: { pos: n.getAttribLocation(le, "aVertexPosition"), norm: n.getAttribLocation(le, "aVertexNormal"), pos_pick: n.getAttribLocation(G, "aVertexPosition"), color: n.getAttribLocation(le, "aVertexColor"), texture: n.getAttribLocation(le, "aTextureCoord") }, unif: { proj: n.getUniformLocation(le, "uProjectionMatrix"), model: n.getUniformLocation(le, "uModelViewMatrix"), sampler: n.getUniformLocation(le, "uSampler"), normal: n.getUniformLocation(le, "uNormalMatrix"), time: n.getUniformLocation(le, "fTime"), mode: n.getUniformLocation(le, "fMode"), fade: n.getUniformLocation(le, "fFade"), proj_pick: n.getUniformLocation(G, "uProjectionMatrix"), model_pick: n.getUniformLocation(G, "uModelViewMatrix"), id_pick: n.getUniformLocation(G, "uId") }, bufs: { pos: Z[0], color: Z[1], tex: Z[2], index: Z[3], norm: Z[4] }, pick: { fb: n.createFramebuffer(), rb: n.createRenderbuffer(), tex: n.createTexture() } };
    A(), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, true), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), a = ce;
  }, I = () => {
    if (t.value === void 0 || (n === null && (n = t.value.getContext("webgl2", {})), n === null)) return;
    a === null && B(), n.viewport(0, 0, c.value, s.value);
    let F = 0, H = false;
    R = setInterval(() => {
      H ? (F -= 0.033, F < 0 && (F = 0, H = false)) : (F += 0.033, F > 7.5 && (F = 7.5, H = true)), a !== null && (L(), k(a, F));
    }, 25);
  }, L = (F) => {
    for (let H = 0; H < 4; ++H) i.value - 1 == H ? u.value[H] < 1 && (u.value[H] += 0.05) : u.value[H] > 0 && (u.value[H] -= 0.05);
  }, $ = (F, H) => {
    if (n === null) throw new Error("no webgl");
    const le = z(n.VERTEX_SHADER, F), Q = z(n.FRAGMENT_SHADER, H), T = n.createProgram();
    return n.attachShader(T, le), n.attachShader(T, Q), n.linkProgram(T), T;
  }, z = (F, H) => {
    if (n === null) throw new Error("no webgl");
    const le = n.createShader(F);
    if (le === null) throw new Error("bad shader");
    return n.shaderSource(le, H), n.compileShader(le), le;
  }, q = () => {
    if (n === null) return null;
    const F = n.createTexture();
    return n.bindTexture(n.TEXTURE_2D, F), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, 1, 1, 0, n.RGBA, n.UNSIGNED_BYTE, null), F;
  }, A = () => {
    if (n === null) throw new Error("loadTexture no context");
    l.front_0 = q(), l.front_1 = q(), l.front_2 = q(), l.body = q();
  }, C = (F, H) => {
    if (n === null) return;
    const le = H.target;
    n.bindTexture(n.TEXTURE_2D, l[F]), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, le), n.generateMipmap(n.TEXTURE_2D);
  }, N = (F) => {
    if (n === null || t.value === void 0) return;
    const H = F, le = H.offsetX, Q = H.offsetY;
    le - t.value.clientWidth / 2, Q - t.value.clientHeight / 2, (le - n.canvas.width / 2) / 2, (Q - n.canvas.height / 2) / 2, r.value = [le, Q];
  }, U = () => {
    R != 0 && clearInterval(R);
    const F = document.getElementById("header");
    F !== null && (f.value = F.getBoundingClientRect().bottom);
    let H = 0;
    document.getElementById("footer"), F !== null && (H = F.getBoundingClientRect().height), We(() => {
      c.value = window.innerWidth, s.value = window.innerHeight - f.value - H, We(I);
    });
  };
  ft(() => {
  ...
  return (F, H) => (Yn(), Bv(rn, null, [Gn("canvas", { id: "canvas", ref_key: "canvas", ref: t, onMousemove: H[0] || (H[0] = (le) => N(le)), width: c.value, height: s.value, style: jo(W()) }, null, 44, bx), Gn("img", { src: "img/tex.jpg", onLoad: H[1] || (H[1] = (le) => C("front_0", le)), style: { display: "none" } }, null, 32), Gn("img", { src: "img/clock.jpg", onLoad: H[2] || (H[2] = (le) => C("front_1", le)), style: { display: "none" } }, null, 32), Gn("img", { src: "img/tv.jpg", onLoad: H[3] || (H[3] = (le) => C("front_2", le)), style: { display: "none" } }, null, 32), Gn("img", { src: "img/wood.jpg", onLoad: H[4] || (H[4] = (le) => C("body", le)), style: { display: "none" } }, null, 32)], 64));
