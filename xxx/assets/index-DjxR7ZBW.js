...
const ag = (e, t) => {
  ...
  const t = Vw();
  let n = Q(true), l = Q(false), a = Q(true);
  return (r, o) => {
    const i = us("router-view"), u = q0("ripple");
    return Yn(), Pl(De(w1), { view: "hHh LpR fFf" }, { default: Lt(() => [Je(De(u1), { class: "bg-primary text-white", elevated: "" }, { default: Lt(() => [Je(De(L_), null, { default: Lt(() => [Je(De(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: o[0] || (o[0] = (c) => pt(n) ? n.value = !De(n) : n = !De(n)) }), Je(De(B_), null, { default: Lt(() => [Je(De(im), null, { default: Lt(() => o[10] || (o[10] = [ds("img", { src: "https://cdn.quasar.dev/logo-v2/svg/logo-mono-white.svg" }, null, -1)])), _: 1 }), o[11] || (o[11] = oa("\xA0Title"))]), _: 1 }), De(t).dark.isActive ? (Yn(), Pl(De(Ze), { key: 0, dense: "", flat: "", round: "", icon: De(jw), onClick: o[1] || (o[1] = (c) => De(t).dark.set(false)) }, null, 8, ["icon"])) : mc("", true), De(t).dark.isActive ? mc("", true) : (Yn(), Pl(De(Ze), { key: 1, dense: "", flat: "", round: "", icon: De(Nw), onClick: o[2] || (o[2] = (c) => De(t).dark.set(true)) }, null, 8, ["icon"])), Je(De(Ze), { dense: "", flat: "", round: "", icon: "menu", onClick: o[3] || (o[3] = (c) => pt(l) ? l.value = !De(l) : l = !De(l)) })]), _: 1 }), Je(De(Lu), { align: "left" }, { default: Lt(() => [Je(De(eu), { to: "/page1", label: "Page One" }), Je(De(eu), { to: "/page2", label: "Page Two" }), Je(De(eu), { to: "/page3", label: "Page Three" })]), _: 1 })]), _: 1 }), Je(De(_d), { "show-if-above": "", modelValue: De(n), "onUpdate:modelValue": o[8] || (o[8] = (c) => pt(n) ? n.value = c : n = c), side: "left", bordered: "", mini: De(a) }, { default: Lt(() => [Je(De(R1), { class: "fit" }, { default: Lt(() => [Je(De(xh), { class: "menu-list padding" }, { default: Lt(() => [un((Yn(), Pl(De(wa), { clickable: "", onMouseover: o[4] || (o[4] = (c) => pt(a) ? a.value = false : a = false), onMouseout: o[5] || (o[5] = (c) => pt(a) ? a.value = true : a = true) }, { default: Lt(() => [Je(De(mn), { avatar: "" }, { default: Lt(() => [Je(De(et), { name: "inbox" })]), _: 1 }), Je(De(mn), null, { default: Lt(() => o[12] || (o[12] = [oa("inbox")])), _: 1 })]), _: 1 })), [[u]]), un((Yn(), Pl(De(wa), { clickable: "", onMouseover: o[6] || (o[6] = (c) => pt(a) ? a.value = false : a = false), onMouseout: o[7] || (o[7] = (c) => pt(a) ? a.value = true : a = true) }, { default: Lt(() => [Je(De(mn), { avatar: "" }, { default: Lt(() => [Je(De(et), { name: "login" })]), _: 1 }), Je(De(mn), null, { default: Lt(() => o[13] || (o[13] = [oa("login")])), _: 1 })]), _: 1 })), [[u]])]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["modelValue", "mini"]), Je(De(_d), { modelValue: De(l), "onUpdate:modelValue": o[9] || (o[9] = (c) => pt(l) ? l.value = c : l = c), side: "right", bordered: "" }, { default: Lt(() => o[14] || (o[14] = [oa("right")])), _: 1 }, 8, ["modelValue"]), Je(De($1), null, { default: Lt(() => [Je(i)]), _: 1 })]), _: 1 });
  };
} });
/*!
* vue-router v4.5.0
...
const dx = /* @__PURE__ */ ka({ __name: "WebGL", setup(e) {
  ...
  return ft(c), (h, m) => (Yn(), qv("canvas", { id: "canvas", width: "640", height: "480", ref_key: "canvas", ref: t }, null, 512));
