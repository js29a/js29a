...
function c0(e, t, n = mt) {
  ...
  const y = (b) => {
    if (!(!(s.flags & 1) || !s.dirty && !b)) if (t) {
      const x = s.run();
      if (a || g || (_ ? x.some((A, R) => ml(A, p[R])) : ml(x, p))) {
        h && h();
        const A = $l;
        $l = s;
        try {
          const R = [x, p === Or ? void 0 : _ && p[0] === Or ? [] : p, m];
          u ? u(t, 3, R) : t(...R), p = x;
        } finally {
          $l = A;
        }
...
const Yf = Symbol("_vte"), Gf = (e) => e.__isTeleport, tr = (e) => e && (e.disabled || e.disabled === ""), tc = (e) => e && (e.defer || e.defer === ""), nc = (e) => typeof SVGElement < "u" && e instanceof SVGElement, lc = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, vu = (e, t) => {
  ...
  if (e == null) {
    ...
    const R = (L, P) => {
      ...
      const L = t.target = vu(t.props, g), P = Zf(L, t, _, m);
      L && (o !== "svg" && nc(L) ? o = "svg" : o !== "mathml" && lc(L) && (o = "mathml"), C || (R(L, P), to(t, false)));
    };
    C && (R(n, A), to(t, true)), tc(t.props) ? Bt(() => {
    ...
    const x = t.anchor = e.anchor, A = t.target = e.target, R = t.targetAnchor = e.targetAnchor, I = tr(e.props), L = I ? n : A, P = I ? x : R;
    if (o === "svg" || nc(A) ? o = "svg" : (o === "mathml" || lc(A)) && (o = "mathml"), b ? (h(e.dynamicChildren, b, L, a, r, o, i), ds(e, t, true)) : u || f(e, t, L, P, a, r, o, i, false), C) I ? t.props && e.props && t.props.to !== e.props.to && (t.props.to = e.props.to) : Fr(t, n, x, c, 1);
...
function vr(e, t, n, l, a) {
  const { appear: r, mode: o, persisted: i = false, onBeforeEnter: u, onEnter: c, onAfterEnter: s, onEnterCancelled: f, onBeforeLeave: h, onLeave: m, onAfterLeave: g, onLeaveCancelled: _, onBeforeAppear: w, onAppear: C, onAfterAppear: p, onAppearCancelled: y } = t, b = String(e.key), x = lv(n, e), A = (L, P) => {
    L && En(L, l, 9, P);
  }, R = (L, P) => {
    const z = P[1];
    A(L, P), je(L) ? L.every((q) => q.length <= 1) && z() : L.length <= 1 && z();
    ...
    L[sl] && L[sl](true);
    const z = x[b];
    z && fl(e, z) && z.el[sl] && z.el[sl](), A(P, [L]);
  }, enter(L) {
    let P = c, z = s, q = f;
    if (!n.isMounted) if (r) P = C || c, z = p || s, q = y || f;
    else return;
    let E = false;
    const k = L[Vr] = (D) => {
      E || (E = true, D ? A(q, [L]) : A(z, [L]), I.delayedLeave && I.delayedLeave(), L[Vr] = void 0);
    };
    P ? R(P, [L, k]) : k();
  }, leave(L, P) {
    ...
    let q = false;
    const E = L[sl] = (k) => {
      q || (q = true, P(), k ? A(_, [L]) : A(g, [L]), L[sl] = void 0, x[z] === e && delete x[z]);
    };
    x[z] = e, m ? R(m, [L, E]) : E();
  }, clone(L) {
    const P = vr(L, t, n, l, a);
    return a && a(P), P;
  } };
  return I;
}
...
const ca = (e) => !!e.type.__asyncLoader, Qo = (e) => e.type.__isKeepAlive, y0 = { name: "KeepAlive", __isKeepAlive: true, props: { include: [String, RegExp, Array], exclude: [String, RegExp, Array], max: [String, Number] }, setup(e, { slots: t }) {
  ...
  l.activate = (p, y, b, x, A) => {
    const R = p.component;
    c(p, y, b, 0, i), u(R.vnode, p, y, b, R, i, x, p.slotScopeIds, A), Bt(() => {
      R.isDeactivated = false, R.a && Xa(R.a);
  ...
  return ft(C), Yo(C), Ke(() => {
    ...
    const x = b.type, A = pu(ca(b) ? b.type.__asyncResolved || {} : x), { include: R, exclude: I, max: L } = e;
    if (R && (!A || !Na(R, A)) || I && A && Na(I, A)) return b.shapeFlag &= -257, o = b, y;
    const P = b.key == null ? x : b.key, z = a.get(P);
    return b.el && (b = Gn(b), y.shapeFlag & 128 && (y.ssContent = b)), w = P, z ? (b.el = z.el, b.component = z.component, b.transition && bl(b, b.transition), b.shapeFlag |= 512, r.delete(P), r.add(P)) : (r.add(P), L && r.size > parseInt(L, 10) && _(r.values().next().value)), b.shapeFlag |= 256, o = b, po(y.type) ? y : b;
  };
} }, rv = y0;
function Na(e, t) {
...
function M0(e) {
  ...
  if (N(Wo, f), N(ft, h), N(qa, m), N(Yo, g), N(_l, _), N(Fn, w), N(x0, I), N(S0, A), N(w0, R), N(Ke, p), N(Go, b), N(_0, L), je(P)) if (P.length) {
    const j = e.exposed || (e.exposed = {});
    P.forEach((Y) => {
      Object.defineProperty(j, Y, { get: () => n[Y], set: (le) => n[Y] = le });
    });
  } else e.exposed || (e.exposed = {});
  x && e.render === On && (e.render = x), z != null && (e.inheritAttrs = z), q && (e.components = q), E && (e.directives = E), L && av(e);
}
...
function N0(e, t) {
  ...
  const { insert: l, remove: a, patchProp: r, createElement: o, createText: i, createComment: u, setText: c, setElementText: s, parentNode: f, nextSibling: h, setScopeId: m = On, insertStaticContent: g } = e, _ = (S, M, V, Z = null, te = null, Q = null, de = void 0, me = null, fe = !!M.dynamicChildren) => {
    ...
    M.type === "svg" ? de = "svg" : M.type === "math" && (de = "mathml"), S == null ? A(M, V, Z, te, Q, de, me, fe) : L(S, M, te, Q, de, me, fe);
  }, A = (S, M, V, Z, te, Q, de, me) => {
    let fe, ce;
    const { props: ne, shapeFlag: H, transition: oe, dirs: _e } = S;
    if (fe = S.el = o(S.type, Q, ne && ne.is, ne), H & 8 ? s(fe, S.children) : H & 16 && I(S.children, fe, null, Z, te, Ci(S, Q), de, me), _e && xl(S, null, Z, "created"), R(fe, S, S.scopeId, de, Z), ne) {
    ...
    if (te) {
      ...
      if (M === Q || po(Q.type) && (Q.ssContent === M || Q.ssFallback === M)) {
        const de = te.vnode;
        R(S, de, de.scopeId, de.slotScopeIds, te.parent);
      }
    }
    ...
    let _e;
    if (V && Cl(V, false), (_e = oe.onVnodeBeforeUpdate) && vn(_e, V, M, S), ne && xl(M, S, V, "beforeUpdate"), V && Cl(V, true), (H.innerHTML && oe.innerHTML == null || H.textContent && oe.textContent == null) && s(me, ""), ce ? P(S.dynamicChildren, ce, me, V, Z, Ci(M, te), Q) : de || Y(S, M, me, null, V, Z, Ci(M, te), Q, false), fe > 0) {
    ...
    _e && (me = me ? me.concat(_e) : _e), S == null ? (l(ce, V, Z), l(ne, V, Z), I(M.children || [], V, ne, te, Q, de, me, fe)) : H > 0 && H & 64 && oe && S.dynamicChildren ? (P(S.dynamicChildren, oe, V, te, Q, de, me), (M.key != null || te && M === te.subTree) && ds(S, M, true)) : Y(S, M, V, ne, te, Q, de, me, fe);
  ...
  }, re = { p: _, um: T, m: W, r: ee, mt: k, mc: I, pc: Y, pbc: P, n: $, o: e };
...
function Pv(e) {
  ...
  return zt(t, { onBeforeEnter(q) {
    ...
    L(q, false, void 0, true), kl(y, [q]);
  }, onAppearCancelled(q) {
    L(q, true, void 0, true), kl(I, [q]);
  }, onLeaveCancelled(q) {
    P(q), kl(x, [q]);
  } });
}
...
function li({ fallbackTag: e, useDisableForRouterLinkProps: t = true } = {}) {
  const n = Se(), { props: l, proxy: a, emit: r } = n, o = ps(n), i = v(() => l.disable !== true && l.href !== void 0), u = v(t === true ? () => o === true && l.disable !== true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== "" : () => o === true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== ""), c = v(() => u.value === true ? p(l.to) : null), s = v(() => c.value !== null), f = v(() => i.value === true || s.value === true), h = v(() => l.type === "a" || f.value === true ? "a" : l.tag || e || "div"), m = v(() => i.value === true ? { href: l.href, target: l.target } : s.value === true ? { href: c.value.href, target: l.target } : {}), g = v(() => {
    ...
    const { matched: x } = c.value, { length: A } = x, R = x[A - 1];
    if (R === void 0) return -1;
    const I = a.$route.matched;
    if (I.length === 0) return -1;
    const L = I.findIndex(Nc.bind(null, R));
    if (L !== -1) return L;
    const P = Hc(x[A - 2]);
    return A > 1 && Hc(R) === P && I[I.length - 1].path !== P ? I.findIndex(Nc.bind(null, x[A - 2])) : L;
  ...
  function y(x, { returnRouterError: A, to: R = l.to, replace: I = l.replace } = {}) {
    ...
    x.preventDefault();
    const L = a.$router[I === true ? "replace" : "push"](R);
    return A === true ? L : L.then(() => {
    }).catch(() => {
    });
  }
  function b(x) {
...
var { passiveCapture: fn } = dt, Gl = null, Xl = null, Zl = null, Ze = ve({ name: "QBtn", props: { ...Fy, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: n }) {
  ...
  const C = v(() => e.label !== void 0 && e.label !== null && e.label !== ""), p = v(() => e.disable === true || e.ripple === false ? false : { keyCodes: u.value === true ? [13, 32] : [13], ...e.ripple === true ? {} : e.ripple }), y = v(() => ({ center: e.round })), b = v(() => {
    ...
    if (f.value === true) {
      const k = { onClick: R, onKeydown: I, onMousedown: P };
...
function ks(e, t = 0) {
  ...
  if (ze.is.ios === true && window.visualViewport !== void 0) {
    const A = document.body.style, { offsetLeft: R, offsetTop: I } = window.visualViewport;
    R !== Wc && (A.setProperty("--q-pe-left", R + "px"), Wc = R), I !== Yc && (A.setProperty("--q-pe-top", I + "px"), Yc = I);
  }
...
var ii = ve({ name: "QMenu", inheritAttrs: false, props: { ...bm, ...Ma, ...nt, ...Fl, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noEscDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: Ro }, self: { type: String, validator: Ro }, offset: { type: Array, validator: Mm }, scrollTarget: Wl, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...Ea, "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  let a = null, r, o, i;
  const u = Se(), { proxy: c } = u, { $q: s } = c, f = U(null), h = U(false), m = v(() => e.persistent !== true && e.noRouteDismiss !== true), g = lt(e, s), { registerTick: _, removeTick: w } = ha(), { registerTimeout: C } = Xn(), { transitionProps: p, transitionStyle: y } = ri(e), { localScrollTarget: b, changeScrollEvent: x, unconfigureScrollTarget: A } = ym(e, ee), { anchorEl: R, canShow: I } = Ss({ showing: h }), { hide: L } = $a({ showing: h, canShow: I, handleShow: pe, handleHide: W, hideOnRouteChange: m, processOnMount: true }), { showPortal: P, hidePortal: z, renderPortal: q } = Cs(u, f, J, "menu"), E = { anchorEl: R, innerRef: f, onClickOutside(O) {
    if (e.persistent !== true && h.value === true) return L(O), (O.type === "touchstart" || O.target.classList.contains("q-dialog__backdrop")) && Ne(O), true;
  ...
  function pe(O) {
    if (a = e.noRefocus === false ? document.activeElement : null, qm(be), P(), ee(), r = void 0, O !== void 0 && (e.touchPosition || e.contextMenu)) {
      const re = en(O);
      if (re.left !== void 0) {
        const { top: we, left: S } = R.value.getBoundingClientRect();
    ...
    o === void 0 && (o = he(() => s.screen.width + "|" + s.screen.height + "|" + e.self + "|" + e.anchor + "|" + s.lang.rtl, $)), e.noFocus !== true && document.activeElement.blur(), _(() => {
      ...
      s.platform.is.ios === true && (i = e.autoClose, f.value.click()), $(), P(true), n("show", O);
  ...
  function ee() {
    (R.value !== null || e.scrollTarget !== void 0) && (b.value = Vn(R.value, e.scrollTarget), x(b.value, $));
  }
  function X(O) {
  ...
  function $() {
    ks({ targetEl: f.value, offset: e.offset, anchorEl: R.value, anchorOrigin: k.value, selfOrigin: D.value, absoluteOffset: r, fit: e.fit, cover: e.cover, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function J() {
...
function As() {
  ...
  he(() => e.modelValue, (k, D) => {
    ...
    o !== true && R(N === -1 ? 0 : N < x(D) ? -1 : 1), u.value !== N && (u.value = N, t("beforeTransition", k, D), a(() => {
      t("transition", k, D);
    }, e.transitionDuration));
  });
  function C() {
  ...
  function I(k, D = u.value) {
    ...
    for (; N !== -1 && N < r.length; ) {
      ...
      if (j !== void 0 && j.props.disable !== "" && j.props.disable !== true) {
        R(k), o = true, t("update:modelValue", j.props.name), setTimeout(() => {
          o = false;
        });
        return;
      }
  ...
  return Object.assign(n, { next: C, previous: p, goTo: y }), { panelIndex: u, panelDirectives: s, updatePanelsList: q, updatePanelIndex: L, getPanelContent: z, getEnabledPanels: A, getPanels: E, isValidPanelName: b, keepAliveProps: _, needsUniqueKeepAliveWrapper: w, goToPanelByOffset: I, goToPanel: y, nextPanel: C, previousPanel: p };
}
...
ve({ name: "QCarousel", props: { ...nt, ...Es, ...Rs, transitionPrev: { type: String, default: "fade" }, transitionNext: { type: String, default: "fade" }, height: String, padding: Boolean, controlColor: String, controlTextColor: String, controlType: { type: String, validator: (e) => fp.includes(e), default: "flat" }, autoplay: [Number, Boolean], arrows: Boolean, prevIcon: String, nextIcon: String, navigation: Boolean, navigationPosition: { type: String, validator: (e) => dp.includes(e) }, navigationIcon: String, navigationActiveIcon: String, thumbnails: Boolean }, emits: [...Ps, ...$s], setup(e, { slots: t }) {
  ...
  he(() => e.modelValue, () => {
    ...
    P ? R() : a !== null && (clearTimeout(a), a = null);
  });
  function R() {
...
function Lm(e, t) {
  ...
  function P(q) {
    (q.keyCode === 13 || q.keyCode === 32) && R(q);
  }
  const z = t(g, w);
  return Object.assign(r, { toggle: R }), () => {
    const q = z();
    ...
    return k !== void 0 && E.push(d("div", { class: `q-${e}__label q-anchor--skip` }, k)), d("div", { ref: u, class: p.value, ...A.value, onClick: R, onKeydown: L, onKeyup: P }, E);
  };
}
...
function Dm({ updateValue: e, updatePosition: t, getDragging: n, formAttrs: l }) {
  ...
  }), x = v(() => a.step === 0 ? 1 : a.step), A = v(() => y.value === true ? a.tabindex || 0 : -1), R = v(() => a.max - a.min), I = v(() => p.value - C.value), L = v(() => we(C.value)), P = v(() => we(p.value)), z = v(() => a.vertical === true ? w.value === true ? "bottom" : "top" : w.value === true ? "right" : "left"), q = v(() => a.vertical === true ? "height" : "width"), E = v(() => a.vertical === true ? "width" : "height"), k = v(() => a.vertical === true ? "vertical" : "horizontal"), D = v(() => {
  ...
  const le = v(() => {
    ...
    const ae = P.value - L.value, ye = { [z.value]: `${100 * L.value}%`, [q.value]: ae === 0 ? "2px" : `${100 * ae}%` };
  ...
  function fe(ae) {
    return { [z.value]: `${100 * (ae - a.min) / R.value}%` };
  }
  const ce = v(() => {
...
var wp = ["left", "center", "right", "justify"], Bu = ve({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => wp.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: n }) {
  ...
  let A = null, R = null, I;
  const L = v(() => ({ activeClass: e.activeClass, activeColor: e.activeColor, activeBgColor: e.activeBgColor, indicatorClass: _p(e.indicatorColor, e.switchIndicator, e.vertical), narrowIndicator: e.narrowIndicator, inlineLabel: e.inlineLabel, noCaps: e.noCaps })), P = v(() => {
  ...
  function ee(ne) {
    R !== null && clearInterval(R), R = setInterval(() => {
      O(ne) === true && B();
    }, 5);
  }
  function X() {
  ...
  const de = { currentModel: g, tabProps: L, hasFocus: x, hasActiveTab: P, registerTab: te, unregisterTab: Q, verifyRouteModel: V, updateModel: j, onKbdNavigate: $, avoidRouteWatcher: false };
  hn(em, de);
  function me() {
  ...
  function g(y, b) {
    ...
    if (l.hasRouterLink.value === true) {
      const x = (A = {}) => {
        ...
        return l.navigateToRouterLink(y, { ...A, returnRouterError: true }).catch((L) => {
          R = L;
        }).then((L) => {
          var _a3;
          if (I === a.avoidRouteWatcher && (a.avoidRouteWatcher = false, R === void 0 && (L === void 0 || ((_a3 = L.message) == null ? void 0 : _a3.startsWith("Avoided redundant navigation")) === true) && a.updateModel({ name: e.name })), A.returnRouterError === true) return R !== void 0 ? Promise.reject(R) : L;
        });
      };
...
ve({ name: "QColor", props: { ...nt, ...wn, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function we() {
    ...
    return [d("div", { class: "row items-center q-color-picker__palette-rows" + (m.value === true ? " q-color-picker__palette-rows--editable" : "") }, R.value.map(S))];
  }
  return () => {
    const S = [B()];
    return e.name !== void 0 && e.disable !== true && C(S, "push"), e.noHeader !== true && S.unshift(be()), e.noFooter !== true && S.push(J()), d("div", { class: I.value, ...L.value }, S);
  };
} });
...
ve({ name: "QDate", props: { ...Oo, ...wn, ...nt, modelValue: { required: true, validator: (e) => typeof e == "string" || Array.isArray(e) === true || Object(e) === e || e === null }, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { ...Oo.mask, default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: Hi }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: Hi }, navigationMaxYearMonth: { type: String, validator: Hi }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: fd } }, emits: [...Xm, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: n }) {
  ...
  let f;
  const h = Rr(e), m = Sl(h), g = U(null), _ = U(He()), w = U(c()), C = v(() => He()), p = v(() => c()), y = v(() => s()), b = U(ie(_.value, w.value)), x = U(e.defaultView), A = v(() => a.lang.rtl === true ? "right" : "left"), R = U(A.value), I = U(A.value), L = b.value.year, P = U(L - L % Dn - (L < 0 ? Dn : 0)), z = U(null), q = v(() => {
  ...
  function it(F, K, se) {
    ...
    const Te = F + "/" + rt(K) + "/01";
    Te !== b.value.dateHash && (R.value = b.value.dateHash < Te == (a.lang.rtl !== true) ? "left" : "right", F !== b.value.year && (I.value = R.value), Xe(() => {
  ...
  const Ue = { Calendar: () => [d("div", { key: "calendar-view", class: "q-date__view q-date__calendar" }, [d("div", { class: "q-date__navigation row items-center no-wrap" }, Be({ label: w.value.months[b.value.month - 1], type: "Months", key: b.value.month, dir: R.value, goTo: ae, boundaries: M.value.month, cls: " col" }).concat(Be({ label: b.value.year, type: "Years", key: b.value.year, dir: I.value, goTo: ye, boundaries: M.value.year, cls: "" }))), d("div", { class: "q-date__calendar-weekdays row items-center no-wrap" }, J.value.map((F) => d("div", { class: "q-date__calendar-item" }, [d("div", F)]))), d("div", { class: "q-date__calendar-days-container relative-position overflow-hidden" }, [d(Ot, { name: "q-transition--slide-" + R.value }, () => d("div", { key: Q.value, class: "q-date__calendar-days fit" }, ce.value.map((F) => d("div", { class: F.classes }, [F.in === true ? d(Ze, { class: F.today === true ? "q-date__today" : "", dense: true, flat: F.flat, unelevated: F.unelevated, color: F.color, textColor: F.textColor, label: F.i, tabindex: i.value, ...o("day#" + F.i, { onClick: () => {
    yt(F.i);
  }, onMouseover: () => {
    ht(F.i);
    ...
    const F = P.value, K = F + Dn, se = [], Te = (Ee) => we.value !== null && we.value.year > Ee || S.value !== null && S.value.year < Ee;
...
var Kr = 0, Dp = { standard: "fixed-full flex-center", top: "fixed-top justify-center", bottom: "fixed-bottom justify-center", right: "fixed-right items-center", left: "fixed-left items-center" }, yd = { standard: ["scale", "scale"], top: ["slide-down", "slide-up"], bottom: ["slide-up", "slide-down"], right: ["slide-left", "slide-right"], left: ["slide-right", "slide-left"] }, si = ve({ name: "QDialog", inheritAttrs: false, props: { ...Ma, ...Fl, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, backdropFilter: String, position: { type: String, default: "standard", validator: (e) => ["standard", "top", "bottom", "left", "right"].includes(e) } }, emits: [...Ea, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  const h = v(() => e.persistent !== true && e.noRouteDismiss !== true && e.seamless !== true), { preventBodyScroll: m } = rh(), { registerTimeout: g } = Xn(), { registerTick: _, removeTick: w } = ha(), { transitionProps: C, transitionStyle: p } = ri(e, () => yd[e.position][0], () => yd[e.position][1]), y = v(() => p.value + (e.backdropFilter !== void 0 ? `;backdrop-filter:${e.backdropFilter};-webkit-backdrop-filter:${e.backdropFilter}` : "")), { showPortal: b, hidePortal: x, portalIsAccessible: A, renderPortal: R } = Cs(a, r, be, "dialog"), { hide: I } = $a({ showing: o, hideOnRouteChange: h, handleShow: D, handleHide: N, processOnMount: true }), { addToHistory: L, removeFromHistory: P } = ah(o, I, h), z = v(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${e.maximized === true ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${Dp[e.position]}` + (i.value === true ? " q-dialog__inner--animating" : "") + (e.fullWidth === true ? " q-dialog__inner--fullwidth" : "") + (e.fullHeight === true ? " q-dialog__inner--fullheight" : "") + (e.square === true ? " q-dialog__inner--square" : "")), q = v(() => o.value === true && e.seamless !== true), E = v(() => e.autoClose === true ? { onClick: T } : {}), k = v(() => [`q-dialog fullscreen no-pointer-events q-dialog--${q.value === true ? "modal" : "seamless"}`, l.class]);
  he(() => e.maximized, (B) => {
    o.value === true && W(B);
  }), he(q, (B) => {
  ...
  function D(B) {
    var _a2;
    L(), c = e.noRefocus === false && document.activeElement !== null ? document.activeElement : null, W(e.maximized), b(), i.value = true, e.noFocus !== true ? ((_a2 = document.activeElement) == null ? void 0 : _a2.blur(), _(j)) : w(), g(() => {
  ...
  function N(B) {
    w(), P(), pe(true), i.value = true, x(), c !== null && ((((B == null ? void 0 : B.type.indexOf("key")) === 0 ? c.closest('[tabindex]:not([tabindex^="-"])') : void 0) || c).focus(), c = null), g(() => {
  ...
  function y(H, oe) {
    if (R(), H !== false && s.animate(), M(0), g.value === true) {
  ...
  const { show: x, hide: A } = $a({ showing: C, hideOnRouteChange: p, handleShow: y, handleHide: b }), { addToHistory: R, removeFromHistory: I } = ah(C, A, p), L = { belowBreakpoint: g, hide: A }, P = v(() => e.side === "right"), z = v(() => (r.lang.rtl === true ? -1 : 1) * (P.value === true ? 1 : -1)), q = U(0), E = U(false), k = U(false), D = U(w.value * z.value), N = v(() => P.value === true ? "left" : "right"), j = v(() => C.value === true && g.value === false && e.overlay === false ? e.miniToOverlay === true ? e.miniWidth : w.value : 0), Y = v(() => e.overlay === true || e.miniToOverlay === true || s.view.value.indexOf(P.value ? "R" : "L") !== -1 || r.platform.is.ios === true && s.isContainer.value === true), le = v(() => e.overlay === false && C.value === true && g.value === false), pe = v(() => e.overlay === true && C.value === true && g.value === false), W = v(() => "fullscreen q-drawer__backdrop" + (C.value === false && E.value === false ? " hidden" : "")), T = v(() => ({ backgroundColor: `rgba(0,0,0,${q.value * 0.4})` })), ee = v(() => P.value === true ? s.rows.value.top[2] === "r" : s.rows.value.top[0] === "l"), X = v(() => P.value === true ? s.rows.value.bottom[2] === "r" : s.rows.value.bottom[0] === "l"), be = v(() => {
    const H = {};
  ...
  he(g, (H) => {
    ...
    s.instances[oe] === L && (s.instances[oe] = void 0, s[oe].space = false, s[oe].offset = 0), s.instances[H] = L, s[H].size = w.value, s[H].space = le.value, s[H].offset = j.value;
  }), he(s.totalWidth, () => {
  ...
  function Q(H) {
    ...
    M((r.lang.rtl === true ? P.value !== true : P.value) ? Math.max(oe - _e, 0) : Math.min(0, _e - oe)), V(ct(_e / oe, 0, 1)), H.isFirst === true && (E.value = true);
  }
  function de(H) {
  ...
  return s.instances[e.side] = L, ne(e.miniToOverlay, w.value), fe("space", le.value), fe("offset", j.value), e.showIfAbove === true && e.modelValue !== true && C.value === true && e["onUpdate:modelValue"] !== void 0 && n("update:modelValue", true), ft(() => {
    ...
    m == null ? void 0 : m(), h !== null && (clearTimeout(h), h = null), C.value === true && me(), s.instances[e.side] === L && (s.instances[e.side] = void 0, fe("size", 0), fe("offset", 0), fe("space", false));
  }), () => {
    const H = [];
...
var Hp = /^https?:\/\//, Np = class {
  ...
  if (i.platform.is.mobile === true) {
    const ee = { anchorEl: x, innerRef: u, onClickOutside(be) {
      return L(be), be.target.classList.contains("q-dialog__backdrop") && Ne(be), true;
  ...
  function D() {
    r !== void 0 && (r.disconnect(), r = void 0), a !== void 0 && (a(), a = void 0), b(), Wt(R, "tooltipTemp");
  }
  function N() {
  ...
  function Y(ee) {
    i.platform.is.mobile === true && (Wt(R, "tooltipTemp"), Mn(), setTimeout(() => {
  ...
  function pe() {
    if (x.value !== null || e.scrollTarget !== void 0) {
      ...
      const ee = e.noParentEvent === true ? N : L;
      y(p.value, ee);
    }
  }
  function W() {
...
ve({ name: "QEditor", props: { ...nt, ...Rs, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => e.length === 0 || e.every((t) => t.length), default: () => [["left", "center", "right", "justify"], ["bold", "italic", "underline", "strike"], ["undo", "redo"]] }, toolbarColor: String, toolbarBg: String, toolbarTextColor: String, toolbarToggleColor: { type: String, default: "primary" }, toolbarOutline: Boolean, toolbarPush: Boolean, toolbarRounded: Boolean, paragraphTag: { type: String, validator: (e) => ["div", "p"].includes(e), default: "div" }, contentStyle: Object, contentClass: [Object, Array, String], square: Boolean, flat: Boolean, dense: Boolean }, emits: [...Ps, "update:modelValue", "keydown", "click", "focus", "blur", "dropdownShow", "dropdownHide", "dropdownBeforeShow", "dropdownBeforeHide", "linkShow", "linkHide"], setup(e, { slots: t, emit: n }) {
  ...
  const A = v(() => e.toolbar && e.toolbar.length !== 0), R = v(() => {
    const B = {}, $ = (J) => {
  ...
  }), I = v(() => o.value ? e.contentStyle : [{ minHeight: e.minHeight, height: e.height, maxHeight: e.maxHeight }, e.contentStyle]), L = v(() => `q-editor q-editor--${h.value === true ? "source" : "default"}` + (e.disable === true ? " disabled" : "") + (o.value === true ? " fullscreen column" : "") + (e.square === true ? " q-editor--square no-border-radius" : "") + (e.flat === true ? " q-editor--flat" : "") + (e.dense === true ? " q-editor--dense" : "") + (r.value === true ? " q-editor--dark q-dark" : "")), P = v(() => [e.contentClass, "q-editor__content", { col: o.value, "overflow-auto": o.value || e.maxHeight }]), z = v(() => e.disable === true ? { "aria-disabled": "true" } : {});
  function q() {
    if (s.value !== null) {
  ...
  return ft(() => {
    ...
    return d("div", { ref: c, class: L.value, style: { height: o.value === true ? "100%" : null }, ...z.value, onFocusin: j, onFocusout: Y }, [B, d("div", { ref: s, style: I.value, class: P.value, contenteditable: m.value, placeholder: e.placeholder, ...u.listeners.value, onInput: q, onKeydown: E, onClick: k, onBlur: D, onFocus: N, onMousedown: le, onTouchstartPassive: le })]);
  };
} });
...
ve({ name: "QExpansionItem", props: { ...$r, ...Ma, ...nt, icon: String, label: String, labelLines: [Number, String], caption: String, captionLines: [Number, String], dense: Boolean, toggleAriaLabel: String, expandIcon: String, expandedIcon: String, expandIconClass: [Array, String, Object], duration: {}, headerInsetLevel: Number, contentInsetLevel: Number, expandSeparator: Boolean, defaultOpened: Boolean, hideExpandIcon: Boolean, expandIconToggle: Boolean, switchToggleSide: Boolean, denseToggle: Boolean, group: String, popup: Boolean, headerStyle: [Array, String, Object], headerClass: [Array, String, Object] }, emits: [...Ea, "click", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  function q() {
    ...
    return y.value === true && (Object.assign(j, { tabindex: 0, ...x.value, onClick: I, onKeyup: R }), Y.unshift(d("div", { ref: o, class: "q-expansion-item__toggle-focus q-icon q-focus-helper q-focus-helper--rounded", tabindex: -1 }))), d(mn, j, () => Y);
  }
  function E() {
    let j;
...
function o1(e, t) {
  ...
  function _(C = n.modelValue) {
    ...
    const p = ++i, y = t.value !== true ? () => {
      ...
      A === true && y(), a.value = A, r.value = R || null, t.value = false;
    }, x = [];
    for (let A = 0; A < n.rules.length; A++) {
      const R = n.rules[A];
      let I;
      if (typeof R == "function" ? I = R(C, oo) : typeof R == "string" && oo[R] !== void 0 && (I = oo[R](C)), I === false || typeof I == "string") return b(true, I), false;
    ...
    return x.length === 0 ? (b(false), true) : (t.value = true, Promise.all(x).then((A) => {
      ...
      const R = A.find((I) => I === false || typeof I == "string");
      return p === i && b(R !== void 0, R), R === void 0;
...
function vi(e) {
  ...
  }), e.controlEvents === void 0 && (e.controlEvents = { onFocusin: L, onFocusout: P }), Object.assign(e, { clearValue: z, onControlFocusin: L, onControlFocusout: P, focus: R }), e.computedCounter === void 0 && (e.computedCounter = v(() => {
    if (t.counter !== false) {
  ...
  }), Object.assign(r, { focus: R, blur: I }), function() {
...
function bh({ editable: e, dnd: t, getFileInput: n, addFilesToQueue: l }) {
  ...
  function m(p, y, b, x) {
    ...
    const R = [], I = () => {
      R.length !== 0 && r("rejected", R);
    };
    if (a.accept !== void 0 && u.value.indexOf("*/") === -1 && (A = na(A, R, "accept", (L) => u.value.some((P) => L.type.toUpperCase().startsWith(P) || L.name.toUpperCase().endsWith(P))), A.length === 0)) return I();
    if (a.maxFileSize !== void 0) {
      const L = parseInt(a.maxFileSize, 10);
      if (A = na(A, R, "max-file-size", (P) => P.size <= L), A.length === 0) return I();
    }
    if (a.multiple !== true && A.length !== 0 && (A = [A[0]]), A.forEach((L) => {
      L.__key = L.webkitRelativePath + L.lastModified + L.name + L.size;
    }), x === true) {
      const L = b.map((P) => P.__key);
      A = na(A, R, "duplicate", (P) => L.includes(P.__key) === false);
    }
    if (A.length === 0) return I();
    if (a.maxTotalSize !== void 0) {
      let L = x === true ? b.reduce((P, z) => P + z.size, 0) : 0;
      if (A = na(A, R, "max-total-size", (P) => (L += P.size, L <= s.value)), A.length === 0) return I();
    }
    if (typeof a.filter == "function") {
      const L = a.filter(A);
      A = na(A, R, "filter", (P) => L.includes(P));
    }
    if (a.maxFiles !== void 0) {
      let L = x === true ? b.length : 0;
      if (A = na(A, R, "max-files", () => (L++, L <= c.value)), A.length === 0) return I();
    }
...
ve({ name: "QFile", inheritAttrs: false, props: { ...mh, ...wn, ...hh, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, ...gh], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  function E(j, Y) {
    ...
    pe != null && (pe.value = ""), le !== void 0 && ((e.multiple === true ? e.modelValue && le.every((W) => _.value.includes(W)) : e.modelValue === le[0]) || L(A.value === true ? _.value.concat(le) : le));
  }
  function k() {
  ...
  return Object.assign(r, { fieldClass: x, emitValue: L, hasValue: w, inputRef: o, innerValue: _, floatingLabel: v(() => w.value === true || jl(e.displayValue)), computedCounter: v(() => {
    ...
    return r.editable.value === true && Object.assign(j, { onDragover: s, onDragleave: f, onKeydown: P, onKeyup: z }), d("div", j, [N()].concat(D()));
  } }), Object.assign(a, { removeAtIndex: R, removeFile: I, getNativeElement: () => o.value }), Ft(a, "nativeEl", () => o.value), vi(r);
} });
ve({ name: "QFooter", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: n }) {
  ...
  function p() {
    ...
    const { direction: x, position: A, inflectionPoint: R } = a.scroll.value;
    w(o, x === "up" || A - R < 100 || a.height.value - c.value - A - r.value < 300);
  }
  function y(x) {
    ...
    return (e.greedy === true ? Promise.all(o.map(C)).then((y) => y.filter((b) => b.valid !== true)) : o.reduce((y, b) => y.then(() => C(b).then((x) => {
      ...
      if (_ === r) {
        ...
        if (x !== void 0 && console.error(x), w(false, b), g === true) {
          const A = y.find(({ comp: R }) => typeof R.focus == "function" && hl(R.$) === false);
...
ve({ name: "QImg", props: { ...Is, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, loadingShowDelay: { type: [Number, String], default: 0 }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: s1 }, placeholderSrc: String, errorSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: n }) {
  ...
  function A({ target: q }) {
    hl(r) === false && (i(), l.value = q.naturalHeight === 0 ? 0.5 : q.naturalWidth / q.naturalHeight, R(q, 1));
  }
  function R(q, E) {
  ...
  function P(q) {
    ...
    return m.value === q ? Object.assign(k, { class: k.class + "current", onLoad: A, onError: L }) : k.class += "loaded", d("div", { class: "q-img__container absolute-full", key: "img" + q }, d("img", k));
  }
  function z() {
...
ve({ name: "QInfiniteScroll", props: { offset: { type: Number, default: 500 }, debounce: { type: [String, Number], default: 100 }, scrollTarget: Wl, initialIndex: { type: Number, default: 0 }, disable: Boolean, reverse: Boolean }, emits: ["load"], setup(e, { slots: t, emit: n }) {
  ...
  function f() {
    ...
    const R = Ir(u), I = gl(u), L = pa(u);
    e.reverse === false ? Math.round(I + L + e.offset) >= Math.round(R) && h() : Math.round(I) <= e.offset && h();
  }
  function h() {
    if (e.disable === true || l.value === true || a.value === false) return;
    i++, l.value = true;
  ...
  function p(R) {
    R = parseInt(R, 10);
    const I = c;
    c = R <= 0 ? f : Ta(f, isNaN(R) === true ? 100 : R), u && a.value === true && (I !== void 0 && u.removeEventListener("scroll", I, Ml), u.addEventListener("scroll", c, Ml));
  }
  function y(R) {
    if (b.value === true) {
      if (o.value === null) {
  ...
  return Object.assign(A.proxy, { poll: () => {
    ...
    const R = Er(t.default, []);
    return b.value === true && R[e.reverse === false ? "push" : "unshift"](d("div", { ref: o, class: s.value }, Pe(t.loading))), d("div", { class: "q-infinite-scroll", ref: r }, R);
  };
} });
...
function f1(e, t, n, l) {
  ...
  function g(L) {
    ...
    if (q !== -1) {
      for (let E = L - z.length; E > 0; E--) P += Pt;
  ...
  function _() {
    ...
    const L = xd[e.mask] === void 0 ? e.mask : xd[e.mask], P = typeof e.fillMask == "string" && e.fillMask.length !== 0 ? e.fillMask.slice(0, 1) : "_", z = P.replace(Cd, "\\$&"), q = [], E = [], k = [];
    let D = e.reverseFillMask === true, N = "", j = "";
    L.replace(c1, (W, T, ee, X, be) => {
      if (X !== void 0) {
        const B = Fo[X];
    ...
    }, a = k.map((W) => typeof W == "string" ? W : Pt).join(""), r = a.split(Pt).join(P);
  }
  function w(L, P, z) {
    const q = l.value, E = q.selectionEnd, k = q.value.length - E, D = R(L);
    P === true && _();
    ...
    const le = e.unmaskedValue === true ? R(j) : j;
    String(e.modelValue) !== le && (e.modelValue !== null || le !== "") && n(le, true);
  }
  function C(L, P, z) {
    const q = x(R(L.value));
    P = Math.max(0, a.indexOf(Pt), Math.min(q.length, P)), u = P, L.setSelectionRange(P, z, "forward");
  }
  const p = { left(L, P) {
    ...
    if (q < 0 && a[P] !== void 0 && a[P] !== Pt) return p.right(L, 0);
    ...
    if (q > z && a[P - 1] !== void 0 && a[P - 1] !== Pt) return p.left(L, z);
    ...
    for (; q >= 0; q--) if (z[q - 1] === Pt) {
      P = q;
      break;
    } else if (z[q] === Pt && (P = q, q === 0)) break;
    if (q < 0 && z[P] !== void 0 && z[P] !== Pt) return p.rightReverse(L, 0);
    P >= 0 && L.setSelectionRange(P, P, "backward");
  }, rightReverse(L, P) {
    const z = L.value.length, q = g(z), E = q.slice(0, P + 1).indexOf(Pt) === -1;
    let k = Math.min(z, P + 1);
    for (; k <= z; k++) if (q[k - 1] === Pt) {
      P = k, P > 0 && E === true && P--;
      break;
    }
    if (k > z && q[P - 1] !== void 0 && q[P - 1] !== Pt) return p.leftReverse(L, z);
    L.setSelectionRange(P, P, "forward");
  } };
  function y(L) {
    t("click", L), c = void 0;
  ...
  function b(L) {
    ...
    if (L.shiftKey || (c = void 0), L.keyCode === 37 || L.keyCode === 39) {
      L.shiftKey && c === void 0 && (c = P.selectionDirection === "forward" ? z : q);
      const E = p[(L.keyCode === 39 ? "right" : "left") + (e.reverseFillMask === true ? "Reverse" : "")];
      if (L.preventDefault(), E(P, c === z ? q : z), L.shiftKey) {
        const k = P.selectionStart;
        P.setSelectionRange(Math.min(c, k), Math.max(c, k), "forward");
      }
    } else L.keyCode === 8 && e.reverseFillMask !== true && z === q ? (p.left(P, z), P.setSelectionRange(P.selectionStart, q, "backward")) : L.keyCode === 46 && e.reverseFillMask === true && z === q && (p.rightReverse(P, q), P.setSelectionRange(z, P.selectionEnd, "forward"));
  }
  function x(L) {
    if (L == null || L === "") return "";
    if (e.reverseFillMask === true) return A(L);
    const P = o;
    let z = 0, q = "";
  ...
  function A(L) {
    ...
    for (let k = P.length - 1; k >= 0 && q !== -1; k--) {
      ...
      if (typeof D == "string") E = D + E, N === D && q--;
        ...
        E = (D.transform !== void 0 ? D.transform(N) : N) + E, q--, N = L[q];
...
var wh = ve({ name: "QInput", inheritAttrs: false, props: { ...ci, ...d1, ...wn, modelValue: [String, Number, FileList], shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: n }) {
  ...
  const f = U(null), h = qs(e), { innerValue: m, hasMask: g, moveCursorForPaste: _, updateMaskValue: w, onMaskedKeydown: C, onMaskedClick: p } = f1(e, t, N, f), y = yh(e, true), b = v(() => jl(m.value)), x = _h(k), A = fi({ changeEvent: true }), R = v(() => e.type === "textarea" || e.autogrow === true), I = v(() => R.value === true || ["text", "search", "url", "tel", "password"].includes(e.type)), L = v(() => {
    ...
    return R.value === false && (T.type = e.type), e.autogrow === true && (T.rows = 1), T;
  });
  he(() => e.type, () => {
  ...
  Ke(() => {
    ...
    e.autogrow === true && j();
  }), Object.assign(A, { innerValue: m, fieldClass: v(() => `q-${R.value === true ? "textarea" : "input"}` + (e.autogrow === true ? " q-textarea--autogrow" : "")), hasShadow: v(() => e.type !== "file" && typeof e.shadowText == "string" && e.shadowText.length !== 0), inputRef: f, emitValue: N, hasValue: b, floatingLabel: v(() => b.value === true && (e.type !== "number" || isNaN(m.value) === false) || jl(e.displayValue)), getControl: () => d(R.value === true ? "textarea" : "input", { ref: f, class: ["q-field__native q-placeholder", e.inputClass], style: e.inputStyle, ...P.value, ...L.value, ...e.type !== "file" ? { value: pe() } : y.value }), getShadowControl: () => d("div", { class: "q-field__native q-field__shadow absolute-bottom no-pointer-events" + (R.value === true ? "" : " text-no-wrap") }, [d("span", { class: "invisible" }, pe()), d("span", e.shadowText)]) });
  const W = vi(A);
...
ve({ name: "QKnob", props: { ...wn, ...Bs, modelValue: { type: Number, required: true }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, tabindex: { type: [Number, String], default: 0 }, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change", "dragValue"], setup(e, { slots: t, emit: n }) {
  ...
  const f = v(() => e.disable === false && e.readonly === false), h = v(() => "q-knob non-selectable" + (f.value === true ? " q-knob--editable" : e.disable === true ? " disabled" : "")), m = v(() => (String(e.step).trim().split(".")[1] || "").length), g = v(() => e.step === 0 ? 1 : e.step), _ = v(() => e.instantFeedback === true || o.value === true), w = a.platform.is.mobile === true ? v(() => f.value === true ? { onClick: R } : {}) : v(() => f.value === true ? { onMousedown: A, onClick: R, onKeydown: I, onKeyup: P } : {}), C = v(() => f.value === true ? { tabindex: e.tabindex } : { [`aria-${e.disable === true ? "disabled" : "readonly"}`]: "true" }), p = v(() => {
    const k = {};
    return p1.forEach((D) => {
      k[D] = e[D];
    }), k;
  ...
  function y(k) {
    k.isFinal ? (L(k.evt, true), o.value = false) : (k.isFirst && (x(), o.value = true), L(k.evt));
  }
...
var { passive: Md } = dt, _1 = ["both", "horizontal", "vertical"], Ch = ve({ name: "QScrollObserver", props: { axis: { type: String, validator: (e) => _1.includes(e), default: "vertical" }, debounce: [String, Number], scrollTarget: Wl }, emits: ["scroll"], setup(e, { emit: t }) {
  ...
  function _(b) {
    ...
    let R = false;
    r.value !== x && (R = true, r.value = x, e.onScrollHeight !== void 0 && n("scrollHeight", x), C()), o.value !== A && (R = true, o.value = A), R === true && e.onResize !== void 0 && n("resize", b);
  }
  function w({ height: b }) {
  ...
  if (hn(Kl, y), ro() > 0) {
    let b = function() {
      R = null, I.classList.remove("hide-scrollbar");
    }, x = function() {
      if (R === null) {
      ...
      R !== null && L === "remove" && (clearTimeout(R), b()), window[`${L}EventListener`]("resize", x);
    }, R = null;
...
ve({ name: "QPagination", props: { ...nt, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => (typeof e == "string" ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => e === "" || vm.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  }), R = v(() => ({ ...A.value, color: e.activeColor || e.color, textColor: e.activeTextColor || e.textColor })), I = v(() => {
  ...
  function q(E, k, D) {
    ...
    return D === true && Object.assign(N, { "aria-current": "true", ...R.value }), k !== void 0 && (e.toFn !== void 0 ? N.to = e.toFn(k) : N.onClick = () => {
      L(k);
    }), d(Ze, N);
  }
...
ve({ name: "QParallax", props: { src: String, height: { type: Number, default: 500 }, speed: { type: Number, default: 1, validator: (e) => e >= 0 && e <= 1 }, scrollTarget: Wl, onScroll: Function }, setup(e, { slots: t, emit: n }) {
  ...
  function g() {
    ...
    const A = qo(a.value).top, R = A + e.height;
    if (f !== void 0 || R > y && A < x) {
...
ve({ name: "QPullToRefresh", props: { color: String, bgColor: String, icon: String, noMouse: Boolean, disable: Boolean, scrollTarget: Wl }, emits: ["refresh"], setup(e, { slots: t, emit: n }) {
  ...
  function m(x) {
    ...
    const R = u.value > Xi ? "pulled" : "pull";
    r.value !== R && (r.value = R);
  }
  const g = v(() => {
    const x = { down: true };
...
ve({ name: "QRange", props: { ...zm, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: Im, setup(e, { emit: t }) {
  const { proxy: { $q: n } } = Se(), { state: l, methods: a } = Dm({ updateValue: I, updatePosition: P, getDragging: L, formAttrs: v(() => ({ type: "hidden", name: e.name, value: `${e.modelValue.min}|${e.modelValue.max}` })) }), r = U(null), o = U(0), i = U(0), u = U({ min: 0, max: 0 });
  function c() {
  ...
  const C = v(() => e.dragOnlyRange !== true ? l.tabindex.value : null), p = v(() => n.platform.is.mobile !== true && (e.dragRange || e.dragOnlyRange === true) ? l.tabindex.value : null), y = U(null), b = v(() => w("min")), x = a.getThumbRenderFn({ focusValue: "min", getNodeData: () => ({ ref: y, key: "tmin", ...b.value, tabindex: C.value }), ratio: h, label: v(() => e.leftLabelValue !== void 0 ? e.leftLabelValue : u.value.min), thumbColor: v(() => e.leftThumbColor || e.thumbColor || e.color), labelColor: v(() => e.leftLabelColor || e.labelColor), labelTextColor: v(() => e.leftLabelTextColor || e.labelTextColor) }), A = v(() => w("max")), R = a.getThumbRenderFn({ focusValue: "max", getNodeData: () => ({ ...A.value, key: "tmax", tabindex: C.value }), ratio: m, label: v(() => e.rightLabelValue !== void 0 ? e.rightLabelValue : u.value.max), thumbColor: v(() => e.rightThumbColor || e.thumbColor || e.color), labelColor: v(() => e.rightLabelColor || e.labelColor), labelTextColor: v(() => e.rightLabelTextColor || e.labelTextColor) });
  function I(q) {
  ...
  function P(q, E = l.dragging.value) {
    let k;
...
ve({ name: "QRating", props: { ...Jn, ...wn, modelValue: { type: Number, required: true }, max: { type: [String, Number], default: 5 }, icon: [String, Array], iconHalf: [String, Array], iconSelected: [String, Array], iconAriaLabel: [String, Array], color: [String, Array], colorHalf: [String, Array], colorSelected: [String, Array], noReset: Boolean, noDimming: Boolean, readonly: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  const c = v(() => e.readonly !== true && e.disable !== true), s = v(() => `q-rating row inline items-center q-rating--${c.value === true ? "" : "non-"}editable` + (e.noDimming === true ? " q-rating--no-dimming" : "") + (e.disable === true ? " disabled" : "") + (e.color !== void 0 && Array.isArray(e.color) === false ? ` text-${e.color}` : "")), f = v(() => {
    const y = Array.isArray(e.icon) === true ? e.icon.length : 0, b = Array.isArray(e.iconSelected) === true ? e.iconSelected.length : 0, x = Array.isArray(e.iconHalf) === true ? e.iconHalf.length : 0, A = Array.isArray(e.color) === true ? e.color.length : 0, R = Array.isArray(e.colorSelected) === true ? e.colorSelected.length : 0, I = Array.isArray(e.colorHalf) === true ? e.colorHalf.length : 0;
    return { iconLen: y, icon: y > 0 ? e.icon[y - 1] : e.icon, selIconLen: b, selIcon: b > 0 ? e.iconSelected[b - 1] : e.iconSelected, halfIconLen: x, halfIcon: x > 0 ? e.iconHalf[b - 1] : e.iconHalf, colorLen: A, color: A > 0 ? e.color[A - 1] : e.color, selColorLen: R, selColor: R > 0 ? e.colorSelected[R - 1] : e.colorSelected, halfColorLen: I, halfColor: I > 0 ? e.colorHalf[I - 1] : e.colorHalf };
  }), h = v(() => {
    ...
    const y = [], b = f.value, x = Math.ceil(e.modelValue), A = c.value === true ? 0 : null, R = e.iconHalf === void 0 || x === e.modelValue ? -1 : x;
    for (let I = 1; I <= e.max; I++) {
      const L = i.value === 0 && e.modelValue >= I || i.value > 0 && i.value >= I, P = R === I && i.value < I, z = i.value > 0 && (P === true ? x : e.modelValue) >= I && i.value < I, q = P === true ? I <= b.halfColorLen ? e.colorHalf[I - 1] : b.halfColor : b.selColor !== void 0 && L === true ? I <= b.selColorLen ? e.colorSelected[I - 1] : b.selColor : I <= b.colorLen ? e.color[I - 1] : b.color, E = (P === true ? I <= b.halfIconLen ? e.iconHalf[I - 1] : b.halfIcon : b.selIcon !== void 0 && (L === true || z === true) ? I <= b.selIconLen ? e.iconSelected[I - 1] : b.selIcon : I <= b.iconLen ? e.icon[I - 1] : b.icon) || l.iconSet.rating.icon;
      y.push({ name: (P === true ? I <= b.halfIconLen ? e.iconHalf[I - 1] : b.halfIcon : b.selIcon !== void 0 && (L === true || z === true) ? I <= b.selIconLen ? e.iconSelected[I - 1] : b.selIcon : I <= b.iconLen ? e.icon[I - 1] : b.icon) || l.iconSet.rating.icon, attrs: { tabindex: A, role: "radio", "aria-checked": e.modelValue === I ? "true" : "false", "aria-label": h.value(I, E) }, iconClass: "q-rating__icon" + (L === true || P === true ? " q-rating__icon--active" : "") + (z === true ? " q-rating__icon--exselected" : "") + (i.value === I ? " q-rating__icon--hovered" : "") + (q !== void 0 ? ` text-${q}` : "") });
    }
    return y;
  }), g = v(() => {
  ...
  return qa(() => {
    ...
    const y = [];
    return m.value.forEach(({ iconClass: b, name: x, attrs: A }, R) => {
      const I = R + 1;
...
var R1 = ve({ props: ["store", "barStyle", "verticalBarStyle", "horizontalBarStyle"], setup(e) {
  ...
  function p({ height: k, width: D }) {
    let N = false;
    o.vertical.value !== k && (o.vertical.value = k, N = true), o.horizontal.value !== D && (o.horizontal.value = D, N = true), N === true && R();
  }
  function y({ position: k }) {
    let D = false;
    i.vertical.position.value !== k.top && (i.vertical.position.value = k.top, D = true), i.horizontal.position.value !== k.left && (i.horizontal.position.value = k.left, D = true), D === true && R();
  }
  function b({ height: k, width: D }) {
    i.horizontal.size.value !== D && (i.horizontal.size.value = D, R()), i.vertical.size.value !== k && (i.vertical.size.value = k, R());
  }
  function x(k, D) {
    const N = i[D];
    if (k.isFirst === true) {
...
function $h({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: n, virtualScrollItemSizeComputed: l }) {
  ...
  const A = v(() => l.value + ";" + r.virtualScrollHorizontal), R = v(() => A.value + ";" + r.virtualScrollSliceRatioBefore + ";" + r.virtualScrollSliceRatioAfter);
  he(R, () => {
    N();
  }), he(A, I);
  function I() {
  ...
  return Fn(() => {
    ...
    le.cancel();
  }), Object.assign(i, { scrollTo: P, reset: I, refresh: L }), { virtualScrollSliceRange: b, virtualScrollSliceSizeComputed: w, setVirtualScrollSize: N, onVirtualScrollEvt: le, localResetVirtualScroll: D, padVirtualScroll: j, scrollTo: P, reset: I, refresh: L };
}
...
var V1 = ve({ name: "QSelect", inheritAttrs: false, props: { ...Du, ...wn, ...ci, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], popupNoRouteDismiss: Boolean, useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: Bd }, mapOptions: Boolean, emitValue: Boolean, disableTabSelection: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: {}, transitionHide: {}, transitionDuration: {}, behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: Du.virtualScrollItemSize.type, onNewValue: Function, onFilter: Function }, emits: [...di, "add", "remove", "inputValue", "keyup", "keypress", "keydown", "popupShow", "popupHide", "filterAbort"], setup(e, { slots: t, emit: n }) {
  ...
  const x = U(null), A = U(null), R = U(null), I = U(null), L = U(null), P = qs(e), z = _h(ue), q = v(() => Array.isArray(e.options) ? e.options.length : 0), E = v(() => e.virtualScrollItemSize === void 0 ? e.optionsDense === true ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: k, virtualScrollSliceSizeComputed: D, localResetVirtualScroll: N, padVirtualScroll: j, onVirtualScrollEvt: Y, scrollTo: le, setVirtualScrollSize: pe } = $h({ virtualScrollLength: q, getVirtualScrollTarget: jt, getVirtualScrollEl: xt, virtualScrollItemSizeComputed: E }), W = fi(), T = v(() => {
  ...
  function xt() {
    return g === true ? L.value : R.value !== null && R.value.contentEl !== null ? R.value.contentEl : void 0;
  }
  function jt() {
    return xt();
  }
  ...
  function Ks() {
    o.value === false && R.value !== null && R.value.updatePosition();
  }
  function Ws(G) {
...
ve({ name: "QSlideItem", props: { ...nt, leftColor: String, rightColor: String, topColor: String, bottomColor: String, onSlide: Function }, emits: ["action", "top", "right", "bottom", "left"], setup(e, { slots: t, emit: n }) {
  ...
  function w(C) {
    ...
    if (C.isFirst) c = { dir: null, size: { left: 0, right: 0, top: 0, bottom: 0 }, scale: 0 }, p.classList.add("no-transition"), Od.forEach((A) => {
      if (t[A[0]] !== void 0) {
        const R = f[A[0]];
        R.style.transform = "scale(1)", c.size[A[0]] = R.getBoundingClientRect()[A[3]];
      }
  ...
  return qa(() => {
    ...
    Od.forEach((x) => {
      const A = x[0];
      t[A] !== void 0 && C.push(d("div", { key: A, ref: (R) => {
        s[A] = R;
      }, class: `q-slide-item__${A} absolute-full row no-wrap items-${x[1]} justify-${x[2]}` + (e[A + "Color"] !== void 0 ? ` bg-${e[A + "Color"]}` : "") }, [d("div", { ref: (R) => {
        f[A] = R;
      } }, t[A]())]));
    });
...
ve({ name: "QSplitter", props: { ...nt, modelValue: { type: Number, required: true }, reverse: Boolean, unit: { type: String, default: "%", validator: (e) => ["%", "px"].includes(e) }, limits: { type: Array, validator: (e) => e.length !== 2 || typeof e[0] != "number" || typeof e[1] != "number" ? false : e[0] >= 0 && e[0] <= e[1] }, emitImmediately: Boolean, horizontal: Boolean, disable: Boolean, beforeClass: [Array, String, Object], afterClass: [Array, String, Object], separatorClass: [Array, String, Object], separatorStyle: [Array, String, Object] }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  function p(x) {
    if (x.isFirst === true) {
      const R = r.value.getBoundingClientRect()[u.value];
      m = e.horizontal === true ? "up" : "left", g = e.unit === "%" ? 100 : R, _ = Math.min(g, s.value[1], Math.max(s.value[0], e.modelValue)), w = (e.reverse !== true ? 1 : -1) * (e.horizontal === true ? 1 : l.lang.rtl === true ? -1 : 1) * (e.unit === "%" ? R === 0 ? 0 : 100 / R : 1), r.value.classList.add("q-splitter--active");
      return;
    }
    if (x.isFinal === true) {
...
ve({ name: "QTable", props: { rows: { type: Array, required: true }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: {}, ...Lh, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], tableRowStyleFn: Function, tableRowClassFn: Function, cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], cardStyleFn: Function, cardClassFn: Function, hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...nt, ...Rs, ...$_, ...y_, ...w_, ...T_, ...C_, ...g_ }, emits: ["request", "virtualScroll", ...Ps, ...M_, ...k_], setup(e, { slots: t, emit: n }) {
  ...
  const { innerPagination: _, computedPagination: w, isServerSide: C, requestServerInteraction: p, setPagination: y } = S_(l, ie), { computedFilterMethod: b } = p_(e, y), { isRowExpanded: x, setExpanded: A, updateExpanded: R } = E_(e, n), I = v(() => {
    let ue = e.rows;
  ...
  }), { hasSelectionMode: z, singleSelection: q, multipleSelection: E, allRowsSelected: k, someRowsSelected: D, rowsSelectedNumber: N, isRowSelected: j, clearSelection: Y, updateSelection: le } = q_(e, n, P, u), { colList: pe, computedCols: W, computedColsMap: T, computedColspan: ee } = A_(e, w, z), { columnToSort: X, computedSortMethod: be, sort: B } = b_(e, w, pe, y), { firstRowIndex: $, lastRowIndex: J, isFirstPage: O, isLastPage: re, pagesNumber: we, computedRowsPerPageOptions: S, computedRowsNumber: M, firstPage: V, prevPage: Z, nextPage: te, lastPage: Q } = x_(l, _, w, C, y, L), de = v(() => P.value.length === 0), me = v(() => {
    const ue = {};
  ...
  function ce() {
    ...
    if (f.value === true) {
      ...
      return Be !== void 0 && (Ue.after = () => d("tbody", Be({ cols: W.value }))), d(m_, { ref: s, class: e.tableClass, style: e.tableStyle, ...me.value, scrollTarget: e.virtualScrollTarget, items: P.value, type: "__qtable", tableColspan: ee.value, onVirtualScroll: H }, Ue);
    }
    const xe = [ke()];
  ...
  function tl(ue) {
    ...
    else if (xe = [d("span", Oe !== 0 ? { class: "q-table__bottom-item" } : {}, [Oe ? Be($.value + 1, Math.min(J.value, M.value), M.value) : Be(1, L.value, M.value)])], Oe !== 0 && we.value > 1) {
  ...
  return Object.assign(l.proxy, { requestServerInteraction: p, setPagination: y, firstPage: V, prevPage: Z, nextPage: te, lastPage: Q, isRowSelected: j, clearSelection: Y, isRowExpanded: x, setExpanded: A, sort: B, resetVirtualScroll: fe, scrollTo: ne, getCellValue: ie }), Iv(l.proxy, { filteredSortedRows: () => I.value, computedRows: () => P.value, computedRowsNumber: () => M.value }), () => {
...
ve({ name: "QTime", props: { ...nt, ...wn, ...Oo, modelValue: { required: true, validator: (e) => typeof e == "string" || e === null }, mask: { ...Oo.mask, default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: Xm, setup(e, { slots: t, emit: n }) {
  ...
  function He() {
    const ie = [d("div", { class: "q-time__link " + (y.value === "hour" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onClick: S.hour, onKeyup: Q }, R.value.hour), d("div", ":"), d("div", P.value === true ? { class: "q-time__link " + (y.value === "minute" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: de, onClick: S.minute } : { class: "q-time__link" }, R.value.minute)];
    e.withSeconds === true && ie.push(d("div", ":"), d("div", z.value === true ? { class: "q-time__link " + (y.value === "second" ? "q-time__link--active" : "cursor-pointer"), tabindex: o.value, onKeyup: me, onClick: S.second } : { class: "q-time__link" }, R.value.second));
...
ve({ name: "QTree", props: { ...nt, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => O_.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: {}, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
    ...
    if (be.lazy && be.lazy !== "loaded") {
      ...
      o.value[T] = "loading", Array.isArray(X[e.childrenKey]) !== true && (X[e.childrenKey] = []), n("lazyLoad", { node: X, key: T, done: (B) => {
        o.value[T] = "loaded", X[e.childrenKey] = Array.isArray(B) === true ? B : [], Xe(() => {
          var _a2;
          ((_a2 = C.value[T]) == null ? void 0 : _a2.isParent) === true && L(T, true);
        });
      }, fail: () => {
        delete o.value[T], X[e.childrenKey].length === 0 && delete X[e.childrenKey];
      } });
    } else be.isParent === true && be.expandable === true && L(T, ee);
  }
  function L(T, ee) {
    let X = u.value;
  ...
  return e.defaultExpandAll === true && R(), Object.assign(l, { getNodeByKey: p, getTickedNodes: y, getExpandedNodes: b, isExpanded: x, collapseAll: A, expandAll: R, setExpanded: I, isTicked: P, setTicked: z }), () => {
    const T = E(e.nodes);
...
function V_(e, t) {
  ...
  const R = U(0), I = v(() => R.value === 0 ? 0 : g.uploadedSize.value / R.value), L = v(() => Id(I.value)), P = v(() => Tu(R.value)), z = v(() => s.value === true && g.isUploading.value !== true && (l.multiple === true || g.queuedFiles.value.length === 0) && (l.maxFiles === void 0 || g.files.value.length < x.value) && (l.maxTotalSize === void 0 || R.value < A.value)), q = v(() => s.value === true && g.isBusy.value !== true && g.isUploading.value !== true && g.queuedFiles.value.length !== 0);
  hn(tm, be);
  ...
  function D() {
    l.disable === false && (g.abort(), g.uploadedSize.value = 0, R.value = 0, pe(), g.files.value = [], g.queuedFiles.value = [], g.uploadedFiles.value = []);
  }
  function N() {
  ...
  function T(O, re) {
    ...
    S != null && (S.value = ""), we !== void 0 && (we.forEach((M) => {
      if (g.updateFileStatus(M, "idle"), R.value += M.size, l.noThumbnails !== true && M.type.toUpperCase().startsWith("IMAGE")) {
        const V = new Image();
  ...
  function B() {
    return a.header !== void 0 ? a.header(J) : [d("div", { class: "q-uploader__header-content column" }, [d("div", { class: "flex flex-center no-wrap q-gutter-xs" }, [X(g.queuedFiles.value.length !== 0, "removeQueue", j), X(g.uploadedFiles.value.length !== 0, "removeUploaded", N), g.isUploading.value === true ? d(_n, { class: "q-uploader__spinner" }) : null, d("div", { class: "col column justify-center" }, [l.label !== void 0 ? d("div", { class: "q-uploader__title" }, [l.label]) : null, d("div", { class: "q-uploader__subtitle" }, [P.value + " / " + L.value])]), X(z.value, "add"), X(l.hideUploadBtn === false && q.value === true, "upload", g.upload), X(g.isUploading.value, "clear", g.abort)])])];
  }
  function $() {
  ...
  return Object.assign(J, { upload: ee, reset: D, removeUploadedFiles: N, removeQueuedFiles: j, removeFile: le, pickFiles: _, addFiles: w }), Iv(J, { canAddFiles: () => z.value, canUpload: () => q.value, uploadSizeLabel: () => P.value, uploadProgressLabel: () => L.value }), t({ ...g, upload: ee, reset: D, removeUploadedFiles: N, removeQueuedFiles: j, removeFile: le, pickFiles: _, addFiles: w, canAddFiles: z, canUpload: q, uploadSizeLabel: P, uploadProgressLabel: L }), () => {
...
function U_({ props: e, emit: t, helpers: n }) {
  ...
  function m(g, _) {
    ...
    C.upload.addEventListener("progress", (q) => {
      ...
      }), t("uploaded", { files: g, xhr: C })) : (L = true, n.uploadedSize.value -= R, n.queuedFiles.value = n.queuedFiles.value.concat(g), g.forEach((q) => {
...
function J_(e) {
  ...
  let i, u, c, s;
  const f = o.parentNode, h = o.nextElementSibling, m = Hd(o, r.resize), { width: g, height: _ } = Zr(f), { borderWidth: w, borderStyle: C, borderColor: p, borderRadius: y, backgroundColor: b, transform: x, position: A, cssText: R } = Ud(o, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), I = o.classList.toString(), L = o.style.cssText, P = o.cloneNode(true), z = r.tween === true ? o.cloneNode(true) : void 0;
  z !== void 0 && (z.className = z.classList.toString().split(" ").filter((E) => /^bg-/.test(E) === false).join(" ")), r.hideFromClone === true && P.classList.add("q-morph--internal"), P.setAttribute("aria-hidden", "true"), P.style.transition = "none", P.style.animation = "none", P.style.pointerEvents = "none", f.insertBefore(P, h), o.qMorphCancel = () => {
  ...
  const q = () => {
    ...
    const Y = () => {
      ...
      const ee = E === o && f === le ? P : E.nextElementSibling;
      ...
      const Ve = Qd(P), ie = Qd(E), ge = Me === true ? document.documentElement : { scrollLeft: 0, scrollTop: 0 };
      E.style.position = Me === true ? "fixed" : "absolute", E.style.left = `${V.left - ge.scrollLeft}px`, E.style.right = "unset", E.style.top = `${V.top - ge.scrollTop}px`, E.style.margin = 0, r.resize === true && (E.style.minWidth = "unset", E.style.maxWidth = "unset", E.style.minHeight = "unset", E.style.maxHeight = "unset", E.style.overflow = "hidden", E.style.overflowX = "hidden", E.style.overflowY = "hidden"), document.body.appendChild(E), z !== void 0 && (z.style.cssText = R, z.style.transform = "none", z.style.animation = "none", z.style.transition = "none", z.style.position = E.style.position, z.style.left = `${m.left - ge.scrollLeft}px`, z.style.right = "unset", z.style.top = `${m.top - ge.scrollTop}px`, z.style.margin = 0, z.style.pointerEvents = "none", r.resize === true && (z.style.minWidth = "unset", z.style.maxWidth = "unset", z.style.minHeight = "unset", z.style.maxHeight = "unset", z.style.overflow = "hidden", z.style.overflowX = "hidden", z.style.overflowY = "hidden"), document.body.appendChild(z));
      const ae = (ye) => {
        o === E && l !== true ? (E.style.cssText = L, E.className = I) : (E.style.cssText = M, E.className = S), T.parentNode === le && le.insertBefore(E, T), P.remove(), T.remove(), z == null ? void 0 : z.remove(), t = () => false, o.qMorphCancel = void 0, E.qMorphCancel = void 0, typeof r.onEnd == "function" && r.onEnd(l === true ? "to" : "from", ye === true);
      };
      if (r.useCSS !== true && typeof E.animate == "function") {
        ...
        let xe = "normal";
        P.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-from`, z !== void 0 && (z.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-from-tween`), T.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-to`, E.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}`;
        const Oe = (Be) => {
        ...
        }, E.addEventListener("animationend", Oe), E.addEventListener("animationcancel", Oe), t = (Be) => n === true || !E || !P || !T ? false : Be === true ? (Oe(), true) : (l = l !== true, xe = xe === "normal" ? "reverse" : "normal", P.style.animationDirection = xe, z.style.animationDirection = xe, T.style.animationDirection = xe, E.style.animationDirection = xe, true);
      }
    };
...
var ww = Hs, Sw = ve({ name: "DialogPluginComponent", props: { ...nt, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  ...
  function L() {
    return [d(wh, { color: u.value, dense: true, autofocus: true, dark: a.value, ...f.value, modelValue: o.value, "onUpdate:modelValue": A, onKeyup: R })];
  }
  function P() {
  ...
  function q() {
    const k = [];
    return e.title && k.push(I("q-dialog__title", e.title)), e.progress !== false && k.push(d(Pl, { class: "q-dialog__progress" }, () => d(c.value.component, c.value.props))), e.message && k.push(I("q-dialog__message", e.message)), e.prompt !== void 0 ? k.push(d(Pl, { class: "scroll q-dialog-plugin__form" }, L)) : e.options !== void 0 && k.push(d(Nl, { dark: a.value }), d(Pl, { class: "scroll q-dialog-plugin__form" }, P), d(Nl, { dark: a.value })), (e.ok || e.cancel) && k.push(z()), k;
  }
  function E() {
...
function PS(e, t) {
  ...
  function r(f, h, m) {
    ...
    for (const b of C) {
      const { path: x } = b;
      if (h && x[0] !== "/") {
        const A = h.record.path, R = A[A.length - 1] === "/" ? "" : "/";
        b.path = h.record.path + (x && R + x);
      }
      if (p = RS(b, h, w), m ? m.alias.push(p) : (y = y || p, y !== p && y.alias.push(p), g && f.name && !vf(p) && o(f.name)), gg(p) && u(p), _.children) {
        const A = _.children;
        for (let R = 0; R < A.length; R++) r(A[R], p, m && m.children[R]);
      }
      m = m || p;
    }
    return y ? () => {
...
function WS(e) {
  ...
  function R($, J) {
    ...
    if (V) return R(ut(p(V), { state: typeof V == "object" ? ut({}, we, V.state) : we, force: S, replace: M }), J || O);
    const Z = O;
    Z.redirectedFrom = J;
    let te;
    return !S && sS(l, re, O) && (te = xa(16, { to: Z, from: re }), W(re, re, true, false)), (te ? Promise.resolve(te) : P(Z, re)).catch((Q) => Nn(Q) ? Nn(Q, 2) ? Q : pe(Q) : Y(Q, Z, re)).then((Q) => {
      if (Q) {
        if (Nn(Q, 2)) return R(ut({ replace: M }, p(Q.to), { state: typeof Q.to == "object" ? ut({}, we, Q.to.state) : we, force: S }), J || Z);
  ...
  function P($, J) {
    ...
    return O.push(M), B(O).then(() => {
      ...
      return O.push(M), B(O);
    }).then(() => ($.matched.forEach((V) => V.enterCallbacks = {}), O = ru(S, "beforeRouteEnter", $, J, L), O.push(M), B(O))).then(() => {
      O = [];
  ...
  function k() {
    E || (E = a.listen(($, J, O) => {
      ...
      const re = C($), we = A(re);
      if (we) {
        R(ut(we, { replace: true, force: true }), re).catch(ur);
        return;
      }
      c = re;
      const S = u.value;
      ra && bS(rf(S.fullPath, O.delta), mi()), P(re, S).catch((M) => Nn(M, 12) ? M : Nn(M, 2) ? (R(ut(p(M.to), { force: true }), re).then((V) => {
  ...
  function B($) {
    return $.reduce((J, O) => J.then(() => L(O)), Promise.resolve());
  }
  return be;
}
function YS(e, t) {
...
function iu(e, t, n, l) {
  var a = l[0], r = l[1], o = l[2], i = Math.hypot(a, r, o), u, c, s, f, h, m, g, _, w, C, p, y, b, x, A, R, I, L, P, z, q, E, k, D;
  return i < ux ? null : (i = 1 / i, a *= i, r *= i, o *= i, u = Math.sin(n), c = Math.cos(n), s = 1 - c, f = t[0], h = t[1], m = t[2], g = t[3], _ = t[4], w = t[5], C = t[6], p = t[7], y = t[8], b = t[9], x = t[10], A = t[11], R = a * a * s + c, I = r * a * s + o * u, L = o * a * s - r * u, P = a * r * s - o * u, z = r * r * s + c, q = o * r * s + a * u, E = a * o * s + r * u, k = r * o * s - a * u, D = o * o * s + c, e[0] = f * R + _ * I + y * L, e[1] = h * R + w * I + b * L, e[2] = m * R + C * I + x * L, e[3] = g * R + p * I + A * L, e[4] = f * P + _ * z + y * q, e[5] = h * P + w * z + b * q, e[6] = m * P + C * z + x * q, e[7] = g * P + p * z + A * q, e[8] = f * E + _ * k + y * D, e[9] = h * E + w * k + b * D, e[10] = m * E + C * k + x * D, e[11] = g * E + p * k + A * D, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e);
}
...
const dx = /* @__PURE__ */ ka({ __name: "WebGL", setup(e) {
  ...
  const l = () => {
    ...
    const R = Sf();
    xf(R, R, [0, 0, -6]), iu(R, R, Math.sin(w) * 3.141 / 6 / 3, [0, 1, 0]), iu(R, R, Math.sin(w * 1.15) * 3.141 / 4 / 3, [1, 0, 0]), iu(R, R, Math.sin(w * 1.33) * 3.141 / 5 / 3, [1, 0, 0]), r(_[0], g), o(_[1], g), i(_[2], g), n.useProgram(g.prog), n.activeTexture(n.TEXTURE0), n.bindTexture(n.TEXTURE_2D, f), n.uniform1i(g.locs.sampler, 0), n.uniform1f(g.locs.time, w), n.uniformMatrix4fv(g.locs.proj, false, x), n.uniformMatrix4fv(g.locs.view, false, R), n.drawArrays(n.TRIANGLE_STRIP, 0, 4);
  }, r = (g, _) => {
    ...
    `), C = l(), p = n.getUniformLocation(w, "uProjectionMatrix"), y = n.getUniformLocation(w, "uModelViewMatrix"), b = n.getUniformLocation(w, "uSampler"), x = n.getUniformLocation(w, "fTime");
    if (p === null) throw new Error("no proj loc");
    if (y === null) throw new Error("no view loc");
    if (b === null) throw new Error("no sampler loc");
    if (x === null) throw new Error("no time loc");
    const A = { prog: w, attr: { vertex_pos: n.getAttribLocation(w, "aVertexPosition"), color_pos: n.getAttribLocation(w, "aVertexColor"), tex_pos: n.getAttribLocation(w, "aTextureCoord") }, locs: { proj: p, view: y, sampler: b, time: x } };
