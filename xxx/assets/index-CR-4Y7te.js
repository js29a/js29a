...
const Yf = Symbol("_vte"), Gf = (e) => e.__isTeleport, tr = (e) => e && (e.disabled || e.disabled === ""), tc = (e) => e && (e.defer || e.defer === ""), nc = (e) => typeof SVGElement < "u" && e instanceof SVGElement, lc = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, vu = (e, t) => {
  ...
  if (e == null) {
    ...
    const x = t.anchor = e.anchor, A = t.target = e.target, L = t.targetAnchor = e.targetAnchor, z = tr(e.props), P = z ? n : A, R = z ? x : L;
    if (o === "svg" || nc(A) ? o = "svg" : (o === "mathml" || lc(A)) && (o = "mathml"), b ? (h(e.dynamicChildren, b, P, a, r, o, i), ds(e, t, true)) : u || f(e, t, P, R, a, r, o, i, false), C) z ? t.props && e.props && t.props.to !== e.props.to && (t.props.to = e.props.to) : Fr(t, n, x, c, 1);
...
function vr(e, t, n, l, a) {
  const { appear: r, mode: o, persisted: i = false, onBeforeEnter: u, onEnter: c, onAfterEnter: s, onEnterCancelled: f, onBeforeLeave: h, onLeave: m, onAfterLeave: g, onLeaveCancelled: _, onBeforeAppear: w, onAppear: C, onAfterAppear: p, onAppearCancelled: y } = t, b = String(e.key), x = lv(n, e), A = (P, R) => {
    ...
    const I = R[1];
    A(P, R), je(P) ? P.every((q) => q.length <= 1) && I() : P.length <= 1 && I();
  }, z = { mode: o, persisted: i, beforeEnter(P) {
    let R = u;
    if (!n.isMounted) if (r) R = w || u;
    else return;
    P[sl] && P[sl](true);
    const I = x[b];
    I && fl(e, I) && I.el[sl] && I.el[sl](), A(R, [P]);
  }, enter(P) {
    let R = c, I = s, q = f;
    if (!n.isMounted) if (r) R = C || c, I = p || s, q = y || f;
    else return;
    let E = false;
    const k = P[Vr] = (D) => {
      E || (E = true, D ? A(q, [P]) : A(I, [P]), z.delayedLeave && z.delayedLeave(), P[Vr] = void 0);
    };
    R ? L(R, [P, k]) : k();
  }, leave(P, R) {
    ...
    let q = false;
    const E = P[sl] = (k) => {
      q || (q = true, R(), k ? A(_, [P]) : A(g, [P]), P[sl] = void 0, x[I] === e && delete x[I]);
    };
    x[I] = e, m ? L(m, [P, E]) : E();
  }, clone(P) {
...
const ca = (e) => !!e.type.__asyncLoader, Qo = (e) => e.type.__isKeepAlive, y0 = { name: "KeepAlive", __isKeepAlive: true, props: { include: [String, RegExp, Array], exclude: [String, RegExp, Array], max: [String, Number] }, setup(e, { slots: t }) {
  ...
  return ft(C), Yo(C), Ke(() => {
    ...
    const x = b.type, A = pu(ca(b) ? b.type.__asyncResolved || {} : x), { include: L, exclude: z, max: P } = e;
    if (L && (!A || !Na(L, A)) || z && A && Na(z, A)) return b.shapeFlag &= -257, o = b, y;
    const R = b.key == null ? x : b.key, I = a.get(R);
    return b.el && (b = Gn(b), y.shapeFlag & 128 && (y.ssContent = b)), w = R, I ? (b.el = I.el, b.component = I.component, b.transition && bl(b, b.transition), b.shapeFlag |= 512, r.delete(R), r.add(R)) : (r.add(R), P && r.size > parseInt(P, 10) && _(r.values().next().value)), b.shapeFlag |= 256, o = b, po(y.type) ? y : b;
  };
} }, rv = y0;
function Na(e, t) {
...
function M0(e) {
  ...
  if (N(Wo, f), N(ft, h), N(qa, m), N(Yo, g), N(_l, _), N(Fn, w), N(x0, z), N(S0, A), N(w0, L), N(Ke, p), N(Go, b), N(_0, P), je(R)) if (R.length) {
    const j = e.exposed || (e.exposed = {});
    R.forEach((Y) => {
      Object.defineProperty(j, Y, { get: () => n[Y], set: (le) => n[Y] = le });
    });
  } else e.exposed || (e.exposed = {});
  x && e.render === On && (e.render = x), I != null && (e.inheritAttrs = I), q && (e.components = q), E && (e.directives = E), P && av(e);
}
...
function N0(e, t) {
  ...
  const { insert: l, remove: a, patchProp: r, createElement: o, createText: i, createComment: u, setText: c, setElementText: s, parentNode: f, nextSibling: h, setScopeId: m = On, insertStaticContent: g } = e, _ = (S, M, V, Z = null, te = null, Q = null, de = void 0, me = null, fe = !!M.dynamicChildren) => {
    ...
    if (fe = S.el = o(S.type, Q, ne && ne.is, ne), H & 8 ? s(fe, S.children) : H & 16 && z(S.children, fe, null, Z, te, Ci(S, Q), de, me), _e && xl(S, null, Z, "created"), L(fe, S, S.scopeId, de, Z), ne) {
    ...
    } else !de && ce == null && I(me, H, oe, V, te);
    ...
    _e && (me = me ? me.concat(_e) : _e), S == null ? (l(ce, V, Z), l(ne, V, Z), z(M.children || [], V, ne, te, Q, de, me, fe)) : H > 0 && H & 64 && oe && S.dynamicChildren ? (R(S.dynamicChildren, oe, V, te, Q, de, me), (M.key != null || te && M === te.subTree) && ds(S, M, true)) : Y(S, M, V, ne, te, Q, de, me, fe);
    ...
    _e & 8 ? (ne & 16 && B(ce, te, Q), H !== ce && s(V, H)) : ne & 16 ? _e & 16 ? pe(ce, H, V, Z, te, Q, de, me, fe) : B(ce, te, Q, true) : (ne & 8 && s(V, ""), _e & 16 && z(H, V, Z, te, Q, de, me, fe));
    ...
    ce > ne ? B(S, te, Q, true, false, H) : z(M, V, Z, te, Q, de, me, fe, H);
  ...
  }, re = { p: _, um: T, m: W, r: ee, mt: k, mc: z, pc: Y, pbc: R, n: $, o: e };
...
function Pv(e) {
  ...
  }, onEnter: I(false), onAppear: I(true), onLeave(q, E) {
    q._isLeaving = true;
    const k = () => R(q, E);
...
function li({ fallbackTag: e, useDisableForRouterLinkProps: t = true } = {}) {
  const n = Se(), { props: l, proxy: a, emit: r } = n, o = ps(n), i = v(() => l.disable !== true && l.href !== void 0), u = v(t === true ? () => o === true && l.disable !== true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== "" : () => o === true && i.value !== true && l.to !== void 0 && l.to !== null && l.to !== ""), c = v(() => u.value === true ? p(l.to) : null), s = v(() => c.value !== null), f = v(() => i.value === true || s.value === true), h = v(() => l.type === "a" || f.value === true ? "a" : l.tag || e || "div"), m = v(() => i.value === true ? { href: l.href, target: l.target } : s.value === true ? { href: c.value.href, target: l.target } : {}), g = v(() => {
    ...
    const P = z.findIndex(Nc.bind(null, L));
    if (P !== -1) return P;
    const R = Hc(x[A - 2]);
    return A > 1 && Hc(L) === R && z[z.length - 1].path !== R ? z.findIndex(Nc.bind(null, x[A - 2])) : P;
  ...
  function y(x, { returnRouterError: A, to: L = l.to, replace: z = l.replace } = {}) {
    ...
    x.preventDefault();
    const P = a.$router[z === true ? "replace" : "push"](L);
...
var { passiveCapture: fn } = dt, Gl = null, Xl = null, Zl = null, Ze = ve({ name: "QBtn", props: { ...Fy, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: n }) {
  ...
  const C = v(() => e.label !== void 0 && e.label !== null && e.label !== ""), p = v(() => e.disable === true || e.ripple === false ? false : { keyCodes: u.value === true ? [13, 32] : [13], ...e.ripple === true ? {} : e.ripple }), y = v(() => ({ center: e.round })), b = v(() => {
    ...
    if (f.value === true) {
      const k = { onClick: L, onKeydown: z, onMousedown: R };
  ...
  function z(k) {
    h.value !== null && (n("keydown", k), yn(k, [13, 32]) === true && Xl !== h.value && (Xl !== null && q(), k.defaultPrevented !== true && (k.qAvoidFocus !== true && h.value.focus(), Xl = h.value, h.value.classList.add("q-btn--active"), document.addEventListener("keyup", I, true), h.value.addEventListener("blur", I, fn)), Ne(k)));
  }
  function P(k) {
    h.value !== null && (n("touchstart", k), k.defaultPrevented !== true && (Gl !== h.value && (Gl !== null && q(), Gl = h.value, g = k.target, g.addEventListener("touchcancel", I, fn), g.addEventListener("touchend", I, fn)), _ = true, w !== null && clearTimeout(w), w = setTimeout(() => {
      w = null, _ = false;
    }, 200)));
  }
  function R(k) {
    h.value !== null && (k.qSkipRipple = _ === true, n("mousedown", k), k.defaultPrevented !== true && Zl !== h.value && (Zl !== null && q(), Zl = h.value, h.value.classList.add("q-btn--active"), document.addEventListener("mouseup", I, fn)));
  }
  function I(k) {
  ...
  function q(k) {
    var _a2, _b2;
    const D = m.value;
    k !== true && (Gl === h.value || Zl === h.value) && D !== null && D !== document.activeElement && (D.setAttribute("tabindex", -1), D.focus()), Gl === h.value && (g !== null && (g.removeEventListener("touchcancel", I, fn), g.removeEventListener("touchend", I, fn)), Gl = g = null), Zl === h.value && (document.removeEventListener("mouseup", I, fn), Zl = null), Xl === h.value && (document.removeEventListener("keyup", I, true), (_a2 = h.value) == null ? void 0 : _a2.removeEventListener("blur", I, fn), Xl = null), (_b2 = h.value) == null ? void 0 : _b2.classList.remove("q-btn--active");
  }
  function E(k) {
...
function ks(e, t = 0) {
  ...
  if (ze.is.ios === true && window.visualViewport !== void 0) {
    const A = document.body.style, { offsetLeft: L, offsetTop: z } = window.visualViewport;
    L !== Wc && (A.setProperty("--q-pe-left", L + "px"), Wc = L), z !== Yc && (A.setProperty("--q-pe-top", z + "px"), Yc = z);
  }
  ...
  if (i === void 0 || l === void 0) Li(x, g, b, r, o);
    ...
    z === true && (x = Gc(g, b, r, o), Li(x, g, b, r, o));
  }
...
var ii = ve({ name: "QMenu", inheritAttrs: false, props: { ...bm, ...Ma, ...nt, ...Fl, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noEscDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: Ro }, self: { type: String, validator: Ro }, offset: { type: Array, validator: Mm }, scrollTarget: Wl, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...Ea, "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  let a = null, r, o, i;
  const u = Se(), { proxy: c } = u, { $q: s } = c, f = U(null), h = U(false), m = v(() => e.persistent !== true && e.noRouteDismiss !== true), g = lt(e, s), { registerTick: _, removeTick: w } = ha(), { registerTimeout: C } = Xn(), { transitionProps: p, transitionStyle: y } = ri(e), { localScrollTarget: b, changeScrollEvent: x, unconfigureScrollTarget: A } = ym(e, ee), { anchorEl: L, canShow: z } = Ss({ showing: h }), { hide: P } = $a({ showing: h, canShow: z, handleShow: pe, handleHide: W, hideOnRouteChange: m, processOnMount: true }), { showPortal: R, hidePortal: I, renderPortal: q } = Cs(u, f, J, "menu"), E = { anchorEl: L, innerRef: f, onClickOutside(O) {
  ...
  function W(O) {
    w(), I(), T(true), a !== null && (O === void 0 || O.qClickOutside !== true) && ((((O == null ? void 0 : O.type.indexOf("key")) === 0 ? a.closest('[tabindex]:not([tabindex^="-"])') : void 0) || a).focus(), a = null), C(() => {
      I(true), n("hide", O);
    }, e.transitionDuration);
  }
  function T(O) {
...
function As() {
  ...
  function c(k) {
    ...
    z((n.$q.lang.rtl === true ? -1 : 1) * (k.direction === D ? 1 : -1));
  }
  ...
  function z(k, D = u.value) {
    ...
    e.infinite === true && r.length !== 0 && D !== -1 && D !== r.length && z(k, k === -1 ? r.length : -1);
  }
  function P() {
  ...
  return Object.assign(n, { next: C, previous: p, goTo: y }), { panelIndex: u, panelDirectives: s, updatePanelsList: q, updatePanelIndex: P, getPanelContent: I, getEnabledPanels: A, getPanels: E, isValidPanelName: b, keepAliveProps: _, needsUniqueKeepAliveWrapper: w, goToPanelByOffset: z, goToPanel: y, nextPanel: C, previousPanel: p };
}
...
ve({ name: "QCarousel", props: { ...nt, ...Es, ...Rs, transitionPrev: { type: String, default: "fade" }, transitionNext: { type: String, default: "fade" }, height: String, padding: Boolean, controlColor: String, controlTextColor: String, controlType: { type: String, validator: (e) => fp.includes(e), default: "flat" }, autoplay: [Number, Boolean], arrows: Boolean, prevIcon: String, nextIcon: String, navigation: Boolean, navigationPosition: { type: String, validator: (e) => dp.includes(e) }, navigationIcon: String, navigationActiveIcon: String, thumbnails: Boolean }, emits: [...Ps, ...$s], setup(e, { slots: t }) {
  ...
  function z(R, I) {
    return d("div", { class: `q-carousel__control q-carousel__navigation no-wrap absolute flex q-carousel__navigation--${R} q-carousel__navigation--${C.value}` + (e.controlColor !== void 0 ? ` text-${e.controlColor}` : "") }, [d("div", { class: "q-carousel__navigation-inner flex flex-center no-wrap" }, h().map(I))]);
  }
  function P() {
    const R = [];
    if (e.navigation === true) {
      const I = t["navigation-icon"] !== void 0 ? t["navigation-icon"] : (E) => d(Ze, { key: "nav" + E.name, class: `q-carousel__navigation-icon q-carousel__navigation-icon--${E.active === true ? "" : "in"}active`, ...E.btnProps, onClick: E.onClick }), q = r - 1;
      R.push(z("buttons", (E, k) => {
        const D = E.props.name, N = m.value === k;
        return I({ index: k, maxIndex: q, name: D, active: N, btnProps: { icon: N === true ? x.value : b.value, size: "sm", ...A.value }, onClick: () => {
          c(D);
        } });
      }));
    } else if (e.thumbnails === true) {
      const I = e.controlColor !== void 0 ? ` text-${e.controlColor}` : "";
      R.push(z("thumbnails", (q) => {
        const E = q.props;
        return d("img", { key: "tmb#" + E.name, class: `q-carousel__thumbnail q-carousel__thumbnail--${E.name === e.modelValue ? "" : "in"}active` + I, src: E.imgSrc || E["img-src"], onClick: () => {
          c(E.name);
        } });
      }));
    }
...
function Lm(e, t) {
  ...
  function L(q) {
    q !== void 0 && (Ne(q), s(q)), n.disable !== true && a("update:modelValue", z(), q);
  }
  function z() {
    if (h.value === true) {
      if (g.value === true) {
...
function Dm({ updateValue: e, updatePosition: t, getDragging: n, formAttrs: l }) {
  ...
  }), x = v(() => a.step === 0 ? 1 : a.step), A = v(() => y.value === true ? a.tabindex || 0 : -1), L = v(() => a.max - a.min), z = v(() => p.value - C.value), P = v(() => we(C.value)), R = v(() => we(p.value)), I = v(() => a.vertical === true ? w.value === true ? "bottom" : "top" : w.value === true ? "right" : "left"), q = v(() => a.vertical === true ? "height" : "width"), E = v(() => a.vertical === true ? "width" : "height"), k = v(() => a.vertical === true ? "vertical" : "horizontal"), D = v(() => {
  ...
  const le = v(() => {
    ...
    const ae = R.value - P.value, ye = { [I.value]: `${100 * P.value}%`, [q.value]: ae === 0 ? "2px" : `${100 * ae}%` };
  ...
  const M = v(() => pr(a.markers) === true ? a.markers : x.value), V = v(() => {
    ...
    const ae = z.value === 0 ? "2px" : 100 * M.value / z.value;
  ...
  function fe(ae) {
    return { [I.value]: `${100 * (ae - a.min) / L.value}%` };
  }
  const ce = v(() => {
...
var wp = ["left", "center", "right", "justify"], Bu = ve({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => wp.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: n }) {
  ...
  function Q(ne) {
    y.splice(y.indexOf(ne), 1), b.value--, Y(), z !== void 0 && ne.routeData !== void 0 && (y.every((H) => H.routeData === void 0) === true && z(), V());
  }
  ...
  hn(em, de);
  function me() {
    A !== null && clearTimeout(A), B(), z == null ? void 0 : z();
  }
  let fe, ce;
  return Ke(me), Fn(() => {
    fe = z !== void 0, me();
...
function Qm(e, t, n, l) {
  ...
  function g(y, b) {
    ...
    if (l.hasRouterLink.value === true) {
      const x = (A = {}) => {
        let L;
        const z = A.to === void 0 || kn(A.to, e.to) === true ? a.avoidRouteWatcher = wr() : null;
        return l.navigateToRouterLink(y, { ...A, returnRouterError: true }).catch((P) => {
          L = P;
        }).then((P) => {
          var _a3;
          if (z === a.avoidRouteWatcher && (a.avoidRouteWatcher = false, L === void 0 && (P === void 0 || ((_a3 = P.message) == null ? void 0 : _a3.startsWith("Avoided redundant navigation")) === true) && a.updateModel({ name: e.name })), A.returnRouterError === true) return L !== void 0 ? Promise.reject(L) : P;
        });
      };
...
ve({ name: "QColor", props: { ...nt, ...wn, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function E(S, M, V) {
    ...
    h.value.s = ce, h.value.v = ne, I(H, V);
  }
  function k(S, M) {
  ...
  function j(S, M) {
    ...
    const te = Vi(V);
    if (h.value.h = te.h, h.value.s = te.s, h.value.v = te.v, I(V, M), M !== true) {
  ...
  function Y(S) {
    ...
    V.a === void 0 && (V.a = h.value.a), h.value.h = M.h, h.value.s = M.s, h.value.v = M.v, I(V, true);
  }
  function le(S) {
  ...
  return () => {
    const S = [B()];
    return e.name !== void 0 && e.disable !== true && C(S, "push"), e.noHeader !== true && S.unshift(be()), e.noFooter !== true && S.push(J()), d("div", { class: z.value, ...P.value }, S);
  };
} });
...
ve({ name: "QDate", props: { ...Oo, ...wn, ...nt, modelValue: { required: true, validator: (e) => typeof e == "string" || Array.isArray(e) === true || Object(e) === e || e === null }, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { ...Oo.mask, default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: Hi }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: Hi }, navigationMaxYearMonth: { type: String, validator: Hi }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: fd } }, emits: [...Xm, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: n }) {
  ...
  let f;
  const h = Rr(e), m = Sl(h), g = U(null), _ = U(He()), w = U(c()), C = v(() => He()), p = v(() => c()), y = v(() => s()), b = U(ie(_.value, w.value)), x = U(e.defaultView), A = v(() => a.lang.rtl === true ? "right" : "left"), L = U(A.value), z = U(A.value), P = b.value.year, R = U(P - P % Dn - (P < 0 ? Dn : 0)), I = U(null), q = v(() => {
    ...
    const { init: F, initHash: K, final: se, finalHash: Te } = I.value, [Ee, Ge] = K <= Te ? [F, se] : [se, F], Le = ll(Ee), Ie = ll(Ge);
  ...
  function it(F, K, se) {
    ...
    const Te = F + "/" + rt(K) + "/01";
    Te !== b.value.dateHash && (L.value = b.value.dateHash < Te == (a.lang.rtl !== true) ? "left" : "right", F !== b.value.year && (z.value = L.value), Xe(() => {
  ...
  const Ue = { Calendar: () => [d("div", { key: "calendar-view", class: "q-date__view q-date__calendar" }, [d("div", { class: "q-date__navigation row items-center no-wrap" }, Be({ label: w.value.months[b.value.month - 1], type: "Months", key: b.value.month, dir: L.value, goTo: ae, boundaries: M.value.month, cls: " col" }).concat(Be({ label: b.value.year, type: "Years", key: b.value.year, dir: z.value, goTo: ye, boundaries: M.value.year, cls: "" }))), d("div", { class: "q-date__calendar-weekdays row items-center no-wrap" }, J.value.map((F) => d("div", { class: "q-date__calendar-item" }, [d("div", F)]))), d("div", { class: "q-date__calendar-days-container relative-position overflow-hidden" }, [d(Ot, { name: "q-transition--slide-" + L.value }, () => d("div", { key: Q.value, class: "q-date__calendar-days fit" }, ce.value.map((F) => d("div", { class: F.classes }, [F.in === true ? d(Ze, { class: F.today === true ? "q-date__today" : "", dense: true, flat: F.flat, unelevated: F.unelevated, color: F.color, textColor: F.textColor, label: F.i, tabindex: i.value, ...o("day#" + F.i, { onClick: () => {
    ...
    return e.yearsInMonthView === true && se.unshift(d("div", { class: "row no-wrap full-width" }, [Be({ label: b.value.year, type: "Years", key: b.value.year, dir: z.value, goTo: ye, boundaries: M.value.year, cls: " col" })])), d("div", { key: "months-view", class: "q-date__view q-date__months flex flex-center" }, se);
  }, Years() {
...
var Kr = 0, Dp = { standard: "fixed-full flex-center", top: "fixed-top justify-center", bottom: "fixed-bottom justify-center", right: "fixed-right items-center", left: "fixed-left items-center" }, yd = { standard: ["scale", "scale"], top: ["slide-down", "slide-up"], bottom: ["slide-up", "slide-down"], right: ["slide-left", "slide-right"], left: ["slide-right", "slide-left"] }, si = ve({ name: "QDialog", inheritAttrs: false, props: { ...Ma, ...Fl, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, backdropFilter: String, position: { type: String, default: "standard", validator: (e) => ["standard", "top", "bottom", "left", "right"].includes(e) } }, emits: [...Ea, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  const h = v(() => e.persistent !== true && e.noRouteDismiss !== true && e.seamless !== true), { preventBodyScroll: m } = rh(), { registerTimeout: g } = Xn(), { registerTick: _, removeTick: w } = ha(), { transitionProps: C, transitionStyle: p } = ri(e, () => yd[e.position][0], () => yd[e.position][1]), y = v(() => p.value + (e.backdropFilter !== void 0 ? `;backdrop-filter:${e.backdropFilter};-webkit-backdrop-filter:${e.backdropFilter}` : "")), { showPortal: b, hidePortal: x, portalIsAccessible: A, renderPortal: L } = Cs(a, r, be, "dialog"), { hide: z } = $a({ showing: o, hideOnRouteChange: h, handleShow: D, handleHide: N, processOnMount: true }), { addToHistory: P, removeFromHistory: R } = ah(o, z, h), I = v(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${e.maximized === true ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${Dp[e.position]}` + (i.value === true ? " q-dialog__inner--animating" : "") + (e.fullWidth === true ? " q-dialog__inner--fullwidth" : "") + (e.fullHeight === true ? " q-dialog__inner--fullheight" : "") + (e.square === true ? " q-dialog__inner--square" : "")), q = v(() => o.value === true && e.seamless !== true), E = v(() => e.autoClose === true ? { onClick: T } : {}), k = v(() => [`q-dialog fullscreen no-pointer-events q-dialog--${q.value === true ? "modal" : "seamless"}`, l.class]);
  he(() => e.maximized, (B) => {
    o.value === true && W(B);
  }), he(q, (B) => {
  ...
  function le() {
    e.seamless !== true && (e.persistent === true || e.noEscDismiss === true ? e.maximized !== true && e.noShake !== true && Y() : (n("escapeKey"), z()));
  }
  function pe(B) {
  ...
  function T(B) {
    f !== true && (z(B), n("click", B));
  }
  function ee(B) {
    e.persistent !== true && e.noBackdropDismiss !== true ? z(B) : e.noShake !== true && Y();
  }
  function X(B) {
  ...
  function M(H) {
    H === void 0 ? Xe(() => {
      H = C.value === true ? 0 : w.value, M(I.value * H);
    }) : (s.isContainer.value === true && R.value === true && (g.value === true || Math.abs(H) === w.value) && (H += I.value * s.scrollbarWidth.value), D.value = H);
  }
  function V(H) {
    q.value = H;
  }
  ...
  function Q(H) {
    ...
    if (H.isFinal === true) {
      _e >= Math.min(75, oe) === true ? x() : (s.animate(), V(0), M(I.value * oe)), E.value = false;
      return;
    }
  ...
  function de(H) {
    ...
    M(I.value * ke), V(ct(1 - ke / oe, 0, 1)), H.isFirst === true && (E.value = true);
  }
  function me() {
    i(false), Z(true);
  }
...
ve({ name: "QEditor", props: { ...nt, ...Rs, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => e.length === 0 || e.every((t) => t.length), default: () => [["left", "center", "right", "justify"], ["bold", "italic", "underline", "strike"], ["undo", "redo"]] }, toolbarColor: String, toolbarBg: String, toolbarTextColor: String, toolbarToggleColor: { type: String, default: "primary" }, toolbarOutline: Boolean, toolbarPush: Boolean, toolbarRounded: Boolean, paragraphTag: { type: String, validator: (e) => ["div", "p"].includes(e), default: "div" }, contentStyle: Object, contentClass: [Object, Array, String], square: Boolean, flat: Boolean, dense: Boolean }, emits: [...Ps, "update:modelValue", "keydown", "click", "focus", "blur", "dropdownShow", "dropdownHide", "dropdownBeforeShow", "dropdownBeforeHide", "linkShow", "linkHide"], setup(e, { slots: t, emit: n }) {
  ...
  return ft(() => {
    ...
    return d("div", { ref: c, class: P.value, style: { height: o.value === true ? "100%" : null }, ...I.value, onFocusin: j, onFocusout: Y }, [B, d("div", { ref: s, style: z.value, class: R.value, contenteditable: m.value, placeholder: e.placeholder, ...u.listeners.value, onInput: q, onKeydown: E, onClick: k, onBlur: D, onFocus: N, onMousedown: le, onTouchstartPassive: le })]);
  };
} });
...
ve({ name: "QExpansionItem", props: { ...$r, ...Ma, ...nt, icon: String, label: String, labelLines: [Number, String], caption: String, captionLines: [Number, String], dense: Boolean, toggleAriaLabel: String, expandIcon: String, expandedIcon: String, expandIconClass: [Array, String, Object], duration: {}, headerInsetLevel: Number, contentInsetLevel: Number, expandSeparator: Boolean, defaultOpened: Boolean, hideExpandIcon: Boolean, expandIconToggle: Boolean, switchToggleSide: Boolean, denseToggle: Boolean, group: String, popup: Boolean, headerStyle: [Array, String, Object], headerClass: [Array, String, Object] }, emits: [...Ea, "click", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  function q() {
    ...
    return y.value === true && (Object.assign(j, { tabindex: 0, ...x.value, onClick: z, onKeyup: L }), Y.unshift(d("div", { ref: o, class: "q-expansion-item__toggle-focus q-icon q-focus-helper q-focus-helper--rounded", tabindex: -1 }))), d(mn, j, () => Y);
  }
  function E() {
    let j;
...
function o1(e, t) {
  ...
  function _(C = n.modelValue) {
    ...
    for (let A = 0; A < n.rules.length; A++) {
      const L = n.rules[A];
      let z;
      if (typeof L == "function" ? z = L(C, oo) : typeof L == "string" && oo[L] !== void 0 && (z = oo[L](C)), z === false || typeof z == "string") return b(true, z), false;
      z !== true && z !== void 0 && x.push(z);
    }
    return x.length === 0 ? (b(false), true) : (t.value = true, Promise.all(x).then((A) => {
      ...
      const L = A.find((z) => z === false || typeof z == "string");
...
function vi(e) {
  ...
  }), e.controlEvents === void 0 && (e.controlEvents = { onFocusin: P, onFocusout: R }), Object.assign(e, { clearValue: I, onControlFocusin: P, onControlFocusout: R, focus: L }), e.computedCounter === void 0 && (e.computedCounter = v(() => {
    if (t.counter !== false) {
  ...
  }), Object.assign(r, { focus: L, blur: z }), function() {
...
function bh({ editable: e, dnd: t, getFileInput: n, addFilesToQueue: l }) {
  ...
  function m(p, y, b, x) {
    ...
    if (a.accept !== void 0 && u.value.indexOf("*/") === -1 && (A = na(A, L, "accept", (P) => u.value.some((R) => P.type.toUpperCase().startsWith(R) || P.name.toUpperCase().endsWith(R))), A.length === 0)) return z();
    if (a.maxFileSize !== void 0) {
      const P = parseInt(a.maxFileSize, 10);
      if (A = na(A, L, "max-file-size", (R) => R.size <= P), A.length === 0) return z();
    }
    ...
    if (a.maxTotalSize !== void 0) {
      let P = x === true ? b.reduce((R, I) => R + I.size, 0) : 0;
      if (A = na(A, L, "max-total-size", (R) => (P += R.size, P <= s.value)), A.length === 0) return z();
    }
    ...
    if (a.maxFiles !== void 0) {
      ...
      if (A = na(A, L, "max-files", () => (P++, P <= c.value)), A.length === 0) return z();
    }
    if (z(), A.length !== 0) return A;
  }
  function g(p) {
...
ve({ name: "QFile", inheritAttrs: false, props: { ...mh, ...wn, ...hh, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, ...gh], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  return Object.assign(r, { fieldClass: x, emitValue: P, hasValue: w, inputRef: o, innerValue: _, floatingLabel: v(() => w.value === true || jl(e.displayValue)), computedCounter: v(() => {
    ...
    return r.editable.value === true && Object.assign(j, { onDragover: s, onDragleave: f, onKeydown: R, onKeyup: I }), d("div", j, [N()].concat(D()));
  } }), Object.assign(a, { removeAtIndex: L, removeFile: z, getNativeElement: () => o.value }), Ft(a, "nativeEl", () => o.value), vi(r);
} });
...
ve({ name: "QImg", props: { ...Is, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, loadingShowDelay: { type: [Number, String], default: 0 }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: s1 }, placeholderSrc: String, errorSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: n }) {
  ...
  function L(q, E) {
    E === 1e3 || hl(r) === true || (q.complete === true ? z(q) : o(() => {
      L(q, E + 1);
    }, 50));
  }
  function z(q) {
  ...
  return () => {
    const q = [];
    return a.value !== null && q.push(d("div", { key: "filler", style: a.value })), h[0].value !== null && q.push(R(0)), h[1].value !== null && q.push(R(1)), q.push(d(Ot, { name: "q-transition--fade" }, I)), d("div", { key: "main", class: w.value, style: C.value, role: "img", "aria-label": e.alt }, q);
  };
} });
var { passive: Ml } = dt;
ve({ name: "QInfiniteScroll", props: { offset: { type: Number, default: 500 }, debounce: { type: [String, Number], default: 100 }, scrollTarget: Wl, initialIndex: { type: Number, default: 0 }, disable: Boolean, reverse: Boolean }, emits: ["load"], setup(e, { slots: t, emit: n }) {
  ...
  function f() {
    ...
    const L = Ir(u), z = gl(u), P = pa(u);
    e.reverse === false ? Math.round(z + P + e.offset) >= Math.round(L) && h() : Math.round(z) <= e.offset && h();
  }
  function h() {
    if (e.disable === true || l.value === true || a.value === false) return;
    i++, l.value = true;
  ...
  function p(L) {
    L = parseInt(L, 10);
    const z = c;
    c = L <= 0 ? f : Ta(f, isNaN(L) === true ? 100 : L), u && a.value === true && (z !== void 0 && u.removeEventListener("scroll", z, Ml), u.addEventListener("scroll", c, Ml));
  }
  function y(L) {
    if (b.value === true) {
      if (o.value === null) {
...
function f1(e, t, n, l) {
  ...
  function g(P) {
    ...
    let R = "", I = a;
    const q = I.indexOf(Pt);
    if (q !== -1) {
      for (let E = P - I.length; E > 0; E--) R += Pt;
      I = I.slice(0, q) + R + I.slice(q);
    }
    return I;
  }
  function _() {
    ...
    const P = xd[e.mask] === void 0 ? e.mask : xd[e.mask], R = typeof e.fillMask == "string" && e.fillMask.length !== 0 ? e.fillMask.slice(0, 1) : "_", I = R.replace(Cd, "\\$&"), q = [], E = [], k = [];
    ...
    const Y = new RegExp("^" + q.join("") + "(" + (N === "" ? "." : "[^" + N + "]") + "+)?" + (N === "" ? "" : "[" + N + "]*") + "$"), le = E.length - 1, pe = E.map((W, T) => T === 0 && e.reverseFillMask === true ? new RegExp("^" + I + "*" + W) : T === le ? new RegExp("^" + W + "(" + (j === "" ? "." : j) + "+)?" + (e.reverseFillMask === true ? "$" : I + "*")) : new RegExp("^" + W));
    o = k, i = (W) => {
  ...
  function w(P, R, I) {
    ...
    R === true && _();
    const N = x(D), j = e.fillMask !== false ? z(N) : N, Y = f.value !== j;
  ...
  function C(P, R, I) {
    const q = x(L(P.value));
    R = Math.max(0, a.indexOf(Pt), Math.min(q.length, R)), u = R, P.setSelectionRange(R, I, "forward");
  }
  const p = { left(P, R) {
    const I = a.slice(R - 1).indexOf(Pt) === -1;
    ...
    let q = Math.min(I, R + 1);
    for (; q <= I; q++) if (a[q] === Pt) {
      R = q;
      break;
    } else a[q - 1] === Pt && (R = q);
    if (q > I && a[R - 1] !== void 0 && a[R - 1] !== Pt) return p.left(P, I);
    P.setSelectionRange(R, R, "forward");
  }, leftReverse(P, R) {
    const I = g(P.value.length);
    let q = Math.max(0, R - 1);
    for (; q >= 0; q--) if (I[q - 1] === Pt) {
      R = q;
      break;
    } else if (I[q] === Pt && (R = q, q === 0)) break;
    if (q < 0 && I[R] !== void 0 && I[R] !== Pt) return p.rightReverse(P, 0);
    R >= 0 && P.setSelectionRange(R, R, "backward");
  }, rightReverse(P, R) {
    const I = P.value.length, q = g(I), E = q.slice(0, R + 1).indexOf(Pt) === -1;
    let k = Math.min(I, R + 1);
    for (; k <= I; k++) if (q[k - 1] === Pt) {
      R = k, R > 0 && E === true && R--;
      break;
    }
    if (k > I && q[R - 1] !== void 0 && q[R - 1] !== Pt) return p.leftReverse(P, I);
    P.setSelectionRange(R, R, "forward");
  } };
  function y(P) {
    t("click", P), c = void 0;
  ...
  function b(P) {
    ...
    const R = l.value, I = R.selectionStart, q = R.selectionEnd;
    if (P.shiftKey || (c = void 0), P.keyCode === 37 || P.keyCode === 39) {
      P.shiftKey && c === void 0 && (c = R.selectionDirection === "forward" ? I : q);
      const E = p[(P.keyCode === 39 ? "right" : "left") + (e.reverseFillMask === true ? "Reverse" : "")];
      if (P.preventDefault(), E(R, c === I ? q : I), P.shiftKey) {
        const k = R.selectionStart;
        R.setSelectionRange(Math.min(c, k), Math.max(c, k), "forward");
      }
    } else P.keyCode === 8 && e.reverseFillMask !== true && I === q ? (p.left(R, I), R.setSelectionRange(R.selectionStart, q, "backward")) : P.keyCode === 46 && e.reverseFillMask === true && I === q && (p.rightReverse(R, q), R.setSelectionRange(I, R.selectionEnd, "forward"));
  }
  function x(P) {
    if (P == null || P === "") return "";
    ...
    for (let E = 0; E < R.length; E++) {
      const k = P[I], D = R[E];
      if (typeof D == "string") q += D, k === D && I++;
      else if (k !== void 0 && D.regex.test(k)) q += D.transform !== void 0 ? D.transform(k) : k, I++;
      else return q;
    }
    return q;
  }
  function A(P) {
    const R = o, I = a.indexOf(Pt);
    let q = P.length - 1, E = "";
    for (let k = R.length - 1; k >= 0 && q !== -1; k--) {
      ...
      while (I === k && N !== void 0 && D.regex.test(N));
      else return E;
    }
    return E;
  }
...
var wh = ve({ name: "QInput", inheritAttrs: false, props: { ...ci, ...d1, ...wn, modelValue: [String, Number, FileList], shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...di, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: n }) {
  ...
  const f = U(null), h = qs(e), { innerValue: m, hasMask: g, moveCursorForPaste: _, updateMaskValue: w, onMaskedKeydown: C, onMaskedClick: p } = f1(e, t, N, f), y = yh(e, true), b = v(() => jl(m.value)), x = _h(k), A = fi({ changeEvent: true }), L = v(() => e.type === "textarea" || e.autogrow === true), z = v(() => L.value === true || ["text", "search", "url", "tel", "password"].includes(e.type)), P = v(() => {
  ...
  function k(T) {
    ...
    else if (N(ee), z.value === true && T.target === document.activeElement) {
  ...
  const W = vi(A);
  return Object.assign(l, { focus: I, select: q, getNativeElement: () => f.value }), Ft(l, "nativeEl", () => f.value), W;
...
var { passive: Md } = dt, _1 = ["both", "horizontal", "vertical"], Ch = ve({ name: "QScrollObserver", props: { axis: { type: String, validator: (e) => _1.includes(e), default: "vertical" }, debounce: [String, Number], scrollTarget: Wl }, emits: ["scroll"], setup(e, { emit: t }) {
  ...
  if (hn(Kl, y), ro() > 0) {
    let b = function() {
      L = null, z.classList.remove("hide-scrollbar");
    }, x = function() {
      if (L === null) {
...
ve({ name: "QPagination", props: { ...nt, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => (typeof e == "string" ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => e === "" || vm.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  }), L = v(() => ({ ...A.value, color: e.activeColor || e.color, textColor: e.activeTextColor || e.textColor })), z = v(() => {
  ...
  return Object.assign(n, { set: P, setByOffset: R }), () => {
    ...
    if (c.value === true && (E.push(q({ key: "bls", disable: e.disable || e.modelValue <= r.value, icon: p.value[0], "aria-label": l.lang.pagination.first }, r.value)), k.unshift(q({ key: "ble", disable: e.disable || e.modelValue >= o.value, icon: p.value[3], "aria-label": l.lang.pagination.last }, o.value))), f.value === true && (E.push(q({ key: "bdp", disable: e.disable || e.modelValue <= r.value, icon: p.value[1], "aria-label": l.lang.pagination.prev }, e.modelValue - 1)), k.unshift(q({ key: "bdn", disable: e.disable || e.modelValue >= o.value, icon: p.value[2], "aria-label": l.lang.pagination.next }, e.modelValue + 1))), e.input !== true) {
      D = [];
      const { pgFrom: N, pgTo: j, marginalStyle: Y } = z.value;
...
ve({ name: "QParallax", props: { src: String, height: { type: Number, default: 500 }, speed: { type: Number, default: 1, validator: (e) => e >= 0 && e <= 1 }, scrollTarget: Wl, onScroll: Function }, setup(e, { slots: t, emit: n }) {
  ...
  function g() {
    ...
    if (f !== void 0 || L > y && A < x) {
      const z = (x - A) / (e.height + b);
      _((c - e.height) * z * e.speed), m(z);
    }
  }
  let _ = (y) => {
...
ve({ name: "QPullToRefresh", props: { color: String, bgColor: String, icon: String, noMouse: Boolean, disable: Boolean, scrollTarget: Wl }, emits: ["refresh"], setup(e, { slots: t, emit: n }) {
  ...
  function m(x) {
    ...
    if (x.isFirst === true) {
      ...
      i.value = true;
      const { top: z, left: P } = l.$el.getBoundingClientRect();
      s.value = { top: z + "px", left: P + "px", width: window.getComputedStyle(l.$el).getPropertyValue("width") };
    }
    Vt(x.evt);
...
ve({ name: "QRange", props: { ...zm, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: Im, setup(e, { emit: t }) {
  const { proxy: { $q: n } } = Se(), { state: l, methods: a } = Dm({ updateValue: z, updatePosition: R, getDragging: P, formAttrs: v(() => ({ type: "hidden", name: e.name, value: `${e.modelValue.min}|${e.modelValue.max}` })) }), r = U(null), o = U(0), i = U(0), u = U({ min: 0, max: 0 });
  function c() {
...
ve({ name: "QRating", props: { ...Jn, ...wn, modelValue: { type: Number, required: true }, max: { type: [String, Number], default: 5 }, icon: [String, Array], iconHalf: [String, Array], iconSelected: [String, Array], iconAriaLabel: [String, Array], color: [String, Array], colorHalf: [String, Array], colorSelected: [String, Array], noReset: Boolean, noDimming: Boolean, readonly: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  const c = v(() => e.readonly !== true && e.disable !== true), s = v(() => `q-rating row inline items-center q-rating--${c.value === true ? "" : "non-"}editable` + (e.noDimming === true ? " q-rating--no-dimming" : "") + (e.disable === true ? " disabled" : "") + (e.color !== void 0 && Array.isArray(e.color) === false ? ` text-${e.color}` : "")), f = v(() => {
    const y = Array.isArray(e.icon) === true ? e.icon.length : 0, b = Array.isArray(e.iconSelected) === true ? e.iconSelected.length : 0, x = Array.isArray(e.iconHalf) === true ? e.iconHalf.length : 0, A = Array.isArray(e.color) === true ? e.color.length : 0, L = Array.isArray(e.colorSelected) === true ? e.colorSelected.length : 0, z = Array.isArray(e.colorHalf) === true ? e.colorHalf.length : 0;
    return { iconLen: y, icon: y > 0 ? e.icon[y - 1] : e.icon, selIconLen: b, selIcon: b > 0 ? e.iconSelected[b - 1] : e.iconSelected, halfIconLen: x, halfIcon: x > 0 ? e.iconHalf[b - 1] : e.iconHalf, colorLen: A, color: A > 0 ? e.color[A - 1] : e.color, selColorLen: L, selColor: L > 0 ? e.colorSelected[L - 1] : e.colorSelected, halfColorLen: z, halfColor: z > 0 ? e.colorHalf[z - 1] : e.colorHalf };
  }), h = v(() => {
    ...
    for (let z = 1; z <= e.max; z++) {
      const P = i.value === 0 && e.modelValue >= z || i.value > 0 && i.value >= z, R = L === z && i.value < z, I = i.value > 0 && (R === true ? x : e.modelValue) >= z && i.value < z, q = R === true ? z <= b.halfColorLen ? e.colorHalf[z - 1] : b.halfColor : b.selColor !== void 0 && P === true ? z <= b.selColorLen ? e.colorSelected[z - 1] : b.selColor : z <= b.colorLen ? e.color[z - 1] : b.color, E = (R === true ? z <= b.halfIconLen ? e.iconHalf[z - 1] : b.halfIcon : b.selIcon !== void 0 && (P === true || I === true) ? z <= b.selIconLen ? e.iconSelected[z - 1] : b.selIcon : z <= b.iconLen ? e.icon[z - 1] : b.icon) || l.iconSet.rating.icon;
      y.push({ name: (R === true ? z <= b.halfIconLen ? e.iconHalf[z - 1] : b.halfIcon : b.selIcon !== void 0 && (P === true || I === true) ? z <= b.selIconLen ? e.iconSelected[z - 1] : b.selIcon : z <= b.iconLen ? e.icon[z - 1] : b.icon) || l.iconSet.rating.icon, attrs: { tabindex: A, role: "radio", "aria-checked": e.modelValue === z ? "true" : "false", "aria-label": h.value(z, E) }, iconClass: "q-rating__icon" + (P === true || R === true ? " q-rating__icon--active" : "") + (I === true ? " q-rating__icon--exselected" : "") + (i.value === z ? " q-rating__icon--hovered" : "") + (q !== void 0 ? ` text-${q}` : "") });
    }
    return y;
  }), g = v(() => {
  ...
  return qa(() => {
    ...
    return m.value.forEach(({ iconClass: b, name: x, attrs: A }, L) => {
      ...
      y.push(d("div", { key: z, ref: (P) => {
        ...
        C(P, z);
      } }, kt(t[`tip-${z}`], [d(et, { class: b, name: x })])));
  ...
  function A(k, D) {
    ...
    if (N.thumbHidden.value !== true) {
      ...
      if (Y < le || Y > le + N.thumbSize.value) {
        ...
        z(W * Math.max(0, N.size.value - o[D].value), D);
      }
...
function $h({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: n, virtualScrollItemSizeComputed: l }) {
  ...
  N();
  const le = Ta(I, u.platform.is.ios === true ? 120 : 35);
  Wo(() => {
    N();
  });
  let pe = false;
  return Fn(() => {
    ...
    le.cancel();
  }), Object.assign(i, { scrollTo: R, reset: z, refresh: P }), { virtualScrollSliceRange: b, virtualScrollSliceSizeComputed: w, setVirtualScrollSize: N, onVirtualScrollEvt: le, localResetVirtualScroll: D, padVirtualScroll: j, scrollTo: R, reset: z, refresh: P };
}
...
var V1 = ve({ name: "QSelect", inheritAttrs: false, props: { ...Du, ...wn, ...ci, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], popupNoRouteDismiss: Boolean, useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: Bd }, mapOptions: Boolean, emitValue: Boolean, disableTabSelection: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: {}, transitionHide: {}, transitionDuration: {}, behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: Du.virtualScrollItemSize.type, onNewValue: Function, onFilter: Function }, emits: [...di, "add", "remove", "inputValue", "keyup", "keypress", "keydown", "popupShow", "popupHide", "filterAbort"], setup(e, { slots: t, emit: n }) {
  ...
  const x = U(null), A = U(null), L = U(null), z = U(null), P = U(null), R = qs(e), I = _h(ue), q = v(() => Array.isArray(e.options) ? e.options.length : 0), E = v(() => e.virtualScrollItemSize === void 0 ? e.optionsDense === true ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: k, virtualScrollSliceSizeComputed: D, localResetVirtualScroll: N, padVirtualScroll: j, onVirtualScrollEvt: Y, scrollTo: le, setVirtualScrollSize: pe } = $h({ virtualScrollLength: q, getVirtualScrollTarget: jt, getVirtualScrollEl: xt, virtualScrollItemSizeComputed: E }), W = fi(), T = v(() => {
...
ve({ name: "QTable", props: { rows: { type: Array, required: true }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: {}, ...Lh, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], tableRowStyleFn: Function, tableRowClassFn: Function, cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], cardStyleFn: Function, cardClassFn: Function, hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...nt, ...Rs, ...$_, ...y_, ...w_, ...T_, ...C_, ...g_ }, emits: ["request", "virtualScroll", ...Ps, ...M_, ...k_], setup(e, { slots: t, emit: n }) {
  ...
  const { innerPagination: _, computedPagination: w, isServerSide: C, requestServerInteraction: p, setPagination: y } = S_(l, ie), { computedFilterMethod: b } = p_(e, y), { isRowExpanded: x, setExpanded: A, updateExpanded: L } = E_(e, n), z = v(() => {
    let ue = e.rows;
  ...
  }), { hasSelectionMode: I, singleSelection: q, multipleSelection: E, allRowsSelected: k, someRowsSelected: D, rowsSelectedNumber: N, isRowSelected: j, clearSelection: Y, updateSelection: le } = q_(e, n, R, u), { colList: pe, computedCols: W, computedColsMap: T, computedColspan: ee } = A_(e, w, I), { columnToSort: X, computedSortMethod: be, sort: B } = b_(e, w, pe, y), { firstRowIndex: $, lastRowIndex: J, isFirstPage: O, isLastPage: re, pagesNumber: we, computedRowsPerPageOptions: S, computedRowsNumber: M, firstPage: V, prevPage: Z, nextPage: te, lastPage: Q } = x_(l, _, w, C, y, P), de = v(() => R.value.length === 0), me = v(() => {
    const ue = {};
  ...
  function Ve(ue) {
    Object.assign(ue, { cols: W.value, colsMap: T.value, sort: B, rowIndex: $.value + ue.pageIndex, color: e.color, dark: r.value, dense: e.dense }), I.value === true && Ft(ue, "selected", () => j(ue.key), (xe, Oe) => {
  ...
  return Object.assign(l.proxy, { requestServerInteraction: p, setPagination: y, firstPage: V, prevPage: Z, nextPage: te, lastPage: Q, isRowSelected: j, clearSelection: Y, isRowExpanded: x, setExpanded: A, sort: B, resetVirtualScroll: fe, scrollTo: ne, getCellValue: ie }), Iv(l.proxy, { filteredSortedRows: () => z.value, computedRows: () => R.value, computedRowsNumber: () => M.value }), () => {
...
ve({ name: "QTime", props: { ...nt, ...wn, ...Oo, modelValue: { required: true, validator: (e) => typeof e == "string" || e === null }, mask: { ...Oo.mask, default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: Xm, setup(e, { slots: t, emit: n }) {
  ...
  const g = U(null), _ = v(() => be()), w = v(() => u()), C = v(() => B()), p = Ua(e.modelValue, _.value, w.value, e.calendar, C.value), y = U(R_(p)), b = U(p), x = U(p.hour === null || p.hour < 12), A = v(() => `q-time q-time--${e.landscape === true ? "landscape" : "portrait"}` + (r.value === true ? " q-time--dark q-dark" : "") + (e.disable === true ? " disabled" : e.readonly === true ? " q-time--readonly" : "") + (e.bordered === true ? " q-time--bordered" : "") + (e.square === true ? " q-time--square no-border-radius" : "") + (e.flat === true ? " q-time--flat no-shadow" : "")), L = v(() => {
    ...
    y.value === "hour" ? z.value === true ? (ie = 0, ge = 23) : (ie = 0, ge = 11, x.value === false && (ae = 12)) : (ie = 0, ge = 55, ye = 5);
    const Fe = [];
    for (let $e = ie, We = ie; $e <= ge; $e += ye, We++) {
      const it = $e + ae, xt = (Ce == null ? void 0 : Ce.includes(it)) === false, jt = y.value === "hour" && $e === 0 ? z.value === true ? "00" : "12" : $e;
  ...
  function $() {
    return hl(l) === true || Y.value !== null && (Y.value.values.length === 0 || y.value === "hour" && z.value !== true && D.value[x.value === true ? "am" : "pm"].values.length === 0);
  }
  function J() {
  ...
  function we(ie, ge, ae) {
    ...
    if (ye.top < ge.top ? We = ge.left < ye.left ? 90 - We : 270 + We : We = ge.left < ye.left ? We + 90 : 270 - We, y.value === "hour") {
      if ($e = We / 30, D.value !== null) {
        const it = z.value !== true ? x.value === true : D.value.am.values.length !== 0 && D.value.pm.values.length !== 0 ? Fe >= ge.dist : D.value.am.values.length !== 0;
        $e = X($e + (it === true ? 0 : 12), D.value[it === true ? "am" : "pm"]);
      } else $e = Math.round($e), z.value === true ? Fe < ge.dist ? $e < 12 && ($e += 12) : $e === 12 && ($e = 0) : x.value === true && $e === 12 ? $e = 0 : x.value === false && $e !== 12 && ($e += 12);
      z.value === true && (x.value = $e < 12);
  ...
  function Q(ie) {
    if (ie.keyCode === 13) y.value = "hour";
      ...
      if (D.value !== null) {
        const ae = z.value === true ? D.value.values : D.value[x.value === true ? "am" : "pm"].values;
        ...
        const ae = z.value === true ? 24 : 12, ye = z.value !== true && x.value === false ? 12 : 0, Ce = b.value.hour === null ? -ge : b.value.hour;
        fe(ye + (24 + Ce + ge) % ae);
      }
    }
  }
...
ve({ name: "QTree", props: { ...nt, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => O_.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: {}, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  function z(T, ee, X = p(T), be = C.value[T]) {
  ...
  function pe(T, ee, X, be) {
    X !== void 0 && Ne(X), be !== true && ee.selectable !== false && Y(ee.key), z(ee.key, !ee.expanded, T, ee);
  }
  function W(T, ee) {
  ...
  return e.defaultExpandAll === true && L(), Object.assign(l, { getNodeByKey: p, getTickedNodes: y, getExpandedNodes: b, isExpanded: x, collapseAll: A, expandAll: L, setExpanded: z, isTicked: R, setTicked: I }), () => {
    const T = E(e.nodes);
...
function V_(e, t) {
  ...
  const L = U(0), z = v(() => L.value === 0 ? 0 : g.uploadedSize.value / L.value), P = v(() => Id(z.value)), R = v(() => Tu(L.value)), I = v(() => s.value === true && g.isUploading.value !== true && (l.multiple === true || g.queuedFiles.value.length === 0) && (l.maxFiles === void 0 || g.files.value.length < x.value) && (l.maxTotalSize === void 0 || L.value < A.value)), q = v(() => s.value === true && g.isBusy.value !== true && g.isUploading.value !== true && g.queuedFiles.value.length !== 0);
  hn(tm, be);
  ...
  function B() {
    return a.header !== void 0 ? a.header(J) : [d("div", { class: "q-uploader__header-content column" }, [d("div", { class: "flex flex-center no-wrap q-gutter-xs" }, [X(g.queuedFiles.value.length !== 0, "removeQueue", j), X(g.uploadedFiles.value.length !== 0, "removeUploaded", N), g.isUploading.value === true ? d(_n, { class: "q-uploader__spinner" }) : null, d("div", { class: "col column justify-center" }, [l.label !== void 0 ? d("div", { class: "q-uploader__title" }, [l.label]) : null, d("div", { class: "q-uploader__subtitle" }, [R.value + " / " + P.value])]), X(I.value, "add"), X(l.hideUploadBtn === false && q.value === true, "upload", g.upload), X(g.isUploading.value, "clear", g.abort)])])];
  }
  function $() {
  ...
  return Object.assign(J, { upload: ee, reset: D, removeUploadedFiles: N, removeQueuedFiles: j, removeFile: le, pickFiles: _, addFiles: w }), Iv(J, { canAddFiles: () => I.value, canUpload: () => q.value, uploadSizeLabel: () => R.value, uploadProgressLabel: () => P.value }), t({ ...g, upload: ee, reset: D, removeUploadedFiles: N, removeQueuedFiles: j, removeFile: le, pickFiles: _, addFiles: w, canAddFiles: I, canUpload: q, uploadSizeLabel: R, uploadProgressLabel: P }), () => {
    ...
    return I.value === true && Object.assign(re, { onDragover: C, onDragleave: p }), d("div", re, O);
  };
}
var z_ = () => true;
function Oh(e) {
...
function U_({ props: e, emit: t, helpers: n }) {
  ...
  function m(g, _) {
    ...
    let x = 0, A = 0, L = 0, z = 0, P;
    C.upload.addEventListener("progress", (q) => {
      if (P === true) return;
      const E = Math.min(z, q.loaded);
    ...
    const I = p("sendRaw", g);
    g.forEach((q) => {
      n.updateFileStatus(q, "uploading", 0), I !== true && w.append(p("fieldName", q), q, q.name), q.xhr = C, q.__abort = () => {
        C.abort();
      }, z += q.size;
    }), t("uploading", { files: g, xhr: C }), l.value.push(C), I === true ? C.send(new Blob(g)) : C.send(w);
  }
...
function J_(e) {
  ...
  let i, u, c, s;
  const f = o.parentNode, h = o.nextElementSibling, m = Hd(o, r.resize), { width: g, height: _ } = Zr(f), { borderWidth: w, borderStyle: C, borderColor: p, borderRadius: y, backgroundColor: b, transform: x, position: A, cssText: L } = Ud(o, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), z = o.classList.toString(), P = o.style.cssText, R = o.cloneNode(true), I = r.tween === true ? o.cloneNode(true) : void 0;
  I !== void 0 && (I.className = I.classList.toString().split(" ").filter((E) => /^bg-/.test(E) === false).join(" ")), r.hideFromClone === true && R.classList.add("q-morph--internal"), R.setAttribute("aria-hidden", "true"), R.style.transition = "none", R.style.animation = "none", R.style.pointerEvents = "none", f.insertBefore(R, h), o.qMorphCancel = () => {
    n = true, R.remove(), I == null ? void 0 : I.remove(), r.hideFromClone === true && R.classList.remove("q-morph--internal"), o.qMorphCancel = void 0;
  };
  const q = () => {
    const E = Kd(a.to);
    if (n === true || Wd(E) !== true) {
    ...
    r.hideFromClone !== true && R.classList.remove("q-morph--internal"), E.qMorphCancel = () => {
      n = true, R.remove(), I == null ? void 0 : I.remove(), r.hideFromClone === true && R.classList.remove("q-morph--internal"), r.keepToClone !== true && E.classList.remove("q-morph--internal"), o.qMorphCancel = void 0, E.qMorphCancel = void 0;
    };
    const Y = () => {
      if (n === true) {
      ...
      E.style.position = Me === true ? "fixed" : "absolute", E.style.left = `${V.left - ge.scrollLeft}px`, E.style.right = "unset", E.style.top = `${V.top - ge.scrollTop}px`, E.style.margin = 0, r.resize === true && (E.style.minWidth = "unset", E.style.maxWidth = "unset", E.style.minHeight = "unset", E.style.maxHeight = "unset", E.style.overflow = "hidden", E.style.overflowX = "hidden", E.style.overflowY = "hidden"), document.body.appendChild(E), I !== void 0 && (I.style.cssText = L, I.style.transform = "none", I.style.animation = "none", I.style.transition = "none", I.style.position = E.style.position, I.style.left = `${m.left - ge.scrollLeft}px`, I.style.right = "unset", I.style.top = `${m.top - ge.scrollTop}px`, I.style.margin = 0, I.style.pointerEvents = "none", r.resize === true && (I.style.minWidth = "unset", I.style.maxWidth = "unset", I.style.minHeight = "unset", I.style.maxHeight = "unset", I.style.overflow = "hidden", I.style.overflowX = "hidden", I.style.overflowY = "hidden"), document.body.appendChild(I));
      const ae = (ye) => {
        o === E && l !== true ? (E.style.cssText = P, E.className = z) : (E.style.cssText = M, E.className = S), T.parentNode === le && le.insertBefore(E, T), R.remove(), T.remove(), I == null ? void 0 : I.remove(), t = () => false, o.qMorphCancel = void 0, E.qMorphCancel = void 0, typeof r.onEnd == "function" && r.onEnd(l === true ? "to" : "from", ye === true);
      };
      if (r.useCSS !== true && typeof E.animate == "function") {
        ...
        let xe = "normal";
        R.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-from`, I !== void 0 && (I.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-from-tween`), T.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}-to`, E.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${ye}`;
        const Oe = (Be) => {
        ...
        }, E.addEventListener("animationend", Oe), E.addEventListener("animationcancel", Oe), t = (Be) => n === true || !E || !R || !T ? false : Be === true ? (Oe(), true) : (l = l !== true, xe = xe === "normal" ? "reverse" : "normal", R.style.animationDirection = xe, I.style.animationDirection = xe, T.style.animationDirection = xe, E.style.animationDirection = xe, true);
      }
    };
...
var ww = Hs, Sw = ve({ name: "DialogPluginComponent", props: { ...nt, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  ...
  function q() {
    const k = [];
    return e.title && k.push(z("q-dialog__title", e.title)), e.progress !== false && k.push(d(Pl, { class: "q-dialog__progress" }, () => d(c.value.component, c.value.props))), e.message && k.push(z("q-dialog__message", e.message)), e.prompt !== void 0 ? k.push(d(Pl, { class: "scroll q-dialog-plugin__form" }, P)) : e.options !== void 0 && k.push(d(Nl, { dark: a.value }), d(Pl, { class: "scroll q-dialog-plugin__form" }, R), d(Nl, { dark: a.value })), (e.ok || e.cancel) && k.push(I()), k;
  }
  function E() {
  ...
  function k() {
    E || (E = a.listen(($, J, O) => {
      ...
      ra && bS(rf(S.fullPath, O.delta), mi()), R(re, S).catch((M) => Nn(M, 12) ? M : Nn(M, 2) ? (L(ut(p(M.to), { force: true }), re).then((V) => {
        ...
        M = M || q(re, S, false), M && (O.delta && !Nn(M, 8) ? a.go(-O.delta, false) : O.type === Cr.pop && Nn(M, 20) && a.go(-1, false)), I(re, S, M);
      }).catch(ur);
    }));
  }
  let D = Ha(), N = Ha(), j;
...
function iu(e, t, n, l) {
  var a = l[0], r = l[1], o = l[2], i = Math.hypot(a, r, o), u, c, s, f, h, m, g, _, w, C, p, y, b, x, A, L, z, P, R, I, q, E, k, D;
  return i < ux ? null : (i = 1 / i, a *= i, r *= i, o *= i, u = Math.sin(n), c = Math.cos(n), s = 1 - c, f = t[0], h = t[1], m = t[2], g = t[3], _ = t[4], w = t[5], C = t[6], p = t[7], y = t[8], b = t[9], x = t[10], A = t[11], L = a * a * s + c, z = r * a * s + o * u, P = o * a * s - r * u, R = a * r * s - o * u, I = r * r * s + c, q = o * r * s + a * u, E = a * o * s + r * u, k = r * o * s - a * u, D = o * o * s + c, e[0] = f * L + _ * z + y * P, e[1] = h * L + w * z + b * P, e[2] = m * L + C * z + x * P, e[3] = g * L + p * z + A * P, e[4] = f * R + _ * I + y * q, e[5] = h * R + w * I + b * q, e[6] = m * R + C * I + x * q, e[7] = g * R + p * I + A * q, e[8] = f * E + _ * k + y * D, e[9] = h * E + w * k + b * D, e[10] = m * E + C * k + x * D, e[11] = g * E + p * k + A * D, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e);
}
...
const dx = /* @__PURE__ */ ka({ __name: "WebGL", setup(e) {
  ...
  const l = () => {
    ...
    const w = 45 * Math.PI / 180, C = t.value.clientWidth / t.value.clientHeight, p = 0.1, y = 100, b = Sf();
    cx(b, w, C, p, y);
    const x = Math.cos(_) * 1.767;
    xf(b, b, [Math.sin(x * 0.3) * 1, Math.cos(x * 0.4) * 1, Math.cos(0.6 * x) * 1]);
    const A = Sf();
    xf(A, A, [0, 0, -6]), iu(A, A, Math.sin(_) * 3.141 / 6 / 3, [0, 1, 0]), iu(A, A, Math.sin(_ * 1.15) * 3.141 / 4 / 3, [1, 0, 0]), iu(A, A, Math.sin(_ * 1.33) * 3.141 / 5 / 3, [1, 0, 0]), r(g), o(g), i(g), n.useProgram(g.prog), n.activeTexture(n.TEXTURE0), n.bindTexture(n.TEXTURE_2D, f), n.uniform1i(g.locs.sampler, 0), n.uniform1f(g.locs.time, _), n.uniformMatrix4fv(g.locs.proj, false, b), n.uniformMatrix4fv(g.locs.view, false, A), n.drawArrays(n.TRIANGLE_STRIP, 0, 4);
  }, r = (g) => {
    if (n === null) throw new Error("setPos - no ctx");
    const _ = 2, w = n.FLOAT, C = false, p = 0, y = 0;
    n.bindBuffer(n.ARRAY_BUFFER, g.bufs.pos), n.vertexAttribPointer(g.attr.vertex_pos, _, w, C, p, y), n.enableVertexAttribArray(g.attr.vertex_pos);
  }, o = (g) => {
    if (n === null) throw new Error("setColor - no ctx");
    n.bindBuffer(n.ARRAY_BUFFER, g.bufs.color), n.vertexAttribPointer(g.attr.color_pos, 4, n.FLOAT, false, 0, 0), n.enableVertexAttribArray(g.attr.color_pos);
  }, i = (g) => {
    if (n === null) throw new Error("setTex crash");
    n.bindBuffer(n.ARRAY_BUFFER, g.bufs.tex), n.vertexAttribPointer(g.attr.tex_pos, 2, n.FLOAT, false, 0, 0), n.enableVertexAttribArray(g.attr.tex_pos);
  }, u = () => {
    ...
    const A = { prog: w, attr: { vertex_pos: n.getAttribLocation(w, "aVertexPosition"), color_pos: n.getAttribLocation(w, "aVertexColor"), tex_pos: n.getAttribLocation(w, "aTextureCoord") }, locs: { proj: p, view: y, sampler: b, time: x }, bufs: { pos: C[0], color: C[1], tex: C[2] } };
    f = h(), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, true), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR);
    let L = 0, z = false;
    setInterval(() => {
      z ? (L -= 0.033, L < 0 && (L = 0, z = false)) : (L += 0.033, L > 7.5 && (L = 7.5, z = true)), a(A, L);
    }, 25);
  }, c = (g, _) => {
