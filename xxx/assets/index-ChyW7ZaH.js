...
const bx = ["width", "height"], yx = /* @__PURE__ */ Ta({ __name: "WebGL", setup(e) {
  ...
  return (L, O) => (Gn(), Bv(rn, null, [Ln("canvas", { id: "canvas", ref_key: "canvas", ref: t, onMousemove: O[0] || (O[0] = (U) => C(U)), width: c.value, height: s.value, style: jo(Y()) }, null, 44, bx), Ln("img", { src: "img/tex.jpg", onLoad: O[1] || (O[1] = (U) => M("front_0", U)), style: { display: "none" } }, null, 32), Ln("img", { src: "img/clock.jpg", onLoad: O[2] || (O[2] = (U) => M("front_1", U)), style: { display: "none" } }, null, 32), Ln("img", { src: "img/tv.jpg", onLoad: O[3] || (O[3] = (U) => M("front_2", U)), style: { display: "none" } }, null, 32), Ln("img", { src: "img/phone.jpg", onLoad: O[4] || (O[4] = (U) => M("front_3", U)), style: { display: "none" } }, null, 32), Ln("img", { src: "img/wood.jpg", onLoad: O[5] || (O[5] = (U) => M("body", U)), style: { display: "none" } }, null, 32)], 64));
