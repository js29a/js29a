...
const bx = ["width", "height"], yx = /* @__PURE__ */ Ta({ __name: "WebGL", setup(e) {
  ...
  const r = K([0, 0]), o = K(""), i = K(-1), u = K([0, 0, 0, 0]), c = K(640), s = K(480), f = K(0), m = (L, O, U, ye, W, T, ee) => {
    ...
    n !== null && (n.uniform1i(O.unif.sampler, 0), n.activeTexture(n.TEXTURE0), n.uniform1f(O.unif.mode, 1), n.drawElements(n.TRIANGLES, 3 * 6, n.UNSIGNED_SHORT, 0), n.uniform1i(O.unif.sampler, 0), n.bindTexture(n.TEXTURE_2D, l.body), n.uniform1f(O.unif.mode, 0), n.drawElements(n.TRIANGLES, 3 * 6 * 6, n.UNSIGNED_SHORT, 2 * 3 * 6));
