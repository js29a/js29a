...
o_fn = function(t) {
  var _a3, _b2, _c2;
  t.disb || (((_a3 = t.action) == null ? void 0 : _a3.kind) == "show" && __privateGet(this, _a2).call(this, t.action.page), ((_b2 = t.action) == null ? void 0 : _b2.kind) == "home" && (__privateSet(this, _l2, ro(bo)), __privateSet(this, _t2, "out")), ((_c2 = t.action) == null ? void 0 : _c2.kind) == "sub" && (__privateSet(this, _l2, ro(Fg[t.action.hexes])), __privateSet(this, _t2, "out")));
};
console.log(bo);
