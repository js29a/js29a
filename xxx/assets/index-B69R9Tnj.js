...
function mr(e, t, n, l, a) {
  const { appear: r, mode: o, persisted: i = false, onBeforeEnter: u, onEnter: c, onAfterEnter: s, onEnterCancelled: f, onBeforeLeave: m, onLeave: h, onAfterLeave: g, onLeaveCancelled: _, onBeforeAppear: w, onAppear: k, onAfterAppear: p, onAppearCancelled: y } = t, b = String(e.key), x = fv(n, e), $ = (B, P) => {
    ...
    const I = P[1];
    $(B, P), Ne(B) ? B.every((T) => T.length <= 1) && I() : B.length <= 1 && I();
    ...
    let P = c, I = s, T = f;
    if (!n.isMounted) if (r) P = k || c, I = p || s, T = y || f;
    else return;
    let M = false;
    const C = B[Vr] = (j) => {
      M || (M = true, j ? $(T, [B]) : $(I, [B]), D.delayedLeave && D.delayedLeave(), B[Vr] = void 0);
    };
    P ? F(P, [B, C]) : C();
  }, leave(B, P) {
    ...
    let T = false;
    const M = B[cl] = (C) => {
      T || (T = true, P(), C ? $(_, [B]) : $(g, [B]), B[cl] = void 0, x[I] === e && delete x[I]);
    };
    x[I] = e, h ? F(h, [B, M]) : M();
  }, clone(B) {
...
function P0(e) {
  ...
  if (yu = true, r) for (const L in r) {
    ...
    Object.defineProperty(l, L, { enumerable: true, configurable: true, get: () => W.value, set: (q) => W.value = q });
  }
  ...
  x && e.render === On && (e.render = x), I != null && (e.inheritAttrs = I), T && (e.components = T), M && (e.directives = M), B && vv(e);
}
...
function W0(e, t) {
  ...
  const { insert: l, remove: a, patchProp: r, createElement: o, createText: i, createComment: u, setText: c, setElementText: s, parentNode: f, nextSibling: m, setScopeId: h = On, insertStaticContent: g } = e, _ = (S, E, N, ne = null, le = null, X = null, ve = void 0, ge = null, me = !!E.dynamicChildren) => {
    if (S === E) return;
    S && !vl(S, E) && (ne = A(S), q(S, le, X, true), S = null), E.patchFlag === -2 && (me = false, E.dynamicChildren = null);
    ...
    switch (de) {
      ...
      case Ti:
        ...
        break;
      case rn:
        T(S, E, N, ne, le, X, ve, ge, me);
        break;
      default:
        Q & 1 ? x(S, E, N, ne, le, X, ve, ge, me) : Q & 6 ? M(S, E, N, ne, le, X, ve, ge, me) : (Q & 64 || Q & 128) && de.process(S, E, N, ne, le, X, ve, ge, me, H);
    }
    ...
    E.slotScopeIds = ge, S == null ? E.shapeFlag & 512 ? le.ctx.activate(E, N, ne, ve, me) : C(E, N, ne, le, X, ve, me) : j(S, E, me);
  }, C = (S, E, N, ne, le, X, ve) => {
    const ge = S.component = mb(S, ne, le);
    if (Ko(S) && (ge.ctx.renderer = H), hb(ge, false, ve), ge.asyncDep) {
    ...
    if (de > Q) {
    ...
    } else if (de > oe) for (; de <= Q; ) q(S[de], le, X, true), de++;
    else {
      ...
      for (de = we; de <= Q; de++) {
        ...
        Oe === void 0 ? q(Ce, le, X, true) : (re[Oe - ke] = de + 1, Oe >= pe ? pe = Oe : ie = true, _(Ce, E[Oe], N, null, le, X, ve, ge, me), He++);
      }
    ...
    if (qe && (Me = ve && ve.onVnodeBeforeUnmount) && vn(Me, E, S), ae & 6) fe(S.component, N, ne);
      ...
      ke && kl(S, null, E, "beforeUnmount"), ae & 64 ? S.type.remove(S, E, N, H, ne) : de && !de.hasOnce && (X !== rn || Q > 0 && Q & 64) ? R(de, E, N, false, true) : (X === rn && Q & 384 || !le && ae & 16) && R(me, E, N), ne && ee(S);
    }
    ...
    yo(me), yo(de), ne && Za(ne), le.stop(), X && (X.flags |= 8, q(ve, S, E, N)), ge && Bt(ge, E), Bt(() => {
      S.isUnmounted = true;
    ...
    for (let ve = X; ve < S.length; ve++) q(S[ve], E, N, ne, le);
  }, A = (S) => {
  ...
  let te = false;
  const V = (S, E, N) => {
    S == null ? E._vnode && q(E._vnode, null, null, true) : _(E._vnode || null, S, E, null, null, null, N), E._vnode = S, te || (te = true, nc(), tv(), te = false);
  }, H = { p: _, um: q, m: W, r: ee, mt: C, mc: D, pc: O, pbc: P, n: A, o: e };
...
function Nv(e) {
  ...
  return zt(t, { onBeforeEnter(T) {
    ...
    Tl($, [T]), $n(T, u), $n(T, c);
  }, onEnter: I(false), onAppear: I(true), onLeave(T, M) {
    T._isLeaving = true;
    const C = () => P(T, M);
    $n(T, f), T._enterCancelled ? ($n(T, m), Cu()) : (Cu(), $n(T, m)), Sc(() => {
      T._isLeaving && (il(T, f), $n(T, h), wc(b) || xc(T, l, w, C));
    }), Tl(b, [T, C]);
  }, onEnterCancelled(T) {
    B(T, false, void 0, true), Tl(y, [T]);
  }, onAppearCancelled(T) {
    B(T, true, void 0, true), Tl(D, [T]);
  }, onLeaveCancelled(T) {
    P(T), Tl(x, [T]);
  } });
}
...
var { passiveCapture: fn } = dt, Jl = null, ea = null, ta = null, Ze = he({ name: "QBtn", props: { ...Ny, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: n }) {
  ...
  function F(C) {
    if (m.value !== null) {
      if (C !== void 0) {
        ...
        if (e.type === "submit" && j !== document.body && m.value.contains(j) === false && j.contains(m.value) === false) {
  ...
  function D(C) {
    m.value !== null && (n("keydown", C), yn(C, [13, 32]) === true && ea !== m.value && (ea !== null && T(), C.defaultPrevented !== true && (C.qAvoidFocus !== true && m.value.focus(), ea = m.value, m.value.classList.add("q-btn--active"), document.addEventListener("keyup", I, true), m.value.addEventListener("blur", I, fn)), je(C)));
  }
  function B(C) {
    m.value !== null && (n("touchstart", C), C.defaultPrevented !== true && (Jl !== m.value && (Jl !== null && T(), Jl = m.value, g = C.target, g.addEventListener("touchcancel", I, fn), g.addEventListener("touchend", I, fn)), _ = true, w !== null && clearTimeout(w), w = setTimeout(() => {
      w = null, _ = false;
    }, 200)));
  }
  function P(C) {
    m.value !== null && (C.qSkipRipple = _ === true, n("mousedown", C), C.defaultPrevented !== true && ta !== m.value && (ta !== null && T(), ta = m.value, m.value.classList.add("q-btn--active"), document.addEventListener("mouseup", I, fn)));
  }
  function I(C) {
    if (m.value !== null && !((C == null ? void 0 : C.type) === "blur" && document.activeElement === m.value)) {
      if ((C == null ? void 0 : C.type) === "keyup") {
        if (ea === m.value && yn(C, [13, 32]) === true) {
          const j = new MouseEvent("click", C);
          j.qKeyEvent = true, C.defaultPrevented === true && Vt(j), C.cancelBubble === true && wt(j), m.value.dispatchEvent(j), je(C), C.qKeyEvent = true;
        }
        n("keyup", C);
      }
      T();
  ...
  return Ke(() => {
    ...
    const j = [d("span", { class: "q-focus-helper", ref: h })];
    return e.loading === true && e.percentage !== void 0 && j.push(d("span", { class: "q-btn__progress absolute-full overflow-hidden" + (e.darkPercentage === true ? " q-btn__progress--dark" : "") }, [d("span", { class: "q-btn__progress-indicator fit block", style: b.value })])), j.push(d("span", { class: "q-btn__content text-center col items-center q-anchor--skip " + o.value }, C)), e.loading !== null && j.push(d(Ft, { name: "q-transition--fade" }, () => e.loading === true ? [d("span", { key: "loading", class: "absolute-full flex flex-center" }, t.loading !== void 0 ? t.loading() : [d(_n)])] : null)), sn(d(c.value, $.value, j), [[ri, p.value, void 0, y.value]]);
  };
...
var ui = he({ name: "QMenu", inheritAttrs: false, props: { ...km, ...Aa, ...nt, ...Il, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noEscDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: $o }, self: { type: String, validator: $o }, offset: { type: Array, validator: Fm }, scrollTarget: Xl, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...Ra, "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  let a = null, r, o, i;
  const u = Se(), { proxy: c } = u, { $q: s } = c, f = K(null), m = K(false), h = v(() => e.persistent !== true && e.noRouteDismiss !== true), g = lt(e, s), { registerTick: _, removeTick: w } = ya(), { registerTimeout: k } = Zn(), { transitionProps: p, transitionStyle: y } = oi(e), { localScrollTarget: b, changeScrollEvent: x, unconfigureScrollTarget: $ } = qm(e, ee), { anchorEl: F, canShow: D } = Cs({ showing: m }), { hide: B } = $a({ showing: m, canShow: D, handleShow: ye, handleHide: W, hideOnRouteChange: h, processOnMount: true }), { showPortal: P, hidePortal: I, renderPortal: T } = qs(u, f, te, "menu"), M = { anchorEl: F, innerRef: f, onClickOutside(V) {
    if (e.persistent !== true && m.value === true) return B(V), (V.type === "touchstart" || V.target.classList.contains("q-dialog__backdrop")) && je(V), true;
  } }, C = v(() => Po(e.anchor || (e.cover === true ? "center middle" : "bottom start"), s.lang.rtl)), j = v(() => e.cover === true ? C.value : Po(e.self || "top start", s.lang.rtl)), Y = v(() => (e.square === true ? " q-menu--square" : "") + (g.value === true ? " q-menu--dark q-dark" : "")), L = v(() => e.autoClose === true ? { onClick: G } : {}), O = v(() => m.value === true && e.persistent !== true);
  be(O, (V) => {
  ...
  function W(V) {
    w(), I(), q(true), a !== null && (V === void 0 || V.qClickOutside !== true) && ((((V == null ? void 0 : V.type.indexOf("key")) === 0 ? a.closest('[tabindex]:not([tabindex^="-"])') : void 0) || a).focus(), a = null), k(() => {
      I(true), n("hide", V);
    }, e.transitionDuration);
  }
  function q(V) {
  ...
  function A() {
    Ts({ targetEl: f.value, offset: e.offset, anchorEl: F.value, anchorOrigin: C.value, selfOrigin: j.value, absoluteOffset: r, fit: e.fit, cover: e.cover, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function te() {
  ...
  return Ke(q), Object.assign(c, { focus: U, updatePosition: A }), T;
...
function Ps() {
  ...
  function c(C) {
    ...
    D((n.$q.lang.rtl === true ? -1 : 1) * (C.direction === j ? 1 : -1));
  }
  ...
  be(() => e.modelValue, (C, j) => {
    ...
    o !== true && F(Y === -1 ? 0 : Y < x(j) ? -1 : 1), u.value !== Y && (u.value = Y, t("beforeTransition", C, j), a(() => {
      t("transition", C, j);
    }, e.transitionDuration));
  });
  function k() {
  ...
  function x(C) {
    return r.findIndex((j) => j.props.name === C && j.props.disable !== "" && j.props.disable !== true);
  }
  function $() {
    return r.filter((C) => C.props.disable !== "" && C.props.disable !== true);
  }
  function F(C) {
    const j = C !== 0 && e.animated === true && u.value !== -1 ? "q-transition--" + (C === -1 ? f.value : m.value) : null;
    i.value !== j && (i.value = j);
  }
  function D(C, j = u.value) {
    let Y = j + C;
    for (; Y !== -1 && Y < r.length; ) {
      const L = r[Y];
    ...
    e.infinite === true && r.length !== 0 && j !== -1 && j !== r.length && D(C, C === -1 ? r.length : -1);
  }
  function B() {
  ...
  function T(C) {
    return r = _s(Pe(C.default, [])).filter((j) => j.props !== null && j.props.slot === void 0 && b(j.props.name) === true), r.length;
  }
  function M() {
    return r;
  }
  return Object.assign(n, { next: k, previous: p, goTo: y }), { panelIndex: u, panelDirectives: s, updatePanelsList: T, updatePanelIndex: B, getPanelContent: I, getEnabledPanels: $, getPanels: M, isValidPanelName: b, keepAliveProps: _, needsUniqueKeepAliveWrapper: w, goToPanelByOffset: D, goToPanel: y, nextPanel: k, previousPanel: p };
}
...
he({ name: "QCarousel", props: { ...nt, ...Rs, ...Ls, transitionPrev: { type: String, default: "fade" }, transitionNext: { type: String, default: "fade" }, height: String, padding: Boolean, controlColor: String, controlTextColor: String, controlType: { type: String, validator: (e) => bp.includes(e), default: "flat" }, autoplay: [Number, Boolean], arrows: Boolean, prevIcon: String, nextIcon: String, navigation: Boolean, navigationPosition: { type: String, validator: (e) => gp.includes(e) }, navigationIcon: String, navigationActiveIcon: String, thumbnails: Boolean }, emits: [...Bs, ...$s], setup(e, { slots: t }) {
  ...
  function B() {
    ...
    if (e.navigation === true) {
      const I = t["navigation-icon"] !== void 0 ? t["navigation-icon"] : (M) => d(Ze, { key: "nav" + M.name, class: `q-carousel__navigation-icon q-carousel__navigation-icon--${M.active === true ? "" : "in"}active`, ...M.btnProps, onClick: M.onClick }), T = r - 1;
      P.push(D("buttons", (M, C) => {
        const j = M.props.name, Y = h.value === C;
        return I({ index: C, maxIndex: T, name: j, active: Y, btnProps: { icon: Y === true ? x.value : b.value, size: "sm", ...$.value }, onClick: () => {
          c(j);
        } });
      }));
...
function Nm(e, t) {
  const { props: n, slots: l, emit: a, proxy: r } = Se(), { $q: o } = r, i = lt(n, o), u = K(null), { refocusTargetEl: c, refocusTarget: s } = Vm(n, u), f = tl(n, zm), m = v(() => n.val !== void 0 && Array.isArray(n.modelValue)), h = v(() => {
    const T = Ge(n.val);
    return m.value === true ? n.modelValue.findIndex((M) => Ge(M) === T) : -1;
    ...
    const T = g.value === true ? "truthy" : _.value === true ? "falsy" : "indet", M = n.color !== void 0 && (n.keepColor === true || (e === "toggle" ? g.value === true : _.value !== true)) ? ` text-${n.color}` : "";
    return `q-${e}__inner relative-position non-selectable q-${e}__inner--${T}${M}`;
  }), b = v(() => {
    ...
    const T = { tabindex: k.value, role: e === "toggle" ? "switch" : "checkbox", "aria-label": n.label, "aria-checked": w.value === true ? "mixed" : g.value === true ? "true" : "false" };
    return n.disable === true && (T["aria-disabled"] = "true"), T;
  });
  function F(T) {
    T !== void 0 && (je(T), s(T)), n.disable !== true && a("update:modelValue", D(), T);
  }
  function D() {
    if (m.value === true) {
      if (g.value === true) {
  ...
  return Object.assign(r, { toggle: F }), () => {
    ...
    const M = [d("div", { class: y.value, style: f.value, "aria-hidden": "true" }, T)];
...
function Ym({ updateValue: e, updatePosition: t, getDragging: n, formAttrs: l }) {
  ...
  }), x = v(() => a.step === 0 ? 1 : a.step), $ = v(() => y.value === true ? a.tabindex || 0 : -1), F = v(() => a.max - a.min), D = v(() => p.value - k.value), B = v(() => ue(k.value)), P = v(() => ue(p.value)), I = v(() => a.vertical === true ? w.value === true ? "bottom" : "top" : w.value === true ? "right" : "left"), T = v(() => a.vertical === true ? "height" : "width"), M = v(() => a.vertical === true ? "width" : "height"), C = v(() => a.vertical === true ? "vertical" : "horizontal"), j = v(() => {
  ...
  const U = v(() => {
  ...
  }), ye = v(() => O("markers") + " absolute overflow-hidden"), W = v(() => O("track-container")), q = v(() => L("pin")), ee = v(() => L("label")), G = v(() => L("text-container")), fe = v(() => L("marker-labels-container") + (a.markerLabelsClass !== void 0 ? ` ${a.markerLabelsClass}` : "")), R = v(() => "q-slider__track relative-position no-outline" + (a.trackColor !== void 0 ? ` bg-${a.trackColor}` : "")), A = v(() => {
    ...
    const re = P.value - B.value, _e = { [I.value]: `${100 * B.value}%`, [T.value]: re === 0 ? "2px" : `${100 * re}%` };
  ...
  function ie(re) {
    ...
    return () => {
      ...
      return (a.label === true || a.labelAlways === true) && (Ct.push(d("div", { class: q.value + " absolute fit no-pointer-events" + Ae.value }, [d("div", { class: ee.value, style: { minWidth: a.thumbSize } }, [d("div", { class: G.value, style: Ye.value }, [d("span", { class: it.value }, re.label.value)])])])), a.name !== void 0 && a.disable !== true && c(Ct, "push")), d("div", { class: Ce.value, style: Oe.value, ...re.getNodeData() }, Ct);
    };
  }
  ...
  }), { state: { active: s, focus: m, preventFocus: f, dragging: h, editable: y, classes: Y, tabindex: $, attributes: j, roundValueFn: b, keyStep: x, trackLen: F, innerMin: k, innerMinRatio: B, innerMax: p, innerMaxRatio: P, positionProp: I, sizeProp: T, isReversed: w }, methods: { onActivate: ke, onMobileClick: Me, onBlur: we, onKeyup: He, getContent: pe, getThumbRenderFn: ie, convertRatioToModel: H, convertModelToRatio: ue, getDraggingRatio: S } };
}
...
var qp = ["left", "center", "right", "justify"], ad = he({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => qp.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: n }) {
  ...
  function U(ae) {
    ...
    _.value = we, we === true && o(q), p.value = Q < parseInt(e.breakpoint, 10);
  }
  function ye(ae, Q) {
  ...
  function W(ae) {
    ...
    Me += e.vertical === true ? qe.height - ke : qe.width - oe, Me > 0 && (h.value[e.vertical === true ? "scrollTop" : "scrollLeft"] += Math.ceil(Me), q());
  }
  function q() {
    const ae = h.value;
    if (ae === null) return;
    const Q = ae.getBoundingClientRect(), oe = e.vertical === true ? ae.scrollTop : Math.abs(ae.scrollLeft);
    j.value === true ? (w.value = Math.ceil(oe + Q.width) < ae.scrollWidth - 1, k.value = oe > 0) : (w.value = oe > 0, k.value = e.vertical === true ? Math.ceil(oe + Q.height) < ae.scrollHeight : Math.ceil(oe + Q.width) < ae.scrollWidth);
  }
  function ee(ae) {
  ...
  function A(ae, Q) {
    ...
    if (Me !== void 0) {
      const He = j.value === true ? -1 : 1, Ve = oe.indexOf(Q) + Me * He;
  ...
  function V(ae) {
    ...
    const Me = ae < qe ? -1 : 1;
    return qe += Me * 5, qe < 0 ? (ke = true, qe = 0) : (Me === -1 && qe <= ae || Me === 1 && qe >= ae) && (ke = true, qe = ae), we(Q, qe), q(), ke;
  }
  function H(ae, Q) {
  ...
  function ue() {
    ...
    for (const Me of oe) {
      ...
      if (He === true) {
        if (Ve !== we || _e !== qe || H(ke, ie) === false) continue;
        ae = Me.name.value;
        break;
      }
      if (Ve !== "" && Ve !== we || _e !== 0 && H(ie, ke) === false) continue;
...
he({ name: "QColor", props: { ...nt, ...wn, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function O(S) {
    const E = T(S), N = { r: E.r, g: E.g, b: E.b, a: E.a };
  ...
  function R() {
    return d(Mp, { modelValue: f.value, animated: true }, () => [d(zi, { class: "q-color-picker__spectrum-tab overflow-hidden", name: "spectrum" }, V), d(zi, { class: "q-pa-md q-color-picker__tune-tab", name: "tune" }, H), d(zi, { class: "q-color-picker__palette-tab", name: "palette" }, ue)]);
  }
  function A(S) {
    f.value = S;
  }
  ...
  function V() {
    const S = { ref: o, class: "q-color-picker__spectrum non-selectable relative-position cursor-pointer" + (h.value !== true ? " readonly" : ""), style: x.value, ...h.value === true ? { onClick: W, onMousedown: q } : {} }, E = [d("div", { style: { paddingBottom: "100%" } }), d("div", { class: "q-color-picker__spectrum-white absolute-full" }), d("div", { class: "q-color-picker__spectrum-black absolute-full" }), d("div", { class: "absolute", style: $.value }, [m.value.hex !== void 0 ? d("div", { class: "q-color-picker__spectrum-circle" }) : null])], N = [d(na, { class: "q-color-picker__hue non-selectable", modelValue: m.value.h, min: 0, max: 360, trackSize: "8px", innerTrackColor: "transparent", selectionColor: "transparent", readonly: h.value !== true, thumbPath: dd, "onUpdate:modelValue": C, onChange: j })];
...
he({ name: "QDate", props: { ...Fo, ...wn, ...nt, modelValue: { required: true, validator: (e) => typeof e == "string" || Array.isArray(e) === true || Object(e) === e || e === null }, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { ...Fo.mask, default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: ji }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: ji }, navigationMaxYearMonth: { type: String, validator: ji }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: hd } }, emits: [...rh, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: n }) {
  ...
  let f;
  const m = $r(e), h = Cl(m), g = K(null), _ = K(He()), w = K(c()), k = v(() => He()), p = v(() => c()), y = v(() => s()), b = K(ie(_.value, w.value)), x = K(e.defaultView), $ = v(() => a.lang.rtl === true ? "right" : "left"), F = K($.value), D = K($.value), B = b.value.year, P = K(B - B % Nn - (B < 0 ? Nn : 0)), I = K(null), T = v(() => {
  ...
  }), M = v(() => e.color || "primary"), C = v(() => e.textColor || "white"), j = v(() => e.emitImmediately === true && e.multiple !== true && e.range !== true), Y = v(() => Array.isArray(e.modelValue) === true ? e.modelValue : e.modelValue !== null && e.modelValue !== void 0 ? [e.modelValue] : []), L = v(() => Y.value.filter((z) => typeof z == "string").map((z) => Ve(z, _.value, w.value)).filter((z) => z.dateHash !== null && z.day !== null && z.month !== null && z.year !== null)), O = v(() => {
  ...
  }), ye = v(() => e.calendar === "persian" ? Un : (z, Z, ce) => dh(new Date(z.year, z.month - 1, z.day, z.hour, z.minute, z.second, z.millisecond), Z === void 0 ? _.value : Z, ce === void 0 ? w.value : ce, z.year, z.timezoneOffset)), W = v(() => L.value.length + O.value.reduce((z, Z) => z + 1 + ch(U.value(Z.to), U.value(Z.from)), 0)), q = v(() => {
  ...
  }), H = v(() => typeof e.eventColor == "function" ? e.eventColor : () => e.eventColor), ue = v(() => {
  ...
  function re(z) {
    ...
    ce === 13 ? (ce = 1, Z++) : ce === 0 && (ce = 12, Z--), it(Z, ce), j.value === true && jt("month");
  }
  function _e(z) {
  ...
  function Ce(z) {
    it(z, b.value.month), x.value = e.defaultView === "Years" ? "Months" : "Calendar", j.value === true && jt("year");
  }
  function Oe(z) {
    it(b.value.year, z), x.value = "Calendar", j.value === true && jt("month");
  }
  function Ae(z, Z) {
    var _a2;
  ...
  function Fe() {
    ...
    } }) }, [fe.value]))]), d("div", { class: "q-date__header-title relative-position flex no-wrap" }, [d("div", { class: "relative-position col" }, [d(Ft, { name: "q-transition--fade" }, () => d("div", { key: "h-sub" + q.value, class: "q-date__header-title-label q-date__header-link " + (x.value === "Calendar" ? "q-date__header-link--active" : "cursor-pointer"), tabindex: i.value, ...o("vC", { onClick() {
      x.value = "Calendar";
    }, onKeyup(z) {
      z.keyCode === 13 && (x.value = "Calendar");
    } }) }, [q.value]))]), e.todayBtn === true ? d(Ze, { class: "q-date__header-today self-start", icon: a.iconSet.datetime.today, ariaLabel: a.lang.date.today, flat: true, size: "sm", round: true, tabindex: i.value, onClick: oe }) : null])]);
  }
  ...
  return Object.assign(l, { setToday: oe, setView: we, offsetCalendar: ke, setCalendarTo: qe, setEditingRange: Me }), () => {
    ...
    return Z !== void 0 && z.push(d("div", { class: "q-date__actions" }, Z)), e.name !== void 0 && e.disable !== true && h(z, "push"), d("div", { class: T.value, ...ae.value }, [Fe(), d("div", { ref: g, class: "q-date__main col column", tabindex: -1 }, z)]);
  };
} });
function fh(e, t, n) {
  let l;
...
var Kr = 0, Qp = { standard: "fixed-full flex-center", top: "fixed-top justify-center", bottom: "fixed-bottom justify-center", right: "fixed-right items-center", left: "fixed-left items-center" }, wd = { standard: ["scale", "scale"], top: ["slide-down", "slide-up"], bottom: ["slide-up", "slide-down"], right: ["slide-left", "slide-right"], left: ["slide-right", "slide-left"] }, ci = he({ name: "QDialog", inheritAttrs: false, props: { ...Aa, ...Il, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, backdropFilter: String, position: { type: String, default: "standard", validator: (e) => ["standard", "top", "bottom", "left", "right"].includes(e) } }, emits: [...Ra, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  const m = v(() => e.persistent !== true && e.noRouteDismiss !== true && e.seamless !== true), { preventBodyScroll: h } = vh(), { registerTimeout: g } = Zn(), { registerTick: _, removeTick: w } = ya(), { transitionProps: k, transitionStyle: p } = oi(e, () => wd[e.position][0], () => wd[e.position][1]), y = v(() => p.value + (e.backdropFilter !== void 0 ? `;backdrop-filter:${e.backdropFilter};-webkit-backdrop-filter:${e.backdropFilter}` : "")), { showPortal: b, hidePortal: x, portalIsAccessible: $, renderPortal: F } = qs(a, r, fe, "dialog"), { hide: D } = $a({ showing: o, hideOnRouteChange: m, handleShow: j, handleHide: Y, processOnMount: true }), { addToHistory: B, removeFromHistory: P } = fh(o, D, m), I = v(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${e.maximized === true ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${Qp[e.position]}` + (i.value === true ? " q-dialog__inner--animating" : "") + (e.fullWidth === true ? " q-dialog__inner--fullwidth" : "") + (e.fullHeight === true ? " q-dialog__inner--fullheight" : "") + (e.square === true ? " q-dialog__inner--square" : "")), T = v(() => o.value === true && e.seamless !== true), M = v(() => e.autoClose === true ? { onClick: q } : {}), C = v(() => [`q-dialog fullscreen no-pointer-events q-dialog--${T.value === true ? "modal" : "seamless"}`, l.class]);
  be(() => e.maximized, (R) => {
    o.value === true && W(R);
  }), be(T, (R) => {
    ...
    B(), c = e.noRefocus === false && document.activeElement !== null ? document.activeElement : null, W(e.maximized), b(), i.value = true, e.noFocus !== true ? ((_a2 = document.activeElement) == null ? void 0 : _a2.blur(), _(L)) : w(), g(() => {
      if (a.proxy.$q.platform.is.ios === true) {
        if (e.seamless !== true && document.activeElement) {
          const { top: A, bottom: te } = document.activeElement.getBoundingClientRect(), { innerHeight: V } = window, H = window.visualViewport !== void 0 ? window.visualViewport.height : V;
          A > 0 && te > H / 2 && (document.scrollingElement.scrollTop = Math.min(document.scrollingElement.scrollHeight - H, te >= V ? 1 / 0 : Math.ceil(document.scrollingElement.scrollTop + te - H / 2))), document.activeElement.scrollIntoView();
        }
  ...
  const { show: x, hide: $ } = $a({ showing: k, hideOnRouteChange: p, handleShow: y, handleHide: b }), { addToHistory: F, removeFromHistory: D } = fh(k, $, p), B = { belowBreakpoint: g, hide: $ }, P = v(() => e.side === "right"), I = v(() => (r.lang.rtl === true ? -1 : 1) * (P.value === true ? 1 : -1)), T = K(0), M = K(false), C = K(false), j = K(w.value * I.value), Y = v(() => P.value === true ? "left" : "right"), L = v(() => k.value === true && g.value === false && e.overlay === false ? e.miniToOverlay === true ? e.miniWidth : w.value : 0), O = v(() => e.overlay === true || e.miniToOverlay === true || s.view.value.indexOf(P.value ? "R" : "L") !== -1 || r.platform.is.ios === true && s.isContainer.value === true), U = v(() => e.overlay === false && k.value === true && g.value === false), ye = v(() => e.overlay === true && k.value === true && g.value === false), W = v(() => "fullscreen q-drawer__backdrop" + (k.value === false && M.value === false ? " hidden" : "")), q = v(() => ({ backgroundColor: `rgba(0,0,0,${T.value * 0.4})` })), ee = v(() => P.value === true ? s.rows.value.top[2] === "r" : s.rows.value.top[0] === "l"), G = v(() => P.value === true ? s.rows.value.bottom[2] === "r" : s.rows.value.bottom[0] === "l"), fe = v(() => {
    ...
    const Q = { width: `${w.value}px`, transform: `translateX(${j.value}px)` };
  ...
  function E(Q) {
    ...
    }) : (s.isContainer.value === true && P.value === true && (g.value === true || Math.abs(Q) === w.value) && (Q += I.value * s.scrollbarWidth.value), j.value = Q);
  }
  function N(Q) {
    T.value = Q;
  }
  ...
  return s.instances[e.side] = B, ae(e.miniToOverlay, w.value), me("space", U.value), me("offset", L.value), e.showIfAbove === true && e.modelValue !== true && k.value === true && e["onUpdate:modelValue"] !== void 0 && n("update:modelValue", true), ft(() => {
    ...
    const Q = [];
    g.value === true && (e.noSwipeOpen === false && Q.push(sn(d("div", { key: "open", class: `q-drawer__opener fixed-${e.side}`, "aria-hidden": "true" }), V.value)), Q.push(pn("div", { ref: "backdrop", class: W.value, style: q.value, "aria-hidden": "true", onClick: $ }, void 0, "backdrop", e.noSwipeBackdrop !== true && k.value === true, () => ue.value)));
    const oe = _.value === true && t.mini !== void 0, we = [d("div", { ...l, key: "" + oe, class: [A.value, l.class] }, oe === true ? t.mini() : Pe(t.default))];
    return e.elevated === true && k.value === true && we.push(d("div", { class: "q-layout__shadow absolute-full overflow-hidden no-pointer-events" })), Q.push(pn("aside", { ref: "content", class: te.value, style: R.value }, we, "contentclose", e.noSwipeClose !== true && g.value === true, () => H.value)), d("div", { class: "q-drawer-container" }, Q);
  };
} });
function mh(e, t) {
...
var Kp = /^https?:\/\//, Wp = class {
  ...
  const { showPortal: P, hidePortal: I, renderPortal: T } = qs(o, u, q, "tooltip");
  ...
  return Ke(j), Object.assign(o.proxy, { updatePosition: Y }), T;
...
he({ name: "QEditor", props: { ...nt, ...Ls, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => e.length === 0 || e.every((t) => t.length), default: () => [["left", "center", "right", "justify"], ["bold", "italic", "underline", "strike"], ["undo", "redo"]] }, toolbarColor: String, toolbarBg: String, toolbarTextColor: String, toolbarToggleColor: { type: String, default: "primary" }, toolbarOutline: Boolean, toolbarPush: Boolean, toolbarRounded: Boolean, paragraphTag: { type: String, validator: (e) => ["div", "p"].includes(e), default: "div" }, contentStyle: Object, contentClass: [Object, Array, String], square: Boolean, flat: Boolean, dense: Boolean }, emits: [...Bs, "update:modelValue", "keydown", "click", "focus", "blur", "dropdownShow", "dropdownHide", "dropdownBeforeShow", "dropdownBeforeHide", "linkShow", "linkHide"], setup(e, { slots: t, emit: n }) {
  ...
  const k = v(() => e.toolbarBg ? ` bg-${e.toolbarBg}` : ""), p = v(() => ({ type: "a", flat: e.toolbarOutline !== true && e.toolbarPush !== true, noWrap: true, outline: e.toolbarOutline, push: e.toolbarPush, rounded: e.toolbarRounded, dense: true, color: e.toolbarColor, disable: !h.value, size: "sm" })), y = v(() => {
    ...
    return e.toolbar.map((te) => te.map((V) => {
      ...
      const H = A[V];
      return H ? H.type === "no-state" || R[V] && (H.cmd === void 0 || y.value[H.cmd] && y.value[H.cmd].type === "no-state") ? H : Object.assign({ type: "toggle" }, H) : { type: "slot", slot: V };
    }));
  }), x = { $q: a, props: e, slots: t, emit: n, inFullscreen: o, toggleFullscreen: i, runCmd: q, isViewingSource: m, editLinkUrl: f, toolbarBackgroundClass: k, buttonProps: p, contentRef: s, buttons: b, setContent: W };
  be(() => e.modelValue, (R) => {
    w !== R && (w = R, W(R, true));
  }), be(f, (R) => {
    n(`link${R ? "Show" : "Hide"}`);
  ...
  return ft(() => {
  ...
  }), Object.assign(l, { runCmd: q, refreshToolbar: ee, focus: G, getContentEl: fe }), () => {
    let R;
    if ($.value) {
    ...
    return d("div", { ref: c, class: B.value, style: { height: o.value === true ? "100%" : null }, ...I.value, onFocusin: L, onFocusout: O }, [R, d("div", { ref: s, style: D.value, class: P.value, contenteditable: h.value, placeholder: e.placeholder, ...u.listeners.value, onInput: T, onKeydown: M, onClick: C, onBlur: j, onFocus: Y, onMousedown: U, onTouchstartPassive: U })]);
  };
} });
...
he({ name: "QExpansionItem", props: { ...Ar, ...Aa, ...nt, icon: String, label: String, labelLines: [Number, String], caption: String, captionLines: [Number, String], dense: Boolean, toggleAriaLabel: String, expandIcon: String, expandedIcon: String, expandIconClass: [Array, String, Object], duration: {}, headerInsetLevel: Number, contentInsetLevel: Number, expandSeparator: Boolean, defaultOpened: Boolean, hideExpandIcon: Boolean, expandIconToggle: Boolean, switchToggleSide: Boolean, denseToggle: Boolean, group: String, popup: Boolean, headerStyle: [Array, String, Object], headerClass: [Array, String, Object] }, emits: [...Ra, "click", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  function M() {
    let L;
    return t.header !== void 0 ? L = [].concat(t.header(b.value)) : (L = [d(mn, () => [d(Du, { lines: e.labelLines }, () => e.label || ""), e.caption ? d(Du, { lines: e.captionLines, caption: true }, () => e.caption) : null])], e.icon && L[e.switchToggleSide === true ? "push" : "unshift"](d(mn, { side: e.switchToggleSide === true, avatar: e.switchToggleSide !== true }, () => d(et, { name: e.icon })))), e.disable !== true && e.hideExpandIcon !== true && L[e.switchToggleSide === true ? "unshift" : "push"](T()), L;
  }
  function C() {
  ...
  function Y() {
    const L = [C(), d(Ds, { duration: e.duration, onShow: B, onHide: P }, j)];
...
function mi(e) {
  ...
  return Vn(() => {
    ...
    return d(e.tag.value, { ref: e.rootRef, class: [w.value, a.class], style: a.style, ...U }, [l.before !== void 0 ? d("div", { class: "q-field__before q-field__marginal row no-wrap items-center", onClick: Vt }, l.before()) : null, d("div", { class: "q-field__inner relative-position col self-stretch" }, [d("div", { ref: e.controlRef, class: k.value, tabindex: -1, ...e.controlEvents }, M()), g.value === true ? j() : null]), l.after !== void 0 ? d("div", { class: "q-field__after q-field__marginal row no-wrap items-center", onClick: Vt }, l.after()) : null]);
  };
}
...
he({ name: "QFile", inheritAttrs: false, props: { ...Sh, ...wn, ...xh, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...fi, ...Ch], setup(e, { slots: t, emit: n, attrs: l }) {
  ...
  function M(L, O) {
    const U = m(L, O, _.value, $.value), ye = T();
  ...
  return Object.assign(r, { fieldClass: x, emitValue: B, hasValue: w, inputRef: o, innerValue: _, floatingLabel: v(() => w.value === true || Kl(e.displayValue)), computedCounter: v(() => {
    ...
    return r.editable.value === true && Object.assign(L, { onDragover: s, onDragleave: f, onKeydown: P, onKeyup: I }), d("div", L, [Y()].concat(j()));
...
he({ name: "QImg", props: { ...Ns, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, loadingShowDelay: { type: [Number, String], default: 0 }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: h1 }, placeholderSrc: String, errorSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: n }) {
  ...
  function F(T, M) {
    M === 1e3 || gl(r) === true || (T.complete === true ? D(T) : o(() => {
      F(T, M + 1);
    }, 50));
  }
  function D(T) {
    gl(r) !== true && (h.value = h.value ^ 1, m[h.value].value = null, x(), T.getAttribute("__qerror") !== "true" && (_.value = false), n("load", T.currentSrc || T.src));
  }
  function B(T) {
    i(), x(), _.value = true, m[h.value].value = f.value, m[h.value ^ 1].value = s.value, n("error", T);
  }
  function P(T) {
    const M = m[T].value, C = { key: "img_" + T, class: p.value, style: y.value, alt: e.alt, crossorigin: e.crossorigin, decoding: e.decoding, referrerpolicy: e.referrerpolicy, height: e.height, width: e.width, loading: e.loading, fetchpriority: e.fetchpriority, "aria-hidden": "true", draggable: e.draggable, ...M };
    return h.value === T ? Object.assign(C, { class: C.class + "current", onLoad: $, onError: B }) : C.class += "loaded", d("div", { class: "q-img__container absolute-full", key: "img" + T }, d("img", C));
  }
  function I() {
  ...
  return () => {
    const T = [];
    return a.value !== null && T.push(d("div", { key: "filler", style: a.value })), m[0].value !== null && T.push(P(0)), m[1].value !== null && T.push(P(1)), T.push(d(Ft, { name: "q-transition--fade" }, I)), d("div", { key: "main", class: w.value, style: k.value, role: "img", "aria-label": e.alt }, T);
  };
} });
var { passive: Al } = dt;
...
function y1(e, t, n, l) {
  ...
  function g(B) {
    ...
    let P = "", I = a;
    const T = I.indexOf(Lt);
    if (T !== -1) {
      for (let M = B - I.length; M > 0; M--) P += Lt;
      I = I.slice(0, T) + P + I.slice(T);
    }
    return I;
  }
  function _() {
    ...
    const B = qd[e.mask] === void 0 ? e.mask : qd[e.mask], P = typeof e.fillMask == "string" && e.fillMask.length !== 0 ? e.fillMask.slice(0, 1) : "_", I = P.replace(Td, "\\$&"), T = [], M = [], C = [];
    let j = e.reverseFillMask === true, Y = "", L = "";
    B.replace(g1, (W, q, ee, G, fe) => {
      if (G !== void 0) {
        const R = Oo[G];
        C.push(R), L = R.negate, j === true && (M.push("(?:" + L + "+)?(" + R.pattern + "+)?(?:" + L + "+)?(" + R.pattern + "+)?"), j = false), M.push("(?:" + L + "+)?(" + R.pattern + ")?");
      } else if (ee !== void 0) Y = "\\" + (ee === "\\" ? "" : ee), C.push(ee), T.push("([^" + Y + "]+)?" + Y + "?");
      else {
        const R = q !== void 0 ? q : fe;
        Y = R === "\\" ? "\\\\\\\\" : R.replace(Td, "\\\\$&"), C.push(R), T.push("([^" + Y + "]+)?" + Y + "?");
      }
    });
    const O = new RegExp("^" + T.join("") + "(" + (Y === "" ? "." : "[^" + Y + "]") + "+)?" + (Y === "" ? "" : "[" + Y + "]*") + "$"), U = M.length - 1, ye = M.map((W, q) => q === 0 && e.reverseFillMask === true ? new RegExp("^" + I + "*" + W) : q === U ? new RegExp("^" + W + "(" + (L === "" ? "." : L) + "+)?" + (e.reverseFillMask === true ? "$" : I + "*")) : new RegExp("^" + W));
    o = C, i = (W) => {
      const q = O.exec(e.reverseFillMask === true ? W : W.slice(0, C.length + 1));
      q !== null && (W = q.slice(1).join(""));
  ...
  function w(B, P, I) {
    const T = l.value, M = T.selectionEnd, C = T.value.length - M, j = F(B);
    P === true && _();
    const Y = x(j), L = e.fillMask !== false ? D(Y) : Y, O = f.value !== L;
    T.value !== L && (T.value = L), O === true && (f.value = L), document.activeElement === T && We(() => {
      if (L === r) {
        const ye = e.reverseFillMask === true ? r.length : 0;
        T.setSelectionRange(ye, ye, "forward");
        return;
      }
      if (I === "insertFromPaste" && e.reverseFillMask !== true) {
        const ye = T.selectionEnd;
        let W = M - 1;
        for (let q = u; q <= W && q < ye; q++) a[q] !== Lt && W++;
        p.right(T, W);
        return;
      }
      ...
      if (e.reverseFillMask === true) if (O === true) {
        ...
        ye === 1 && M === 1 ? T.setSelectionRange(ye, ye, "forward") : p.rightReverse(T, ye);
      } else {
        const ye = L.length - C;
        T.setSelectionRange(ye, ye, "backward");
      }
      else if (O === true) {
  ...
  function k(B, P, I) {
    const T = x(F(B.value));
    P = Math.max(0, a.indexOf(Lt), Math.min(T.length, P)), u = P, B.setSelectionRange(P, I, "forward");
  }
  const p = { left(B, P) {
    ...
    if (T < 0 && a[P] !== void 0 && a[P] !== Lt) return p.right(B, 0);
    ...
    if (T > I && a[P - 1] !== void 0 && a[P - 1] !== Lt) return p.left(B, I);
    B.setSelectionRange(P, P, "forward");
  }, leftReverse(B, P) {
    const I = g(B.value.length);
    let T = Math.max(0, P - 1);
    for (; T >= 0; T--) if (I[T - 1] === Lt) {
      P = T;
      break;
    } else if (I[T] === Lt && (P = T, T === 0)) break;
    if (T < 0 && I[P] !== void 0 && I[P] !== Lt) return p.rightReverse(B, 0);
    P >= 0 && B.setSelectionRange(P, P, "backward");
  }, rightReverse(B, P) {
    const I = B.value.length, T = g(I), M = T.slice(0, P + 1).indexOf(Lt) === -1;
    let C = Math.min(I, P + 1);
    for (; C <= I; C++) if (T[C - 1] === Lt) {
      P = C, P > 0 && M === true && P--;
      break;
    }
    if (C > I && T[P - 1] !== void 0 && T[P - 1] !== Lt) return p.leftReverse(B, I);
    B.setSelectionRange(P, P, "forward");
  } };
  function y(B) {
    t("click", B), c = void 0;
  ...
  function b(B) {
    ...
    const P = l.value, I = P.selectionStart, T = P.selectionEnd;
    if (B.shiftKey || (c = void 0), B.keyCode === 37 || B.keyCode === 39) {
      B.shiftKey && c === void 0 && (c = P.selectionDirection === "forward" ? I : T);
      const M = p[(B.keyCode === 39 ? "right" : "left") + (e.reverseFillMask === true ? "Reverse" : "")];
      if (B.preventDefault(), M(P, c === I ? T : I), B.shiftKey) {
        const C = P.selectionStart;
        P.setSelectionRange(Math.min(c, C), Math.max(c, C), "forward");
      }
    } else B.keyCode === 8 && e.reverseFillMask !== true && I === T ? (p.left(P, I), P.setSelectionRange(P.selectionStart, T, "backward")) : B.keyCode === 46 && e.reverseFillMask === true && I === T && (p.rightReverse(P, T), P.setSelectionRange(I, P.selectionEnd, "forward"));
  }
  function x(B) {
    if (B == null || B === "") return "";
    ...
    for (let M = 0; M < P.length; M++) {
      const C = B[I], j = P[M];
      if (typeof j == "string") T += j, C === j && I++;
      else if (C !== void 0 && j.regex.test(C)) T += j.transform !== void 0 ? j.transform(C) : C, I++;
      else return T;
    }
    return T;
  }
  function $(B) {
    ...
    for (let C = P.length - 1; C >= 0 && T !== -1; C--) {
      const j = P[C];
      let Y = B[T];
      if (typeof j == "string") M = j + M, Y === j && T--;
      else if (Y !== void 0 && j.regex.test(Y)) do
        M = (j.transform !== void 0 ? j.transform(Y) : Y) + M, T--, Y = B[T];
      while (I === C && Y !== void 0 && j.regex.test(Y));
      else return M;
    }
    return M;
  }
...
var Eh = he({ name: "QInput", inheritAttrs: false, props: { ...di, ...b1, ...wn, modelValue: [String, Number, FileList], shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...fi, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: n }) {
  ...
  const f = K(null), m = Ms(e), { innerValue: h, hasMask: g, moveCursorForPaste: _, updateMaskValue: w, onMaskedKeydown: k, onMaskedClick: p } = y1(e, t, Y, f), y = qh(e, true), b = v(() => Kl(h.value)), x = Mh(C), $ = vi({ changeEvent: true }), F = v(() => e.type === "textarea" || e.autogrow === true), D = v(() => F.value === true || ["text", "search", "url", "tel", "password"].includes(e.type)), B = v(() => {
    const q = { ...$.splitAttrs.listeners.value, onInput: C, onPaste: M, onChange: O, onBlur: U, onFocus: wt };
    return q.onCompositionstart = q.onCompositionupdate = q.onCompositionend = x, g.value === true && (q.onKeydown = k, q.onClick = p), e.autogrow === true && (q.onAnimationend = j), q;
  }), P = v(() => {
    const q = { tabindex: 0, "data-autofocus": e.autofocus === true || void 0, rows: e.type === "textarea" ? 6 : void 0, "aria-label": e.label, name: m.value, ...$.splitAttrs.attributes.value, id: $.targetUid.value, maxlength: e.maxlength, disabled: e.disable === true, readonly: e.readonly === true };
    return F.value === false && (q.type = e.type), e.autogrow === true && (q.rows = 1), q;
  });
  be(() => e.type, () => {
    ...
    q === true ? We(L) : f.value !== null && n.rows > 0 && (f.value.style.height = "auto");
  }), be(() => e.dense, () => {
    e.autogrow === true && We(L);
  });
  function I() {
    Pa(() => {
      ...
      f.value !== null && f.value !== q && (q === null || q.id !== $.targetUid.value) && f.value.focus({ preventScroll: true });
    });
  }
  function T() {
    var _a2;
  ...
  function C(q) {
    ...
    if (g.value === true) w(ee, false, q.inputType);
    else if (Y(ee), D.value === true && q.target === document.activeElement) {
      const { selectionStart: G, selectionEnd: fe } = q.target;
      G !== void 0 && fe !== void 0 && We(() => {
        q.target === document.activeElement && ee.indexOf(q.target.value) === 0 && q.target.setSelectionRange(G, fe);
      });
    }
    e.autogrow === true && L();
  }
  ...
  function Y(q, ee) {
    s = () => {
      c = null, e.type !== "number" && r.hasOwnProperty("value") === true && delete r.value, e.modelValue !== q && o !== q && (o = q, ee === true && (u = true), t("update:modelValue", q), We(() => {
        o === q && (o = NaN);
      })), s = void 0;
  ...
  function L() {
    requestAnimationFrame(() => {
      const q = f.value;
      if (q !== null) {
        const ee = q.parentNode.style, { scrollTop: G } = q, { overflowY: fe, maxHeight: R } = a.platform.is.firefox === true ? {} : window.getComputedStyle(q), A = fe !== void 0 && fe !== "scroll";
        A === true && (q.style.overflowY = "hidden"), ee.marginBottom = q.scrollHeight - 1 + "px", q.style.height = "1px", q.style.height = q.scrollHeight + "px", A === true && (q.style.overflowY = parseInt(R, 10) < q.scrollHeight ? "auto" : "hidden"), ee.marginBottom = "", q.scrollTop = G;
      }
    });
  }
  function O(q) {
    x(q), c !== null && (clearTimeout(c), c = null), s == null ? void 0 : s(), t("change", q.target.value);
  }
  function U(q) {
  ...
  const W = mi($);
  return Object.assign(l, { focus: I, select: T, getNativeElement: () => f.value }), Ot(l, "nativeEl", () => f.value), W;
...
he({ name: "QKnob", props: { ...wn, ...Os, modelValue: { type: Number, required: true }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, tabindex: { type: [Number, String], default: 0 }, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change", "dragValue"], setup(e, { slots: t, emit: n }) {
  ...
  function x() {
    const { top: C, left: j, width: Y, height: L } = l.$el.getBoundingClientRect();
    c = { top: C + L / 2, left: j + Y / 2 };
  }
  function $(C) {
    x(), B(C);
  }
  ...
  function D(C) {
    ...
    je(C);
    const j = ([34, 33].includes(C.keyCode) ? 10 : 1) * g.value, Y = [34, 37, 40].includes(C.keyCode) ? -j : j;
  ...
  function B(C, j) {
    ...
    ye = ct(ye, i.value, u.value), n("dragValue", ye), r.value !== ye && (r.value = ye), I(j);
  }
  function P(C) {
  ...
  return () => {
    const C = { class: m.value, role: "slider", "aria-valuemin": i.value, "aria-valuemax": u.value, "aria-valuenow": e.modelValue, ...k.value, ...p.value, value: r.value, instantFeedback: _.value, ...w.value }, j = { default: t.default };
    return f.value === true && e.name !== void 0 && (j.internal = M), pn(Qm, C, j, "knob", f.value, () => b.value);
  };
} });
...
he({ name: "QPagination", props: { ...nt, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => (typeof e == "string" ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => e === "" || wm.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  function T(M, C, j) {
    ...
    return j === true && Object.assign(Y, { "aria-current": "true", ...F.value }), C !== void 0 && (e.toFn !== void 0 ? Y.to = e.toFn(C) : Y.onClick = () => {
      B(C);
    }), d(Ze, Y);
  }
  return Object.assign(n, { set: B, setByOffset: P }), () => {
    const M = [], C = [];
    let j;
    if (c.value === true && (M.push(T({ key: "bls", disable: e.disable || e.modelValue <= r.value, icon: p.value[0], "aria-label": l.lang.pagination.first }, r.value)), C.unshift(T({ key: "ble", disable: e.disable || e.modelValue >= o.value, icon: p.value[3], "aria-label": l.lang.pagination.last }, o.value))), f.value === true && (M.push(T({ key: "bdp", disable: e.disable || e.modelValue <= r.value, icon: p.value[1], "aria-label": l.lang.pagination.prev }, e.modelValue - 1)), C.unshift(T({ key: "bdn", disable: e.disable || e.modelValue >= o.value, icon: p.value[2], "aria-label": l.lang.pagination.next }, e.modelValue + 1))), e.input !== true) {
      j = [];
      const { pgFrom: Y, pgTo: L, marginalStyle: O } = D.value;
      if (D.value.boundaryStart === true) {
        const U = r.value === e.modelValue;
        M.push(T({ key: "bns", style: O, disable: e.disable, label: r.value }, r.value, U));
      }
      if (D.value.boundaryEnd === true) {
        const U = o.value === e.modelValue;
        C.unshift(T({ key: "bne", style: O, disable: e.disable, label: o.value }, o.value, U));
      }
      D.value.ellipsesStart === true && M.push(T({ key: "bes", style: O, disable: e.disable, label: "\u2026", ripple: false }, Y - 1)), D.value.ellipsesEnd === true && C.unshift(T({ key: "bee", style: O, disable: e.disable, label: "\u2026", ripple: false }, L + 1));
      for (let U = Y; U <= L; U++) j.push(T({ key: `bpg${U}`, style: O, disable: e.disable, label: U }, U, U === e.modelValue));
    }
    return d("div", { class: _.value, ...y.value }, [d("div", { class: "q-pagination__content row no-wrap items-center", style: k.value }, [...M, e.input === true ? d(Eh, { class: "inline", style: { width: `${u.value.length / 1.5}em` }, type: "number", dense: true, value: h.value, disable: e.disable, dark: a.value, borderless: true, inputClass: e.inputClass, inputStyle: e.inputStyle, placeholder: u.value, min: r.value, max: o.value, ...I.value }) : d("div", { class: "q-pagination__middle row justify-center" }, j), ...C])]);
  };
} });
function Zi(e) {
  let t = false, n, l;
...
he({ name: "QRange", props: { ...Km, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: Wm, setup(e, { emit: t }) {
  ...
  function B(T) {
    const { left: M, top: C, width: j, height: Y } = r.value.getBoundingClientRect(), L = e.dragOnlyRange === true ? 0 : e.vertical === true ? y.value.offsetHeight / (2 * Y) : y.value.offsetWidth / (2 * j), O = { left: M, top: C, width: j, height: Y, valueMin: u.value.min, valueMax: u.value.max, ratioMin: s.value, ratioMax: f.value }, U = a.getDraggingRatio(T, O);
  ...
  function P(T, M = l.dragging.value) {
    let C;
    const j = a.getDraggingRatio(T, M), Y = a.convertRatioToModel(j);
    switch (M.type) {
      case rl.MIN:
        j <= M.ratioMax ? (C = { minR: j, maxR: M.ratioMax, min: Y, max: M.valueMax }, l.focus.value = "min") : (C = { minR: M.ratioMax, maxR: j, min: M.valueMax, max: Y }, l.focus.value = "max");
        break;
      case rl.MAX:
        j >= M.ratioMin ? (C = { minR: M.ratioMin, maxR: j, min: M.valueMin, max: Y }, l.focus.value = "max") : (C = { minR: j, maxR: M.ratioMin, min: Y, max: M.valueMin }, l.focus.value = "min");
        break;
      case rl.RANGE:
        const L = j - M.offsetRatio, O = ct(M.ratioMin + L, l.innerMinRatio.value, l.innerMaxRatio.value - M.rangeRatio), U = Y - M.offsetModel, ye = ct(M.valueMin + U, l.innerMin.value, l.innerMax.value - M.rangeValue);
  ...
  function I(T) {
    ...
    je(T);
    const M = ([34, 33].includes(T.keyCode) ? 10 : 1) * l.keyStep.value, C = ([34, 37, 40].includes(T.keyCode) ? -1 : 1) * (l.isReversed.value === true ? -1 : 1) * (e.vertical === true ? -1 : 1) * M;
    if (l.focus.value === "both") {
      const j = u.value.max - u.value.min, Y = ct(l.roundValueFn.value(u.value.min + C), l.innerMin.value, l.innerMax.value - j);
      u.value = { min: Y, max: l.roundValueFn.value(Y + j) };
    } else {
      if (l.focus.value === false) return;
      {
        const j = l.focus.value;
        u.value = { ...u.value, [j]: ct(l.roundValueFn.value(u.value[j] + C), j === "min" ? l.innerMin.value : u.value.min, j === "max" ? l.innerMax.value : u.value.max) };
      }
    }
    D();
  }
  return () => {
    const T = a.getContent(g, p, _, (M) => {
      M.push(x(), F());
    });
...
he({ name: "QRating", props: { ...el, ...wn, modelValue: { type: Number, required: true }, max: { type: [String, Number], default: 5 }, icon: [String, Array], iconHalf: [String, Array], iconSelected: [String, Array], iconAriaLabel: [String, Array], color: [String, Array], colorHalf: [String, Array], colorSelected: [String, Array], noReset: Boolean, noDimming: Boolean, readonly: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { slots: t, emit: n }) {
  ...
  const c = v(() => e.readonly !== true && e.disable !== true), s = v(() => `q-rating row inline items-center q-rating--${c.value === true ? "" : "non-"}editable` + (e.noDimming === true ? " q-rating--no-dimming" : "") + (e.disable === true ? " disabled" : "") + (e.color !== void 0 && Array.isArray(e.color) === false ? ` text-${e.color}` : "")), f = v(() => {
    ...
    for (let D = 1; D <= e.max; D++) {
      const B = i.value === 0 && e.modelValue >= D || i.value > 0 && i.value >= D, P = F === D && i.value < D, I = i.value > 0 && (P === true ? x : e.modelValue) >= D && i.value < D, T = P === true ? D <= b.halfColorLen ? e.colorHalf[D - 1] : b.halfColor : b.selColor !== void 0 && B === true ? D <= b.selColorLen ? e.colorSelected[D - 1] : b.selColor : D <= b.colorLen ? e.color[D - 1] : b.color, M = (P === true ? D <= b.halfIconLen ? e.iconHalf[D - 1] : b.halfIcon : b.selIcon !== void 0 && (B === true || I === true) ? D <= b.selIconLen ? e.iconSelected[D - 1] : b.selIcon : D <= b.iconLen ? e.icon[D - 1] : b.icon) || l.iconSet.rating.icon;
...
var V1 = he({ props: ["store", "barStyle", "verticalBarStyle", "horizontalBarStyle"], setup(e) {
  ...
  Object.assign(o, { verticalInner: v(() => o.vertical.value - e.verticalOffset[0] - e.verticalOffset[1]), horizontalInner: v(() => o.horizontal.value - e.horizontalOffset[0] - e.horizontalOffset[1]) }), i.vertical.percentage = v(() => {
    ...
    if (C <= 0) return 0;
    const j = ct(i.vertical.position.value / C, 0, 1);
    ...
    if (C <= 0) return 0;
    const j = ct(Math.abs(i.horizontal.position.value) / C, 0, 1);
    return Math.round(j * 1e4) / 1e4;
  ...
  function _() {
    ...
    return Ld.forEach((j) => {
      const Y = i[j];
      Object.assign(C, { [j + "Position"]: Y.position.value, [j + "Percentage"]: Y.percentage.value, [j + "Size"]: Y.size.value, [j + "ContainerSize"]: o[j].value, [j + "ContainerInnerSize"]: o[j + "Inner"].value });
    }), C;
  }
  const w = Ea(() => {
    const C = _();
  ...
  function k(C, j, Y) {
    ...
    (C === "vertical" ? pa : Bi)(m.value, j, Y);
  }
  function p({ height: C, width: j }) {
    let Y = false;
    o.vertical.value !== C && (o.vertical.value = C, Y = true), o.horizontal.value !== j && (o.horizontal.value = j, Y = true), Y === true && F();
  }
  function y({ position: C }) {
    let j = false;
    i.vertical.position.value !== C.top && (i.vertical.position.value = C.top, j = true), i.horizontal.position.value !== C.left && (i.horizontal.position.value = C.left, j = true), j === true && F();
  }
  function b({ height: C, width: j }) {
    i.horizontal.size.value !== j && (i.horizontal.size.value = j, F()), i.vertical.size.value !== C && (i.vertical.size.value = C, F());
  }
  function x(C, j) {
    const Y = i[j];
    if (C.isFirst === true) {
    ...
    const L = eu[j], O = (Y.size.value - o[j].value) / (o[j + "Inner"].value - Y.thumbSize.value), U = C.distance[L.dist], ye = f + (C.direction === L.dir ? 1 : -1) * U * O;
    D(ye, j);
  }
  function $(C, j) {
    const Y = i[j];
    if (Y.thumbHidden.value !== true) {
      const L = j === "vertical" ? e.verticalOffset[0] : e.horizontalOffset[0], O = C[eu[j].offset] - L, U = Y.thumbStart.value - L;
      if (O < U || O > U + Y.thumbSize.value) {
        const ye = O - Y.thumbSize.value / 2, W = ct(ye / (o[j + "Inner"].value - Y.thumbSize.value), 0, 1);
        D(W * Math.max(0, Y.size.value - o[j].value), j);
      }
  ...
  }), Ke(w.cancel), Object.assign(u, { getScrollTarget: () => m.value, getScroll: _, getScrollPosition: () => ({ top: i.vertical.position.value, left: i.horizontal.position.value }), getScrollPercentage: () => ({ top: i.vertical.percentage.value, left: i.horizontal.percentage.value }), setScrollPosition: k, setScrollPercentage(C, j, Y) {
    k(C, j * (i[C].size.value - o[C].value) * (C === "horizontal" && u.$q.lang.rtl === true ? -1 : 1), Y);
  } });
...
function Vh({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: n, virtualScrollItemSizeComputed: l }) {
  ...
  function P(W, q) {
    ...
    f !== G.scrollViewSize && Y(G.scrollViewSize), T(ee, G, Math.min(e.value - 1, Math.max(0, parseInt(W, 10) || 0)), 0, I1.indexOf(q) !== -1 ? q : s !== -1 && W > s ? "end" : "start");
  }
  function I() {
    const W = t();
    if (W == null || W.nodeType === 8) return;
    const q = tu(W, n(), k.value, p.value, r.virtualScrollHorizontal, u.lang.rtl, r.virtualScrollStickySizeStart, r.virtualScrollStickySizeEnd), ee = e.value - 1, G = q.scrollMaxSize - q.offsetStart - q.offsetEnd - _.value;
    if (c === q.scrollStart) return;
    if (q.scrollMaxSize <= 0) {
      T(W, q, 0, 0);
      return;
    }
    f !== q.scrollViewSize && Y(q.scrollViewSize), M(b.value.from);
    const fe = Math.floor(q.scrollMaxSize - Math.max(q.scrollViewSize, q.offsetEnd) - Math.min(h[ee], q.scrollViewSize / 2));
    if (fe > 0 && Math.ceil(q.scrollStart) >= fe) {
      T(W, q, ee, q.scrollMaxSize - q.offsetEnd - m.reduce(_a, 0));
      return;
    }
    let R = 0, A = q.scrollStart - q.offsetStart, te = A;
    if (A <= G && A + q.scrollViewSize >= g.value) A -= g.value, R = b.value.from, te = A;
    else for (let V = 0; A >= m[V] && R < ee; V++) A -= m[V], R += Cn;
    for (; A > 0 && R < ee; ) A -= h[R], A > -q.scrollViewSize ? (R++, te = A) : te = h[R] + A;
    T(W, q, R, te);
  }
  function T(W, q, ee, G, fe) {
    const R = typeof fe == "string" && fe.indexOf("-force") !== -1, A = R === true ? fe.replace("-force", "") : fe, te = A !== void 0 ? A : "start";
    let V = Math.max(0, ee - w.value[te]), H = V + w.value.total;
    H > e.value && (H = e.value, V = Math.max(0, H - w.value.total)), c = q.scrollStart;
    const ue = V !== b.value.from || H !== b.value.to;
    ...
    if (ue === true) {
      const ne = H >= b.value.from && V <= b.value.to ? b.value.to : H;
      b.value = { from: V, to: ne }, g.value = Ia(m, h, 0, V), _.value = Ia(m, h, H, e.value), requestAnimationFrame(() => {
        b.value.to !== H && c === q.scrollStart && (b.value = { from: b.value.from, to: H }, _.value = Ia(m, h, H, e.value));
      });
    }
    requestAnimationFrame(() => {
      if (c !== q.scrollStart) return;
      ue === true && M(V);
      const ne = h.slice(V, ee).reduce(_a, 0), le = ne + q.offsetStart + g.value, X = le + h[ee];
      let ve = le + G;
      if (A !== void 0) {
        const ge = ne - N, me = q.scrollStart + ge;
        ve = R !== true && me < le && X < me + q.scrollViewSize ? me : A === "end" ? X - q.scrollViewSize : le - (A === "start" ? 0 : Math.round((q.scrollViewSize - h[ee]) / 2));
      }
  ...
  function M(W) {
    const q = y.value;
    if (q) {
      const ee = Bh.call(q.children, (V) => V.classList && V.classList.contains("q-virtual-scroll--skip") === false), G = ee.length, fe = r.virtualScrollHorizontal === true ? (V) => V.getBoundingClientRect().width : (V) => V.offsetHeight;
      let R = W, A, te;
      for (let V = 0; V < G; ) {
  ...
  function Y(W) {
    ...
    f = W;
    const q = parseFloat(r.virtualScrollSliceRatioBefore) || 0, ee = parseFloat(r.virtualScrollSliceRatioAfter) || 0, G = 1 + q + ee, fe = W === void 0 || W <= 0 ? 1 : Math.ceil(W / l.value), R = Math.max(1, fe, Math.ceil((r.virtualScrollSliceSize > 0 ? r.virtualScrollSliceSize : 10) / G));
    w.value = { total: Math.ceil(R * G), start: Math.ceil(R * q), center: Math.ceil(R * (0.5 + q)), end: Math.ceil(R * (1 + q)), view: fe };
  }
  function L(W, q) {
    const ee = r.virtualScrollHorizontal === true ? "width" : "height", G = { ["--q-virtual-scroll-item-" + ee]: l.value + "px" };
    return [W === "tbody" ? d(W, { class: "q-virtual-scroll__padding", key: "before", ref: k }, [d("tr", [d("td", { style: { [ee]: `${g.value}px`, ...G }, colspan: x.value })])]) : d(W, { class: "q-virtual-scroll__padding", key: "before", ref: k, style: { [ee]: `${g.value}px`, ...G } }), d(W, { class: "q-virtual-scroll__content", key: "content", ref: y, tabindex: -1 }, q.flat()), W === "tbody" ? d(W, { class: "q-virtual-scroll__padding", key: "after", ref: p }, [d("tr", [d("td", { style: { [ee]: `${_.value}px`, ...G }, colspan: x.value })])]) : d(W, { class: "q-virtual-scroll__padding", key: "after", ref: p, style: { [ee]: `${_.value}px`, ...G } })];
  }
  function O(W) {
  ...
  return Vn(() => {
    ...
    U.cancel();
  }), Object.assign(i, { scrollTo: P, reset: D, refresh: B }), { virtualScrollSliceRange: b, virtualScrollSliceSizeComputed: w, setVirtualScrollSize: Y, onVirtualScrollEvt: U, localResetVirtualScroll: j, padVirtualScroll: L, scrollTo: P, reset: D, refresh: B };
}
...
var j1 = he({ name: "QSelect", inheritAttrs: false, props: { ...ju, ...wn, ...di, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], popupNoRouteDismiss: Boolean, useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: Vd }, mapOptions: Boolean, emitValue: Boolean, disableTabSelection: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: {}, transitionHide: {}, transitionDuration: {}, behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: ju.virtualScrollItemSize.type, onNewValue: Function, onFilter: Function }, emits: [...fi, "add", "remove", "inputValue", "keyup", "keypress", "keydown", "popupShow", "popupHide", "filterAbort"], setup(e, { slots: t, emit: n }) {
  ...
  const x = K(null), $ = K(null), F = K(null), D = K(null), B = K(null), P = Ms(e), I = Mh(se), T = v(() => Array.isArray(e.options) ? e.options.length : 0), M = v(() => e.virtualScrollItemSize === void 0 ? e.optionsDense === true ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: C, virtualScrollSliceSizeComputed: j, localResetVirtualScroll: Y, padVirtualScroll: L, onVirtualScrollEvt: O, scrollTo: U, setVirtualScrollSize: ye } = Vh({ virtualScrollLength: T, getVirtualScrollTarget: jt, getVirtualScrollEl: Ct, virtualScrollItemSizeComputed: M }), W = vi(), q = v(() => {
  ...
  }), G = v(() => e.optionsDark === null ? W.isDark.value : e.optionsDark), fe = v(() => Kl(q.value)), R = v(() => {
    let J = "q-field__input q-placeholder col";
    return e.hideSelected === true || q.value.length === 0 ? [J, e.inputClass] : (J += " q-field__input--padding", e.inputClass === void 0 ? J : [J, e.inputClass]);
  }), A = v(() => (e.virtualScrollHorizontal === true ? "q-virtual-scroll--horizontal" : "") + (e.popupContentClass ? " " + e.popupContentClass : "")), te = v(() => T.value === 0), V = v(() => q.value.map((J) => ae.value(J)).join(", ")), H = v(() => e.displayValue !== void 0 ? e.displayValue : V.value), ue = v(() => e.optionsHtml === true ? () => true : (J) => (J == null ? void 0 : J.html) === true), S = v(() => e.displayValueHtml === true || e.displayValue === void 0 && (e.optionsHtml === true || q.value.some(ue.value))), E = v(() => W.focused.value === true ? e.tabindex : -1), N = v(() => {
  ...
  }), ne = v(() => ({ id: `${W.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": e.multiple === true ? "true" : "false" })), le = v(() => q.value.map((J, Re) => ({ index: Re, opt: J, html: ue.value(J), selected: true, removeAtIndex: Me, toggleOption: Ve, tabindex: E.value }))), X = v(() => {
    if (T.value === 0) return [];
  ...
  function qe(J) {
    if (J !== -1 && J < q.value.length) if (e.multiple === true) {
  ...
  function Ve(J, Re) {
    ...
    const $e = de.value(J);
    if (e.multiple !== true) {
      Re !== true && (Fe(e.fillInput === true ? ae.value(J) : "", true, true), at()), (_a2 = $.value) == null ? void 0 : _a2.focus(), (q.value.length === 0 || kn(de.value(q.value[0]), $e) !== true) && n("update:modelValue", e.emitValue === true ? $e : J);
      return;
    }
    if ((g !== true || c.value === true) && W.focus(), Ce(), q.value.length === 0) {
  ...
  function Ae(J) {
    ...
    if (J.target.value = "", f !== null && (clearTimeout(f), f = null), m !== null && (clearTimeout(m), m = null), cn(), typeof Re == "string" && Re.length !== 0) {
      const $e = Re.toLocaleLowerCase(), tt = (vt) => {
        ...
        return Dt === void 0 ? false : (q.value.indexOf(Dt) === -1 ? Ve(Dt) : at(), true);
      }, gt = (vt) => {
  ...
  function it(J) {
    ...
    (J.keyCode === 35 || J.keyCode === 36) && (typeof u.value != "string" || u.value.length === 0) && (je(J), i.value = -1, pe(J.keyCode === 36 ? 1 : -1, e.multiple)), (J.keyCode === 33 || J.keyCode === 34) && j.value !== void 0 && (je(J), i.value = Math.max(-1, Math.min(T.value, i.value + (J.keyCode === 33 ? -1 : 1) * j.value.view)), pe(J.keyCode === 33 ? 1 : -1, e.multiple)), (J.keyCode === 38 || J.keyCode === 40) && (je(J), pe(J.keyCode === 38 ? -1 : 1, e.multiple));
    const tt = T.value;
  ...
  function nl() {
    return e.hideSelected === true ? [] : t["selected-item"] !== void 0 ? le.value.map((J) => t["selected-item"](J)).slice() : t.selected !== void 0 ? [].concat(t.selected()) : e.useChips === true ? le.value.map((J, Re) => d(Hm, { key: "option-" + Re, removable: W.editable.value === true && Q.value(J.opt) !== true, dense: true, textColor: e.color, tabindex: E.value, onRemove() {
      J.removeAtIndex(Re);
    } }, () => d("span", { class: "ellipsis", [J.html === true ? "innerHTML" : "textContent"]: ae.value(J.opt) }))) : [d("span", { class: "ellipsis", [S.value === true ? "innerHTML" : "textContent"]: H.value })];
  }
  function ln() {
  ...
  function Be(J, Re, $e) {
    ...
    W.innerLoading.value === true ? n("filterAbort") : (W.innerLoading.value = true, s.value = true), J !== "" && e.multiple !== true && q.value.length !== 0 && _ !== true && J === ae.value(q.value[0]) && (J = "");
    const tt = setTimeout(() => {
  ...
  function cn() {
    e.useInput === true && Fe(e.multiple !== true && e.fillInput === true && q.value.length !== 0 && ae.value(q.value[0]) || "", true, true);
  }
  function gi(J) {
    let Re = -1;
    if (J === true) {
      if (q.value.length !== 0) {
        const $e = de.value(q.value[0]);
...
he({ name: "QTable", props: { rows: { type: Array, required: true }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: {}, ...Nh, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], tableRowStyleFn: Function, tableRowClassFn: Function, cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], cardStyleFn: Function, cardClassFn: Function, hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...nt, ...Ls, ...F_, ...C_, ...T_, ...P_, ...A_, ...S_ }, emits: ["request", "virtualScroll", ...Bs, ...L_, ...R_], setup(e, { slots: t, emit: n }) {
  ...
  }), { hasSelectionMode: I, singleSelection: T, multipleSelection: M, allRowsSelected: C, someRowsSelected: j, rowsSelectedNumber: Y, isRowSelected: L, clearSelection: O, updateSelection: U } = $_(e, n, P, u), { colList: ye, computedCols: W, computedColsMap: q, computedColspan: ee } = O_(e, w, I), { columnToSort: G, computedSortMethod: fe, sort: R } = x_(e, w, ye, y), { firstRowIndex: A, lastRowIndex: te, isFirstPage: V, isLastPage: H, pagesNumber: ue, computedRowsPerPageOptions: S, computedRowsNumber: E, firstPage: N, prevPage: ne, nextPage: le, lastPage: X } = E_(l, _, w, k, y, B), ve = v(() => P.value.length === 0), ge = v(() => {
    const se = {};
  ...
  function Ve(se) {
    Object.assign(se, { cols: W.value, colsMap: q.value, sort: R, rowIndex: A.value + se.pageIndex, color: e.color, dark: r.value, dense: e.dense }), I.value === true && Ot(se, "selected", () => L(se.key), (xe, Fe) => {
  ...
  const pe = v(() => ({ pagination: w.value, pagesNumber: ue.value, isFirstPage: V.value, isLastPage: H.value, firstPage: N, prevPage: ne, nextPage: le, lastPage: X, inFullscreen: o.value, toggleFullscreen: i }));
  function re() {
  ...
  const _e = v(() => j.value === true ? null : C.value);
  function Ce() {
    const se = Oe();
  ...
  function Ae(se) {
    return Object.assign(se, { cols: W.value, sort: R, colsMap: q.value, color: e.color, dark: r.value, dense: e.dense }), M.value === true && Ot(se, "selected", () => _e.value, Ye), se;
  }
  function Ye(se) {
    j.value === true && (se = false), U(P.value.map(u.value), P.value, se);
  }
  const it = v(() => {
  ...
  function nl(se) {
    ...
    if (se.push(d("div", { class: "q-table__separator col" })), yt === true && se.push(d("div", { class: "q-table__control" }, [d("span", { class: "q-table__bottom-item" }, [e.rowsPerPageLabel || a.lang.table.recordsPerPage]), d(j1, { class: "q-table__select inline q-table__bottom-item", color: e.color, modelValue: Fe, options: S.value, displayValue: Fe === 0 ? a.lang.table.allRows : Fe, dark: r.value, borderless: true, dense: true, optionsDense: true, optionsCover: true, "onUpdate:modelValue": jt })])), Ue !== void 0) xe = Ue(pe.value);
      ...
      e.dense === true && (ht.size = "sm"), ue.value > 2 && xe.push(d(Ze, { key: "pgFirst", ...ht, icon: it.value[0], disable: V.value, ariaLabel: a.lang.pagination.first, onClick: N })), xe.push(d(Ze, { key: "pgPrev", ...ht, icon: it.value[1], disable: V.value, ariaLabel: a.lang.pagination.prev, onClick: ne }), d(Ze, { key: "pgNext", ...ht, icon: it.value[2], disable: H.value, ariaLabel: a.lang.pagination.next, onClick: le })), ue.value > 2 && xe.push(d(Ze, { key: "pgLast", ...ht, icon: it.value[3], disable: H.value, ariaLabel: a.lang.pagination.last, onClick: X }));
    }
...
he({ name: "QTime", props: { ...nt, ...wn, ...Fo, modelValue: { required: true, validator: (e) => typeof e == "string" || e === null }, mask: { ...Fo.mask, default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: rh, setup(e, { slots: t, emit: n }) {
  ...
  function A() {
    return gl(l) === true || O.value !== null && (O.value.values.length === 0 || y.value === "hour" && D.value !== true && j.value[x.value === true ? "am" : "pm"].values.length === 0);
  }
  function te() {
  ...
  function V(ie) {
    if (A() !== true) {
      ...
      h = ue(ie.evt, m, h), ie.isFinal === true && (m = false, h = null, H());
    }
  }
  function H() {
  ...
  function ue(ie, pe, re) {
    ...
    if (_e.top < pe.top ? Ye = pe.left < _e.left ? 90 - Ye : 270 + Ye : Ye = pe.left < _e.left ? Ye + 90 : 270 - Ye, y.value === "hour") {
      if (Ae = Ye / 30, j.value !== null) {
        const it = D.value !== true ? x.value === true : j.value.am.values.length !== 0 && j.value.pm.values.length !== 0 ? Oe >= pe.dist : j.value.am.values.length !== 0;
        Ae = G(Ae + (it === true ? 0 : 12), j.value[it === true ? "am" : "pm"]);
  ...
  function ne(ie) {
    A() !== true && (a.platform.is.desktop !== true && ue(ie, te()), H());
  }
  function le(ie) {
    A() !== true && ue(ie, te());
  }
  function X(ie) {
    if (ie.keyCode === 13) y.value = "hour";
      ...
      if (j.value !== null) {
        const re = D.value === true ? j.value.values : j.value[x.value === true ? "am" : "pm"].values;
...
he({ name: "QTree", props: { ...nt, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => I_.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: {}, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: n }) {
  ...
  const s = v(() => `q-tree q-tree--${e.dense === true ? "dense" : "standard"}` + (e.noConnectors === true ? " q-tree--no-connectors" : "") + (r.value === true ? " q-tree--dark" : "") + (e.color !== void 0 ? ` text-${e.color}` : "")), f = v(() => e.selected !== void 0), m = v(() => e.icon || a.iconSet.tree.icon), h = v(() => e.controlColor || e.color), g = v(() => e.textColor !== void 0 ? ` text-${e.textColor}` : ""), _ = v(() => {
    ...
    return q ? ` text-${q}` : "";
  }), w = v(() => e.filterMethod !== void 0 ? e.filterMethod : (q, ee) => {
    const G = ee.toLowerCase();
    return q[e.labelKey] && q[e.labelKey].toLowerCase().indexOf(G) !== -1;
  }), k = v(() => {
    const q = {}, ee = (G, fe) => {
      const R = G.tickStrategy || (fe ? fe.tickStrategy : e.tickStrategy), A = G[e.nodeKey], te = G[e.childrenKey] && Array.isArray(G[e.childrenKey]) && G[e.childrenKey].length !== 0, V = G.disabled !== true && f.value === true && G.selectable !== false, H = G.disabled !== true && G.expandable !== false, ue = R !== "none", S = R === "strict", E = R === "leaf-filtered", N = R === "leaf" || R === "leaf-filtered";
    ...
    return e.nodes.forEach((G) => ee(G, null)), q;
  });
  be(() => e.ticked, (q) => {
    i.value = q;
  }), be(() => e.expanded, (q) => {
  ...
  function x(q) {
    return q && k.value[q] ? k.value[q].expanded : false;
  }
  function $() {
  ...
  function F() {
    const q = [], ee = (G) => {
      G[e.childrenKey] && G[e.childrenKey].length !== 0 && G.expandable !== false && G.disabled !== true && (q.push(G[e.nodeKey]), G[e.childrenKey].forEach(ee));
    };
    e.nodes.forEach(ee), e.expanded !== void 0 ? n("update:expanded", q) : u.value = q;
  }
  function D(q, ee, G = p(q), fe = k.value[q]) {
    if (fe.lazy && fe.lazy !== "loaded") {
      if (fe.lazy === "loading") return;
      o.value[q] = "loading", Array.isArray(G[e.childrenKey]) !== true && (G[e.childrenKey] = []), n("lazyLoad", { node: G, key: q, done: (R) => {
        o.value[q] = "loaded", G[e.childrenKey] = Array.isArray(R) === true ? R : [], We(() => {
          var _a2;
          ((_a2 = k.value[q]) == null ? void 0 : _a2.isParent) === true && B(q, true);
        });
      }, fail: () => {
        delete o.value[q], G[e.childrenKey].length === 0 && delete G[e.childrenKey];
      } });
    } else fe.isParent === true && fe.expandable === true && B(q, ee);
  }
  function B(q, ee) {
    let G = u.value;
    const fe = e.expanded !== void 0;
    if (fe === true && (G = G.slice()), ee) {
      if (e.accordion && k.value[q]) {
        const R = [];
        k.value[q].parent ? k.value[q].parent.children.forEach((A) => {
          A.key !== q && A.expandable === true && R.push(A.key);
        }) : e.nodes.forEach((A) => {
          const te = A[e.nodeKey];
          te !== q && R.push(te);
        }), R.length !== 0 && (G = G.filter((A) => R.includes(A) === false));
      }
      G = G.concat([q]).filter((R, A, te) => te.indexOf(R) === A);
    } else G = G.filter((R) => R !== q);
    fe === true ? n("update:expanded", G) : u.value = G;
  }
  function P(q) {
    return q && k.value[q] ? k.value[q].ticked : false;
  }
  function I(q, ee) {
    let G = i.value;
    const fe = e.ticked !== void 0;
    fe === true && (G = G.slice()), ee ? G = G.concat(q).filter((R, A, te) => te.indexOf(R) === A) : G = G.filter((R) => q.includes(R) === false), fe === true && n("update:ticked", G);
  }
  function T(q, ee, G) {
    const fe = { tree: l, node: q, key: G, color: e.color, dark: r.value };
  ...
  function M(q) {
    return (e.filter ? q.filter((ee) => k.value[ee[e.nodeKey]].matchesFilter) : q).map((ee) => L(ee));
  }
  function C(q) {
    if (q.icon !== void 0) return d(et, { class: "q-tree__icon q-mr-sm", name: q.icon, color: q.iconColor });
    const ee = q.img || q.avatar;
    if (ee) return d("img", { class: `q-tree__${q.img ? "img" : "avatar"} q-mr-sm`, src: ee });
  }
  function j() {
    n("afterShow");
  }
  ...
  function L(q) {
    const ee = q[e.nodeKey], G = k.value[ee], fe = q.header && t[`header-${q.header}`] || t["default-header"], R = G.isParent === true ? M(q[e.childrenKey]) : [], A = R.length !== 0 || G.lazy && G.lazy !== "loaded";
    let te = q.body && t[`body-${q.body}`] || t["default-body"];
    const V = fe !== void 0 || te !== void 0 ? T(q, G, ee) : null;
    return te !== void 0 && (te = d("div", { class: "q-tree__node-body relative-position" }, [d("div", { class: g.value }, [te(V)])])), d("div", { key: ee, class: `q-tree__node relative-position q-tree__node--${A === true ? "parent" : "child"}` }, [d("div", { class: "q-tree__node-header relative-position row no-wrap items-center" + (G.link === true ? " q-tree__node--link q-hoverable q-focusable" : "") + (G.selected === true ? " q-tree__node--selected" : "") + (G.disabled === true ? " q-tree__node--disabled" : ""), tabindex: G.link === true ? 0 : -1, ariaExpanded: R.length > 0 ? G.expanded : null, role: "treeitem", onClick: (H) => {
      U(q, G, H);
    }, onKeypress(H) {
      Yl(H) !== true && (H.keyCode === 13 ? U(q, G, H, true) : H.keyCode === 32 && ye(q, G, H, true));
    } }, [d("div", { class: "q-focus-helper", tabindex: -1, ref: (H) => {
      c[G.key] = H;
    } }), G.lazy === "loading" ? d(_n, { class: "q-tree__spinner", color: h.value }) : A === true ? d(et, { class: "q-tree__arrow" + (G.expanded === true ? " q-tree__arrow--rotate" : ""), name: m.value, onClick(H) {
      ye(q, G, H);
    } }) : null, G.hasTicking === true && G.noTick !== true ? d(ir, { class: "q-tree__tickbox", modelValue: G.indeterminate === true ? null : G.ticked, color: h.value, dark: r.value, dense: true, keepColor: true, disable: G.tickable !== true, onKeydown: je, "onUpdate:modelValue": (H) => {
      W(G, H);
    } }) : null, d("div", { class: "q-tree__node-header-content col row no-wrap items-center" + (G.selected === true ? _.value : g.value) }, [fe ? fe(V) : [C(q), d("div", q[e.labelKey])]])]), A === true ? e.noTransition === true ? G.expanded === true ? d("div", { class: "q-tree__node-collapsible" + g.value, key: `${ee}__q` }, [te, d("div", { class: "q-tree__children" + (G.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, R)]) : null : d(Ds, { duration: e.duration, onShow: j, onHide: Y }, () => sn(d("div", { class: "q-tree__node-collapsible" + g.value, key: `${ee}__q` }, [te, d("div", { class: "q-tree__children" + (G.disabled === true ? " q-tree__node--disabled" : ""), role: "group" }, R)]), [[Uv, G.expanded]])) : te]);
  }
  function O(q) {
    var _a2;
    (_a2 = c[q]) == null ? void 0 : _a2.focus();
  }
  function U(q, ee, G, fe) {
    fe !== true && ee.selectable !== false && O(ee.key), f.value && ee.selectable ? e.noSelectionUnset === false ? n("update:selected", ee.key !== e.selected ? ee.key : null) : ee.key !== e.selected && n("update:selected", ee.key === void 0 ? null : ee.key) : ye(q, ee, G, fe), typeof q.handler == "function" && q.handler(q);
  }
  function ye(q, ee, G, fe) {
    G !== void 0 && je(G), fe !== true && ee.selectable !== false && O(ee.key), D(ee.key, !ee.expanded, q, ee);
  }
  function W(q, ee) {
    if (q.indeterminate === true && (ee = q.indeterminateNextState), q.strictTicking) I([q.key], ee);
...
function N_(e, t) {
  ...
  function c(V, H, ue) {
    ...
    V.__uploaded = H === "uploaded" ? V.size : ue, V.__progress = H === "uploaded" ? 1 : Math.min(0.9999, V.__uploaded / V.size), V.__progressLabel = Ud(V.__progress), o.$forceUpdate();
  }
  ...
  const F = K(0), D = v(() => F.value === 0 ? 0 : g.uploadedSize.value / F.value), B = v(() => Ud(D.value)), P = v(() => Au(F.value)), I = v(() => s.value === true && g.isUploading.value !== true && (l.multiple === true || g.queuedFiles.value.length === 0) && (l.maxFiles === void 0 || g.files.value.length < x.value) && (l.maxTotalSize === void 0 || F.value < $.value)), T = v(() => s.value === true && g.isBusy.value !== true && g.isUploading.value !== true && g.queuedFiles.value.length !== 0);
  hn(cm, fe);
  ...
  be(g.isUploading, (V, H) => {
    H === false && V === true ? r("start") : H === true && V === false && r("finish");
  });
  function j() {
  ...
  function O(V, H) {
    ...
    ue.files.length !== 0 && (g.files.value = S, H(ue), r("removed", ue.files));
  }
  function U(V) {
    l.disable || (V.__status === "uploaded" ? g.uploadedFiles.value = g.uploadedFiles.value.filter((H) => H.__key !== V.__key) : V.__status === "uploading" ? V.__abort() : F.value -= V.size, g.files.value = g.files.value.filter((H) => H.__key !== V.__key ? true : (H.__img !== void 0 && window.URL.revokeObjectURL(H.__img.src), false)), g.queuedFiles.value = g.queuedFiles.value.filter((H) => H.__key !== V.__key), r("removed", [V]));
  }
  function ye() {
  ...
  function q(V, H) {
    const ue = y(V, H, g.files.value, true), S = W();
  ...
  function G(V, H, ue) {
    if (V === true) {
      const S = { type: "a", key: H, icon: i.iconSet.uploader[H], flat: true, dense: true };
      let E;
      return H === "add" ? (S.onClick = _, E = fe) : S.onClick = ue, d(Ze, S, E);
    }
  }
  function fe() {
  ...
  function R() {
    return a.header !== void 0 ? a.header(te) : [d("div", { class: "q-uploader__header-content column" }, [d("div", { class: "flex flex-center no-wrap q-gutter-xs" }, [G(g.queuedFiles.value.length !== 0, "removeQueue", L), G(g.uploadedFiles.value.length !== 0, "removeUploaded", Y), g.isUploading.value === true ? d(_n, { class: "q-uploader__spinner" }) : null, d("div", { class: "col column justify-center" }, [l.label !== void 0 ? d("div", { class: "q-uploader__title" }, [l.label]) : null, d("div", { class: "q-uploader__subtitle" }, [P.value + " / " + B.value])]), G(I.value, "add"), G(l.hideUploadBtn === false && T.value === true, "upload", g.upload), G(g.isUploading.value, "clear", g.abort)])])];
  }
  function A() {
  ...
  return Object.assign(te, { upload: ee, reset: j, removeUploadedFiles: Y, removeQueuedFiles: L, removeFile: U, pickFiles: _, addFiles: w }), Yv(te, { canAddFiles: () => I.value, canUpload: () => T.value, uploadSizeLabel: () => P.value, uploadProgressLabel: () => B.value }), t({ ...g, upload: ee, reset: j, removeUploadedFiles: Y, removeQueuedFiles: L, removeFile: U, pickFiles: _, addFiles: w, canAddFiles: I, canUpload: T, uploadSizeLabel: P, uploadProgressLabel: B }), () => {
    ...
    const H = { ref: m, class: M.value };
    return I.value === true && Object.assign(H, { onDragover: k, onDragleave: p }), d("div", H, V);
  };
}
var H_ = () => true;
function jh(e) {
...
function Y_({ props: e, emit: t, helpers: n }) {
  ...
  function h(g, _) {
    const w = new FormData(), k = new XMLHttpRequest(), p = (T, M) => _[T] !== void 0 ? Hn(_[T])(M) : o.value[T](M), y = p("url", g);
    if (!y) {
    ...
    k.upload.addEventListener("progress", (T) => {
      if (B === true) return;
      const M = Math.min(D, T.loaded);
      n.uploadedSize.value += M - F, F = M;
      let C = F - $;
      for (let j = x; C > 0 && j < g.length; j++) {
        const Y = g[j];
    ...
    const I = p("sendRaw", g);
    g.forEach((T) => {
      n.updateFileStatus(T, "uploading", 0), I !== true && w.append(p("fieldName", T), T, T.name), T.xhr = k, T.__abort = () => {
        k.abort();
      }, D += T.size;
...
function lw(e) {
  ...
  const T = () => {
    ...
    const { width: C, height: j } = Zr(f), { width: Y, height: L } = Zr(M.parentNode);
    ...
    const O = () => {
      ...
      const U = M.parentNode, { width: ye, height: W } = Zr(U), q = M.cloneNode(r.keepToClone);
      ...
      U.insertBefore(q, ee);
      const { borderWidth: G, borderStyle: fe, borderColor: R, borderRadius: A, backgroundColor: te, transform: V, position: H, cssText: ue } = Gd(M, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), S = M.classList.toString(), E = M.style.cssText;
      ...
      const N = Kd(M, r.resize), ne = h.left - N.left, le = h.top - N.top, X = h.width / (N.width > 0 ? N.width : 10), ve = h.height / (N.height > 0 ? N.height : 100), ge = g - C, me = _ - j, de = ye - Y, ae = W - L, Q = Math.max(h.widthM, ge), oe = Math.max(h.heightM, me), we = Math.max(N.widthM, de), ke = Math.max(N.heightM, ae), qe = o === M && ["absolute", "fixed"].includes(H) === false && ["absolute", "fixed"].includes($) === false;
      let Me = H === "fixed", He = U;
      ...
      const re = (_e) => {
        o === M && l !== true ? (M.style.cssText = B, M.className = D) : (M.style.cssText = E, M.className = S), q.parentNode === U && U.insertBefore(M, q), P.remove(), q.remove(), I == null ? void 0 : I.remove(), t = () => false, o.qMorphCancel = void 0, M.qMorphCancel = void 0, typeof r.onEnd == "function" && r.onEnd(l === true ? "to" : "from", _e === true);
      };
      if (r.useCSS !== true && typeof M.animate == "function") {
        ...
        let xe = "normal";
        P.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${_e}-from`, I !== void 0 && (I.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${_e}-from-tween`), q.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${_e}-to`, M.style.animation = `${r.duration}ms ${r.easing} ${r.delay}ms ${xe} ${r.fill} ${_e}`;
        const Fe = (Be) => {
        ...
        }, M.addEventListener("animationend", Fe), M.addEventListener("animationcancel", Fe), t = (Be) => n === true || !M || !P || !q ? false : Be === true ? (Fe(), true) : (l = l !== true, xe = xe === "normal" ? "reverse" : "normal", P.style.animationDirection = xe, I.style.animationDirection = xe, q.style.animationDirection = xe, M.style.animationDirection = xe, true);
      }
    };
    r.waitFor > 0 || r.waitFor === "transitionend" || r.waitFor === Object(r.waitFor) && typeof r.waitFor.then == "function" ? (r.waitFor > 0 ? new Promise((ye) => setTimeout(ye, r.waitFor)) : r.waitFor === "transitionend" ? new Promise((ye) => {
      const W = () => {
        q !== null && (clearTimeout(q), q = null), M && (M.removeEventListener("transitionend", W), M.removeEventListener("transitioncancel", W)), ye();
      };
      let q = setTimeout(W, 400);
      M.addEventListener("transitionend", W), M.addEventListener("transitioncancel", W);
    }) : r.waitFor).then(O).catch(() => {
      typeof M.qMorphCancel == "function" && M.qMorphCancel();
    }) : O();
  };
  return typeof e.onToggle == "function" && e.onToggle(), requestAnimationFrame(T), (M) => t(M);
}
...
var kw = js, qw = he({ name: "DialogPluginComponent", props: { ...nt, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  const { proxy: n } = Se(), { $q: l } = n, a = lt(e, l), r = K(null), o = K(e.prompt !== void 0 ? e.prompt.model : e.options !== void 0 ? e.options.model : void 0), i = v(() => "q-dialog-plugin" + (a.value === true ? " q-dialog-plugin--dark q-dark" : "") + (e.progress !== false ? " q-dialog-plugin--progress" : "")), u = v(() => e.color || (a.value === true ? "amber" : "primary")), c = v(() => e.progress === false ? null : Pt(e.progress) === true ? { component: e.progress.spinner || _n, props: { color: e.progress.color || u.value } } : { component: _n, props: { color: u.value } }), s = v(() => e.prompt !== void 0 || e.options !== void 0), f = v(() => {
    ...
    const { model: C, isValid: j, items: Y, ...L } = e.prompt !== void 0 ? e.prompt : e.options;
    return L;
  ...
  function D(C, j) {
    return e.html === true ? d(Fl, { class: C, innerHTML: j }) : d(Fl, { class: C }, () => j);
  }
  function B() {
...
function ZS(e) {
  ...
  function h(A, te) {
    let V, H;
    return wg(A) ? (V = t.getRecordMatcher(A), H = te) : H = A, t.addRoute(H, V);
  }
  function g(A) {
  ...
  function k(A, te) {
    ...
    const H = t.resolve(V, te), ue = A.hash || "";
    H.params = s(m(H.params));
    const S = fS(l, ut({}, A, { hash: oS(ue), path: H.path })), E = a.createHref(S);
    return ut({ fullPath: S, hash: ue, query: l === _f ? HS(A.query) : A.query || {} }, H, { redirectedFrom: void 0, href: E });
  }
  function p(A) {
  ...
  function $(A) {
    ...
    if (te && te.redirect) {
      const { redirect: V } = te;
      let H = typeof V == "function" ? V(A) : V;
      return typeof H == "string" && (H = H.includes("?") || H.includes("#") ? H = p(H) : { path: H }, H.params = {}), ut({ query: A.query, hash: A.hash, params: H.path != null ? {} : A.params }, H);
    }
  }
  function F(A, te) {
    const V = c = k(A), H = u.value, ue = A.state, S = A.force, E = A.replace === true, N = $(V);
    if (N) return F(ut(p(N), { state: typeof N == "object" ? ut({}, ue, N.state) : ue, force: S, replace: E }), te || V);
    const ne = V;
    ne.redirectedFrom = te;
    let le;
    return !S && vS(l, H, V) && (le = qa(16, { to: ne, from: H }), W(H, H, true, false)), (le ? Promise.resolve(le) : P(ne, H)).catch((X) => jn(X) ? jn(X, 2) ? X : ye(X) : O(X, ne, H)).then((X) => {
      if (X) {
        if (jn(X, 2)) return F(ut({ replace: E }, p(X.to), { state: typeof X.to == "object" ? ut({}, ue, X.to.state) : ue, force: S }), te || ne);
      } else X = T(ne, H, true, E, ue);
      return I(ne, H, X), X;
    });
  }
  function D(A, te) {
  ...
  function P(A, te) {
    let V;
    const [H, ue, S] = JS(A, te);
    V = ou(H.reverse(), "beforeRouteLeave", A, te);
    for (const N of H) N.leaveGuards.forEach((ne) => {
      V.push(fl(ne, A, te));
    });
  ...
  function I(A, te, V) {
    i.list().forEach((H) => B(() => H(A, te, V)));
  }
  function T(A, te, V, H, ue) {
    const S = y(A, te);
    if (S) return S;
    const E = te === ol, N = ua ? history.state : {};
    V && (H || E ? a.replace(A.fullPath, ut({ scroll: E && N && N.scroll }, ue)) : a.push(A.fullPath, ue)), u.value = A, W(A, te, V, E), ye();
  }
  let M;
  function C() {
    M || (M = a.listen((A, te, V) => {
      ...
      const H = k(A), ue = $(H);
      if (ue) {
        F(ut(ue, { replace: true, force: true }), H).catch(sr);
        return;
      }
      c = H;
      const S = u.value;
      ua && wS(df(S.fullPath, V.delta), hi()), P(H, S).catch((E) => jn(E, 12) ? E : jn(E, 2) ? (F(ut(p(E.to), { force: true }), H).then((N) => {
        jn(N, 20) && !V.delta && V.type === Cr.pop && a.go(-1, false);
      }).catch(sr), Promise.reject()) : (V.delta && a.go(-V.delta, false), O(E, H, S))).then((E) => {
        E = E || T(H, S, false), E && (V.delta && !jn(E, 8) ? a.go(-V.delta, false) : V.type === Cr.pop && jn(E, 20) && a.go(-1, false)), I(H, S, E);
      }).catch(sr);
    }));
  }
  let j = ja(), Y = ja(), L;
  function O(A, te, V) {
    ye(A);
    const H = Y.list();
    return H.length ? H.forEach((ue) => ue(A, te, V)) : console.error(A), Promise.reject(A);
  }
  function U() {
  ...
  function ye(A) {
    return L || (L = !A, C(), j.list().forEach(([te, V]) => A ? V(A) : te()), j.reset()), A;
  }
  function W(A, te, V, H) {
    const { scrollBehavior: ue } = e;
    if (!ua || !ue) return Promise.resolve();
    const S = !V && SS(df(A.fullPath, 0)) || (H || !V) && history.state && history.state.scroll || null;
    return We().then(() => ue(A, te, S)).then((E) => E && _S(E)).catch((E) => O(E, A, te));
  }
  const q = (A) => a.go(A);
  let ee;
  const G = /* @__PURE__ */ new Set(), fe = { currentRoute: u, listening: true, addRoute: h, removeRoute: g, clearRoutes: t.clearRoutes, hasRoute: w, getRoutes: _, resolve: k, options: e, push: b, replace: x, go: q, back: () => q(-1), forward: () => q(1), beforeEach: r.add, beforeResolve: o.add, afterEach: i.add, onError: Y.add, isReady: U, install(A) {
    const te = this;
    ...
    G.add(A), A.unmount = function() {
      G.delete(A), G.size < 1 && (c = ol, M && M(), M = null, u.value = ol, ee = false, L = false), H();
    };
  } };
  function R(A) {
...
function mx(e, t) {
  var n = t[0], l = t[1], a = t[2], r = t[3], o = t[4], i = t[5], u = t[6], c = t[7], s = t[8], f = t[9], m = t[10], h = t[11], g = t[12], _ = t[13], w = t[14], k = t[15], p = n * i - l * o, y = n * u - a * o, b = n * c - r * o, x = l * u - a * i, $ = l * c - r * i, F = a * c - r * u, D = s * _ - f * g, B = s * w - m * g, P = s * k - h * g, I = f * w - m * _, T = f * k - h * _, M = m * k - h * w, C = p * M - y * T + b * I + x * P - $ * B + F * D;
  return C ? (C = 1 / C, e[0] = (i * M - u * T + c * I) * C, e[1] = (a * T - l * M - r * I) * C, e[2] = (_ * F - w * $ + k * x) * C, e[3] = (m * $ - f * F - h * x) * C, e[4] = (u * P - o * M - c * B) * C, e[5] = (n * M - a * P + r * B) * C, e[6] = (w * b - g * F - k * y) * C, e[7] = (s * F - m * b + h * y) * C, e[8] = (o * T - i * P + c * D) * C, e[9] = (l * P - n * T - r * D) * C, e[10] = (g * $ - _ * b + k * p) * C, e[11] = (f * b - s * $ - h * p) * C, e[12] = (i * B - o * I - u * D) * C, e[13] = (n * I - l * B + a * D) * C, e[14] = (_ * y - g * x - w * p) * C, e[15] = (s * x - f * y + m * p) * C, e) : null;
}
function su(e, t, n) {
...
function cu(e, t, n, l) {
  var a = l[0], r = l[1], o = l[2], i = Math.hypot(a, r, o), u, c, s, f, m, h, g, _, w, k, p, y, b, x, $, F, D, B, P, I, T, M, C, j;
  return i < fx ? null : (i = 1 / i, a *= i, r *= i, o *= i, u = Math.sin(n), c = Math.cos(n), s = 1 - c, f = t[0], m = t[1], h = t[2], g = t[3], _ = t[4], w = t[5], k = t[6], p = t[7], y = t[8], b = t[9], x = t[10], $ = t[11], F = a * a * s + c, D = r * a * s + o * u, B = o * a * s - r * u, P = a * r * s - o * u, I = r * r * s + c, T = o * r * s + a * u, M = a * o * s + r * u, C = r * o * s - a * u, j = o * o * s + c, e[0] = f * F + _ * D + y * B, e[1] = m * F + w * D + b * B, e[2] = h * F + k * D + x * B, e[3] = g * F + p * D + $ * B, e[4] = f * P + _ * I + y * T, e[5] = m * P + w * I + b * T, e[6] = h * P + k * I + x * T, e[7] = g * P + p * I + $ * T, e[8] = f * M + _ * C + y * j, e[9] = m * M + w * C + b * j, e[10] = h * M + k * C + x * j, e[11] = g * M + p * C + $ * j, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e);
}
...
const bx = ["width", "height"], yx = /* @__PURE__ */ Ta({ __name: "WebGL", setup(e) {
  ...
  let a = null;
  const r = K([0, 0]), o = K(""), i = K(-1), u = K([0, 0, 0, 0]), c = K(640), s = K(480), f = K(0), m = (L, O, U, ye, W, q, ee) => {
    const G = [];
    for (let fe = 0; fe < 6; ++fe) G.push(L + (fe + ye) % 6 + 1 + ee), G.push(O + (fe + W) % 6 + 1 + ee), G.push(U + (fe + q) % 6 + 1 + ee);
    return G;
  }, h = () => {
    ...
    for (let H = 0; H < 6; ++H) U = U.concat([1, 1, 1, 1]);
    for (let H = 0; H < 6; ++H) U = U.concat([1, 1, 1, 1]);
    for (let H = 0; H < 6; ++H) U = U.concat([1, 1, 1, 1]);
    for (let H = 0; H < 6; ++H) U = U.concat([1, 1, 1, 1]);
    for (let H = 0; H < 6; ++H) U = U.concat([1, 1, 1, 1]);
    ...
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * H * 60 / 180;
      q = q.concat([0.5 + 0.5 * Math.cos(ue), 0.5 + 0.5 * Math.sin(ue)]);
    }
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * H * 60 / 180;
      q = q.concat([0.5 + 0.4 * Math.cos(ue), 0.5 + 0.4 * Math.sin(ue)]);
    }
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * H * 60 / 180;
      q = q.concat([0.7 + 0.4 * Math.cos(ue), 0.7 + 0.4 * Math.sin(ue)]);
    }
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * H * 60 / 180;
      q = q.concat([0.8 + 0.5 * Math.cos(ue), 0.8 + 0.5 * Math.sin(ue)]);
    }
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * H * 60 / 180;
      q = q.concat([0.5 + 0.5 * Math.cos(ue), 0.5 + 0.5 * Math.sin(ue)]);
    ...
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * (H + 1) * 60 / 180;
      q = q.concat([0.3 + 0.5 * Math.cos(ue + 0), 0.3 + 0.5 * Math.sin(ue + 0)]);
    }
    for (let H = 0; H < 6; ++H) {
      const ue = 3.141 * (H + 1) * 60 / 180;
      q = q.concat([0.3 + 0.5 * Math.cos(ue + 0), 0.3 + 0.5 * Math.sin(ue + 0)]);
    }
    n.bindBuffer(n.ARRAY_BUFFER, W), n.bufferData(n.ARRAY_BUFFER, new Float32Array(q), n.STATIC_DRAW);
    const ee = n.createBuffer();
    let G = [];
    for (let H = 1; H < 7; ++H) G = G.concat([0, H, 1 + H % 6]);
    ...
    let R = [0, 0, 1], A = [], te = [], V = [];
    for (let H = 0; H < 6; ++H) {
      const ue = H * 3.414 / 180 * 60, S = 0 * (90 * 3.414 / 180);
    ...
    n !== null && (n.uniform1i(O.unif.sampler, 0), n.uniform1f(O.unif.mode, 1), n.drawElements(n.TRIANGLES, 1 * 6 * 6, n.UNSIGNED_SHORT, 0), n.uniform1i(O.unif.sampler, 1), n.uniform1f(O.unif.mode, 0), n.drawElements(n.TRIANGLES, 3 * 6 * 6, n.UNSIGNED_SHORT, 2 * 3 * 6));
    ...
    const U = 45 * Math.PI / 180, ye = c.value / s.value, W = 0.1, q = 100, ee = uu();
    gx(ee, U, ye, W, q);
    const G = O;
    ...
    const U = 3, ye = n.FLOAT, W = false, q = 0, ee = 0;
    n.bindBuffer(n.ARRAY_BUFFER, L.bufs.pos), n.vertexAttribPointer(O ? L.attr.pos_pick : L.attr.pos, U, ye, W, q, ee), n.enableVertexAttribArray(O ? L.attr.pos_pick : L.attr.pos);
  }, y = (L) => {
  ...
  ft(() => {
    ...
    clearInterval($), window.removeEventListener("resize", j);
  });
